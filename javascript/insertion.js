...
if(key==113)
{
    ...
    if(document.activeElement.id=="txtdistrict")
        {      
            ...
            document.getElementById('divdistrict').style.top=165+ "px" ;
            document.getElementById('divdistrict').style.left=450+ "px";
            document.getElementById('lstdistrict').focus();
            insertion.fillF2_Creditexecutive(compcode,uid,F2filldistrict_callback);
           // return false;
      }
}
