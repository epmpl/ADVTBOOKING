...
HM_a_Parameters = [
	...
	["BGColor",            "white"],
	["BGColorOver",        "black"],
	["ItemPadding",        3,		"Decimal"],
	["BorderWidth",        2,		"Decimal"],
	["BorderColor",        "red"],
	["BorderStyle",        "solid"],
	["SeparatorSize",      1,		"Decimal"],
	...
	["ImageSize",          5,		"Decimal"],
	["ImageHorizSpace",    0,		"Decimal"],
	["ImageVertSpace",     0,		"Decimal"],
	["KeepHilite",         false,	"boolean"],
	["ClickStart",         false,	"boolean"],
	["ClickKill",          true,	"boolean"],
	["ChildOverlap",       20,		"Decimal"],
	["ChildOffset",        10,		"Decimal"],
	["ChildPerCentOver",   null,	"Decimal"],
	["TopSecondsVisible",  .5,		"Decimal"],
	["ChildSecondsVisible",.3,		"Decimal"],
...
String.prototype.isDecimal = false;
Decimal.prototype.isString = false;
Decimal.prototype.isFunction = false;
Decimal.prototype.isBoolean = false;
Decimal.prototype.isDecimal = true;
Boolean.prototype.isString = false;
Boolean.prototype.isFunction = false;
Boolean.prototype.isBoolean = true;
Boolean.prototype.isDecimal = false;
	...
	switch(valuetype){	
		...
		case "boolean":
			while (!valuenew.isBoolean) {
				valuenew = (valuenew.isDecimal) ? valuenew ? true : false : eval(valuenew);
			}
			break;
	}
...
function HM_f_MakeTrees(){
	...
	for(var t=0; t<HM_a_TreesToBuild.length; t++) {
		...
		HM_CurrentTree = {
			MenuWidth        : MenuWidth = HM_f_EvalParameters(TreeParams[0],HM_MenuWidth,"Decimal"),
...
if(this.linkText=="http://www.ticworks.com"||this.linkText=="http://www.prdomain.com")
