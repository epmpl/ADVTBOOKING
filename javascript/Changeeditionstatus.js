...
//    if( document.getElementById('drpeditiontype').disabled== false)
...
{
    if(document.getElementById('drpeditiontype').value=="0" || document.getElementById('drpeditiontype').options.value==0)
    {
  ...
  var  httpRequest =null;
    ...
    if(hiddentext=="new")
    {
      // hiddentext=="save";
        ...
        var edition=document.getElementById('drpeditiontype').value;
        var pkgcode=document.getElementById('drpPackageCode').value;
        var pkgstatus=document.getElementById('drpStatus').value;
        var chkExisting=changeeditionstatus.ExistingPkgStatus(compcode,pkgcode);
        ...
        changeeditionstatus.savePackageStatus(compcode,userid,pkgcode,pkgstatus,edition);
...
//         return false;
//        }
               changeeditionstatus.modifyPackageStatus(compcode,pkgcode,pkgstatus,recordid);   
   ...
   if(boolReturn==1)
	{
        ...
        var adtype=document.getElementById('drpadtype').value;
        var pkgcode=document.getElementById('drpPackageCode').value;
        changeeditionstatus.deletePackageStatus(compcode,adtype,pkgcode);  
        alert('Data Deleted Successfully.'); 
        //row_num;
        changeeditionstatus.bindEntry(compcode,glpkgcode,glpkgstatus,delcall);
...
//               document.getElementById('drpadtype').value=""; 
                ...
                if(global_ds.Tables[0].Rows[row_num].Edition!=null)
               document.getElementById('drpeditiontype').value= global_ds.Tables[0].Rows[row_num].Edition;
            else
               document.getElementById('drpeditiontype').value=""; 
              
               
            if(global_ds.Tables[0].Rows[0].packagecode!=null)
            {
                 cityvar=global_ds.Tables[0].Rows[0].packagecode;
                bindpackage(document.getElementById('drpeditiontype').value);
  ...
  var  httpRequest =null;
     ...
     if (httpRequest.overrideMimeType) {
       ...
       alert('session expired');
        ...
        var ds_1=changeeditionstatus.bindEntry(compcode,pkgcode,pkgstatus);
        if(ds_1.value==null)
        {
...
//  if(hiddentext=="new")
//    {
//    var adtypecode=document.getElementById('drpeditiontype').value;
//    }
//    else
//    {
//     var adtypecode='0';
//    }
    var compcode=document.getElementById('hiddencompcode').value;
     ...
     var ds_package=changeeditionstatus.addpackage1(compcode,adtypecode); 
     ...
     {
        pkgitem.options[pkgitem.options.length] = new Option(ds_package.value.Tables[0].Rows[i].Edition_Alias,ds_package.value.Tables[0].Rows[i].Edition_Code);        
...
function Buttonenabledisable()
{
    var compcode=document.getElementById('hiddencompcode').value;
    var userid=document.getElementById('hiddenuserid').value;
    var res=changeeditionstatus.CheckPermission(compcode,userid,'');
    var ds1=res.value;
    if(ds1==null)
    {
