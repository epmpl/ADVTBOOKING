			...
			while(i1<tot)
			{
			    if(document.getElementById('hiddendateformat').value=="mm/dd/yyyy")
			    {
			        ...
			        if(val!="")
			        {
			            ...
			            if (caldatemonth[j1].length == "1")
			                caldatemonth[j1] = "0" + caldatemonth[j1].toString();
...
function hadDoubleClick() {
    ...
    */
    ...
    {
     if(document.getElementById('drpratecode')!=null)
        document.getElementById('drpratecode').style.visibility = "";
        if(document.getElementById('drprptcurrency')!=null)
        document.getElementById('drprptcurrency').style.visibility = "";
     if(document.getElementById('drpedition')!=null)
        document.getElementById('drpedition').style.visibility = "";
    if(document.getElementById('drpourbank')!=null)
        document.getElementById('drpourbank').style.visibility = "";
      if(document.getElementById('drpboxcode')!=null)
        document.getElementById('drpboxcode').style.visibility = "";
     if(document.getElementById('drppagetype')!=null)
        document.getElementById('drppagetype').style.visibility = "";
      if(document.getElementById('drppageprem')!=null)
        document.getElementById('drppageprem').style.visibility = "";
    if(document.getElementById('drpadstype')!=null)
        document.getElementById('drpadstype').style.visibility = "";
    if(document.getElementById('drppageposition')!=null)
        {
            document.getElementById('drppageposition').style.visibility = "";
        }
        if(document.getElementById('drpbullet')!=null)
        {
            document.getElementById('drpbullet').style.visibility = "";
        }
      if(document.getElementById('drppackage')!=null)
        {
            document.getElementById('drppackage').style.visibility = "";
        }
         if(document.getElementById('drppackagecopy')!=null)
        {
            document.getElementById('drppackagecopy').style.visibility = "";
        }
          if(document.getElementById('drpcurrency')!=null)
        {
            document.getElementById('drpcurrency').style.visibility = "";
        }
        if(document.getElementById('drpyear')!=null)
        {
            document.getElementById('drpyear').style.visibility = "";
        }
         if(document.getElementById('drpmonth')!=null)
        {
            document.getElementById('drpmonth').style.visibility = "";
        }
         if(document.getElementById('drptype')!=null)
        {
            document.getElementById('drptype').style.visibility = "";
        }
          if(document.getElementById('drpadcat4')!=null)
        {
            document.getElementById('drpadcat4').style.visibility = "";
        }
          if(document.getElementById('drpbgcolor')!=null)
        {
            document.getElementById('drpbgcolor').style.visibility = "";
        }
        if(document.getElementById('drpcolor')!=null)
        {
            document.getElementById('drpcolor').style.visibility = "";
        }
         if(document.getElementById('drpbillcycle')!=null)
        {
            document.getElementById('drpbillcycle').style.visibility = "";
        }
         if(document.getElementById('drprevenue')!=null)
        {
            document.getElementById('drprevenue').style.visibility = "";
        }
        if(document.getElementById('drppaymenttype')!=null)
        {
            document.getElementById('drppaymenttype').style.visibility = "";
        }
           if(document.getElementById('drpbillstatus')!=null)
        {
            document.getElementById('drpbillstatus').style.visibility = "";
        }
  if(document.getElementById('drpbillto')!=null)
        {
            document.getElementById('drpbillto').style.visibility = "";
        }

        if(document.getElementById('drpmatstat')!=null)
        {
            document.getElementById('drpmatstat').style.visibility = "";
        }
         if(document.getElementById('drpmatsta')!=null)
        {
            document.getElementById('drpmatsta').style.visibility = "";
        }
        if(document.getElementById('drpbrand')!=null)
        {
            document.getElementById('drpbrand').style.visibility = "";
        }
         if(document.getElementById('drpuom')!=null)
        {
            document.getElementById('drpuom').style.visibility = "";
        }
          if(document.getElementById('drpadcategory')!=null)
        {
            document.getElementById('drpadcategory').style.visibility = "";
        }
          if(document.getElementById('drpadsubcategory')!=null)
        {
            document.getElementById('drpadsubcategory').style.visibility = "";
        }
          if(document.getElementById('drpadcat3')!=null)
        {
            document.getElementById('drpadcat3').style.visibility = "";
        }
          if(document.getElementById('drpadcat5')!=null)
        {
            document.getElementById('drpadcat5').style.visibility = "";
        }
          if(document.getElementById('drpbooktype')!=null)
        {
            document.getElementById('drpbooktype').style.visibility = "";
        }
           if(document.getElementById('txtratecode')!=null)
        {
            document.getElementById('txtratecode').style.visibility = "";
        }
     return;
    try
    {
...
//		consdate=constructDate(dateSelected,monthSelected,yearSelected);
	...
	try
	{
	  ...
	  function hideCalendar1(dummy)
	  {
	    try
	    {
	    var consdate;
	    var flagret = "T";
	   // alert(document.activeElement.id+"dateSelected:"+dateSelected+"id"+dummy.id);
	   var dummyid="";
	   if(dummy!=undefined && dummy!="undefined")
	    dummyid=dummy.id;
	    if(dateSelected==undefined || dateSelected=="" || document.activeElement.id=="txtdummydate" || dummyid =="txtdummydate")
	    {
	            name="txtdummydate";
	            var dateformat = document.getElementById('hiddendateformat').value;
	            //==================To enter Date Without "/" ============================//
	            var dateInitial = "20";
	            var dateenter = document.getElementById('txtdummydate').value;
	            if (dateenter.indexOf('/') < 0) {
	                ...
	                if (dateformat == "mm/dd/yyyy") {
	                    if (dateenter.length >= "8")
	                        ...
	                        date12 = document.getElementById('txtdummydate').value;
	                }
	                ...
	                document.getElementById('txtdummydate').value = date12;
	            }
	            //==============================================================================//
                  ...
                  if (!validformat.test(document.getElementById('txtdummydate').value))
                  {
	        	...
	        	var txt1=document.getElementById('txtdummydate').value.split("/");
                if(dateformat=="dd/mm/yyyy")
                {
                ...
                consdate=document.getElementById('txtdummydate').value;
	   ...
	   else
	   {
		...
		alert("Booking Date can't Be Less than or equal to Current Date");
//		dummydate=tempdate;
//		document.getElementById('txtdummydate').value=tempdate;
		return false;
		}
		// for back days
		if(document.URL.indexOf('Classified_Booking.aspx')>=0 )//&& ctlToPlaceValue==undefined) //Kuldeep
		{
		    	//for backdays check
      ...
      if(pdateformat=="dd/mm/yyyy")
      {
        ...
        seldt123 = tmpdata[0] + "/" + tmpdata[1] + "/" + tmpdata[2]
      }  
      else if(pdateformat=="yyyy/mm/dd")
      {
        var tmpdata=pentrydate.split("/")
        seldt = tmpdata[1] + "/" + tmpdata[2] + "/" + tmpdata[0]
        seldt123 = tmpdata[1] + "/" + tmpdata[2] + "/" + tmpdata[0]
      }  
      var dt=new Date()
      var seldt=new Date(seldt)
      if(dt.toString().substring(0,10)!=seldt.toString().substring(0,10))
      {
          var ds = Classified_Booking.backdate_validate(pcompcode, pformname, puserid, seldt123, pdateformat, pextra1, pextra2);
            if(ds.error!=null)
            {
                alert(ds.error);
                return false;
		...
		//////bhanu
		if(document.URL.indexOf('Booking_master.aspx')>=0)
		{
		    	//for backdays check
		 var pcompcode=document.getElementById('hiddencompcode').value;
      var pformname="Classified_Booking"
    ...
    if (document.URL.indexOf('QBC.aspx') >= 0) {
        //for backdays check
        var pcompcode = document.getElementById('hiddencompcode').value;
        var pformname = "QBC"
        var puserid = document.getElementById('hiddenuserid').value
        ...
        var seldt = new Date(seldt)
        if (dt.toString().substring(0, 10) != seldt.toString().substring(0, 10)) {
            var dsback = QBC.backdate_validate(pcompcode, pformname, puserid, pentrydate, pdateformat, pextra1, pextra2);
            if (dsback.error != null) {
                alert(ds.error);
                return false;
            }
            else if (dsback.value == 'N') {
                alert('You can not enter data for this date !!');
                document.getElementById('txtdummydate').value = "";
                document.getElementById('txtdummydate').focus();
                return false;
  ...
  ///web boking
  if (document.URL.indexOf('web_booking.aspx') >= 0) {
      //for backdays check
      var pcompcode = document.getElementById('hiddencompcode').value;
      var pformname = "web_booking"
      var puserid = document.getElementById('hiddenuserid').value
      var pentrydate = document.getElementById('txtdummydate').value
      var pdateformat = document.getElementById('hiddendateformat').value;
      var pextra1 = ""
      ...
      if (dt.toString().substring(0, 10) != seldt.toString().substring(0, 10)) {
		...
		//if(dummydate=="")
		//{
		    dummydate=document.getElementById('txtdummydate').value;
		//}
        var dateday=dummydate;//document.getElementById('txtdummydate').value;
                  var compcode=document.getElementById('hiddencompcode').value;
        var strtext="";
        //NEW CHANGE
        //
        var rowcount=document.getElementById('bookdiv').getElementsByTagName('table')[0].rows.length - 1;  
        for(var x=0;x<parseInt(rowcount);x++)
		//for(x=0;x<obj.options.length;x++)
		{
		         // var strid = obj.options[x].value;
		          if(pkgfullname=='')
		          {
		            pkgfullname=document.getElementById('pkg_alias'+x).value;//obj.options[x].text.substring(0,obj.options[x].text.indexOf('('));
		          }
		          else
		          {
		             pkgfullname=pkgfullname + "+ " + document.getElementById('pkg_alias'+x).value;//obj.options[x].text.substring(0,obj.options[x].text.indexOf('('));
		          }
                //  var strid1=strid.split('@');
                    temp_pkg=document.getElementById('pkg_alias'+x).value;
                  // temp_pkg=strid1[1];
                   value="1";
                   /*new change ankur*/
                   if(pkgid=="")
                   {
                     pkgid=document.getElementById('hiddenpckcode'+x).value;
                   }
                   else
                   {
                     pkgid=pkgid + '+' + document.getElementById('hiddenpckcode'+x).value;
                   }
                   if(pkgname=="")
                   {
                    pkgname=temp_pkg;
                   ...
                   {
                    pkgname=temp_pkg+ "+" +pkgname;
                   }
                  
                 
        }
        /*new change ankur 26 feb*/
        globalpkgname=pkgfullname;
        ////////////////////////
        var arS=new Array();
        arS=pkgname.split('+');
        var jS=0;
        for(jS=0;jS<arS.length;jS++)
        {
...
//////////                httpRequest.open( "GET","packagename.aspx?adcat="+adcat+"&pkgid="+pkgid+"&compcode="+compcode+"&value="+value+"&dateday="+dateday+"&pkgname="+pkgfullname, false );
//////////                httpRequest.send('');
...
//////////                var adcat=document.getElementById('drpadcategory').value;
//////////                var center='';
//////////                if(document.getElementById('hiddencenter')!=null)
//////////                {
...
//////////                }
//////////                }
//////////                xml.Open( "GET","packagename.aspx?center="+center+"&adtype="+document.getElementById('hiddenadtype').value+"&adcat="+adcat+"&pkgid="+pkgid+"&compcode="+compcode+"&value="+value+"&dateday="+dateday+"&pkgname="+pkgfullname, false );
//////////                xml.Send();
...
//////////                    return false;
//////////                }
//////////                /*new change ankur 24 feb  validuse*/
//////////                if(strtext!="1" && strtext!="0")
//////////                {
//////////                
//////////                    //alert(strtext)
//////////                     if(globalpkgname.indexOf("+")>=0 )
//////////                    {
//////////                        
//////////                    }
//////////                    else
...
//////////                        {
//////////                            document.getElementById('txtdummydate').value=strtext;
//////////                        }   
//////////                    }
//////////                     
//////////                    
//////////                    var valdate;var valmon;var valyear;
//////////                    //constructDate(dateSelected,monthSelected,yearSelected)
//////////                    /*new changes ankur 24feb*/
//////////                    validuse="validdateselection";
//////////                 
//////////	            ///////////////////////////////////////////////////////////////////////
//////////                    
//////////                    
//////////                }
                 ...
                 /*this is to see that whether there is a booking of cyop or package and in preferrences valid date is yes than callback function is used*/
        /*new change ankur 26 feb*/
            //if(globalpkgname.indexOf("+")>=0 && document.getElementById('hiddenvaliddate').value=="yes" && strtext=="1")
            
            if(document.getElementById('hiddenvaliddate')!=null && document.getElementById('hiddenvaliddate').value=="yes")
            {
            
                validuse="validdateselection";
                if (document.URL.indexOf('Booking_master.aspx') >= 0) {
                    var resbook = Booking_master.get_validdates(document.getElementById('hiddendateformat').value, dummydate, globalpkgname, document.getElementById('drpadcategory').value, document.getElementById('hiddencenter').value, pkgid, globalpkgname); //,call_getvaliddate)
                    call_getvaliddate(resbook);
                    if (flagret == "F")
                        return false;
                }
                else if (document.URL.indexOf('Classified_Booking.aspx') >= 0) {
                    Classified_Booking.get_validdates(document.getElementById('hiddendateformat').value, dummydate, globalpkgname, document.getElementById('drpadcategory').value, document.getElementById('hiddencenter').value, pkgid, globalpkgname, call_getvaliddate)
                }
                else if (document.URL.indexOf('QBC.aspx') >= 0) {
                //////////////////////repated date alert
                    var rowlength = document.getElementById('bookdiv').getElementsByTagName('table')[0].rows.length - 1;
                    for (k = 0; k < parseInt(rowlength); k++) {
                        if (consdate == document.getElementById('Text' + k).value)//ok then break call abc.get_validationotherwisw returnfalse
                        {
                            if (confirm("Date is already fill.Do you want to continue?")) {
                    ...
                    QBC.get_validdates(document.getElementById('hiddendateformat').value, dummydate, globalpkgname, document.getElementById('drpadcategory').value, document.getElementById('hiddencenter').value, pkgid, globalpkgname, call_getvaliddate)
                }
                else if (document.URL.indexOf('web_booking.aspx') >= 0) {
                    web_booking.get_validdates(document.getElementById('hiddendateformat').value, dummydate, globalpkgname, document.getElementById('hdncategory').value, document.getElementById('hiddencenter').value, pkgid, globalpkgname, call_getvaliddate)
                }
                return false;
            } 
            else
         ...
         //}
                    ...
                    // {
                        ...
                        {
                            tdText=document.getElementById("gridtab").rows[rowlength].cells[2].innerHTML.split("id=");
                        }    
                    // }
                   //  else
                    // {
	                 //   tdText=document.getElementById("gridtab").rows(rowlength).cells(2).innerHTML.split("id=");
	                 //}
	                var id=tdText[1]//.split("onfocus");
	                var id12=id.substring(id.indexOf("Text"),11);
	                 id12N=id12.split(' ');
                    ...
                    while (isnumber(id12.substring(id12.length-1))==false);
                    var abc=id12;
...
//////	                 id[0]=trim(id[0].replace('class=btextforgrid type=text',''));
//////	                 //alert(id);
//////	                 var val="";
...
//////	                 }
	               ...
	               //   if(document.getElementById(val).value!="" && name=="txtdummydate")
	                 if (caldate.length >0 && name == "txtdummydate")
	                {
	                 if(!confirm("Do you want to increase the insertion"))
		             ...
		             else
		                {
		                     ...
		                     /*22april*/
                           /* document.getElementById('txtfixamt').value="";
                            document.getElementById('txtfixdisc').value="";
                            document.getElementById('txtagreed').value="";*/
                            ///////////////// 
		                    ...
		                    if(validuse!="validdateselection")
		                    {
		                            ...
		                            if ((caldatemonth[cali].toString()).length == "1")
		                                caldatemonth[cali] = "0" + caldatemonth[cali].toString();
	                                caldateyear[cali]=yearSelected;
	                        }
	                        else
	                        {
	                                var splitaliddate=strtext.split("/");
	                                if(document.getElementById('hiddendateformat').value=="mm/dd/yyyy")
	                                {
	                                ...
	                                else if(document.getElementById('hiddendateformat').value=="dd/mm/yyyy")
	                                {
	                                    ...
	                                    var cmon=splitaliddate[1];
	                                    caldatemonth[cali] = cmon - 1;
	                                    if ((caldatemonth[cali].toString()).length == "1")
	                                        caldatemonth[cali] = "0" + caldatemonth[cali].toString();
	                                    caldateyear[cali]=splitaliddate[2];
	                                }
	                ...
	                if(checkflag=="0")
	                {
	                    ...
	                    if(validuse!="validdateselection")
	                        ...
	                        if(document.getElementById('hiddendateformat').value=="mm/dd/yyyy")
	                        {
	                            if(validuse!="validdateselection")
	                            {
	                                    if(mond.toString().length==1)
	                                        mond="0" + mond;
	                                     if(dateSelected.toString().length==1)
	                                        dateSelected="0" + dateSelected;    
	                                  sDate=mond + "/" + dateSelected + "/" + yearSelected;
	                                 if(browser!="Microsoft Internet Explorer")
                                    {
                                      
	                                     var a1="id=\"Text"+st+"\" value=\"\"";
	                                     document.getElementById('tblinsert').innerHTML=document.getElementById('tblinsert').innerHTML.replace(a1,"id=\"Text"+st+"\" value=\""+sDate+"\"");
	                                   //alert(document.getElementById('tblinsert').innerHTML);
	                                   
	                                  }  
	                                  else
	                                  {
	                                    document.getElementById('Text'+st).value=sDate;
	                                  } 
	                            }
	                            else
	                            {
	                                
	                                 sDate=caldatemonth[cali] + "/" + caldate[cali] + "/" + caldateyear[cali];
	                                   if(browser!="Microsoft Internet Explorer")
                                    {
	                        ...
	                        else if(document.getElementById('hiddendateformat').value=="dd/mm/yyyy")
	                        {
	                            if(validuse!="validdateselection")
	                            {
	                               if(mond.toString().length==1)
	                                     ...
	                                     if(dateSelected.toString().length==1)
	                                        dateSelected="0" + dateSelected; 
	                                sDate=dateSelected + "/" + mond + "/" + yearSelected;
	                                  if(browser!="Microsoft Internet Explorer")
                                    {
	                            ...
	                            else
	                            {
	                                ...
	                                sDate=caldate[cali] + "/" + caldatemonth[cali] + "/" + caldateyear[cali];
	                                  if(browser!="Microsoft Internet Explorer")
                                    {
	                        ...
	                        if (dateSelected.toString().length == 1)
	                            ...
	                            if(validuse!="validdateselection")
	                            {
	                                sDate=yearSelected + "/" + mond + "/" + dateSelected;
	                                  if(browser!="Microsoft Internet Explorer")
                                    {
	                            ...
	                            {
	                                sDate=caldateyear[cali] + "/" + caldatemonth[cali] + "/" + caldate[cali];
	                                  if(browser!="Microsoft Internet Explorer")
                                    {
                  ...
                  {}
                  var noi=document.getElementById('txtinsertion').value;
//                       if(noi == '1')
//                   {
//                       temdategaurav1=consdate;
//                   }
//                       document.getElementById('txtdummydate').value=temdategaurav1 ; 
	    //crossobj.visibility="hidden"
	        //showElement( 'SELECT' );
		    //showElement( 'APPLET' );   
	    }
	    ...
	    /*new change ankur 26 feb*/
	    function call_getvaliddate(res)
	    {
	               // cali=0;
	                        var ds=res.value;
	                        gbincinsds=ds;
	                        mond = parseInt(monthSelected) + 1;
//	                        if (dummydate != ds.Tables[0].Rows[0].date_noissue) {
//	                            alert(dummydate + " Date is no issue date");
//                            }
	                                var gridlen =  document.getElementById('hiddenrowcount').value;
	                                ...
	                                if(document.getElementById('txtdummydate').value=="")
                                    {
	                                     document.getElementById('txtdummydate').value=ds.Tables[0].Rows[0].date_noissue
	                                }
	                                 dummydate = document.getElementById('txtdummydate').value;
                       ...
                       //  }
                        ...
                        // {
	                        //tdText=document.getElementById("gridtab").rows(rowlength).cells(2).innerHTML.split("id=");
	                   //  }
	                      var id=tdText[1]//.split("onkeydown");
	                      var id=tdText[1]//.split("onfocus");
	                        var id12=id.substring(id.indexOf("Text"),11);
	                        id12=id12.replace('"','');
	                        id12=id12.replace('>','');
...
//////	                     }
	                   ...
	                   if (caldate.length>0 && name == "txtdummydate")
	                    {
	                        if (chkforalert == "Y" && document.getElementById('hiddenadtype').value != "CL0") {
	                            if (!confirm("Do you want to increase the insertion")) {
	                                checkflag = "0";
	                                ...
	                                if (validuse != "validdateselection") {
	                                    ...
	                                    // var splitaliddate=dummydate.split("/");
	                                    if (document.getElementById('hiddendateformat').value == "mm/dd/yyyy") {
	                                        caldate[cali] = splitaliddate[1];
	                                        caldatemonth[cali] = splitaliddate[0];
	                                        if ((caldatemonth[cali].toString()).length == "1")
	                            ...
	                            if (validuse != "validdateselection") {
	                                caldate[cali] = dateSelected;
	                                if ((caldate[cali].toString()).length == "1")
	                                    caldate[cali] = "0" + caldate[cali].toString();
	                                caldatemonth[cali] = parseInt(monthSelected) + 1;
	                                if ((caldatemonth[cali].toString()).length == "1")
	                                    caldatemonth[cali] = "0" + caldatemonth[cali].toString();
	                                caldateyear[cali] = yearSelected;
...
//	                    {
	                  ...
	                  var len="bookdiv";
                        ...
                        countGridElement=gridItemCount;
	                        ...
	                        /*new change ankur 24 feb*/
//                	        for(var jk=0jk<ds.Tables[1].Rows.length;j++)
//                	        {
	                                        var mond;
	                                        var splitaliddate;
	                                        var edit="edit"+k;
	                                        if(validuse!="validdateselection")
		                                        {
	                                                ...
	                                                mond=parseInt(monthSelected)+1;
	                                                    ...
	                                                    if(ds==null)
	                                                        return false;
	                                                        for(var jk=0;jk<=ds.Tables[1].Rows.length-1;jk++)
	                                                        {
	                                                        var edit_="edit"+jk;
	                                                        if (ds.Tables[1].Rows[jk].Edition_code == document.getElementById(edit).value || (ds.Tables[1].Rows[jk].Edition_code1!=null && ds.Tables[1].Rows[jk].Edition_code1 == document.getElementById(edit).value))
	                                                                {
	                                                                //DATE_NOISSUE
	                                                                if(ds.Tables[1].Rows[jk].date_noissue!=null)
	                                                                {
	                                                                         splitaliddate=ds.Tables[1].Rows[jk].date_noissue.split("/");
	                                                                        if(document.getElementById('hiddendateformat').value=="mm/dd/yyyy")
	                                                                        {
	                                                                            caldate[cali] = splitaliddate[1];
	                                                                            if ((caldate[cali].toString()).length == "1")
	                                                    ...
	                                                    if(document.getElementById('hiddendateformat').value=="mm/dd/yyyy")
	                                                    {
	                                                        ...
	                                                        {
	                                                            if(caldate[cali]!='undefined' && caldate[cali]!=undefined)
	                                                            {
	                                                    ...
	                                                    if (dummydate != document.getElementById('txtdummydate').value || (dummydate != caldate[cali] + "/" + caldatemonth[cali] + "/" + caldateyear[cali] && caldate[cali] + "/" + caldatemonth[cali] + "/" + caldateyear[cali] != "undefined/undefined/undefined")) {
	                                                        alert(document.getElementById('txtdummydate').value + " Date is no issue date");
	                                                        document.getElementById('Text' + st).value = ds.Tables[1].Rows[jk].date_noissue;
//	                                                        cali = cali - 1;
	                                                    }
	                                                    // check valid date for grid item line
	                                                    var jj = validDate_Grid('Text' + st);
	                                                    if (jj == false) {
	                                                        document.getElementById('Text' + st).value = "";
	                                                        return false;
	                                                    }
	                                                    }
	                                                    cali=cali+1;
		...
		var	sTmp;
dummydate=constructDate(dateSelected,monthSelected,yearSelected);
if(ctlToPlaceValue.id=="txtdummydate")
{
...
var idvalue=globalid.id;
 ...
 {
 var test=chkdateforbook(globalid,ctlval);
 if(test==false)
 {
    return false;
 }
 ...
 {
    arr_consdate=consdate.split('/');
    var dd=arr_consdate[0];
    var mm=arr_consdate[1];
    var yy=arr_consdate[2];
    consdate= mm + "/" + dd + "/" + yy;
    if(currdate != "")
    {
        var txt=currdate;
 ...
 {
    arr_consdate=consdate.split('/');
    var dd=arr_consdate[2];
    var mm=arr_consdate[1];
    var yy=arr_consdate[0];
    consdate= mm + "/" + dd + "/" + yy;
...
var fdate=new Date(consdate);
var tdate=new Date(currdate);
...
if(tdate>fdate && (document.getElementById('hiddenbackdatebook').value=="0" || document.getElementById('hiddenbackdatebook').value=="N"))
{
 	...
 	if(name.indexOf("Text")==0)
		{
                ...
                if(strtext!="1" && strtext!="0")    
                {
                     if(document.getElementById(name).value==document.getElementById('txtdummydate').value)
                        document.getElementById('txtdummydate').value=strtext;
 ...
 if(idvalue=="txtrodate" )
		        ...
		        chkratedate();
        		hideCalendar();
        		if(document.getElementById('drprostatus')!=null && document.getElementById('drprostatus').disabled==false)
                ...
                ///bhanu//
                    if (idvalue == "txtrevisedate") {
                        bindrategroupcodeforreviserate();
                      hideCalendar();
                      if (document.getElementById('txtrevisedate') != null && document.getElementById('txtrevisedate').disabled == false)
                          document.getElementById('txtrevisedate').focus();
                      //return false;
...
if(caldate.length==0)
	...
	try
	{
		...
		if (browser != "Microsoft Internet Explorer") {
		    	 ...
		    	 crossYearObj.left += "180px"

		    	
		    	 crossYearObj.top += "480px"
   ...
   try
   {
	...
	try
	{
		...
		for	( datePointer=1; datePointer<=numDaysInMonth; datePointer++ )
		{
			...
			var kcal=0;
			if(name!="txtrodate" && name!="txtreceiptdate")
			{
...
//	}
	...
	function getMonthNo(monthname)
	{
	    ...
	    else  if(monthname=="Feb" || monthname=="FEB")
	    {
	     ...
	     if(monthname=="Mar" || monthname=="MAR")
	    {
	        monthno="03";
	    }
	     if(monthname=="Apr" || monthname=="APR")
	    {
	        monthno="04";
	    }
	     if(monthname=="May" || monthname=="MAY")
	    {
	     ...
	     if(monthname=="Jun" || monthname=="JUN")
	    {
	        monthno="06";
	    }
	     if(monthname=="Jul" || monthname=="JUL")
	    {
	        monthno="07";
	    }
	     if(monthname=="Aug" || monthname=="AUG")
	    {
	        monthno="08";
	    }
	     if(monthname=="Sep" || monthname=="SEP")
	    {
	        monthno="09";
	    }
	     if(monthname=="Oct" || monthname=="OCT")
	    {
	        monthno="10";
	    }
	     if(monthname=="Nov" || monthname=="NOV")
	    {
	        monthno="11";
	    }
	     if(monthname=="Dec" || monthname=="DEC")
	    {
	        monthno="12";
	    }
	    return monthno;
