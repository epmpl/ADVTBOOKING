...
if (modi == "11")
 ...
 {
    // logo_Premium.update1(compcode, userid, logoprem, edition, amount, premimum, temp1,validfrom, validto);
 ...
 logo_Premium.update1(compcode, userid, logoprem, edition, amount, premimum, temp1,validfrom, validto);
    ...
    
    {
        ...
        var bb = logo_Premium.duplicay(compcode, logoprem, edition, validfrom, validto);
...
//            return false;
        ...
        var aa = logo_Premium.save(compcode, userid, logoprem, edition, premimum, amount, validfrom, validto);
      ...
      //  alert("9")
       ...
       // logo_Premium.save(compcode, userid, logoprem, edition, premimum, amount);
    }
...
function insertretstatuscall(response) 
{
    ...
    logo_Premium.binddata123(document.getElementById('hiddencompcode').value, document.getElementById('hdnlogo').value);
    window.location = window.location
...
//        }
        ...
        //	
        //	}
        var aa = logo_Premium.bindlogo1(compcode, logocode, temp1);
...

{
    ...
    logo_Premium.Delete(compcode,temp1);
    window.location = window.location;
