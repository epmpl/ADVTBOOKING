...
//
    ...
    /*change ankur*/
    if(document.getElementById('hiddenuomdesc').value=="ROL" || document.getElementById('hiddenuomdesc').value=="ROW" || document.getElementById('hiddenuomdesc').value=="ROD")
    {
...
else if((document.getElementById('txtrate').value=="" || document.getElementById('txtrate').value=="0") && (document.getElementById('txtextrarate').value=="" || document.getElementById('txtextrarate').value=="0"))
{
...
return false;
    ...
    {
    arrayweekendrate=weekendrate+arrayweekendrate;
    }
...
var packagecode=document.getElementById('drppkgcode').value;
    ...
    if(packagecode!="0")    
    {
        ...
        popup= window.open('seealeditrate.aspx?packagecode='+packagecode,'Ankur2', 'status=0,toolbar=0,resizable=0,scrollbars=yes,top=244,left=210,width=780px,height=415px');
        popup.focus();
    }
    else
    {
...
function executeclick()
{
    ...
    var res = Ratemaster.executerate(compcode, ratecode, adtype, currency, rategroup, colorcode, uomcode, pkgcode, center)
    ...
    var index1=document.getElementById("drpadtype").selectedIndex;
       ...
       /* if (uom_desc == "ROW")
        {           
         ...
         if (uom_desc == "ROL" || uom_desc == "ROD" || uom_desc == "ROW")
        {
             if(hiddentext!="query")
                 enabledayrate();
               document.getElementById('txtrate').disabled=false;
...
function saveclick()
{
    ...
    var premium = document.getElementById("drppremium").value;
   ...
   // if(adtype=="CL0")
    //{
        rateuniqueid = pubcenter + ratecode + adtype + adcategory + adsubcategory + color + packagecode + currency + fromdate + tilldate + uom + adscat4 + adscat5 + adscat6 + premium + sizefrom + sizeto + txtfrominsert + txttoinsert + clientcat;
    //}
//    if(adtype=="DI0")
//    {
     ...
     if (httpRequest.overrideMimeType) {
       ...
       alert('session expired');
           ...
           return false;
            ...
            disabledayrate();
            updateStatusRate();
            var res = Ratemaster.executerate(compcode, gbratecode, gbadtype, gbcurrency, gbratetype, gbcolor, gbuom, gbpkgcode, gbcenter)
            executeclick_call(res);
