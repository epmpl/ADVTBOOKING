...
function NewClick2() {
    ...
    document.getElementById('lbcommdetail').value = "";
...
function CancelClick2() {
    ...
    givebuttonpermission('stylemaster');
    setButtonImages();
    return false;
}
...
function SaveClick2(compcode1) {
    ...
    //  document.getElementById('drpremium').value=trim(document.getElementById('drpremium').value);
    ...
    var Amount = document.getElementById('txtamount').value;
    var premium = document.getElementById('drpremium').value;
    var pub_code = document.getElementById('hdnpub_code').value;
    var edit_code = document.getElementById('hdnedit_code').value;
    var adcat_code = document.getElementById('hdnadcat_code').value;
    ...
    var reschk = stylemaster.chkpastypename(PosTypCode, PosType, compcode, userid, flag, fdate, tdate);
    var ds = reschk.value;
    ...
    if (flag == 1)
    {
        ...
        //stylemaster.modify(PosTypCode, PosType, Alias, Amount, premium, compcode, userid, fdate, tdate, description);
        stylemaster.modify(compcode, PosTypCode, PosType, Alias, Amount, premium, userid, fdate, tdate, description, pub_code, edit_code, adcat_code);
        document.getElementById('btnNew').disabled = true;
        document.getElementById('btnSave').disabled = true;
        ...
        advpostypeds.Tables[0].Rows[z].STY_TYPE_CODE = PosTypCode;
        advpostypeds.Tables[0].Rows[z].STY_TYPE = PosType;
        advpostypeds.Tables[0].Rows[z].STY_TYPE_ALIAS = Alias;
        ...
        stylemaster.chksave(compcode, PosTypCode, userid, callsave);
...
function callsave(res) {
    ...
    if (ds.Tables[0].Rows.length == 0) {
        ...
        var description = document.getElementById('txtdessigndesc').value; 
        var stylecode = document.getElementById('txtPosTypCode').value;
        if (browser != "Microsoft Internet Explorer") {
            var httpRequest = null;
            httpRequest = new XMLHttpRequest();
            if (httpRequest.overrideMimeType) {
            ...
            //httpRequest.onreadystatechange = function() { alertContents(httpRequest) };
            httpRequest.open("GET", "savestylepopup.aspx?bulletcode=" + stylecode, false);
            httpRequest.send('');//     
        }
        else {
            var xml = new ActiveXObject("Microsoft.XMLHTTP");
            xml.Open("GET", "savestylepopup.aspx?bulletcode=" + stylecode, false);
            xml.Send();
            var dl = xml.responseText;
        }
 
	stylemaster.insert(compcode, PosTypCode, PosType, Alias, Amount, premium, userid, fdate, tdate, description, pub_code, edit_code, adcat_code);
        //stylemaster.insert(PosTypCode, PosType, Alias, Amount, premium, compcode, userid, fdate, tdate, description);
...
function uppercase3() {
    ...
    if (document.getElementById('txtPosType').value != "") {
        ...
        str = mstr;
        stylemaster.chkadvposition(str, fillcall);
        return false;
    }
    return false;
...
function fillcall(res) {
    ...
    //		        else
    {
        if (ds.Tables[1].Rows.length == 0) {
            ...
            newstr = ds.Tables[1].Rows[0].STY_TYPE_CODE;
        }
        if (newstr != null) {
...
function ExecuteClick2(compcode1)
{
	...
	stylemaster.Selectpage(compcode, PosTypCode, PosType, Alias, Amount, premium, userid, dateformat, call_Execute);
    //stylemaster.Selectpage(PosTypCode, PosType, Alias, Amount, premium, compcode, userid, call_Execute);
...
function call_Execute(response)
{
    ...
    {
        document.getElementById('txtPosTypCode').value = advpostypeds.Tables[0].Rows[0].STY_TYPE_CODE;
        document.getElementById('txtPosType').value = advpostypeds.Tables[0].Rows[0].STY_TYPE;
        document.getElementById('txtAlias').value = advpostypeds.Tables[0].Rows[0].STY_TYPE_ALIAS;
        /*change ankur*/
        ...
        if (advpostypeds.Tables[0].Rows[0].FROM_DATE == "" || advpostypeds.Tables[0].Rows[0].FROMDATE == null) {
            document.getElementById('txtvalid').value = "";
        }
        else {
        ...
        if (advpostypeds.Tables[0].Rows[0].STY_DESCRIPTION == "" || advpostypeds.Tables[0].Rows[0].STY_DESCRIPTION == null) {
            document.getElementById('txtdessigndesc').value = "";
        }
        else {

            document.getElementById('txtdessigndesc').value = advpostypeds.Tables[0].Rows[0].STY_DESCRIPTION;
        }
        ///////////////////////////////////////
...
function FirstClick2() {
    ...
    if (advpostypeds.Tables[0].Rows[0].FROMDATE == "" || advpostypeds.Tables[0].Rows[0].FROMDATE == null) {
        ...
        document.getElementById('txtvalid').value =showDate( advpostypeds.Tables[0].Rows[0].FROMDATE);
    }
    if (advpostypeds.Tables[0].Rows[0].TODATE == "" || advpostypeds.Tables[0].Rows[0].TODATE == null) {
        document.getElementById('txtvalidtill').value = "";
    }
    else {
        document.getElementById('txtvalidtill').value = showDate(advpostypeds.Tables[0].Rows[0].TODATE);
    }
...
function NextClick2() {
    ...
    if (z != -1 && z >= 0) {
        if (z <= y - 1) {
            document.getElementById('txtPosTypCode').value = advpostypeds.Tables[0].Rows[z].STY_TYPE_CODE;
            document.getElementById('txtPosType').value = advpostypeds.Tables[0].Rows[z].STY_TYPE;
            document.getElementById('txtAlias').value = advpostypeds.Tables[0].Rows[z].STY_TYPE_ALIAS;
            ...
            if (advpostypeds.Tables[0].Rows[z].FROMDATE == "" || advpostypeds.Tables[0].Rows[z].FROMDATE == null) {
                ...
                document.getElementById('txtvalid').value = showDate(advpostypeds.Tables[0].Rows[z].FROMDATE);
            }
            if (advpostypeds.Tables[0].Rows[z].TODATE == "" || advpostypeds.Tables[0].Rows[z].TODATE == null) {
                document.getElementById('txtvalidtill').value = "";
            }
            else {
                document.getElementById('txtvalidtill').value = showDate(advpostypeds.Tables[0].Rows[z].TODATE);
            }
            ///////////////////////////////////////
            ...
            if (advpostypeds.Tables[0].Rows[z].STY_DESCRIPTION == "" || advpostypeds.Tables[0].Rows[z].STY_DESCRIPTION == null) {
                document.getElementById('txtdessigndesc').value = "";
            }
            else {

                document.getElementById('txtdessigndesc').value = advpostypeds.Tables[0].Rows[z].STY_DESCRIPTION;
            }
...
function DeleteClick2(compcode1) {
    ...
    if (boolReturn == 1) {
        ...
        stylemaster.delete1(PosTypCode, compcode, userid);
        if (browser != "Microsoft Internet Explorer") {
        ...
        stylemaster.Selectpage(glpostypcode, glpostype, glalias, glamount, glpremium, compcode, userid, call_delete);
...
function commission() {
    ...
    var strReturn = window.open('style_premium.aspx?' + '&logocode=' + logocode + '&temp=' + temp + '&flag2=' + flag2 + '&ankit=' + ankit, '', 'status=0,toolbar=0,resizable=0,scrollbars=yes,top=144,left=210,width=700px,height=400px');
