                ...
                if (texid.indexOf("Text") >= 0 || texid.indexOf("rem") >= 0 || texid.indexOf("pagno") >= 0 || texid.indexOf("hei") >= 0) {
                    ...
                    if (i != undefined) {
                        for (g = i; g < y; g--) {
                            ...
                            if (document.getElementById(idtext + i).disabled == false)
                                document.getElementById(idtext + i).focus();
                            break;
                        }
                    }
...
//123
    if (event.keyCode == 113 || (event.shiftKey==true && event.keyCode== 51 )) {
        if (document.activeElement.id.indexOf("adcatdiv") == 0) {
            activeid = document.activeElement.id;
            var compcode = document.getElementById('hiddencompcode').value;
            var divid = "agdivpop";
            var listboxid = "aglistpop";
            var ds = Classified_Booking.advcatinGrid(compcode);
            if (ds == null)
                return false;
        ...
        if (document.activeElement.id.indexOf("coldiv") == 0) {
            ...
            var divid = "agdivpop";
            var listboxid = "aglistpop";
            var ds = Classified_Booking.bindcolorForGrid(compcode, userid);
            if (ds == null)
                return false;
            ...
            var ds = Classified_Booking.colexec_bind(compcode, colexec);
            if (ds == null)
                return false;
            ...
            var listboxid = "aglistpop";
            var compcode = document.getElementById('hiddencompcode').value;
            var adcategory = document.activeElement.id.replace("adsdiv", "adcatdiv");
            adcategory = document.getElementById(adcategory).value;
            var ds = Classified_Booking.getadsubcat(compcode, adcategory);
            if (ds == null)
                return false;
            var objadscat = document.getElementById(listboxid);
            objadscat.options.length = 0;
            ...
            var resB = Classified_Booking.bindreferenceID(document.getElementById('hiddencompcode').value, agency, client);
            ...
            var ext4 = "";
            var ext5 = "";
            var resB = Classified_Booking.indus(document.getElementById('hiddencompcode').value, "", document.getElementById("txtindustry").value);
            ...
            var ext4 = "";
            var ext5 = "";
            var resB = Classified_Booking.procatsub(document.getElementById('hiddencompcode').value, indus, procat);
            ...
            var ext4 = "";
            var ext5 = "";
            var resB = Classified_Booking.bindbrand(document.getElementById('hiddencompcode').value, document.getElementById("drpbrand").value , ext1,ext2,ext3,ext4,ext5);
            ...
            // Classified_Booking.bindagencyname(document.getElementById('hiddencompcode').value, document.getElementById('hiddenuserid').value, document.getElementById('txtagency').value, "N", bindagencyname_callback);
            if (document.getElementById('hdnbranchf2req').value == "Y") {
                Classified_Booking.bindagencyname1(document.getElementById('hiddencompcode').value, document.getElementById('hiddenuserid').value, document.getElementById('txtagency').value, "Y", document.getElementById('hdnrevenuecentcd').value, bindagencyname_callback);
            }
            else {
                Classified_Booking.bindagencyname(document.getElementById('hiddencompcode').value, document.getElementById('hiddenuserid').value, document.getElementById('txtagency').value, "N", bindagencyname_callback);
            }
            ...
            res = Classified_Booking.getBarter(document.getElementById('hiddencompcode').value, document.getElementById('hiddencenter').value, document.getElementById('txtbranch').value, agencycode, client);
            ...
            if (document.location.toString().indexOf("advts.aspx") > 0) {
                ...
                res = Classified_Booking.bindcirRate(document.getElementById('hiddencompcode').value, document.getElementById('hiddencenter').value);
            }
            if (res.value != null && res.value.Tables.length > 0) {
                var ds = res.value;
            ...
            var res = Classified_Booking.bindciragency(document.getElementById('hiddencompcode').value, document.getElementById('hiddencenter').value, document.getElementById('txtciragency').value);
            if (res.value != null) {
                var ds = res.value;
            ...
            Classified_Booking.bindclientname(document.getElementById('hiddencompcode').value, document.getElementById('txtclient').value, "N", bindclientname_callback);
        }
        else if (document.activeElement.id == "txtproduct") {
            ...
            Classified_Booking.bindProduct(document.getElementById('hiddencompcode').value, document.getElementById('txtproduct').value, bindproductname_callback);
        }
            ...
            //Classified_Booking.bindExec(document.getElementById('hiddencompcode').value, document.getElementById('txtexecname').value, bindexecname_callback);
            if (document.getElementById('configclient').value == "SP") {
                ...
                var extra9 = "";
                var extra10 = "";
                Classified_Booking.bindExec_agency(document.getElementById('hiddencompcode').value, document.getElementById('hiddenadtype').value, agmain_code, agsubcode_code, code_subcode, exename, extra1, extra2, extra3, extra4, extra5, extra6, extra7, extra8, extra9, extra10, bindexecname_callback);
            }
            else {
                if (document.getElementById('hdnbranchf2req').value == "Y") {
                    var rev_cent = document.getElementById('hdnrevenuecentcd').value;
                    Classified_Booking.bindExec_new(document.getElementById('hiddencompcode').value, document.getElementById('txtexecname').value, document.getElementById('hiddenadtype').value, rev_cent, bindexecname_callback);
                }
                else {
                    Classified_Booking.bindExec(document.getElementById('hiddencompcode').value, document.getElementById('txtexecname').value, bindexecname_callback);
                }
        ...
        //*14Aug*
            ...
            if (retexeboth != "both") {
                if (document.getElementById('txtexecname').value != "") {
                    ...
                    if (confirm('Are you sure you want to Take ' + b)) {
                        ...
                        //Classified_Booking.bindRetainer(document.getElementById('hiddencompcode').value, document.getElementById('drpretainer').value, agcode, bindretainer_callback);
                        if (document.getElementById('hdnbranchf2req').value == "Y") {
                            var rev_centret = document.getElementById('hdnrevenuecentcd').value;
                            Classified_Booking.bindRetainer_new(document.getElementById('hiddencompcode').value, document.getElementById('drpretainer').value, agcode, rev_centret, bindretainer_callback);
                        }
                        else {
                            Classified_Booking.bindRetainer(document.getElementById('hiddencompcode').value, document.getElementById('drpretainer').value, agcode, bindretainer_callback);
                        }
            ...
            var ds = Classified_Booking.getResourceNo(val_);
            ...
            var listboxid = "aglist";
            var val_ = document.getElementById(document.activeElement.id).value;
            var ds = Classified_Booking.getSectionCode(val_);
            if (ds == null)
                return false;
            var objadscat = document.getElementById(listboxid);
            objadscat.options.length = 0;
            ...
            var divid = "agdiv";
            var listboxid = "aglist";
            var ds = Classified_Booking.bindpagePositioninGrid(compcode, document.getElementById('txtdatetime').value,"CL0");
            if (ds == null)
                return false;
            var objadscat = document.getElementById(listboxid);
            objadscat.options.length = 0;
        ...
        else if (document.activeElement.id.indexOf("adcat") == 0 || document.activeElement.id.indexOf("pgpre") == 0 || document.activeElement.id.indexOf("inssta") == 0 || document.activeElement.id.indexOf("mat") == 0 || document.activeElement.id.indexOf("col") == 0 || document.activeElement.id.indexOf("ads") == 0 || document.activeElement.id.indexOf("aglist") == 0 || document.activeElement.id.indexOf("agdiv") == 0 || document.activeElement.id.indexOf("aglistpop") == 0 || document.activeElement.id.indexOf("agdivpop") == 0) {
        ...
        if (document.activeElement.id == "drptranslation" && document.getElementById('txttotalarea').disabled == true) {
            changedivrate();
            return false;
        }
    ...
    //else if(event.keyCode===16 )
    {
        ...
        else if (document.activeElement.id == "drpboxcode") {//alert("5");
            //document.getElementById('LinkButton3').focus();
            changebilldiv();
            return false;
        }
        else if (document.activeElement.id == "txtvts") {//alert("5");
            //document.getElementById('LinkButton3').focus();
            openboxpopup();
            return false;
        }
    ...
    ////when f8 save data
        ...
        else if (document.activeElement.id == "LinkButton3") {//alert("7");
            openboxpopup();
        }
        else if (document.activeElement.id == "LinkButton4") {
            changepackage();
...
function getpayandstatus() {
    ...
    Classified_Booking.getpayandstatus(agencycodeglo, subagency, compcode, datetime, dateformat, call_fillpay);
    return false;
}
...
function call_bindexeczone(res) {
    ...
    if (ds != null) {
        ...
        if (ds != null) {
            ...
            var agencycodesubcode = document.getElementById('txtagency').value.substring(document.getElementById('txtagency').value.lastIndexOf('(') + 1, document.getElementById('txtagency').value.lastIndexOf(')')); /*bhanu*/
            var ds_ret_b = Classified_Booking.adexec_billbase_outstanding(document.getElementById('hiddencompcode').value, agencycodesubcode, exec_code, document.getElementById('txtdatetime').value, document.getElementById('hiddendateformat').value, document.getElementById('txtagencytype').value);
...
function bind_agen_bill() {
    ...
    if (agencycodeglo != "undefined" && agencycodeglo != undefined)
        Classified_Booking.bindbillto_ag(agencycodeglo, compcode, call_bindbillto);
    ...
    if (agnf2 == "Y" && event.keyCode != 113 && event.keyCode != 27) {
        if (document.activeElement.id == "txtagency") {
            ...
            if (document.getElementById('hdnbranchf2req').value == "Y") {
                ...
                Classified_Booking.bindagencyname(document.getElementById('hiddencompcode').value, document.getElementById('hiddenuserid').value, document.getElementById('txtagency').value, "Y", bindagencyname_callback);
            }
            ...
            document.getElementById('divclient').style.left = document.getElementById("txtclient").offsetLeft + leftpos + "px";
            Classified_Booking.bindclientname(document.getElementById('hiddencompcode').value, document.getElementById('txtclient').value, "Y", bindclientname_callback);
        }
    }
        ...
        if (event.keyCode == 113) {
            ...
            Classified_Booking.abc_get_unit_allocation(document.getElementById('hiddencompcode').value, document.getElementById("txtrevenuecenternew").value, "", "A", "", "", bindrevenuecenternew_callback);
        }
...
function bindrevenuecenternew_callback(response) {
    ...
    if (ds != null && typeof (ds) == "object" && ds.Tables[0].Rows.length > 0) {
        pkgitem.options.length = 1;
        for (var i = 0; i < ds.Tables[0].Rows.length; ++i) {
            pkgitem.options[pkgitem.options.length] = new Option(ds.Tables[0].Rows[i].UNIT_NAME + '~' + ds.Tables[0].Rows[i].UNIT_CODE, ds.Tables[0].Rows[i].UNIT_NAME + '~' + ds.Tables[0].Rows[i].UNIT_CODE);
...
function opencopyDivInsertion(activeid) {
    ...
    var re = Classified_Booking.getbillnobilldate(document.getElementById('txtciobookid').value, document.getElementById(activeid).innerHTML);
    var ds = re.value;
    ...
    if (chkbtnStatus != "execute") {
        ...
        if (document.getElementById("hiddenuomdesc").value == "CD") {
            str = str + "<tr><td class=TextField valign=top>" + document.getElementById(activeid).innerHTML + "</td><td valign=top><input class=\"btextforgriddate\" disabled type=\"text\" id='Textdiv" + no + "'  onchange=\"return chkDateforGrid(this);\"  value='" + document.getElementById("Text" + no).value + "' ></td><td valign=top><input disabled id='adcatdiv" + no + "' onchange=\"return blankGross();\" class=\"btextforgrid\" type=\"text\"  value=" + document.getElementById("adcat" + no).value + " ></td><td valign=top><input disabled id='adsdiv" + no + "' onchange=\"return blankGross();\" class=\"btextforgrid\" type=\"text\"  value=" + document.getElementById("ads" + no).value + " ><div id='agdivpop' Width=100px Height=50px style='position:absolute;display: none;'><select name='aglistpop'  id='aglistpop' CssClass='btextlist' size=4 Width=100px Height=50px></select></div></td><td valign=top><input class=\"btextsmallsize\" disabled id='coldiv" + no + "' onchange=\"return blankGross();\" type=\"text\" value=" + document.getElementById("col" + no).value + " ></td><td valign=top><input  class=\"btextsmallsize\" disabled id='heidiv" + no + "'  type=\"text\" onChange=\"divAddclick('" + no + "','" + activeid + "');  value=" + document.getElementById("hei" + no).value + " \"></td><td valign=top><input  class=\"btextsmallsize\" disabled id='widdiv" + no + "'  type=\"text\" onChange=\"divAddclick('" + no + "','" + activeid + "');\" value=" + document.getElementById("wid" + no).value + "></td><td valign=top><input  class=\"btextsmallsize\" disabled id='sizdiv" + no + "'  type=\"text\" value=" + document.getElementById("siz" + no).value + "></td><td valign=top><input  class=\"btextforgrid\" disabled id='insbillamtdiv" + no + "'  type=\"text\" value=" + insbillamt + "></td><td valign=top><input class=\"btextforgrid\" disabled  type=\"text\" id='divinssta" + no + "' onchange=\"return blankGross();\" value=" + "'" + document.getElementById("inssta" + no).value + "'" + "></td><td valign=top><input  class=\"btextforgrid\" disabled id='billnodiv" + no + "'  type=\"text\" value=" + billno + "></td><td valign=top><input  class=\"btextforgrid\" disabled id='billdtdiv" + no + "'  type=\"text\" value=" + billdate + "></td>";
            if (document.getElementById('hiddisceditgrid').value == "Y")
            ...
            str = str + "<tr><td class=TextField valign=top>" + document.getElementById(activeid).innerHTML + "</td><td valign=top><input class=\"btextforgriddate\" disabled type=\"text\" id='Textdiv" + no + "' onchange=\"return chkDateforGrid(this);\"  value='" + document.getElementById("Text" + no).value + "' ></td><td valign=top><input id='adcatdiv" + no + "' onchange=\"return blankGross();\" class=\"btextforgrid\" disabled type=\"text\"  value=" + document.getElementById("adcat" + no).value + " ></td><td valign=top><input id='adsdiv" + no + "' onchange=\"return blankGross();\" class=\"btextforgrid\" type=\"text\" disabled value=" + document.getElementById("ads" + no).value + " ><div id='agdivpop' Width=100px Height=50px style='position:absolute;display: none;'><select name='aglistpop'  id='aglistpop' CssClass='btextlist' size=4 Width=100px Height=50px></select></div></td><td valign=top><input class=\"btextsmallsize\" id='coldiv" + no + "' onchange=\"return blankGross();\" disabled type=\"text\" value=" + document.getElementById("col" + no).value + " ></td><td valign=top><input  class=\"btextsmallsize\" disabled id='heidiv" + no + "'  type=\"text\" value=" + document.getElementById("hei" + no).value + "></td><td valign=top><input  class=\"btextsmallsize\" disabled id='widdiv" + no + "'  type=\"text\" value=" + document.getElementById("wid" + no).value + "></td><td valign=top><input  class=\"btextsmallsize\" disabled onchange=\"return blankGross();\" id='sizdiv" + no + "'  type=\"text\" value=" + document.getElementById("siz" + no).value + "></td><td valign=top><input  class=\"btextforgrid\" disabled id='insbillamtdiv" + no + "'  type=\"text\" value=" + insbillamt + "></td><td valign=top><input class=\"btextforgrid\" disabled type=\"text\" id='divinssta" + no + "' onchange=\"return blankGross();\" value=" + "'" + document.getElementById("inssta" + no).value + "'" + "></td><td valign=top><input  class=\"btextforgrid\" disabled id='billnodiv" + no + "'  type=\"text\" value=" + billno + "></td><td valign=top><input  class=\"btextforgrid\" disabled id='billdtdiv" + no + "'  type=\"text\" value=" + billdate + "></td>";
            if (document.getElementById('hiddisceditgrid').value == "Y")
                str = str + "<td valign=top><input  class=\"btextsmallsize\" disabled  id='discdiv" + no + "'  type=\"text\"  onkeypress=\"return greterthan(event);\"value=" + disc_ + "></td><td valign=top><input class=\"btextsmallsizeH\" disabled id='pagnodiv" + no + "' type=\"text\" value=" + document.getElementById("pagno" + no).value + "></td><td valign=top><textarea  class=\"btextforgrid\" disabled id='capdiv" + no + "'   type=\"text\" title='" + document.getElementById("cap" + no).value + "'  style='height:30px;width:120px'>" + document.getElementById("cap" + no).value + "</textarea></td><td valign=top><textarea  class=\"btextforgrid\" disabled id='remdiv" + no + "'   type=\"text\" title='" + document.getElementById("rem" + no).value + "'  style='height:30px;width:120px'>" + document.getElementById("rem" + no).value + "</textarea></td>";
            else
                str = str + "<td valign=top><input  class=\"btextsmallsize\" disabled id='discdiv" + no + "'  type=\"text\" value=" + disc_ + "></td><td valign=top><input class=\"btextsmallsizeH\" disabled id='pagnodiv" + no + "' type=\"text\" value=" + document.getElementById("pagno" + no).value + "></td><td valign=top><textarea  class=\"btextforgrid\" disabled id='capdiv" + no + "'   type=\"text\" title='" + document.getElementById("cap" + no).value + "'  style='height:30px;width:120px'>" + document.getElementById("cap" + no).value + "</textarea></td><td valign=top><textarea  class=\"btextforgrid\" disabled id='remdiv" + no + "'   type=\"text\" title='" + document.getElementById("rem" + no).value + "'  style='height:30px;width:120px'>" + document.getElementById("rem" + no).value + "</textarea></td>";
    ...
    str = str + "<tr ><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td colspan='2' align=right><input type=button class=\"buttonsplit\" value=Ok onClick=\"divokclick('" + no + "','" + document.getElementById(activeid).innerHTML + "');\"><input type=button class=\"buttonsplit\" value=Close onClick=\"divcancelclick();\"></td><td></td><td></td></tr>";
    ...
    arrNS[13] = document.getElementById('adcatdiv' + no).value;
    arrNS[14] = document.getElementById('paiddiv' + no).value;
...
function divokclick(no, activeid) {
    ...
    if (res != false) {
        ...
        if (document.getElementById('divinssta' + no).value != "booked" && document.getElementById("divinssta" + no).value != "cancel" && document.getElementById("divinssta" + no).value != "hold") 
        {
            alert("Please Select Status With F2 Only");
            return false;
        }
        ...
        if(document.getElementById('pagnodiv' + no).value!="" && document.getElementById('pagnodiv' + no).value !=0)
        {
                if(confirm("Do You Want to Fill Page no in All Insertions"))
                 {
                        for (var i = parseInt(no, 10); i < count1; i++) 
                        {
        ...
        for (var i = parseInt(no, 10); i < count1; i++) {
            if (valT == document.getElementById("ins" + i).innerHTML) {
                if (document.getElementById("inssta" + i).value != "cancel") {
                    if (arrNS[13].toString() != document.getElementById('adcatdiv' + no).value && document.getElementById('ena_adsubcataftbill').value == "Y")
                        document.getElementById('adcat' + i).value = document.getElementById('adcatdiv' + no).value;
                    ...
                    if (arrNS[14].toString() != document.getElementById('paiddiv' + no).value && (document.getElementById("inssta" + i).value != "billed"|| document.getElementById('hiddensupplimentflag').value != ""))
...
function modifyLine_callback(response) {
    ...
    for (s = 0; s < ds.Tables[0].Rows.length; s++) {
        ...
        if (dCheck == true) {
            ...
            if (online_flag == false && ds.Tables[0].Rows[s].PUBTYPE == "IN0") {
                online_flag = true;
            }
...
//        var re = Classified_Booking.pub_centbind();
//        var str = "<table  border=1><tr><td><table  style='background-color: #ffffff;' class=\"dtGridHd121\"><tr bgcolor=\"#7DAAF3\">"
//        str = str + "<tr style=\"font-size:12px;  \"><td style=\"width: 15%;\">Group</td><td style=\"width: 20%;\">Center</td><td style=\"width: 75%;\">Branch</td></tr>";
//        var centergp="";
//        var centercd="";
//        var centernm="";
//        var i1 = 0;
...
//            //var re1 = Classified_Booking.branchbind(re.value.Tables[0].Rows[i].Pub_cent_Code,document.getElementById('txtciobookid').value);
...
//            btag = eval(aTag)
//        } while (aTag.tagName != "BODY" && aTag.tagName != "HTML");
//        document.getElementById('divmail').style.top = document.getElementById('btnmail').offsetTop + toppos + "px";
//        document.getElementById('divmail').style.left = document.getElementById('btnmail').offsetLeft + leftpos + "px";        
//    }
//    else {
//        document.getElementById('divmail').style.display = "block";
//    }
...
function funbtnmail() {
    ...
    if (a == "") {
        var pub = Classified_Booking.bindpublication_formail();
...
function funbtnmail2(abc) {
    ...
    if (a == "") {
        ...
        re = Classified_Booking.pub_centbind(abc);
...
function divokclick1(i1,j1) {
    ...
    mailsendstr="";
    for (var i = 0; i < i1; ++i) {
        ///var re1 = Classified_Booking.branchbind(document.getElementById("hdncenter_" + i).value,document.getElementById('txtciobookid').value);
