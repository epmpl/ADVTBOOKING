    ...
    for (var i = 0; i < aa-1; i++) {
        ...
        if (document.getElementById('chk' + i).checked == true) {
         var isertid = document.getElementById('chk' + i).value;
            var res = chnagesatausholdbooked.update11(isertid);
...
function tabvalue1(event) {
    ...
    if (event.keyCode == 113) {
        ...
        if (document.activeElement.id == "txtagency1") {
            ...
            chnagesatausholdbooked.bindagencyname(document.getElementById('hiddencompcode').value, document.getElementById('hiddenuserid').value, document.getElementById('txtagency1').value.toUpperCase(), bindagencyname_callback);
