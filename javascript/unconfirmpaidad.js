...
unconfirmpaidad.execute(cioid,document.getElementById('hiddencompcode').value,adtype,exec_callback);
...
//              }
// else 
// if(document.getElementById('drprevenu').value=="0") 
//              {
...
//unconfirmpaidad.execute(todate,fromdate,call_back);
}
...
//	else	
//	document.getElementById('btnbookingaudit').style.visibility="visible";    
}
...
//clientid="";
//}
	unconfirmpaidad.selected(bookingid,clientid,call_grid_sel);
////	
	}
	if(k==0)
	{
...
//function bindQBC()
//{
//unconfirmpaidad.fillQBC(document.getElementById('drprevenu').value,bindQBC_callback);
//}
                ...
                if(document.getElementById(chkid).checked==true)
                    {
                        ...
                        unconfirmpaidad.updateStatus2(booking_id);
...
unconfirmpaidad.save(remarks,cioid)
...
//                document.getElementById('div1').style.left=parseInt(document.getElementById('drprevenu').offsetLeft) + parseInt(document.getElementById('sectd').offsetLeft) + parseInt(document.getElementById('tdagen').offsetLeft) + parseInt(document.getElementById('tbl1').offsetLeft) + parseInt(document.getElementById('tbl2').offsetLeft) + parseInt(document.getElementById('tbl3').offsetLeft) + parseInt(document.getElementById('OuterTable').offsetLeft) + 9 + "px";
            ...
            unconfirmpaidad.bindagencyname(document.getElementById('hiddencompcode').value,document.getElementById('hiddenuserid').value,document.getElementById('drprevenu').value.toUpperCase(),bindagencyname_callback);
