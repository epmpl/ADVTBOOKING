...
////             y=document.getElementById(len).getElementsByTagName('table')[0].rows.length;
	...
	if(tot!="")
	 {
	 var edition1= tot;
	 CombinationMaster.chkag(edition1,fillchkagen);
...
function fillchkagen(res)
		...
		var ds= res.value;
		   ...
		   //   alert("This Combination Is Already Exist");
		      if(confirm("This Combination Is Already Exist.Do You Want To Continue"))
		      {
		      return false;
...
function submittedclick()
{
    ...
    else if (document.getElementById('txtvalidto').value == "") {
...
//CombinationMaster.updatecomm(comcode,alias,packagename,combinationname,compcode,userid,total);
    ...
    if (document.getElementById('hiddencodedesc').value != document.getElementById('btncomname').value) {
    ...
    var validfrom = document.getElementById('txtvalidityfrom').value;
    var validto = document.getElementById('txtvalidto').value;
    var olddpkg = document.getElementById('txtoldcode').value;
    CombinationMaster.updatecomm(comcode, alias, packagename, combinationname, compcode, userid, total, cat, subcat, adtype, noedition, valofchkbox, no_ofinsert, split, consumption, validfrom, validto, pubcenter, olddpkg);
///////////////////////////////////////////////////////////////////////////
...
var validto = document.getElementById('txtvalidto').value;
var olddpkg = document.getElementById('txtoldcode').value;
CombinationMaster.insertcomm(comcode, alias, packagename, combinationname, compcode, userid, total, cat, subcat, adtype, noedition, editiontype, valofchkbox, no_ofinsert, pubcenter, split, consumption, validfrom, validto, olddpkg);
...
document.getElementById('hiddencodedesc').value = global_ds.Tables[0].Rows[0].Combin_Desc;
...
if (global_ds.Tables[0].Rows[0].VALID_FROM != null && global_ds.Tables[0].Rows[0].VALID_FROM != "null") {
    document.getElementById('txtvalidityfrom').value = CHKDATE(global_ds.Tables[0].Rows[0].VALID_FROM, document.getElementById('hiddendateformat').value);
}
else {
    document.getElementById('txtvalidityfrom').value == "";
}
...
if (global_ds.Tables[0].Rows[0].VALID_TO != null && global_ds.Tables[0].Rows[0].VALID_TO != "null") {
    document.getElementById('txtvalidto').value = CHKDATE(global_ds.Tables[0].Rows[0].VALID_TO, document.getElementById('hiddendateformat').value);
}
else {
    document.getElementById('txtvalidto').value = "";
}
...
//CombinationMaster.firstcomm(call_firstclick);
    ...
    document.getElementById('hiddencodedesc').value = "";
			document.getElementById('btntextcomcode').disabled=true;
						document.getElementById('btextalias').disabled=true;
						document.getElementById('btnpackname').disabled=true;
						document.getElementById('btncomname').disabled=true;
...
document.getElementById('hiddencodedesc').value = global_ds.Tables[0].Rows[a].Combin_Desc;
...
if (global_ds.Tables[0].Rows[a].VALID_FROM != null && global_ds.Tables[0].Rows[a].VALID_FROM != "null") {
    document.getElementById('txtvalidityfrom').value = CHKDATE(global_ds.Tables[0].Rows[a].VALID_FROM, document.getElementById('hiddendateformat').value);
}
else {
    document.getElementById('txtvalidityfrom').value = "";
}
...
if (global_ds.Tables[0].Rows[a].VALID_TO != null && global_ds.Tables[0].Rows[a].VALID_TO != "null") {
    document.getElementById('txtvalidto').value = CHKDATE(global_ds.Tables[0].Rows[a].VALID_TO, document.getElementById('hiddendateformat').value);
}
else {
    document.getElementById('txtvalidto').value = "";
}
...
document.getElementById('hiddencodedesc').value = global_ds.Tables[0].Rows[z].Combin_Desc;
...
if (global_ds.Tables[0].Rows[z].VALID_FROM != null && global_ds.Tables[0].Rows[z].VALID_FROM != "null") {
    document.getElementById('txtvalidityfrom').value = CHKDATE(global_ds.Tables[0].Rows[z].VALID_FROM, document.getElementById('hiddendateformat').value);
}
else {
    document.getElementById('txtvalidityfrom').value = "";
}
...
if (global_ds.Tables[0].Rows[z].VALID_TO != null && global_ds.Tables[0].Rows[z].VALID_TO != "null") {
    document.getElementById('txtvalidto').value = CHKDATE(global_ds.Tables[0].Rows[z].VALID_TO, document.getElementById('hiddendateformat').value);
}
else {
    document.getElementById('txtvalidto').value = "";
}
...
if (global_ds.Tables[0].Rows[0].VALID_FROM != null && global_ds.Tables[0].Rows[0].VALID_FROM != "null") {
    document.getElementById('txtvalidityfrom').value = CHKDATE(Tables[0].Rows[0].VALID_FROM, document.getElementById('hiddendateformat').value);
}
else {
    document.getElementById('txtvalidityfrom').value = "";
}
...
if (global_ds.Tables[0].Rows[0].VALID_TO != null && global_ds.Tables[0].Rows[0].VALID_TO != "null") {
    document.getElementById('txtvalidto').value = CHKDATE(Tables[0].Rows[0].VALID_TO, document.getElementById('hiddendateformat').value);
}
else {
    document.getElementById('txtvalidto').value = "";
}
