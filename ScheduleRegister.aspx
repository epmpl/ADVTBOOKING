<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ScheduleRegister.aspx.cs" Inherits="ScheduleRegister" %>
													...
													<td align="left">
														...
														<td align="left" ><asp:Label id="lbAdtype" runat="server" CssClass="TextField"></asp:Label></td>
														  <td align="left"><asp:UpdatePanel ID="UpdatePanel11" runat="server">
                                                                <ContentTemplate>
                                                                    <asp:DropDownList CssClass="dropdown" id="dpaddtype" runat="server" OnSelectedIndexChanged="dpaddtype_SelectedIndexChanged" AutoPostBack="True"></asp:DropDownList>
                                                                </ContentTemplate>
                                                            </asp:UpdatePanel>
                                                        </td>
                                                      ...
                                                      <tr>
                                                       ...
                                                       <td align="left">
														...
														<td  align="left">
                                                            <asp:UpdatePanel ID="UpdatePanel7" runat="server">
                                                                <ContentTemplate>
                                                                    <asp:DropDownList id="dppubcent" runat="server" OnSelectedIndexChanged="dppubcent_SelectedIndexChanged1" CssClass="dropdown" type="password"  AutoPostBack="True"></asp:DropDownList>
                                                                </ContentTemplate>
                                                            </asp:UpdatePanel>
                                                        </td>
