<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdSubCat5.aspx.cs" Inherits="AdSubCat5" %>
...
<head id="Head1" runat="server">
         <title>Display Ad. Booking & Sheduling Ad Sub Category Master AdCategory5 Master</title>
...
<body onkeypress="eventcalling(event);" onkeydown="tabvalue(event,'txtalias');"onload="javascript:return clearadsub();" style="background-color:#f3f6fd;">
      <form id="frmcat3" method="post" runat="server">
    			<%--<table id="OuterTable" width="980" border="0" cellpadding="0" cellspacing="0">
				<tr valign="top">
					<td colspan="2"><uc1:topbar id="Topbar1" runat="server" Text="Ad Sub Category5 Master"></uc1:topbar></td>
				</tr>
				<tr valign="top">
			...
			<table border="0" width="100%" cellpadding="0" cellspacing="0" style="width:auto;margin:15px 30px;">
                  <tr>
                     ...
                     <td style="width:135PX;font-family:Verdana;text-align:right;font-size:10px;background-color:#a0bfeb; height:20px;"><b><center>Ad Sub Category5</center></b></td>
                     <td style="background-image:url(images/corner-right.jpg); background-repeat:no-repeat; height:20px;width:11px"></td>
					 <td style="width:730px"><table cellpadding="0" cellspacing="0"><tr><td style="background-color:#a0bfeb;width:770px; height:3px;"></td></tr></table></td>
                   </tr>
            </table>
			<table  class="ajax" cellpadding="0" cellspacing="0" >
									<tr>
										...
										<td><asp:label id="AdCatCode" runat="server" CssClass="TextField"></asp:label></td>
											<td><asp:textbox id="txtadcatcode" runat="server" CssClass="btext" MaxLength="8"></asp:textbox></td>
										...
										<tr>
											<td style="height: 19px"><asp:label id="salesorg" runat="server" CssClass="TextField"></asp:label></td>
											<td style="height: 19px"><asp:textbox id="txtsalesorg" runat="server" CssClass="btext1" MaxLength="8"></asp:textbox></td>
										</tr>
									</table>
