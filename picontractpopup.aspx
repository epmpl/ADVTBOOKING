<%@ Page Language="C#" AutoEventWireup="true" CodeFile="picontractpopup.aspx.cs" Inherits="picontractpopup" %>
   ...
   alrt=document.getElementById('lbpdfsort').innerText;
		    ...
		    try
	{
		if(typeof(window.opener)!="undefined")
		{
				...
				while(x_win!="undefined")
				{
					...
					if(typeof(x_win.opener)=="undefined")
					{
						...
						{
						    x_win.location.href="picontractviewreport.aspx?fromdate=" + $('txtfrmdate').value + "&dateto=" +$('txttodate1').value  + "&prodcode=" + $('dpprodcat').value +  "&agency=" +$('dpagency').value +"&client=" + $('dpclient').value + "&package=" + $('dppackage').value + "&adtype=" + $('dpadtype').value + "&adcategory=" + str + "&region=" +$('dpregion').value + "&drilout=" + "yes" + "&destination="+ $('dpdestination').value+ "&sortorder=" + $('txtpdfsort').value + "&sortvalue=" + $('txtpdfsortvalue').value;
						}
						else
						{
						    x_win.location.href="picontractviewreport.aspx?fromdate=" + $('txtfrmdate').value + "&dateto=" +$('txttodate1').value  + "&prodcode=" + $('dpprodcat').value +  "&agency=" +$('dpagency').value +"&client=" + $('dpclient').value + "&package=" + $('dppackage').value + "&adtype=" + $('dpadtype').value + "&adcategory=" + str + "&region=" +$('dpregion').value + "&drilout=" + "yes" + "&destination="+ $('dpdestination').value+ "&sortorder=" + "50" + "&sortvalue=" + "50";
						}
		...
		else
		{
			...
			window.location.href="picontractviewreport.aspx?fromdate=" + $('txtfrmdate').value + "&dateto=" +$('txttodate1').value  + "&prodcode=" + $('dpprodcat').value +  "&agency=" +$('dpagency').value +"&client=" + $('dpclient').value + "&package=" + $('dppackage').value + "&adtype=" + $('dpadtype').value + "&adcategory=" + str + "&region=" +$('dpregion').value + "&drilout=" + "yes" + "&destination="+ $('dpdestination').value+ "&sortorder=" + $('txtpdfsort').value + "&sortvalue=" + $('txtpdfsortvalue').value;
			//window.open("epapermain.aspx?queryed="+a+"&getda=h&eddate="+b);
		}
	}
	catch(e)
...
<body>
    <form id="picontract" runat="server">
											...
											<table   align="center"  width="0" border="0" cellspacing="0" cellpadding="2">
														...
														<td  align="left">
                                                            <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                                                <ContentTemplate>
                                                                    ...
                                                                    <%--<img src='Images/cal1.gif'  onclick='popUpCalendar(this, picontract.txtfrmdate, "mm/dd/yyyy")' onfocus="abc();" height=14 width=14/>--%>
                                                                </ContentTemplate>
                                                            </asp:UpdatePanel>
                                                        </td>
														...
														<td  align="left">
                                                            <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                                                <ContentTemplate>
                                                                   ...
                                                                   <%-- <img src='Images/cal1.gif'  onclick='popUpCalendar(this, picontract.txttodate1, "mm/dd/yyyy")' onfocus="abc();" height="14" width="14"/>--%>
                                                                </ContentTemplate>
                                                            </asp:UpdatePanel>
                                                        </td>
													...
													<td align="left"><asp:Label id="lbadtype" runat="server" CssClass="TextField" ></asp:Label></td>
														<td align="left"><asp:UpdatePanel ID="UpdatePanel1" runat="server" >
                                                                <ContentTemplate>
                                                                     <asp:DropDownList id="dpadtype" runat="server" AutoPostBack="true" CssClass="dropdown" OnSelectedIndexChanged="dpadtype_SelectedIndexChanged" ></asp:DropDownList>
                                                                </ContentTemplate>
                                                            </asp:UpdatePanel>
                                                        </td>
													</tr>
