...
public partial class HoldRate : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Ajax.Utility.RegisterTypeForAjax(typeof(HoldRate));
        ...
        ds.ReadXml(Server.MapPath("XML/HoldRate.xml"));
        lblratecod.Text = ds.Tables[0].Rows[0].ItemArray[0].ToString();
        ...
        if (!Page.IsPostBack)
        {
            ...
            txtratcod.Attributes.Add("onkeydown", "javascript:return ratecodef2(event);");
    ...
    public void bindstatus()
    {
        ...
        ds1.ReadXml(Server.MapPath("XML/HoldRate.xml"));
    ...
    public string Savename(string fields, string finalval, string tablename, string insert, string dateformat, string extra2, string extra3)
    {
        ...
        {
            NewAdbooking.Classes.HoldRate obj = new NewAdbooking.Classes.HoldRate();
              str = obj.Save_main(fields, finalval, tablename, insert, dateformat, extra2, extra3);
        }
        else
            if (ConfigurationSettings.AppSettings["ConnectionType"].ToString() == "orcl")
            {
                NewAdbooking.classesoracle.HoldRate obj = new NewAdbooking.classesoracle.HoldRate();
                str = obj.Save_main(fields, finalval, tablename, insert, dateformat, extra2, extra3);
            }
        return str;
    }
    ...
    public DataSet bindratecod(string compcode, string ratecode)
    {
        DataSet ds = new DataSet();
        if (ConfigurationSettings.AppSettings["ConnectionType"].ToString() == "sql")
        {
            NewAdbooking.Classes.HoldRate bindagenname = new NewAdbooking.Classes.HoldRate();
            ds = bindagenname.bindratecode(compcode, ratecode);
        }
        else
        {
            NewAdbooking.classesoracle.HoldRate bindagenname = new NewAdbooking.classesoracle.HoldRate();
