<%@ Page Language="C#" AutoEventWireup="true" CodeFile="agencyclient.aspx.cs" Inherits="agencyclient" %>
...
<body onkeydown="javascript:return tabvalue(event);" onload="document.getElementById('dpagencycli').focus();">
											...
											<table width="0" border="0" cellspacing="0" cellpadding="0">
													<%--<tr>
														...
														<td align="left"><asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                                <ContentTemplate>
                                                                    <asp:DropDownList CssClass="dropdown" id="dpagencyna" runat="server" AutoPostBack="True"></asp:DropDownList>
                                                                </ContentTemplate>
                                                            </asp:UpdatePanel>
                                                        </td>
													...
													<tr>
														...
														<td align="left"><asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                                <ContentTemplate>
                                                                    <asp:DropDownList CssClass="dropdown" id="dpagencycli" runat="server" AutoPostBack="True"></asp:DropDownList>
                                                                </ContentTemplate>
                                                            </asp:UpdatePanel>
                                                        </td>
													...
													<tr>
														...
														<td align="left"><asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                                                <ContentTemplate>
                                                                    <asp:DropDownList CssClass="dropdown" id="dpaddtype" runat="server" AutoPostBack="False" OnSelectedIndexChanged="dpaddtype_SelectedIndexChanged"></asp:DropDownList>
                                                                </ContentTemplate>
                                                            </asp:UpdatePanel>
                                                        </td>
													...
													<tr>
														...
														<td style="HEIGHT: 25px" align="left">
                                                            <asp:UpdatePanel ID="UpdatePanel7" runat="server">
                                                                <ContentTemplate>
                                                                    <asp:DropDownList id="dppubcent" runat="server" CssClass="dropdown" type="password"  AutoPostBack="True" OnSelectedIndexChanged="dppubcent_SelectedIndexChanged1"></asp:DropDownList>
                                                                </ContentTemplate>
                                                            </asp:UpdatePanel>
                                                        </td></tr>
   ...
   <input id="hiddenadcatname" type="hidden" runat="server" />
    <input id="hiddenclientname" type="hidden" runat="server" />
    <input id="hiddenagencycode" type="hidden" runat="server" />
