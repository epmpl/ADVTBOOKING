<%@ Page Language="C#" AutoEventWireup="true" CodeFile="stoptime.aspx.cs" Inherits="stoptime" %>
...
<head runat="server">
    ...
    <script language="javascript" type="text/javascript" src="javascript/givepermission.js"></script>
		...
		<script language="javascript" type="text/javascript" src="javascript/stoptime.js"></script>
		<script language="javascript" type="text/javascript" src="javascript/entertotab.js"></script>		
</head>
<body onload="executelick();">
    ...
    <div>
         <table border="0" cellpadding="0" cellspacing="0" width="100%" style="width:auto;margin:2px 40px;">
                  <tr>
                     ...
                     <td style="width:135PX;font-family:Verdana;text-align:right;font-size:10px;background-color:#a0bfeb; height:20px;"><b><center>Stop Time</center></b></td>
    ...
    <div id="divcost" style="height:250px;width:450px;  margin-left:250px; margin-top: 8px; overflow:auto;"  >
<table>
...
<td runat="server" id="hdsviewgrid" valign="top" align="right"></td></tr>
    ...
    <input id="hiddencompcode" type="hidden" name="pub" runat="server" />
    <input id="hiddenuserid" type="hidden" name="pub" runat="server" />
    <input id="hiddendateformat" type="hidden" name="pub" runat="server" />
    <input id="HDN_server_date" type="hidden" name="pub" runat="server" />
     <input id="hdnunit" type="hidden" name="pub" runat="server" />
