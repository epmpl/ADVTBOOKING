<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ExtRebate.aspx.cs" Inherits="ExtRebate" %>
													...
													<td align="left">
														...
														<td  align="left">
                                                            <asp:UpdatePanel ID="UpdatePane21" runat="server">
                                                                <ContentTemplate>
                                                                    <asp:DropDownList id="dpregion" runat="server" CssClass="dropdown" AutoPostBack="True" OnSelectedIndexChanged="dpregion_SelectedIndexChanged1"></asp:DropDownList>
                                                                </ContentTemplate>
                                                            </asp:UpdatePanel>
                                                        </td>
