<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Fmgreasonmaster.aspx.cs" Inherits="Fmgreasonmaster" %>
...
<head id="Head1" runat="server">
    <title>Fmg Reason Master</title>
    <meta content="Microsoft Visual Studio .NET 7.1" name="GENERATOR"/>
		<meta content="C#" name="CODE_LANGUAGE"/>
		<meta content="JavaScript" name="vs_defaultClientScript"/>
		<meta content="http://schemas.microsoft.com/intellisense/ie5" name="vs_targetSchema"/>
			<script type="text/javascript" language="javascript" src="javascript/Fmgreasonmaster.js"></script>
		...
		<asp:ScriptManager ID="ScriptManager1" runat="server">
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%" style="width:auto;margin:15px 40px;">
                  <tr>
                     ...
                     <td style="width:135PX;font-family:Verdana;text-align:right;font-size:10px;background-color:#a0bfeb; height:20px;"><b><center>Fmg Reason Master</center></b></td>
				...
				<table cellpadding="0" cellspacing="0" style="width:auto;margin:30px 300px;">
						  <tr>
								<td><asp:label id="fmgreasoncode" runat="server" CssClass="TextField"></asp:label></td>
								<td><asp:TextBox ID="txtfmgcode" runat="server" CssClass="btext1" MaxLength="20" ></asp:TextBox></td>
                             ...
                             <tr>
								<td><asp:label id="fmgreasondesc" runat="server" CssClass="TextField"></asp:label></td>
								<td><asp:TextBox ID="txtfmgdesc" runat="server" CssClass="btext1" MaxLength="300" ></asp:TextBox>
                                   </td>
                            </tr>
