<%@ Control Language="C#" AutoEventWireup="true" CodeFile="openlayout.ascx.cs" Inherits="openlayout" %>
<%@ Register Assembly="System.Web.Extensions, Version=1.0.61025.0, Culture=neutral, PublicKeyToken=31bf3856ad364e35"
    Namespace="System.Web.UI" TagPrefix="asp" %>
<div id="opendialog" class="dragprop" style="display: none; cursor: default; background-color: buttonface;
    ...
    <table id="layouttab" border="0" cellpadding="0" cellspacing="0">
        <tr>
            <td colspan="2">
                <img src="images/Open-Template.jpg" usemap="#closemapo" width="203px" unselectable=on  />
                <map id="closemapo" name="closemapo" class="handcursor">
                    <area shape="rect" coords="188,15,200,2" alt="close" href="javascript:closepropO();" />
                </map>
            </td>
        </tr>
        <tr>
            <td align="center">
                <table border="0" cellpadding="0" cellspacing="0" style="top: 5px">
                    ...
                    <%--<tr><td>
                    <asp:Label id="drpcode" runat="server" Text="Choose Category" CssClass="proplbl"></asp:Label>
                    <asp:DropDownList id="drpcategory" runat="server" CssClass="" Width="80px"></asp:DropDownList>
                    </td></tr>--%>
                    <tr>
                        <td>
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                <ContentTemplate>
                                    <asp:ListBox ID="xmllist" runat="server" CssClass="listbox" Width="193px" Height="262px"
                                        OnSelectedIndexChanged="xmllist_SelectedIndexChanged"></asp:ListBox>
                                </ContentTemplate>
                            </asp:UpdatePanel>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td align="right">
                            <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                                <ContentTemplate>
                                    <input type="button" id="cancelL" value="Ok" onclick="document.getElementById('opendialog').style.display='none';"
