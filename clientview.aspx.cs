...
public partial class clientview : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        heading.Text = ds1.Tables[0].Rows[0].ItemArray[6].ToString();
        fromdt = Session["fromdate"].ToString();
        dateto = Session["todate"].ToString();
        //agencyname = Request.QueryString["agencyname"].ToString();
        //////subcat = Request.QueryString["subcategory"].ToString();
        //////subcategoryname = Request.QueryString["subcategoryname"].ToString();
        //////publicname = Request.QueryString["publiccode"].ToString();
        ...
        if (Request.QueryString["drilout"] == "yes")
        {
            ...
            publicationcode = Request.QueryString["publiccode"].ToString();
            product = Request.QueryString["Product"].ToString();
            subcat = Request.QueryString["subcat"].ToString();
            subsubcat = Request.QueryString["subsubcat"].ToString();
            brand = Request.QueryString["brand"].ToString();
            varient = Request.QueryString["varient"].ToString();
            ...
            {
                drillout(fromdt, dateto, agency, client, publicationcode, product, subcat, subsubcat, brand, varient, region, package, Session["compcode"].ToString(), Session["dateformat"].ToString());
            }
            else if (destination == "3")
            {
                hiddenascdesc.Value = sortorder;
                hiddencioid.Value = sortvalue;
                pdf_drillout(fromdt, dateto, agency, client, publicationcode, product, subcat, subsubcat, brand, varient, region, package, Session["compcode"].ToString(), Session["dateformat"].ToString(), hiddencioid.Value.Trim(), hiddenascdesc.Value.Trim());
            }
            else if (destination == "4")
            {
                excel_drillout(fromdt, dateto, agency, client, publicationcode, product, subcat, subsubcat, brand, varient, region, package, Session["compcode"].ToString(), Session["dateformat"].ToString());
            }
        ...
        else
        {
            ...
            dateto = Request.QueryString["dateto"].ToString();
            product = Request.QueryString["Product"].ToString();
            //prod = Request.QueryString["Productcode"].ToString();
            //clientname = Request.QueryString["client"].ToString();
            regionname = Request.QueryString["region"].ToString();
            region = Request.QueryString["regioncode"].ToString();
            destination = Request.QueryString["destination"].ToString();

            Ajax.Utility.RegisterTypeForAjax(typeof(clientview));
            ...
            if (destination == "1" || destination == "0")
            {
                ...
                onscreen(fromdt, dateto, agency, client, publicationcode, product, subcat, subsubcat, brand, varient, Session["compcode"].ToString(), Session["dateformat"].ToString(), region);
            }
            else if (destination == "4")
            {
                //excel(adtyp, adcat, fromdt, dateto, publ, pubcen, Session["compcode"].ToString(), edition, Session["dateformat"].ToString());
                excel(fromdt, dateto, agency, client, publicationcode, product, subcat, subsubcat, brand, varient, Session["compcode"].ToString(), Session["dateformat"].ToString(), region);
                ...
                if (destination == "3")
                {
                    ...
                    pdf(fromdt, dateto, agency, client, publicationcode, product, subcat, subsubcat, brand, varient, Session["compcode"].ToString(), Session["dateformat"].ToString(), region);
                }
        }

    }

    private void onscreen(string fromdt, string dateto, string agency, string client, string publication, string product, string subcat, string subsubcat,  string brand, string varient, string compcode, string dateformat, string region)
    {
        NewAdbooking.Classes.Class1 obj = new NewAdbooking.Classes.Class1();
        SqlDataAdapter da = new SqlDataAdapter();
        DataSet ds = new DataSet();
        ds = obj.onscreenreportforclient(fromdt, dateto, agency, client, publication, product, subcat, subsubcat, brand, varient, region, Session["compcode"].ToString(), Session["dateformat"].ToString(), hiddencioid.Value.Trim(), hiddenascdesc.Value.Trim());
        ...
        {
            tbl = tbl + ("<tr><td class='middle31'>S.No.</td><td class='middle31'>CIOID</td><td class='middle31'>Insdate</td><td id='tdag~3' class='middle3'   onclick=sorting('Agency',this.id)>Agency<img id='imgagdown' src='Images\\down.gif' style='display:block;'><img id='imgagup' src='Images\\up.gif' style='display:none;'></td><td id='tdcli~4' class='middle3'   onclick=sorting('Client',this.id)>Client<img id='imgclidown' src='Images\\down.gif' style='display:block;'><img id='imgcliup' src='Images\\up.gif' style='display:none;'></td><td id='tdpac~5' class='middle3'   onclick=sorting('Package',this.id)>Package<img id='imgpacdown' src='Images\\down.gif' style='display:block;'><img id='imgpacup' src='Images\\up.gif' style='display:none;'></td><td class='middle31'>Depth</td><td class='middle31'>width</td><td class='middle31'>Hue</td><td id='tdpro~9' class='middle3'   onclick=sorting('Product',this.id)>Product<img id='imgpacdown' src='Images\\down.gif' style='display:block;'><img id='imgpacup' src='Images\\up.gif' style='display:none;'></td><td id='tdbrad~10' class='middle3'   onclick=sorting('Brand',this.id)>Brand<img id='imgpacdown' src='Images\\down.gif' style='display:block;'><img id='imgpacup' src='Images\\up.gif' style='display:none;'></td><td class='middle31'>CardRate</td><td class='middle31'>AggRate</td><td id='tdreg~13' class='middle3'   onclick=sorting('Region',this.id)>Region<img id='imgregdown' src='Images\\down.gif' style='display:block;'><img id='imgregup' src='Images\\up.gif' style='display:none;'></td><td class='middle31'>Varient</td></tr>");
           //tbl = tbl + ("<tr><td class='middle3'>S.No.</td><td class='middle3' >CIOID</td><td id='tdag~2' class='middle3'   onclick=test('Agency',this.id)>Agency<img id='imgagdown' src='Images\\down.gif' style='display:block;'><img id='imgagup' src='Images\\up.gif' style='display:none;'></td><td class='middle3'>Client</td></td><td id='tdpub~5' class='middle3' onclick=test('publication',this.id)>Publication<img id='imgpubdown' src='Images\\down.gif' style='display:block;'><img id='imgpubup' src='Images\\up.gif' style='display:none;'></td><td class='middle3'>AdType</td><td class='middle3'>PaymentType</td><td class='middle3'>Area</td><td class='middle3'>BillAmt</td><td class='middle3'>BillStatus</td><td class='middle3'>BillableArea</td><td class='middle3'>RevenueCenter</td>");
        }
        else if (hiddenascdesc.Value == "asc")
        {
            tbl = tbl + ("<tr><td class='middle31'>S.No.</td><td class='middle31'>CIOID</td><td class='middle31'>Insdate</td><td id='tdag~3' class='middle3'   onclick=sorting('Agency',this.id)>Agency<img id='imgagdown' src='Images\\down.gif' style='display:block;'><img id='imgagup' src='Images\\up.gif' style='display:none;'></td><td id='tdcli~4' class='middle3'   onclick=sorting('Client',this.id)>Client<img id='imgclidown' src='Images\\down.gif' style='display:block;'><img id='imgcliup' src='Images\\up.gif' style='display:none;'></td><td id='tdpac~5' class='middle3'   onclick=sorting('Package',this.id)>Package<img id='imgpacdown' src='Images\\down.gif' style='display:block;'><img id='imgpacup' src='Images\\up.gif' style='display:none;'></td><td class='middle31'>Depth</td><td class='middle31'>width</td><td class='middle31'>Hue</td><td id='tdpro~9' class='middle3'   onclick=sorting('Product',this.id)>Product<img id='imgpacdown' src='Images\\down.gif' style='display:block;'><img id='imgpacup' src='Images\\up.gif' style='display:none;'></td><td id='tdbrad~10' class='middle3'   onclick=sorting('Brand',this.id)>Brand<img id='imgpacdown' src='Images\\down.gif' style='display:block;'><img id='imgpacup' src='Images\\up.gif' style='display:none;'></td><td class='middle31'>CardRate</td><td class='middle31'>AggRate</td><td id='tdreg~13' class='middle3'   onclick=sorting('Region',this.id)>Region<img id='imgregdown' src='Images\\down.gif' style='display:block;'><img id='imgregup' src='Images\\up.gif' style='display:none;'></td><td class='middle31'>Varient</td></tr>");
           //tbl = tbl + ("<tr><td class='middle3'>S.No.</td><td class='middle3'>CIOID</td><td class='middle3'>Insdate</td><td id='tdag~3' class='middle3'   onclick=test('Agency',this.id)>Agency<img id='imgagdown' src='Images\\down.gif' style='display:block;'><img id='imgagup' src='Images\\up.gif' style='display:none;'></td><td id='tdcli~4' class='middle3'   onclick=test('Client',this.id)>Client<img id='imgclidown' src='Images\\down.gif' style='display:block;'><img id='imgcliup' src='Images\\up.gif' style='display:none;'></td><td id='tdpac~5' class='middle3'   onclick=test('Package',this.id)>Package<img id='imgpacdown' src='Images\\down.gif' style='display:block;'><img id='imgpacup' src='Images\\up.gif' style='display:none;'></td><td class='middle3'>Depth</td><td class='middle3'>width</td><td class='middle3'>Hue</td><td class='middle3'>Product</td><td class='middle3'>Brand</td><td class='middle3'>CardRate</td><td class='middle3'>AggRate</td><td id='tdreg~11' class='middle3'   onclick=test('Region',this.id)>Region<img id='imgregdown' src='Images\\down.gif' style='display:block;'><img id='imgregup' src='Images\\up.gif' style='display:none;'></td><td class='middle3'>Varient</td></tr>");
            //tbl = tbl + ("<tr><td class='middle3'>S.No.</td><td class='middle3' >CIOID</td><td id='tdag~2' class='middle3'  onclick=test('Agency',this.id)>Agency<img id='imgagdown' src='Images\\down.gif' style='display:block;'><img id='imgagup' src='Images\\up.gif' style='display:none;'></td><td class='middle3'>Client</td></td><td id='tdpub~5' class='middle3' onclick=test('publication',this.id)>Publication<img id='imgpubdown' src='Images\\down.gif' style='display:block;'><img id='imgpubup' src='Images\\up.gif' style='display:none;'></td><td class='middle3'>AdType</td><td class='middle3'>PaymentType</td><td class='middle3'>Area</td><td class='middle3'>BillAmt</td><td class='middle3'>BillStatus</td><td class='middle3'>BillableArea</td><td class='middle3'>RevenueCenter</td>");
        }
        else if (hiddenascdesc.Value == "desc")
        {
           // tbl = tbl + ("<tr><td class='middle3'>S.No.</td><td class='middle3'>CIOID</td><td class='middle3'>Insdate</td><td id='tdag~3' class='middle3'   onclick=test('Agency',this.id)>Agency<img id='imgagdown' src='Images\\down.gif' style='display:none;'><img id='imgagup' src='Images\\up.gif' style='display:block;'></td><td id='tdcli~4' class='middle3'   onclick=test('Client',this.id)>Client<img id='imgclidown' src='Images\\down.gif' style='display:none;'><img id='imgcliup' src='Images\\up.gif' style='display:block;'></td><td id='tdpac~5' class='middle3'   onclick=test('Package',this.id)>Package<img id='imgpacdown' src='Images\\down.gif' style='display:none;'><img id='imgpacup' src='Images\\up.gif' style='display:block;'></td><td class='middle3'>Depth</td><td class='middle3'>width</td><td class='middle3'>Hue</td><td class='middle3'>Product</td><td class='middle3'>Brand</td><td class='middle3'>CardRate</td><td class='middle3'>AggRate</td><td id='tdreg~11' class='middle3'   onclick=test('Region',this.id)>Region<img id='imgregdown' src='Images\\down.gif' style='display:none;'><img id='imgregup' src='Images\\up.gif' style='display:block;'></td><td class='middle3'>Varient</td></tr>");
            //tbl = tbl + ("<tr><td class='middle3'>S.No.</td><td class='middle3' >CIOID</td><td id='tdag~2' class='middle3'  onclick=test('Agency',this.id)>Agency<img id='imgagdown' src='Images\\down.gif' style='display:none;'><img id='imgagup' src='Images\\up.gif' style='display:block;'></td><td class='middle3'>Client</td></td><td id='tdpub~5' class='middle3' onclick=test('publication',this.id)>Publication<img id='imgpubdown' src='Images\\down.gif' style='display:none;'><img id='imgpubup' src='Images\\up.gif' style='display:block;'></td><td class='middle3'>AdType</td><td class='middle3'>PaymentType</td><td class='middle3'>Area</td><td class='middle3'>BillAmt</td><td class='middle3'>BillStatus</td><td class='middle3'>BillableArea</td><td class='middle3'>RevenueCenter</td>");
            tbl = tbl + ("<tr><td class='middle31'>S.No.</td><td class='middle31'>CIOID</td><td class='middle31'>Insdate</td><td id='tdag~3' class='middle3'   onclick=sorting('Agency',this.id)>Agency<img id='imgagdown' src='Images\\down.gif' style='display:none;'><img id='imgagup' src='Images\\up.gif' style='display:block;'></td><td id='tdcli~4' class='middle3'   onclick=sorting('Client',this.id)>Client<img id='imgclidown' src='Images\\down.gif' style='display:none;'><img id='imgcliup' src='Images\\up.gif' style='display:block;'></td><td id='tdpac~5' class='middle3'   onclick=sorting('Package',this.id)>Package<img id='imgpacdown' src='Images\\down.gif' style='display:none;'><img id='imgpacup' src='Images\\up.gif' style='display:block;'></td><td class='middle31'>Depth</td><td class='middle31'>width</td><td class='middle31'>Hue</td><td id='tdpro~9' class='middle3'   onclick=sorting('Product',this.id)>Product<img id='imgpacdown' src='Images\\down.gif' style='display:none;'><img id='imgpacup' src='Images\\up.gif' style='display:block;'></td><td id='tdbrad~10' class='middle3'   onclick=sorting('Brand',this.id)>Brand<img id='imgpacdown' src='Images\\down.gif' style='display:none;'><img id='imgpacup' src='Images\\up.gif' style='display:block;'></td><td class='middle31'>CardRate</td><td class='middle31'>AggRate</td><td id='tdreg~13' class='middle3'   onclick=sorting('Region',this.id)>Region<img id='imgregdown' src='Images\\down.gif' style='display:none;'><img id='imgregup' src='Images\\up.gif' style='display:block;'></td><td class='middle31'>Varient</td></tr>");
        ...
        for (int i = 0; i <= cont - 1; i++)
        {
            ...
            tbl = tbl + ("<td class='rep_data'>");
            tbl = tbl + (ds.Tables[0].Rows[i]["Brand"] + "</td>");
            tbl = tbl + ("<td class='rep_data'>");
        ...
        tbl = tbl + ("<tr >");
        tbl = tbl + "<tr><td class='middle14' width='3px'>-</td><td class='middle14' width='3px'>-</td><td class='middle14' width='3px'>-</td><td class='middle14' width='3px'>-</td><td class='middle14' width='3px'>-</td><td class='middle14' width='3px'>-</td><td class='middle14' width='3px'>-</td><td class='middle4' width='3px'>-</td><td class='middle14' width='3px'>-</td><td class='middle14' width='3px'>-</td><td class='middle14' width='3px'>-</td><td class='middle14' width='3px'>-</td><td class='middle14' width='3px'>-</td><td class='middle14' width='3px'>-</td><td class='middle14' width='3px'>-</td></tr>";
        tbl = tbl + ("<tr >");
    ...
    private void excel(string fromdt, string dateto, string agency, string client, string publication, string product, string subcat, string subsubcat, string brand, string varient, string compcode, string dateformat, string region)
    {
        ...
        try
        {
            ...
            myReader = obj.excelfileforclient(fromdt, dateto, agency, client, publication, product, subcat, subsubcat, brand, varient, region, Session["compcode"].ToString(), Session["dateformat"].ToString());
            ...
            ds1.ReadXml(Server.MapPath("XML/report1.xml"));
            // heading.Text = ds1.Tables[0].Rows[0].ItemArray[6].ToString();
            oSheet.Cells[1, 7] = ds1.Tables[0].Rows[0].ItemArray[6].ToString();
            ...
            for (int j = 0; j < myReader.FieldCount; j++)
            {
                ...
                oSheet.Cells[3, 10] = pdfxml.Tables[0].Rows[0].ItemArray[58].ToString();
                oSheet.Cells[3, 11] = pdfxml.Tables[0].Rows[0].ItemArray[59].ToString();
                oSheet.Cells[3, 12] = pdfxml.Tables[0].Rows[0].ItemArray[21].ToString();
                oSheet.Cells[3, 13] = pdfxml.Tables[0].Rows[0].ItemArray[22].ToString();
            ...
            while (myReader.Read())
            {
                ...
                for (int k = 0; k < myReader.FieldCount; k++)
                {
                    ...
                    oSheet.Cells[iRow, 10] = myReader["Product"].ToString();
                    oSheet.Cells[iRow, 11] = myReader["Brand"].ToString();
                    oSheet.Cells[iRow, 12] = myReader["CardRate"].ToString();
                    oSheet.Cells[iRow, 13] = myReader["AgreedRate"].ToString();
    ...
    private void pdf(string fromdt, string dateto, string agency, string client, string publication, string product, string subcat, string subsubcat, string brand, string varient, string compcode, string dateformat, string region)
    {
        ...
        try
        {
           ...
           // heading.Text = ds1.Tables[0].Rows[0].ItemArray[6].ToString();
            ...
            tbl.addCell(new Phrase(ds1.Tables[0].Rows[0].ItemArray[6].ToString(), font9));
            ...
            float[] headerwidths = { 12, 14, 16, 16, 16, 18, 12, 15, 18, 20,12,12,12,15 }; // percentage
            ...
            datatable.addCell(new Phrase(pdfxml.Tables[0].Rows[0].ItemArray[59].ToString(), font10));
            ...
            while (row < ds.Tables[0].Rows.Count)
            {
                ...
                datatable.addCell(new Phrase(ds.Tables[0].Rows[row]["Brand"].ToString(), font11));
    ...
    private void pdf1(string fromdt, string dateto, string agency, string client, string publication, string product, string subcat, string subsubcat, string brand, string varient, string compcode, string dateformat, string region)
    {
        DataSet pdfxml = new DataSet();
        pdfxml.ReadXml(Server.MapPath("XML/pdf.xml"));
        string pdfName1 = "";
    ...
    private void drillout(string fromdt, string dateto, string agency, string client, string publicationcode, string product, string subcat, string subsubcat, string brand, string varient, string region, string package, string compcode, string dateformat)
    {
        NewAdbooking.Classes.Class1 obj = new NewAdbooking.Classes.Class1();
        SqlDataAdapter da = new SqlDataAdapter();
        DataSet ds = new DataSet();
        ds = obj.clientdrillout(fromdt, dateto, agency, client, publicationcode, product, subcat, subsubcat, brand, varient, region, package, Session["compcode"].ToString(), Session["dateformat"].ToString(), hiddencioid.Value.Trim(), hiddenascdesc.Value.Trim());
        int cont = ds.Tables[0].Rows.Count;
        string tbl = "";
        tbl = "<table width='100%'align='left' cellpadding='5' cellspacing='0'>";
        tbl = tbl + "<tr><td class='middle4' width='5px'>-</td><td class='middle4' width='5px'>-</td><td class='middle4' width='5px'>-</td><td class='middle4' width='5px'>-</td><td class='middle4' width='4px'>-</td><td class='middle4' width='5px'>-</td><td class='middle4' width='4px'>-</td><td class='middle4' width='4px'>-</td><td class='middle4' width='4px'>-</td><td class='middle4' width='4px'>-</td><td class='middle4' width='4px'>-</td><td class='middle4' width='4px'>-</td><td class='middle4' width='4px'>-</td><td class='middle4' width='4px'>-</td><td class='middle4' width='4px'>-</td></tr>";
    ...
    private void pdf_drillout(string fromdt, string dateto, string agency, string client, string publicationcode, string product, string subcat, string subsubcat, string brand, string varient, string region, string package, string compcode, string dateformat, string descid, string ascdesc)
    {
        DataSet pdfxml = new DataSet();
        pdfxml.ReadXml(Server.MapPath("XML/pdf.xml"));
        string pdfName = "";
        ...
        try
        {
            ...
            DataSet ds = new DataSet();
            //ds = obj.pdffile(adtyp, adcat, fromdt, dateto, publ, pubcen, Session["compcode"].ToString(), edition, Session["dateformat"].ToString());
            ds = obj.clientdrillout(fromdt, dateto, agency, client, publicationcode, product, subcat, subsubcat, brand, varient, region, package, Session["compcode"].ToString(), Session["dateformat"].ToString(), descid, ascdesc);
    ...
    private void excel_drillout(string fromdt, string dateto, string agency, string client, string publicationcode, string product, string subcat, string subsubcat, string brand, string varient, string region, string package, string compcode, string dateformat)
    {
        string strCurrentDir = Server.MapPath(".") + "\\";
        //RemoveFiles(strCurrentDir); // utility method to clean up old files			
        Excel.Application oXL;
        ...
        try
        {
            ...
            NewAdbooking.Classes.Class1 obj = new NewAdbooking.Classes.Class1();
            //myReader = obj.excelfile(adtyp, adcat, fromdt, dateto, publ, pubcen, Session["compcode"].ToString(), edition, Session["dateformat"].ToString());
            myReader = obj.client_drillout(fromdt, dateto, agency, client, publicationcode, product, subcat, subsubcat, brand, varient, region, package, Session["compcode"].ToString(), Session["dateformat"].ToString());
            //DataSet dst=clsbook.spfun();
            int iRow = 4;  //2
