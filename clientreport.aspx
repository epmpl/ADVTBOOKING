<%@ Page Language="C#" AutoEventWireup="true" CodeFile="clientreport.aspx.cs" Inherits="clientreport" EnableEventValidation="false" %>
...
<head id="Head1" runat="server">
	...
	.style2 { COLOR: #ffffff }
		...
		<%--<script type="text/javascript"  language="javascript" src="javascript/entertotabindustry.js"></script>--%>
...
<body onkeydown="javascript:return tabvaluebyid();" onkeypress="eventcalling(event);" <%--onload="document.getElementById('txtfrmdate').focus();"--%> >
				...
				<tr>
					...
					<table width="985" border="0" cellspacing="0" cellpadding="0" style="WIDTH: 985px; HEIGHT: 486px">
                        ...
                        <input id="hiddencompcode" type="hidden" runat="server" />
                         ...
                         <td><asp:UpdatePanel ID="updat112" runat="server"><ContentTemplate><input type="hidden" id="dpsubcat1" runat="server" /></ContentTemplate></asp:UpdatePanel></td>
                         <td><asp:UpdatePanel ID="Updat113" runat="server"><ContentTemplate><input type="hidden" id="dpsubsubcat1" runat="server" /></ContentTemplate></asp:UpdatePanel></td>
                         <td><asp:UpdatePanel ID="Updat114" runat="server"><ContentTemplate><input type="hidden" id="dpbrand1" runat="server" /></ContentTemplate></asp:UpdatePanel></td>
                         <td><asp:UpdatePanel ID="Updat115" runat="server"><ContentTemplate><input type="hidden" id="dpvarient1" runat="server" /></ContentTemplate></asp:UpdatePanel></td>
