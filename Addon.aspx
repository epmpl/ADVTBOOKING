<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Addon.aspx.cs" EnableEventValidation="false"Inherits="Addon" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>Rate Master Add On</title>
...
<body onkeydown="javascript:return tabvalue('txtrate');">
    <form id="form1" runat="server">
                ...
                <td>
                    ...
                    <table width="90%" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td align="left">
                                ...
                                <ContentTemplate>
                                    <asp:DropDownList ID="drpedition" runat="server" CssClass="dropdown" OnSelectedIndexChanged="drpedition_SelectedIndexChanged" AutoPostBack="True" Enabled="False">
                        ...
                        <tr>
                            <td align="left">
                                <asp:Label ID="lblsup" runat="server" CssClass="TextField"></asp:Label></td>
                            <td align="left"><asp:UpdatePanel ID="UpdatePanel9" runat="server">
                                <ContentTemplate>
                                    <asp:DropDownList ID="drpsup" runat="server" CssClass="dropdown" Enabled="False">
                            ...
                            <td align="left">
                                <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                    <ContentTemplate>
                                <asp:TextBox ID="txtrate" runat="server" CssClass="numerictext" Enabled="False" onkeypress="return isNumberKey(event);" MaxLength="8"></asp:TextBox>
                        ...
                        <tr>
                            <td align="left">
                                <asp:Label ID="lblextrarate" runat="server" CssClass="TextField">Extra Rate</asp:Label>
                            </td>
                            <td align="left">
                            <asp:UpdatePanel ID="UpdatePanel13" runat="server">
                                    <ContentTemplate>
                                <asp:TextBox ID="txtextrarate" runat="server" CssClass="numerictext" Enabled="False" onkeypress="return isNumberKey(event);" MaxLength="8"></asp:TextBox>
                                
                                    </ContentTemplate>
                                </asp:UpdatePanel>
                            </td>
                            <td >
                            <asp:Label ID="Label1" runat="server" CssClass="TextField">No Of Insert</asp:Label>
                            </td>
                             <td align="left">
                            <asp:UpdatePanel ID="UpdatePanel14" runat="server">
                                    <ContentTemplate>
                                <asp:TextBox ID="txtnoofinsert" runat="server" CssClass="numerictext" Enabled="False" onkeypress="return isNumberKey(event);" MaxLength="8"></asp:TextBox>
                    ...
                    <asp:DataGrid ID="DataGrid1" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn HeaderText="Edition" DataField="Edition_Name" SortExpression="Edition_Name"></asp:BoundColumn>
                            <asp:BoundColumn DataField="Supp_Name" HeaderText="Supplement" SortExpression="Supp_Name"></asp:BoundColumn>
                            <asp:BoundColumn HeaderText="Rate" DataField="Rate" SortExpression="Rate"></asp:BoundColumn>
                            <asp:BoundColumn DataField="Adon_code" HeaderText="code" Visible="False"></asp:BoundColumn>
                            <asp:BoundColumn DataField="extrarate" HeaderText="Extra Rate"></asp:BoundColumn>
                    ...
                    <asp:DataGrid ID="DataGrid2" runat="server"  AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn HeaderText="Edition" DataField="Edition_Name"></asp:BoundColumn>
                            <asp:BoundColumn DataField="Supp_Name" HeaderText="Supplement"></asp:BoundColumn>
        ...
        <input id="hiddenrateuniqueid" runat="server" type="hidden" style="width: 40px" />
