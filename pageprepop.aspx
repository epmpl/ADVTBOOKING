<%@ Page Language="C#" AutoEventWireup="true" CodeFile="pageprepop.aspx.cs" Inherits="pageprepop" %>
...
//          }
		   ...
		   try
	{
		if(typeof(window.opener)!="undefined")
		{
				...
				while(x_win!="undefined")
				{
					...
					if(typeof(x_win.opener)=="undefined")
					{
						...
						x_win.location.href="pageprview1.aspx?page=" + $('dppage').value + "&position=" + $('dpposition').value  + "&agency=" + $('dpagency').value + "&client=" + $('dpclient').value + "&adtype=" + $('dpdadtype').value + "&fromdate=" + $('txtfrmdate').value + "&dateto=" + $('txttodate1').value + "&publication=" + $('dppub1').value + "&pubcenter=" +$('pubcent').value + "&edition=" +$('dpedition').value + "&package=" +$('dppackage').value + "&status1=" + $('dpstatus').value+ "&drilout=" + "yes" + "&destination=" + $('dpdestination').value+ "&sortorder=" + $('txtpdfsort').value + "&sortvalue=" + $('txtpdfsortvalue').value;
						}
						else
						{
			x_win.location.href="pageprview1.aspx?page=" + $('dppage').value + "&position=" + $('dpposition').value  + "&agency=" + $('dpagency').value + "&client=" + $('dpclient').value + "&adtype=" + $('dpdadtype').value + "&fromdate=" + $('txtfrmdate').value + "&dateto=" + $('txttodate1').value + "&publication=" + $('dppub1').value + "&pubcenter=" +$('pubcent').value + "&edition=" +$('dpedition').value + "&package=" +$('dppackage').value + "&status1=" + $('dpstatus').value+ "&drilout=" + "yes" + "&destination=" + $('dpdestination').value+ "&sortorder=" + "50" + "&sortvalue=" + "50";
		...
		else
		{
			...
			window.location.href="pageprview1.aspx?page=" + $('dppage').value + "&position=" + $('dpposition').value  + "&agency=" + $('dpagency').value + "&client=" + $('dpclient').value + "&adtype=" + $('dpdadtype').value + "&fromdate=" + $('txtfrmdate').value + "&dateto=" + $('txttodate1').value + "&publication=" + $('dppub1').value + "&pubcenter=" +$('pubcent').value + "&edition=" +$('dpedition').value + "&package=" +$('dppackage').value + "&status1=" + $('dpstatus').value+ "&drilout=" + "yes" + "&destination=" + $('dpdestination').value+ "&sortorder=" + $('txtpdfsort').value + "&sortvalue=" + $('txtpdfsortvalue').value;
					...
					<td width="100%" bordercolor="#1"><img src="images/top.jpg" width="500" border="0" /></td>
										...
										<tr>
											...
											<table   align="center"  width="0" border="0" cellspacing="0" cellpadding="2">
													...
													<tr>
														<td align="left" ><asp:Label id="lbpage" runat="server" CssClass="TextField"></asp:Label></td>
														<td align="left"><asp:UpdatePanel ID="UpdatePanel13" runat="server">
                                                                <ContentTemplate>
                                                                    <asp:DropDownList CssClass="dropdown" id="dppage" runat="server"></asp:DropDownList>
                                                                </ContentTemplate>
                                                            </asp:UpdatePanel>
                                                        </td>
													...
													<tr>
													<td align="left"><asp:Label id="lbposition" runat="server" CssClass="TextField" ></asp:Label></td>
														<td align="left"><asp:UpdatePanel ID="UpdatePanel14" runat="server" >
                                                                <ContentTemplate>
                                                                    <asp:DropDownList CssClass="dropdown" id="dpposition" runat="server"></asp:DropDownList>
                                                                </ContentTemplate>
                                                            </asp:UpdatePanel>
                                                        </td>
													</tr>	
														...
														<td style="HEIGHT: 25px" align="left">
                                                            <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                                                <ContentTemplate>
                                                                    ...
                                                                    <%--<img src='Images/cal1.gif'  onclick='popUpCalendar(this, page11.txtfrmdate, "mm/dd/yyyy")' onfocus="abc();" height=14 width=14/>--%>
                                                                </ContentTemplate>
                                                            </asp:UpdatePanel>
                                                        </td>
														...
														<td style="HEIGHT: 25px" align="left">
                                                            <asp:UpdatePanel ID="UpdatePanel7" runat="server">
                                                                <ContentTemplate>
                                                                    ...
                                                                    <%--<img src='Images/cal1.gif'  onclick='popUpCalendar(this, page11.txttodate1, "mm/dd/yyyy")' onfocus="abc();" height=14 width=14/>--%>
                                                                </ContentTemplate>
                                                            </asp:UpdatePanel>
                                                        </td>
													...
													<td align="left"><asp:Label id="lblpackage" runat="server" CssClass="TextField" ></asp:Label></td>
														...
														<td style="HEIGHT: 25px" align="left">
                                                            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                                                <ContentTemplate>
                                                                    <asp:DropDownList id="dpdestination" runat="server" CssClass="dropdown" type="password" AutoPostBack="True"></asp:DropDownList>
                                                                </ContentTemplate>
                                                            </asp:UpdatePanel>
                                                        </td></tr>
