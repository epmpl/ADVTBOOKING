...
public partial class Pubrebateview : System.Web.UI.Page
{
    ...
    string todate, fromdate, client, publication, adtype, billstatus, payment, region, agency = "";
    //string temp1 = "", temp2 = "", temp3 = "", temp4 = "", temp5 = "", temp6 = "", temp7 = "", temp8 = "";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["drilout"] == "yes")
        {
           ...
           // todate = Request.QueryString["todate"].Trim().ToString();
            ...
            if (destination == "3")
            {
                ...
                pdf_drillout(fromdt, dateto, Session["compcode"].ToString(), region, Session["dateformat"].ToString(), publication, agency, client, billstatus, payment, adtype, category, hiddencioid.Value.Trim(), hiddenascdesc.Value.Trim());
            }
            else if (destination == "4")
            {
                excel_drillout(fromdt, dateto, Session["compcode"].ToString(), region, Session["dateformat"].ToString(), publication, agency, client, billstatus, payment, adtype, category);
            }
            else if (destination == "1" || destination == "0")
            {
                drillonscreen(fromdt, dateto, Session["compcode"].ToString(), region, Session["dateformat"].ToString(), publication, agency, client, billstatus, payment, adtype, category, hiddencioid.Value.Trim(), hiddenascdesc.Value.Trim());
        ...
        else
        {
            ...
            categoryname = Request.QueryString["agency"].ToString();
            ...
            {
                onscreen(fromdt, dateto, Session["compcode"].ToString(), category, product, Session["dateformat"].ToString());
            }
            else if (destination == "4")
            {
                excel(fromdt, dateto, Session["compcode"].ToString(), category, product, Session["dateformat"].ToString());

            }
            else
                if (destination == "3")
                {
                    pdf(fromdt, dateto, Session["compcode"].ToString(), category, product, Session["dateformat"].ToString());
                }
    ...
    private void onscreen(string frmdt, string todate, string compcode, string category, string product, string dateformate)
    {
       // NewAdbooking.Classes.bill obj = new NewAdbooking.Classes.bill();
        SqlDataAdapter da = new SqlDataAdapter();
        DataSet ds = new DataSet();
       // ds = obj.pubrebate(fromdt, dateto, Session["compcode"].ToString(), category, product, Session["dateformat"].ToString(), hiddencioid.Value.Trim(), hiddenascdesc.Value.Trim());
        ...
        else if (ConfigurationSettings.AppSettings["ConnectionType"].ToString() == "orcl")
        {
            ...
            ds = obj.pubrebate(fromdt, dateto, Session["compcode"].ToString(), category, product, Session["dateformat"].ToString(), hiddencioid.Value.Trim(), hiddenascdesc.Value.Trim(), temp1, temp2, temp3, temp4, temp5, temp6);
        }
        else
        {
        ...
        tbl = tbl + "<tr><td class='middle4' width='5px'>-</td><td class='middle4' width='5px'>-</td><td class='middle4' width='5px'>-</td><td class='middle4' width='5px'>-</td><td class='middle4' width='5px'>-</td><td class='middle4' width='4px'>-</td><td class='middle4' width='5px'>-</td><td class='middle4' width='4px'>-</td><td class='middle4' width='4px'>-</td><td class='middle4' width='4px'>-</td><td class='middle4' width='4px'>-</td><td class='middle4' width='4px'>-</td><td class='middle4' width='4px'>-</td><td class='middle4' width='4px'>-</td><td class='middle4' width='4px'>-</td></tr>";
        ...
        //tbl = tbl + ("<tr><td class='middle3'>S.No.</td><td class='middle3'>CIOID</td><td class='middle3'>Agency</td><td class='middle3'>Client</td><td class='middle3'>Publication</td><td class='middle3'>AdType</td><td class='middle3'>PaymentType</td><td class='middle3'>Area</td><td class='middle3'>BillAmt</td><td class='middle3'>BillStatus</td><td class='middle3'>BillableArea</td><td class='middle3'>CardRate</td><td class='middle3'>AggRate</td><td class='middle3'>Disc</td><td class='middle3'>RevenueCenter</td><td class='middle3'></td></tr>");
        ...
        if (hiddenascdesc.Value == "")
        {
            ...
            tbl = tbl + ("<tr><td class='middle31'>S.No.</td><td id='tdro~28' class='middle3'   onclick=sorting('CIOID',this.id)> CIOID<img id='img28down' src='Images\\down.gif' style='display:block;'><img id='img28up' src='Images\\up.gif' style='display:none;'></td><td id='tdag~2' class='middle3'   onclick=sorting('Agency',this.id)>Agency<img id='imgagdown' src='Images\\down.gif' style='display:block;'><img id='imgagup' src='Images\\up.gif' style='display:none;'></td><td id='tdcli~3' class='middle3'   onclick=sorting('Client',this.id)>Client<img id='imgclidown' src='Images\\down.gif' style='display:block;'><img id='imgcliup' src='Images\\up.gif' style='display:none;'></td><td id='tdpub~4' class='middle3' onclick=sorting('Publication',this.id)>Publication<img id='imgpubdown' src='Images\\down.gif' style='display:block;'><img id='imgpubup' src='Images\\up.gif' style='display:none;'></td><td id='tadtype~5' class='middle3' onclick=sorting('AdType',this.id)>AdType<img id='imgadtypedown' src='Images\\down.gif' style='display:block;'><img id='imgadtypeup' src='Images\\up.gif' style='display:none;'></td><td id='tdpay~6' class='middle3'   onclick=sorting('PaymentType',this.id)>PaymentType<img id='imgpaydown' src='Images\\down.gif' style='display:block;'><img id='imgpayup' src='Images\\up.gif' style='display:none;'></td><td id='tdro~25' class='middle3'   onclick=sorting('Area',this.id)> Area<img id='img25down' src='Images\\down.gif' style='display:block;'><img id='img25up' src='Images\\up.gif' style='display:none;'></td><td id='td~291' class='middle3' onclick=sorting('BillAmt',this.id)>BillAmount<img id='img291down' src='Images\\down.gif' style='display:block;'><img id='img291up' src='Images\\up.gif' style='display:none;'></td><td id='tdbill~9' class='middle3' onclick=sorting('BillStatus',this.id)>BillStatus<img id='imgbillstdown' src='Images\\down.gif' style='display:block;'><img id='imgbillstup' src='Images\\up.gif' style='display:none;'></td><td id='tdbama~29' class='middle3'   onclick=sorting('BillableArea',this.id)>BillableArea<img id='imgamta29down' src='Images\\down.gif' style='display:block;'><img id='imgamta29up' src='Images\\up.gif' style='display:none;'></td><td id='tdro~21' class='middle3'   onclick=sorting('CardRate',this.id)> CardRate<img id='img21down' src='Images\\down.gif' style='display:block;'><img id='img21up' src='Images\\up.gif' style='display:none;'></td><td id='tdro~20' class='middle3'   onclick=sorting('AgreedRate',this.id)> AggRate<img id='img20down' src='Images\\down.gif' style='display:block;'><img id='img20up' src='Images\\up.gif' style='display:none;'></td><td id='tddisc~281' class='middle3'   onclick=sorting('Disc',this.id)>Disc<img id='imgdiscdown' src='Images\\down.gif' style='display:block;'><img id='imgdiscup' src='Images\\up.gif' style='display:none;'></td><td id='trevec~14' class='middle3' onclick=sorting('RevenueCenter',this.id)>RevenueCenter<img id='imgrevcdown' src='Images\\down.gif' style='display:block;'><img id='imgrevcup' src='Images\\up.gif' style='display:none;'></td></tr>");
        }
        ...
        {
            tbl = tbl + ("<tr><td class='middle31'>S.No.</td><td id='tdro~28' class='middle3'  onclick=sorting('CIOID',this.id)> CIOID<img id='img28down' src='Images\\down.gif' style='display:none;'><img id='img28up' src='Images\\up.gif' style='display:block;'></td><td id='tdag~2' class='middle3'   onclick=sorting('Agency',this.id)>Agency<img id='imgagdown' src='Images\\down.gif' style='display:none;'><img id='imgagup' src='Images\\up.gif' style='display:block;'></td><td id='tdcli~3' class='middle3'   onclick=sorting('Client',this.id)>Client<img id='imgclidown' src='Images\\down.gif' style='display:none;'><img id='imgcliup' src='Images\\up.gif' style='display:block;'></td><td id='tdpub~4' class='middle3' onclick=sorting('Publication',this.id)>Publication<img id='imgpubdown' src='Images\\down.gif' style='display:none;'><img id='imgpubup' src='Images\\up.gif' style='display:block;'></td><td id='tadtype~5' class='middle3' onclick=sorting('AdType',this.id)>AdType<img id='imgadtypedown' src='Images\\down.gif' style='display:none;'><img id='imgadtypeup' src='Images\\up.gif' style='display:block;'></td><td id='tdpay~6' class='middle3'   onclick=sorting('PaymentType',this.id)>PaymentType<img id='imgpaydown' src='Images\\down.gif' style='display:none;'><img id='imgpayup' src='Images\\up.gif' style='display:block;'></td><td id='tdro~25' class='middle3'  onclick=sorting('Area',this.id)> Area<img id='img25down' src='Images\\down.gif' style='display:none;'><img id='img25up' src='Images\\up.gif' style='display:block;'></td><td id='td~291' class='middle3' onclick=sorting('BillAmt',this.id)>BillAmount<img id='img291down' src='Images\\down.gif' style='display:none;'> <img id='img291up' src='Images\\up.gif' style='display:block;'></td><td id='tdbill~9' class='middle3' onclick=sorting('BillStatus',this.id)>BillStatus<img id='imgbillstdown' src='Images\\down.gif' style='display:none;'><img id='imgbillstup' src='Images\\up.gif' style='display:block;'></td><td id='tdbama~29' class='middle3'  onclick=sorting('BillableArea',this.id)>BillableArea<img id='imgamta29down' src='Images\\down.gif' style='display:none;'><img id='imgamta29up' src='Images\\up.gif' style='display:block;'></td><td id='tdro~21' class='middle3'  onclick=sorting('CardRate',this.id)> CardRate<img id='img21down' src='Images\\down.gif' style='display:none;'><img id='img21up' src='Images\\up.gif' style='display:block;'></td><td id='tdro~20' class='middle3'  onclick=sorting('AgreedRate',this.id)> AggRate<img id='img20down' src='Images\\down.gif' style='display:none;'><img id='img20up' src='Images\\up.gif' style='display:block;'></td><td id='tddisc~281' class='middle3'  onclick=sorting('Disc',this.id)>Disc<img id='imgdiscdown' src='Images\\down.gif' style='display:none;'><img id='imgdiscup' src='Images\\up.gif' style='display:block;'></td><td id='trevec~14' class='middle3' onclick=sorting('RevenueCenter',this.id)>RevenueCenter<img id='imgrevcdown' src='Images\\down.gif' style='display:none;'><img id='imgrevcup' src='Images\\up.gif' style='display:block;'></td></tr>");
        }
        ...
        tbl = tbl + ("<td class='middle13'>");
        tbl = tbl + ("</td><td class='middle13'></td><td class='middle13'></td><td class='middle13'></td><td class='middle13'>Total</td>");
        tbl = tbl + ("<td class='middle13'>");
    ...
    private void excel(string fromdt, string dateto, string compcode, string category, string product, string dateformat)
    {
        ...
        DataGrid1.DataBind();
        hw.Write("<p align=\"center\">Rebate Report Publication Wise");
        ...
        try
        {
            ...
            //NewAdbooking.Classes.bill obj = new NewAdbooking.Classes.bill();
            //myReader = obj.pubrebateexcel(fromdt, dateto, Session["compcode"].ToString(), category, product, Session["dateformat"].ToString());
            //DataSet dst=clsbook.spfun();

            if (ConfigurationSettings.AppSettings["ConnectionType"].ToString() == "sql")
            {
                NewAdbooking.Classes.bill obj = new NewAdbooking.Classes.bill();
                myReader1 = obj.pubrebateexcel(fromdt, dateto, Session["compcode"].ToString(), category, product, Session["dateformat"].ToString());
            }
            else if (ConfigurationSettings.AppSettings["ConnectionType"].ToString() == "orcl")
            {
                NewAdbooking.classesoracle.bill obj = new NewAdbooking.classesoracle.bill();
                myReader = obj.pubrebateexcel(fromdt, dateto, Session["compcode"].ToString(), category, product, Session["dateformat"].ToString(), temp1, temp2, temp3, temp4, temp5, temp6,temp7,temp8);
            }
            else
            {
                //NewAdbooking.classmysql.bill pub = new NewAdbooking.classmysql.bill();
            ...
            oSheet.Cells[1, 7] = ds1.Tables[0].Rows[0].ItemArray[34].ToString();
            for (int j = 0; j < myReader.FieldCount; j++)
            {
                ...
                oSheet.Cells[3, 14] = pdfxml.Tables[0].Rows[0].ItemArray[23].ToString();
                oSheet.Cells[3, 15] = pdfxml.Tables[1].Rows[0].ItemArray[2].ToString();
                // oSheet.Cells[3, 12] = myReader.GetName(30).ToString();
            ...
            while (myReader.Read())
            {
                ...
                for (int k = 0; k < myReader.FieldCount; k++)
                {
                    ...
                    oSheet.Cells[iRow, 14] = myReader["Disc"].ToString();
                    oSheet.Cells[iRow, 15] = myReader["RevenueCenter"].ToString();
        ...
        {
            Response.Redirect("Pubrebate.aspx");
        }
    }

        */
    private void pdf(string frmdt, string todate, string compcode, string category, string product, string dateformate)
    {
        DataSet pdfxml = new DataSet();
        pdfxml.ReadXml(Server.MapPath("XML/pdf.xml"));
        string pdfName = "";
     ...
     //   btnprint.Attributes.Add("onclick", "javascript:window.print();");
        ...
        try
        {
            ...
            //float[] headerwidths = { 12, 14, 14, 16, 16, 7, 14, 12, 18, 18, 17, 12, 16, 12 }; // percentage
            ...
            // datatable.addCell(new Phrase(pdfxml.Tables[1].Rows[0].ItemArray[].ToString(), font10));
            ...
            float[] headerwidths = { 11, 13, 14, 14, 10, 7, 12, 14, 8, 10, 10, 10, 16 }; // percentage
            ...
            //Phrase p4 = (new Phrase(pdfxml.Tables[0].Rows[0].ItemArray[38].ToString(), font10));
            //document.Add(p4);
    ...
    //{
    //    pdf1(fromdt, dateto, Session["compcode"].ToString(), category ,product ,Session["dateformat"].ToString());

    //}

    //=========================================================================================

    private void pdf1(string frmdt, string todate, string compcode, string category, string product, string dateformate)
    {
        DataSet pdfxml = new DataSet();
        pdfxml.ReadXml(Server.MapPath("XML/pdf.xml"));
        string pdfName1 = "";
    ...
    private void drillonscreen(string fromdate, string todate, string compcode, string region, string dateformat, string publication, string agency, string client, string billstatus, string payment, string adtype, string category, string descid , string ascdesc)
    {
        ...
        if (hiddenascdesc.Value == "")
        {
            ...
            tbl = tbl + ("<tr><td class='middle31'>S.No.</td><td class='middle31'>CIOID</td><td id='tdag~2' class='middle3'   onclick=sorting('Agency',this.id)>Agency<img id='imgagdown' src='Images\\down.gif' style='display:block;'><img id='imgagup' src='Images\\up.gif' style='display:none;'></td><td id='tdcli~3' class='middle3'   onclick=sorting('Client',this.id)>Client<img id='imgclidown' src='Images\\down.gif' style='display:block;'><img id='imgcliup' src='Images\\up.gif' style='display:none;'></td><td id='tdpub~4' class='middle3' onclick=sorting('publication',this.id)>Publication<img id='imgpubdown' src='Images\\down.gif' style='display:block;'><img id='imgpubup' src='Images\\up.gif' style='display:none;'></td><td id='tadtype~5' class='middle3' onclick=sorting('AdType',this.id)>AdType<img id='imgadtypedown' src='Images\\down.gif' style='display:block;'><img id='imgadtypeup' src='Images\\up.gif' style='display:none;'></td><td id='tdpay~6' class='middle3'   onclick=sorting('PaymentType',this.id)>PaymentType<img id='imgpaydown' src='Images\\down.gif' style='display:block;'><img id='imgpayup' src='Images\\up.gif' style='display:none;'></td><td class='middle31'>Area</td><td class='middle31'>BillAmt</td><td id='tdbill~9' class='middle3' onclick=sorting('BillStatus',this.id)>BillStatus<img id='imgbillstdown' src='Images\\down.gif' style='display:block;'><img id='imgbillstup' src='Images\\up.gif' style='display:none;'></td><td class='middle31'>BillableArea</td><td class='middle31'>CardRate</td><td class='middle31'>AggRate</td><td class='middle31'>Disc</td><td id='trevec~14' class='middle3' onclick=sorting('RevenueCenter',this.id)>RevenueCenter<img id='imgrevcdown' src='Images\\down.gif' style='display:block;'><img id='imgrevcup' src='Images\\up.gif' style='display:none;'></td></tr>");
        }
        else if (hiddenascdesc.Value == "asc")
        {
            //tbl = tbl + ("<tr><td class='middle3'>S.No.</td><td class='middle3'>CIOID</td><td class='middle3'>Agency</td><td class='middle3'>Client</td><td class='middle3'>Publication</td><td class='middle3'>AdType</td><td class='middle3'>PaymentType</td><td class='middle3'>Area</td><td class='middle3'>BillAmt</td><td class='middle3'>BillStatus</td><td class='middle3'>BillableArea</td><td class='middle3'>CardRate</td><td class='middle3'>AggRate</td><td class='middle3'>Disc</td><td class='middle3'>RevenueCenter</td><td class='middle3'></td></tr>");
            tbl = tbl + ("<tr><td class='middle31'>S.No.</td><td class='middle31'>CIOID</td><td id='tdag~2' class='middle3'   onclick=sorting('Agency',this.id)>Agency<img id='imgagdown' src='Images\\down.gif' style='display:block;'><img id='imgagup' src='Images\\up.gif' style='display:none;'></td><td id='tdcli~3' class='middle3'   onclick=sorting('Client',this.id)>Client<img id='imgclidown' src='Images\\down.gif' style='display:block;'><img id='imgcliup' src='Images\\up.gif' style='display:none;'></td><td id='tdpub~4' class='middle3' onclick=sorting('publication',this.id)>Publication<img id='imgpubdown' src='Images\\down.gif' style='display:block;'><img id='imgpubup' src='Images\\up.gif' style='display:none;'></td><td id='tadtype~5' class='middle3' onclick=sorting('AdType',this.id)>AdType<img id='imgadtypedown' src='Images\\down.gif' style='display:block;'><img id='imgadtypeup' src='Images\\up.gif' style='display:none;'></td><td id='tdpay~6' class='middle3'   onclick=sorting('PaymentType',this.id)>PaymentType<img id='imgpaydown' src='Images\\down.gif' style='display:block;'><img id='imgpayup' src='Images\\up.gif' style='display:none;'></td><td class='middle31'>Area</td><td class='middle31'>BillAmt</td><td id='tdbill~9' class='middle3' onclick=sorting('BillStatus',this.id)>BillStatus<img id='imgbillstdown' src='Images\\down.gif' style='display:block;'><img id='imgbillstup' src='Images\\up.gif' style='display:none;'></td><td class='middle31'>BillableArea</td><td class='middle31'>CardRate</td><td class='middle31'>AggRate</td><td class='middle31'>Disc</td><td id='trevec~14' class='middle3' onclick=sorting('RevenueCenter',this.id)>RevenueCenter<img id='imgrevcdown' src='Images\\down.gif' style='display:block;'><img id='imgrevcup' src='Images\\up.gif' style='display:none;'></td></tr>");
            //tbl = tbl + ("<tr><td class='middle3'>S.No.</td><td class='middle3'>CIOID</td><td id='tdag~2' class='middle3'   onclick=sorting('Agency',this.id)>Agency<img id='imgagdown' src='Images\\down.gif' style='display:block;'><img id='imgagup' src='Images\\up.gif' style='display:none;'></td><td id='tdcli~3' class='middle3'   onclick=sorting('Client',this.id)>Client<img id='imgclidown' src='Images\\down.gif' style='display:block;'><img id='imgcliup' src='Images\\up.gif' style='display:none;'></td><td id='tdpub~4' class='middle3' onclick=sorting('publication',this.id)>Publication<img id='imgpubdown' src='Images\\down.gif' style='display:block;'><img id='imgpubup' src='Images\\up.gif' style='display:none;'></td><td class='middle3'>Area</td><td id='tdbill~6' class='middle3' onclick=sorting('BillStatus',this.id)>BillStatus<img id='imgbillstdown' src='Images\\down.gif' style='display:block;'><img id='imgbillstup' src='Images\\up.gif' style='display:none;'></td><td id='tdpay~6' class='middle3'   onclick=sorting('PaymentType',this.id)>PaymentType<img id='imgpaydown' src='Images\\down.gif' style='display:block;'><img id='imgpayup' src='Images\\up.gif' style='display:none;'></td><td class='middle3'>BillAmt</td><td class='middle3'>BillableArea</td><td class='middle3'>AdType</td><td id='trevec~11' class='middle3' onclick=sorting('RevenueCenter',this.id)>RevenueCenter<img id='imgrevcdown' src='Images\\down.gif' style='display:block;'><img id='imgrevcup' src='Images\\up.gif' style='display:none;'></td></tr>");
        }
        else if (hiddenascdesc.Value == "desc")
        {
              tbl = tbl + ("<tr><td class='middle31'>S.No.</td><td class='middle31'>CIOID</td><td id='tdag~2' class='middle3'   onclick=sorting('Agency',this.id)>Agency<img id='imgagdown' src='Images\\down.gif' style='display:none;'><img id='imgagup' src='Images\\up.gif' style='display:block;'></td><td id='tdcli~3' class='middle3'   onclick=sorting('Client',this.id)>Client<img id='imgclidown' src='Images\\down.gif' style='display:none;'><img id='imgcliup' src='Images\\up.gif' style='display:block;'></td><td id='tdpub~4' class='middle3' onclick=sorting('publication',this.id)>Publication<img id='imgpubdown' src='Images\\down.gif' style='display:none;'><img id='imgpubup' src='Images\\up.gif' style='display:block;'></td><td id='tadtype~5' class='middle3' onclick=sorting('AdType',this.id)>AdType<img id='imgadtypedown' src='Images\\down.gif' style='display:none;'><img id='imgadtypeup' src='Images\\up.gif' style='display:block;'></td><td id='tdpay~6' class='middle3'   onclick=sorting('PaymentType',this.id)>PaymentType<img id='imgpaydown' src='Images\\down.gif' style='display:none;'><img id='imgpayup' src='Images\\up.gif' style='display:block;'></td><td class='middle31'>Area</td><td class='middle31'>BillAmt</td><td id='tdbill~9' class='middle3' onclick=sorting('BillStatus',this.id)>BillStatus<img id='imgbillstdown' src='Images\\down.gif' style='display:none;'><img id='imgbillstup' src='Images\\up.gif' style='display:block;'></td><td class='middle31'>BillableArea</td><td class='middle31'>CardRate</td><td class='middle31'>AggRate</td><td class='middle31'>Disc</td><td id='trevec~14' class='middle3' onclick=sorting('RevenueCenter',this.id)>RevenueCenter<img id='imgrevcdown' src='Images\\down.gif' style='display:none;'><img id='imgrevcup' src='Images\\up.gif' style='display:block;'></td></tr>");
        }
...
/*        string strCurrentDir = Server.MapPath(".") + "\\";
    ...
    */
    ...
    protected void DataGrid1_ItemDataBound(object sender, System.Web.UI.WebControls.DataGridItemEventArgs e)
    {
        ...
        string billarea = e.Item.Cells[10].Text;
        ...
        if (check2 != "BillableArea")
        {
            if (check2 != "&nbsp;")
            {
                ...
                string billarea1 = e.Item.Cells[10].Text;
