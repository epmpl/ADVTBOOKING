...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="piregionpopup.aspx.cs" Inherits="piregionpopup" %>
   ...
   alrt=document.getElementById('lbpdfsort').innerText;
		    ...
		    try
	{
		if(typeof(window.opener)!="undefined")
		{
				...
				while(x_win!="undefined")
				{
					...
					if(typeof(x_win.opener)=="undefined")
					{
						...
						{
						    x_win.location.href="regionwisereport.aspx?fromdate=" + $('txtfrmdate').value + "&dateto=" +$('txttodate1').value  + "&region=" + $('dpregion').value +  "&language=" +$('dplanguage').value +"&agency=" + $('dpagency').value + "&client=" + $('dpclient').value +"&lang="+$('dplanguage').value + "&drilout=" + "yes" + "&destination="+ $('dpdestination').value + "&sortorder=" + $('txtpdfsort').value + "&sortvalue=" + $('txtpdfsortvalue').value;
						}
						else
						{
						    x_win.location.href="regionwisereport.aspx?fromdate=" + $('txtfrmdate').value + "&dateto=" +$('txttodate1').value  + "&region=" + $('dpregion').value +  "&language=" +$('dplanguage').value +"&agency=" + $('dpagency').value + "&client=" + $('dpclient').value +"&lang="+$('dplanguage').value + "&drilout=" + "yes" + "&destination="+ $('dpdestination').value + "&sortorder=" + "50" + "&sortvalue=" + "50";
						}
		...
		else
		{
			...
			window.location.href="regionwisereport.aspx?fromdate=" + $('txtfrmdate').value + "&dateto=" +$('txttodate1').value  + "&region=" + $('dpregion').value +  "&language=" +$('dplanguage').value +"&agency=" + $('dpagency').value + "&client=" + $('dpclient').value +"&lang="+$('dplanguage').value + "&drilout=" + "yes" + "&destination="+ $('dpdestination').value + "&sortorder=" + $('txtpdfsort').value + "&sortvalue=" + $('txtpdfsortvalue').value;
			//window.open("epapermain.aspx?queryed="+a+"&getda=h&eddate="+b);
		}
	}
	catch(e)
...
<body>
    <form id="piregionpop" runat="server">
										...
										<tr>
											...
											<table   align="center"  width="0" border="0" cellspacing="0" cellpadding="2">
														...
														<td  align="left">
                                                            <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                                                <ContentTemplate>
                                                                    ...
                                                                    <%--<img src='Images/cal1.gif'  onclick='popUpCalendar(this, piregionpop.txtfrmdate, "mm/dd/yyyy")' onfocus="abc();" height=14 width=14/>--%>
                                                                </ContentTemplate>
                                                            </asp:UpdatePanel>
                                                        </td>
													...
													<td align="left">
														...
														<td  align="left">
                                                            <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                                                <ContentTemplate>
                                                                    ...
                                                                    <%--<img src='Images/cal1.gif'  onclick='popUpCalendar(this, piregionpop.txttodate1, "mm/dd/yyyy")' onfocus="abc();" height="14" width="14"/>--%>
                                                                </ContentTemplate>
                                                            </asp:UpdatePanel>
                                                        </td>
                                                        ...
                                                        <td align="left">
                                                        <asp:Label id="lblanguage" runat="server" CssClass="TextField"></asp:Label></td>
														<td  align="left">
                                                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                                <ContentTemplate>
                                                       
                                                       <asp:DropDownList id="dplanguage" runat="server" CssClass="dropdown"></asp:DropDownList>
