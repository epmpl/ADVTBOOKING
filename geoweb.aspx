<%@ Page Language="C#" AutoEventWireup="true" CodeFile="geoweb.aspx.cs" Inherits="geoweb" %>
...
<body onload="tempexcutedays123();" onkeydown="javascript:tabvalue123(event)">
    ...
    <table width="575px"   style="border: 2px solid #0066FF; margin-top:0px; caption-side: top; v-align:top;">
        ...
        <table width="530px"> <tr><td colspan="3" align="left" style="font-size:14px;font-family:Arial;" ><b>Adjust Delivery</b>&nbsp;&nbsp;<asp:Button ID="Button1" CssClass="inputbuttongeo" runat="server" Text="Views" /></td></tr></table>
      ...
      <tr> <td width="100px"><asp:Label ID="lbagency" runat="server" style="font-size:14px;font-family:Verdana"  Text="Rotation(%)" ></asp:Label></td>
       ...
       <td ><asp:TextBox ID="txtrotation" runat="server" Height="15px" width="150px" 
                                      ...
                                      MaxLength="3"                     onkeypress="return isNumberKey(event);"   ></asp:TextBox></td></tr>
      ...
      <table width="530px" border="0" >
       ...
       <td align="left" style="font-size:14px;font-family:Verdana;" width="75px"  >Sex</td><td width="20px"></td><td style="font-size:14px"><asp:RadioButton runat="server" Text="Male" ID="ml1" GroupName="Radio" Checked="true"></asp:RadioButton>&nbsp;&nbsp;&nbsp;<asp:RadioButton runat="server" Text="Female" ID="fe1" GroupName="Radio" ></asp:RadioButton></td>
