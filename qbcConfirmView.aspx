<%@ Page Language="C#" AutoEventWireup="true" CodeFile="qbcConfirmView.aspx.cs" Inherits="qbcConfirmView" %>
...
<%--<body onload="document.getElementById('btnprint').focus();javascript:return showUpDownImg();">onkeydown ="javascript:return windowop('alagency.aspx');">--%>
<body onload="javascript:return showUpDownImg();">
<form id="form1" runat="server">
  <table style="width: 794px" >
  
<tr style="width:100px">
<td align="left" style="width: 69px" ><asp:Button ID="btnprint" runat="server" Text="Print"  style="display:none" OnClientClick="javascript:return print()" /><%--<input type="button" id="btnprint" value ="Print"  runat ="server"  onclick="javascript:return printbtn();"   />--%></td> 
...
<tr>
    ...
    <tr>
        ...
        <%--<td class="upper2">Status:</td><td class="middle2"><asp:Label ID="lbStatus" CssClass="reporttext1" runat="server"></asp:Label></td>--%>
