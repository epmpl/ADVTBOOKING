...
public partial class Retaincomview2 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
       ...
       // lbcatgory.Text = ds.Tables[0].Rows[0].ItemArray[4].ToString();
        ...
        lblretainname.Text = ds1.Tables[0].Rows[0].ItemArray[51].ToString();
...
//--------------------------------------
            ...
            Btnreset.Attributes.Add("onclick", "javascript:return retain();");
...
//-------------------------------------------------------------------
    ...
    public void bindsortvalue()
    {
        ...
        //for (i = 0; i < destination.Tables[0].Columns.Count - 1; i++)
        for (i = 0; i < sortvalue.Tables[11].Columns.Count; i++)
        {
            ListItem li;
            li = new ListItem();
            li.Text = sortvalue.Tables[11].Rows[0].ItemArray[i].ToString();
            i = i + 1;
            li.Value = sortvalue.Tables[11].Rows[0].ItemArray[i].ToString();
    ...
    public void bindretainname()
    {
        //regionhidden=hiddenregion.Value;
        NewAdbooking.Classes.bill retainobj = new NewAdbooking.Classes.bill();
        ...
        ds = retainobj.retainname(Session["compcode"].ToString());
        ListItem li1;
        li1 = new ListItem();
        li1.Text = ds1.Tables[0].Rows[0].ItemArray[20].ToString();
        li1.Value = "0";//objDataSet.Tables[0].Rows[i].ItemArray[0].ToString();
        li1.Selected = true;
       dpretainname .Items.Add(li1);
