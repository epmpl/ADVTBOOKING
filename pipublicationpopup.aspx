...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="pipublicationpopup.aspx.cs" Inherits="pipublicationpopup" %>
   ...
   alrt=document.getElementById('lbpdfsort').innerText;
		    ...
		    try
	{
		if(typeof(window.opener)!="undefined")
		{
				...
				while(x_win!="undefined")
				{
					...
					if(typeof(x_win.opener)=="undefined")
					{
						...
						{
						    x_win.location.href="pipublicationviewpage.aspx?fromdate=" + $('txtfrmdate').value + "&dateto=" +$('txttodate1').value  + "&publication=" + $('dppublication').value +  "&agname=" +$('dpagency').value +"&clientname=" + $('dpclient').value + "&published1=" + $('dppubnot').value + "&region=" + $('dpregion').value+ "&drilout=" + "yes" + "&destination="+ $('dpdestination').value+ "&sortorder=" + $('txtpdfsort').value + "&sortvalue=" + $('txtpdfsortvalue').value;
						}
						else
						{
						    x_win.location.href="pipublicationviewpage.aspx?fromdate=" + $('txtfrmdate').value + "&dateto=" +$('txttodate1').value  + "&publication=" + $('dppublication').value +  "&agname=" +$('dpagency').value +"&clientname=" + $('dpclient').value + "&published1=" + $('dppubnot').value + "&region=" + $('dpregion').value+ "&drilout=" + "yes" + "&destination="+ $('dpdestination').value+ "&sortorder=" + "50" + "&sortvalue=" + "50";
						}
		...
		else
		{
			...
			window.location.href="pipublicationviewpage.aspx?fromdate=" + $('txtfrmdate').value + "&dateto=" +$('txttodate1').value  + "&publication=" + $('dppublication').value +  "&agname=" +$('dpagency').value +"&clientname=" + $('dpclient').value + "&published1=" + $('dppubnot').value + "&region=" + $('dpregion').value+ "&drilout=" + "yes" + "&destination="+ $('dpdestination').value+ "&sortorder=" + $('txtpdfsort').value + "&sortvalue=" + $('txtpdfsortvalue').value;
			//window.open("epapermain.aspx?queryed="+a+"&getda=h&eddate="+b);
		}
	}
	catch(e)
...
<body>
    <form id="pipublication" runat="server">
														...
														<td  align="left">
                                                            <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                                                <ContentTemplate>
                                                                   ...
                                                                   <%-- <img src='Images/cal1.gif'  onclick='popUpCalendar(this, pipublication.txtfrmdate, "mm/dd/yyyy")' onfocus="abc();" height=14 width=14/>--%>
                                                                </ContentTemplate>
                                                            </asp:UpdatePanel>
                                                        </td>
														...
														<td  align="left">
                                                            <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                                                <ContentTemplate>
                                                                   ...
                                                                   <%-- <img src='Images/cal1.gif'  onclick='popUpCalendar(this, pipublication.txttodate1, "mm/dd/yyyy")' onfocus="abc();" height="14" width="14"/>--%>
                                                                </ContentTemplate>
                                                            </asp:UpdatePanel>
                                                        </td>
												...
												<tr>
													...
													<td align="left"><asp:Label id="lbclient" runat="server" CssClass="TextField" ></asp:Label></td>
                                                       ...
                                                       <asp:DropDownList id="dppublication" runat="server" CssClass="dropdown"></asp:DropDownList>
                                                        ...
                                                        <tr>
														<td align="left"><asp:Label id="lbpubnot" runat="server" CssClass="TextField"></asp:Label></td>
														<td  align="left">
                                                            <asp:UpdatePanel ID="UpdatePanel6" runat="server">
                                                                <ContentTemplate>
                                                                    <asp:DropDownList id="dppubnot" runat="server" CssClass="dropdown">
                                                                        <asp:ListItem>select published</asp:ListItem>
														...
														<td  align="left">
                                                            <asp:UpdatePanel ID="UpdatePanel7" runat="server">
                                                                <ContentTemplate>
                                                                    <asp:DropDownList id="dpdestination" runat="server" CssClass="dropdown" AutoPostBack="True" ></asp:DropDownList>
                                                                </ContentTemplate>
                                                            </asp:UpdatePanel>
                                                        </td>
