<%@ Page Language="C#" AutoEventWireup="true" CodeFile="agencynew.aspx.cs" Inherits="agencynew" EnableEventValidation="false"%>
...
<head>
		...
		<script type="text/javascript" language="javascript" src="javascript/agencynew.js"></script>
 ...
 else
 {
	...
	<body leftMargin="0" topMargin="0" 	id="bdy"  onkeydown="javascript:return tabvalue(event);"  onkeypress="eventcalling(event);"  style="background-color:#f3f6fd;">
		...
		<form id="Form1" method="post" runat="server">
			<div id="divagency" style="position: absolute; top: 155px; left: 670px; border: none; display: none;
            z-index: 1; " >
			...
			<table id="OuterTable" width="1000" border="0" cellpadding="0" cellspacing="0">
				<tr valign="top">
					<td colspan="2"><uc1:topbar id="Topbar1" runat="server" Text="Agency Hold"></uc1:topbar></td>
				</tr>
				<tr valign="top">
			...
			<table border="0" width="100%" cellpadding="0" cellspacing="0" style="width:auto;margin:15px 30px;">
                  <tr>
                     ...
                     <td style="width:135PX;font-family:Verdana;text-align:right;font-size:10px;background-color:#a0bfeb; height:20px;"><b><center>Agency Hold</center></b></td>
			...
			<table  style="width:auto;margin:40px 350px;" cellpadding="0" cellspacing="0" >
							<tr>
							    <td><asp:Label id="lbagency" runat="server" CssClass="TextField"></asp:Label></td>
											<td><asp:TextBox onkeypress="return ClientSpecialchardp(event);" id="txtagency" runat="server" CssClass="btext1"
													MaxLength="8" onpaste="return false"></asp:TextBox></td>
											
								
							</tr>
							<%--<tr><td><asp:label id="lblagencyname" runat="server" CssClass="TextField"> </asp:label></td>
								<td><asp:textbox onkeypress="return ClientSpecialcharss();" id="txtagencyname" runat="server" MaxLength="20"
										CssClass="btext1"></asp:textbox></td></tr>--%>
							<tr>
								<td><asp:label id="lblagencymaincode" runat="server" CssClass="TextField"></asp:label></td>
								<td><asp:textbox    onkeypress="return ClientSpecialcharss();" id="txtagencymaincode" Enabled="false" runat="server" MaxLength="20"
										CssClass="btext1"></asp:textbox></td>
							</tr>
							<tr>
								<td><asp:label id="lblagencysubcode" runat="server" CssClass="TextField"></asp:label></td>
								<td><asp:textbox onkeypress="return ClientSpecialcharss();"   id="txtagencysubcode" Enabled="false" runat="server" MaxLength="20"
										CssClass="btext1"></asp:textbox></td>
							</tr>
