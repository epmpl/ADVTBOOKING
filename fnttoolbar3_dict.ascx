<%@ Control Language="C#" AutoEventWireup="true" CodeFile="fnttoolbar3_dict.ascx.cs" Inherits="fnttoolbar3_dict" %>
        ...
        <tbody>
            <tr>
                ...
                <td align="center" style="width: 72px" >
                    <select id="KEYBORD"  runat="server" disabled class="dropdowns" onchange="javascript:getKeyboard();" style="width: 65px; z-index: 50;">
