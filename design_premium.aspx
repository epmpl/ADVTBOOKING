<%@ Page Language="C#" AutoEventWireup="true" CodeFile="design_premium.aspx.cs" Inherits="design_premium" %>
...
<head id="Head1" runat="server">
    ...
    <title>design_premium</title>
    
     <script language="javascript" src="javascript/design_premium.js" type="text/javascript"></script>
...
<body>
    ...
    <tr>
                ...
                runat="server" CssClass="button1" 
                                                        Height="24px" onclick="btnSubmit_Click1" 
                 />
									...
									<asp:datagrid    id="DataGrid1" runat="server" CssClass="dtGrid" 
                                        AllowSorting="True" AutoGenerateColumns="False" 
											...
											<asp:CheckBox ID="CheckBox1" CssClass="textfield1" Runat="server" />
												...
												<asp:BoundColumn Visible ="false"  DataField="DESIGNTYPEDETCODE" SortExpression="LOGOPREMIUMDETCODE" HeaderText="LOGOPREMIUMDETCODE">
													<HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle"></HeaderStyle><ItemStyle HorizontalAlign="Center"></ItemStyle>
												</asp:BoundColumn>
