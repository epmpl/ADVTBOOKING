<%@ Page Language="C#" AutoEventWireup="true" CodeFile="reportmisbookid.aspx.cs" Inherits="reportmisbookid" %>
														...
														<%--<td align="left" colSpan="2" style="width: 72px; height: 25px;">
                                                            ...
                                                            <td style="height: 116px">
                                                                <asp:DataGrid ID="DataGrid1" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                                                    CellPadding="0" CssClass="dtGrid" DESIGNTIMEDRAGDROP="775" Width="554px" AllowPaging="True" OnPageIndexChanged="DataGrid1_PageIndexChanged" PageSize="20">
                                                                    <SelectedItemStyle Font-Names="Trebuchet MS" Font-Size="XX-Small" HorizontalAlign="Center"
                                                                        VerticalAlign="Middle" />
                                                                    <Columns>
                                                                        <asp:BoundColumn DataField="id" HeaderText="Missing Booking Id(s)" ReadOnly="True"
