        ...
        else
        {
         ...
         /*change ankur*/
            ...
            if (dstreexml.Tables[0].Rows[0].ItemArray[115].ToString() == "enable")
            {
                ...
                tree += "<tr>";
                tree += "<td valign=\"top\">";
                tree += "<a style='cursor:hand;cursor:pointer' class=\"folder\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=\"minus.gif\"></a><a     style=\"text-decoration:none;cursor:hand;cursor:pointer\"    class=\"nodescription\" onClick=\"javascript:rolemaster();\">Role Permission</a>";
                tree += "</td>";
                tree += "</tr>";
                tree += "</table>";
            }
            ...
            if (dstreexml.Tables[0].Rows[0].ItemArray[113].ToString() == "enable")
            {
                ...
                tree += "<tr>";
                tree += "<td valign=\"top\">";
                tree += "<a style='cursor:hand;cursor:pointer' class=\"folder\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=\"minus.gif\"></a><a     style=\"text-decoration:none;cursor:hand;cursor:pointer\"    class=\"nodescription\" onClick=\"window.open('xtg_generate.aspx');\" >Generate XTG File </a>";
                tree += "</td>";
                tree += "</tr>";
                tree += "</table>";
            }
            ...
            tree += "<tr>";
            tree += "<td valign=\"top\">";
            tree += "<a style='cursor:hand;cursor:pointer' class=\"folder\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=\"minus.gif\"></a><a     style=\"text-decoration:none;cursor:hand;cursor:pointer\"    class=\"nodescription\" onClick=\"window.open('genReference.aspx');\" >Generate Ref. File </a>";
            tree += "</td>";
            tree += "</tr>";
            tree += "</table>";
            ...
            tree += "<td valign=\"top\">";
            //tree +="<br>";
            tree += "<a style='cursor:hand;cursor:pointer' onClick=\"folder\" class=\"folder\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=\"minus.gif\"></a><a     style=\"text-decoration:none;cursor:hand;cursor:pointer\"     class=\"nodescription\" href=\"javascript:date();\">Preferences</a>";
