...
public partial class ExecutiveAttachment : System.Web.UI.Page
{
    string message;
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        ScriptManager.RegisterStartupScript(this, typeof(ExecutiveAttachment), "ss", "addlabel('" + filename + "');", true);
    }
    //bhanu/////
    ...
    protected void AspNetMessageBox(string strMessage)
    {
        ...
        ScriptManager.RegisterClientScriptBlock(this, typeof(ExecutiveAttachment), "ShowAlert", strAlert, true);
    }
    //bhanu end/////
}
