...
<body onkeydown="javascript:return tabvalue();"onload="document.getElementById('dpdadtype').focus();" >
													...
													<tr>
														...
														<td style="HEIGHT: 25px" align="left">
                                                            <asp:UpdatePanel ID="UpdatePanel7" runat="server">
                                                                <ContentTemplate>
                                                                    <asp:DropDownList id="dppubcent" runat="server" CssClass="dropdown" type="password"  AutoPostBack="True" OnSelectedIndexChanged="dppubcent_SelectedIndexChanged2"></asp:DropDownList>
                                                                </ContentTemplate>
                                                            </asp:UpdatePanel>
                                                        </td></tr>
