<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BarterBill.aspx.cs" Inherits="BarterBill" %>
											...
											<table width="0" border="0" cellspacing="0" cellpadding="2">								
										            ...
										            <tr>
														...
														<td style="HEIGHT: 25px" align="left"><asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                                                <ContentTemplate>
                                                                    <asp:DropDownList CssClass="dropdown" id="dpadtype" runat="server" AutoPostBack="True" OnSelectedIndexChanged="dpadtype_SelectedIndexChanged" ></asp:DropDownList>
                                                                </ContentTemplate>
                                                            </asp:UpdatePanel>
                                                        </td>
                                                        </tr>
													...
													<tr>
														...
														<td  align="left">
                                                            <asp:UpdatePanel ID="UpdatePane21" runat="server">
                                                                <ContentTemplate>
                                                                    <asp:DropDownList id="dpregion" runat="server" CssClass="dropdown" OnSelectedIndexChanged="dpregion_SelectedIndexChanged" AutoPostBack="True"></asp:DropDownList>
                                                                </ContentTemplate>
                                                            </asp:UpdatePanel>
                                                        </td>
