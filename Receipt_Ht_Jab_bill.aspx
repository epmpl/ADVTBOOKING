<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Receipt_Ht_Jab_bill.aspx.cs" Inherits="Receipt_Ht_Jab_bill" %>
    ...
    <table cellpadding ="0" cellspacing ="0" width="500px" border="0">
        <tr>
            <td colspan ="3"  align ="center" valign="top">
                ...
                <tr>
                <td align="left"><asp:Button id="btnpdf" runat="server" Text="Convert to PDF" 
                        CssClass="topbutton" Width="91px" Font-Size="XX-Small"
							BackColor="Control" BorderStyle="Outset" BorderColor="DarkGray" Font-Bold="True" 
                        Height="24px" onclick="btnpdf_Click" /></td>
