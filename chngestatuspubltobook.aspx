<%@ Page Language="C#" AutoEventWireup="true" CodeFile="chngestatuspubltobook.aspx.cs" Inherits="chngestatuspubltobook" EnableEventValidation="false" %>
...
<script type="text/javascript" language="javascript" src="javascript/changestatuspubtobooked.js"></script>
...
<link href="css/main.css" type="text/css" rel="stylesheet"/>
    <title>Change Status From Published To Booked</title>
</head>
    ...
    <td colspan="2"><uc1:topbar id="Topbar1" runat="server" Text="Ad Booking Audit"></uc1:topbar></td>
  	...
  	<table border="0" align="center" width="100%" cellpadding="0" cellspacing="0" style="width:auto;margin:15px 30px;">
                  <tr>
                     ...
                     <td style="width:135PX;font-family:Verdana;text-align:right;font-size:10px;background-color:#a0bfeb; height:20px;"><b><center>Change Status From Publish TO Booked</center></b></td>
