<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CatogryBill.aspx.cs" Inherits="CatogryBill" %>
													...
													<td align="left">
                                                       ...
                                                       <asp:ListBox id="dpproduct" runat="server" CssClass="btext1" Height ="66px" SelectionMode="Multiple" Width="144px" meta:resourcekey="dpadcatgoryResource1">
                                                        ...
                                                        <%--<asp:TextBox ID="txtproduct" runat="server" CssClass="btext1" AutoPostBack="false"></asp:TextBox>--%>
                                                         ...
                                                         <tr>
														<td align="left" ><asp:Label id="agencytype" runat="server" CssClass="TextField" meta:resourcekey="agencynameResource1"></asp:Label></td>
														<td align="left"><asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                                                <ContentTemplate>
                                                                    <asp:DropDownList CssClass="dropdown" id="dpagencytype" runat="server" meta:resourcekey="dpagencynaResource1"></asp:DropDownList>
                                                                </ContentTemplate>
                                                            </asp:UpdatePanel>
                                                        </td>
