<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="retainercommsstructure.aspx.cs"
    Inherits="retainercommsstructure" %>
...
<head id="Head1" runat="server">
    <title>Retainer Commission Structure</title>
...
<script language="javascript" type="text/javascript"src="javascript/entertotab.js"></script>
        ...
        function tabvalue111(event) {
            ...
            if (browser != "Microsoft Internet Explorer") {
                if (event.which == 13 || event.which == 9) {
                    if (document.activeElement.id == "txtfrom") {
                        if (event.which == 13 || event.which == 9) {
                            if (document.getElementById('txtfrom').value == "") {
                                alert("Please Fill  From Target");
                                document.getElementById('txtfrom').focus();
                                return false;
                            }
                            else {
                                document.getElementById('drpteam').focus();
                                return false;
                            }
                        }
                    }
                    if (document.activeElement.id == "drpteam") {
                        if (event.which == 13 || event.which == 9) {
                            if (document.getElementById('drpteam').value == "0") {
                    ...
                    if (document.activeElement.id == "txtto") {

                        if (event.which == 13 || event.which == 9) {


                            if (document.getElementById('txtto').value == "") {
                                alert("Please Fill Target To");
                                document.getElementById('txtto').focus();
                                return false;
                                ...
                                document.getElementById('drpadpub').focus();
                                return false;
                    ...
                    if (document.activeElement.id == "drpadpub") {

                        if (event.which == 13 || event.which == 9) {


                            if (document.getElementById('drpadpub').value == "0") {
                                ...
                                document.getElementById('drpcusttype').focus();
                                return false;
                    ...
                    if (document.activeElement.id == "drpcusttype") {

                        if (event.which == 13 || event.which == 9) {


                            if (document.getElementById('drpcusttype').value == "0") {
                                alert("Please Select Cutomer Type");
                                document.getElementById('drpadpub').focus();
                                return false;
                    ...
                    if (document.activeElement.id == "drpcat") {
                        ...
                        if (event.which == 13 || event.which == 9) {
                            ...
                            if (document.getElementById('drpcat').value == "0") {
                                ...
                                document.getElementById('drppubtype').focus();
                                return false;
                    ...
                    if (document.activeElement.id == "drppubtype") {

                        if (event.which == 13 || event.which == 9) {

                            if (document.getElementById('drppubtype').value == "0") {
   ...
   if(browser!="Microsoft Internet Explorer")
    { 
            if((event.which>=46 && event.which<=57)||(event.which==127)||(event.which==9)||(event.which==8))
            {
            return true;
            }
            else
      ...
      {
            if((event.keyCode>=46 && event.keyCode<=57)||(event.keyCode==127)||(event.keyCode==9)||(event.keyCode==8))
            {
            return true;
            }
            else
...
<body onload="loadXML('xml/errorMessage.xml')" onkeydown="javascript:return tabvalue111(event);">
                            ...
                            <td>
                                <table style="width: 600px; height: 80px">
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtfrom" runat="server" style="text-align:right" CssClass="btext1" onkeydown="eventcalling(event);" 
                                          onkeypress="return notchar2(event);"       onpaste="return false;" MaxLength="3"></asp:TextBox>
                                        </td>
                                        <td>
