...
public partial class logopremmast : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {

        Ajax.Utility.RegisterTypeForAjax(typeof(logopremmast));
        ...
        premium.Text = ds.Tables[0].Rows[0].ItemArray[11].ToString();
    ...
    public DataSet chkpastypename(string PosTypCode, string PosTypName, string compcode, string userid, string flag, string fdate, string tdate)
    {
        ...
        {
            NewAdbooking.classesoracle.logopremmast modify = new NewAdbooking.classesoracle.logopremmast();
            ds = modify.chkpastypename1(PosTypCode, PosTypName, compcode, userid, fdate, tdate, flag);
        }

        else
        {
            string procedureName = "designlogTypechkname";
    ...
    public DataSet insert(string compcode, string PosTypCode, string PosType, string alias, string amount, string premium, string userid, string fdate, string tdate, string description, string adcat)
    {
        DataSet ds = new DataSet();
        string[] parameterValueArray = new string[] { Session["compcode"].ToString(), PosTypCode, PosType, alias, amount, premium, userid, fdate, tdate, description, adcat };
        if (ConfigurationSettings.AppSettings["ConnectionType"].ToString() == "sql")
        {

            //NewAdbooking.Classes.logopremium insert = new NewAdbooking.Classes.logopremium();
        ...
        {
            //NewAdbooking.classesoracle.logopremmast insert = new NewAdbooking.classesoracle.logopremmast();
            //ds = insert.InsertValue(PosTypCode, PosType, Alias, amount, premium, Session["compcode"].ToString(), userid, fdate, tdate, Session["dateformat"].ToString(), description, adcat);
            return ds;
        }
        else
        {
            string procedureName = "logtypemstinsert_logtypemstinsert_p";
            NewAdbooking.classmysql.CommonClass obj = new NewAdbooking.classmysql.CommonClass();
            ds = obj.DynamicBindProcedure(procedureName, parameterValueArray);
        }
       return ds;
    ...
    public DataSet chkadvposition(string str)
    {
        ...
        if (ConfigurationSettings.AppSettings["ConnectionType"].ToString() == "sql")
        {
            ...
            NewAdbooking.Classes.logopremium chk = new NewAdbooking.Classes.logopremium();
            ds = chk.chkadvposition1(str);
            return ds;
        }
        else if (ConfigurationSettings.AppSettings["ConnectionType"].ToString() == "orcl")
        {
            NewAdbooking.classesoracle.logopremmast chk = new NewAdbooking.classesoracle.logopremmast();
            ds = chk.chkadvposition1(str);
        }
    ...
    {
        DataSet ds = new DataSet();
        string[] parameterValueArray = new string[] { compcode, PosTypCode, PosType, Alias, amount, premium, userid, Session["dateformat"].ToString() };
        if (ConfigurationSettings.AppSettings["ConnectionType"].ToString() == "sql")
        {

            NewAdbooking.Classes.logopremium select = new NewAdbooking.Classes.logopremium();
        ...
        {
            NewAdbooking.classesoracle.logopremmast select = new NewAdbooking.classesoracle.logopremmast();
            ds = select.SelectValue(PosTypCode, PosType, Alias, amount, premium, compcode, userid, Session["dateformat"].ToString());
        }
        else
        {
            string procedureName = "AdvLogTypeSelect_AdvLogTypeSelect_P";
            NewAdbooking.classmysql.CommonClass obj = new NewAdbooking.classmysql.CommonClass();
            ds = obj.DynamicBindProcedure(procedureName, parameterValueArray);
        }
        return ds;
    ...
    public DataSet modify(string compcode, string PosTypCode, string PosType, string Alias, string Amount, string premium, string userid, string fdate, string tdate, string description, string adcat)
    {
        DataSet ds = new DataSet();
        ...
        {
            NewAdbooking.classesoracle.logopremmast modify = new NewAdbooking.classesoracle.logopremmast();
            ds = modify.ModifyValue(PosTypCode, PosType, Alias, Amount, premium, compcode, userid, fdate, tdate, Session["dateformat"].ToString(), description, adcat);
            return ds;
        }
        else if (ConfigurationSettings.AppSettings["ConnectionType"].ToString() == "mysql")
        {
            string procedureName = "LogTypeMstModify_LogTypeMstModify_P";
            NewAdbooking.classmysql.CommonClass obj = new NewAdbooking.classmysql.CommonClass();
            ds = obj.DynamicBindProcedure(procedureName, parameterValueArray);
        }
        //else
        ...
        //    ds = modify.ModifyValue(compcode, PosTypCode, PosType, Alias, Amount, premium, userid, fdate, tdate, description, adcat);
        //    return ds;
        //}
    ...
    public void delete1(string PosTypCode, string compcode, string userid)
    {
        ...
        if (ConfigurationSettings.AppSettings["ConnectionType"].ToString() == "sql")
        {
            ...
            NewAdbooking.Classes.logopremium delete1 = new NewAdbooking.Classes.logopremium();

            ds = delete1.delete1(PosTypCode, compcode, userid);
        }
        else if (ConfigurationSettings.AppSettings["ConnectionType"].ToString() == "orcl")
        {
            NewAdbooking.classesoracle.logopremmast delete1 = new NewAdbooking.classesoracle.logopremmast();
            ds = delete1.delete1(PosTypCode, compcode, userid);
        }
        else
        {
