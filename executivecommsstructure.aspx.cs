...
public partial class executivecommsstructure : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Ajax.Utility.RegisterTypeForAjax(typeof(executivecommsstructure));
    ...
    public void bindteam()
    {
        ...
        else
        {
            ...
            ds = name.team(Session["compcode"].ToString());
        }
    ...
    public void binddata1()
    {
        ...
        //mycolumn.ColumnName = "Executive No";
        ...
        else
        {
            ...
            for (int k = 0; k <= ds_tbl.Tables[0].Rows.Count - 1; k++)
            {
                ...
                if (ds_tbl.Tables[0].Rows[k]["TEMPEXECODE"].ToString() == retcode )
                {
                    ...
                    myrow1["TEAM"] = ds_tbl.Tables[0].Rows[k]["TEAM"].ToString();
                    myrow1["FROM_TGT"] = ds_tbl.Tables[0].Rows[k]["FROM_TGT"].ToString();
                    myrow1["TO_TGT"] = ds_tbl.Tables[0].Rows[k]["TO_TGT"].ToString();
                    myrow1["CATEGORY"] = ds_tbl.Tables[0].Rows[k]["CATEGORY"].ToString();
                    myrow1["CUST_TYPE"] = ds_tbl.Tables[0].Rows[k]["CUST_TYPE"].ToString();
                    myrow1["AD_TYPE"] = ds_tbl.Tables[0].Rows[k]["AD_TYPE"].ToString();
                    myrow1["PUB_TYPE"] = ds_tbl.Tables[0].Rows[k]["PUB_TYPE"].ToString();
                    myrow1["PUBLICATION"] = ds_tbl.Tables[0].Rows[k]["PUBLICATION"].ToString();
    ...
    protected void AspNetMessageBox(string strMessage)
    {
        ...
        ScriptManager.RegisterClientScriptBlock(this, typeof(executivecommsstructure), "ShowAlert", strAlert, true);
    }
