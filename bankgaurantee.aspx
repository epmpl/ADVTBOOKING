<%@ Page Language="C#" AutoEventWireup="true" CodeFile="bankgaurantee.aspx.cs" Inherits="bankgaurantee" %>
...
<head id="Head1" runat="server">
    ...
    function openfile()
    {
        window.open("BGATTACH/" + document.getElementById('lblfilename').innerHTML);
        return false;
    }
    </script>
</head>
