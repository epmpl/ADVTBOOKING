<%@ Page Language="C#" AutoEventWireup="true" CodeFile="insertionview.aspx.cs" Inherits="insertionview" %>
...
<head id="Head1" runat="server">
 ...
 <script type="text/javascript" language="javascript" src="javascript/prototype.js"></script>
    <title>Issue Insertion Wise Report</title>
    <script type="text/javascript" language="javascript" src="javascript/prototype.js"></script>
...
<asp:Button ID="btnprint" runat="server"  OnClick="btnprint_Click" Text="Print" />
          ...
          <td align="center" style="height: 28px;" colspan="2"><asp:Label ID="comp_name1" CssClass ="headingc" runat ="server"></asp:Label></td>
          </tr>
...
<asp:Label ID="heading" CssClass ="headingp" runat ="server"></asp:Label></td>
 ...
 <%--<div>
    <table style="width:1000px">
     ...
     <table id="table1" width="100%" cellpadding="0" cellspacing="0" align="center" border="0"  >
 ...
 <td  class="upper2">District:</td><td class="middle2" ><asp:Label ID="lbdist" CssClass="reporttext2" runat="server" ></asp:Label></td>
  <td style="width:300px;" class="upper2" >Printing Center:</td><td><asp:Label ID="pcenter" CssClass="reporttext2" runat="server"></asp:Label></td>
        ...
        <%-- <td  class="upper2" >ADCATGORY:</td><td "middle2"> <asp:Label ID="Adcat" CssClass="reporttext2" runat="server"></asp:Label></td>--%>
         ...
         <td style="width:300px;"  class="upper2">Run Date:</td><td class="middle2"> <asp:Label ID="lbldate" CssClass="reporttext2" runat="server"></asp:Label></td>
...
--%>     </tr>
         ...
         <table><tr> <td><input id="hiddendateformat" type="hidden" runat="server" /></td></tr></table>
               ...
               <tr>
                  ...
                  <td><input id="hiddenedition" type="hidden" runat="server"  /></td>
  <td> <input id="hiddencioid" type="hidden" runat="server"  /></td>
  <td> <input id="hidden_dist" type="hidden" runat="server"  /></td></tr>
