<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BarterBill2.aspx.cs" Inherits="BarterBill2" %>
...
//          }
		    ...
		    try
	{
			...
			if(myrange!="")
			{
			     ...
			     for(j=0;j<myvalue.length-1;j++)
			     {
			        if(j==k)
			        {
						...
						//x_win.location.href="BarterBillview.aspx?fromdate=" + $('txtfrmdate').value + "&todate=" +$('txttodate1').value  + "&region=" + $('dpregion').value +  "&agency=" +$('dpagency').value  + "&client=" + $('dpclient').value + "&publication=" + $('dppub').value + "&adtype=" + $('dpadtype').value + "&payment=" + $('dppayment').value + "&billstatus=" + $('dpbillstatus').value + "&drilout=" + "yes" + "&destination="+"1";
						x_win.location.href="BarterBillview.aspx?region=" + $('dpregion').value +  "&agency=" +$('dpagency').value  + "&client=" + $('dpclient').value + "&publication=" + $('dppub').value + "&adtype=" + $('dpadtype').value + "&payment=" + $('dppayment').value + "&billstatus=" + $('dpbillstatus').value + "&drilout=" + "yes" + "&destination=" + $('Txtdest').value+ "&sortorder=" + $('txtpdfsort').value + "&sortvalue=" + $('txtpdfsortvalue').value + "&myrange=" + myrange +"&userrange="+ userrange;
						}
						else
						{
						x_win.location.href="BarterBillview.aspx?region=" + $('dpregion').value +  "&agency=" +$('dpagency').value  + "&client=" + $('dpclient').value + "&publication=" + $('dppub').value + "&adtype=" + $('dpadtype').value + "&payment=" + $('dppayment').value + "&billstatus=" + $('dpbillstatus').value + "&drilout=" + "yes" + "&destination=" + $('Txtdest').value+ "&sortorder=" + "&sortorder=" + "50"+ "&sortvalue=" + "50";
						}
						window.close() 
					break;
					}
		...
		else
		{
			...
			//window.location.href="BarterBillview.aspx?fromdate=" + $('txtfrmdate').value + "&todate=" +$('txttodate1').value  + "&region=" + $('dpregion').value +  "&agency=" +$('dpagency').value  + "&client=" + $('dpclient').value + "&publication=" + $('dppub').value + "&adtype=" + $('dpadtype').value + "&payment=" + $('dppayment').value + "&billstatus=" + $('dpbillstatus').value + "&drilout=" + "yes" + "&destination="+"1";
			x_win.location.href="BarterBillview.aspx?region=" + $('dpregion').value +  "&agency=" +$('dpagency').value  + "&client=" + $('dpclient').value + "&publication=" + $('dppub').value + "&adtype=" + $('dpadtype').value + "&payment=" + $('dppayment').value + "&billstatus=" + $('dpbillstatus').value + "&drilout=" + "yes" + "&destination=" + $('Txtdest').value+ $('txtpdfsort').value + "&sortvalue=" + $('txtpdfsortvalue').value + "&myrange=" + myrange +"&userrange="+ userrange;
			...
			if(myrange!="")
			{
			     ...
			     for(j=0;j<myvalue.length-1;j++)
			     {
			        if(j==k)
			        {
						...
						{
						 //alert('hello2')
						x_win.location.href="BarterBillview.aspx?region=" + $('dpregion').value +  "&agency=" +$('dpagency').value  + "&client=" + $('dpclient').value + "&publication=" + $('dppub').value + "&adtype=" + $('dpadtype').value + "&payment=" + $('dppayment').value + "&billstatus=" + $('dpbillstatus').value + "&drilout=" + "yes" + "&destination=" + $('Txtdest').value+ "&sortorder=" + "&sortorder=" + "50"+ "&sortvalue=" + "50"+ "&myrange=" + myrange + "&userrange="+ userrange;
						}
						window.close() 
					break;
					}
...
<body>
    <form id="barterbill2" runat="server">
														...
														<td  align="left">
                                                            <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                                                <ContentTemplate>
                                                                    ...
                                                                    <%--<img src='Images/cal1.gif'  onclick='popUpCalendar(this, barterbill2.txtfrmdate, "mm/dd/yyyy")' onfocus="abc();" height=14 width=14/>--%>
                                                                </ContentTemplate>
                                                            </asp:UpdatePanel>
                                                        </td>
														...
														<td  align="left">
                                                            <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                                                <ContentTemplate>
                                                                    ...
                                                                    <%--<img src='Images/cal1.gif'  onclick='popUpCalendar(this, barterbill2.txttodate1, "mm/dd/yyyy")' onfocus="abc();" height="14" width="14"/>--%>
                                                                </ContentTemplate>
                                                            </asp:UpdatePanel>
                                                        </td>
                        ...
                        <input id="hiddendateformat" type="hidden" runat="server" /></td>
                         <td><input id="hiddendateformat1" type="hidden" runat="server" /></td>
                           <td><input id="hiddendateformat2" type="hidden" runat="server" /></td>
                            <input type="hidden" id="arrayval" runat="server" />
