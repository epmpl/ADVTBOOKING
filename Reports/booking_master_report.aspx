<%@ Page Language="C#" AutoEventWireup="true" CodeFile="booking_master_report.aspx.cs" Inherits="Reports_booking_master_report" %>
...
<head  id="Head1" runat="server">
		<title>Booking Master Report</title>
     ...
     <div>
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%" style="width:auto;margin:5px 0px;">
                  <tr>
                     ...
                     <td style="width:135PX;font-family:Verdana;text-align:right;font-size:10px;background-color:#a0bfeb; height:20px;"><b><center>Booking Master Report</center></b></td>
			...
			<table cellpadding="0" cellspacing="0" style="width:auto;margin:10px 200px;" >
                        ...
                        <tr >
						 ...
						 <tr>
						    <td align="left"> <asp:Label id="lbdestination" runat="server" CssClass="TextField" meta:resourcekey="lbdestinationResource1" Text="Destination"></asp:Label></td>
						    <td style="HEIGHT: 25px" align="left">
                                    <asp:DropDownList id="Txtdest" runat="server" CssClass="dropdown" type="password" meta:resourcekey="TxtdestResource1">
						 ...
						 <tr>
						    <td align="left"> <asp:Label id="lblrpttype" runat="server" CssClass="TextField" meta:resourcekey="lbdestinationResource1" Text="Report Type"></asp:Label></td>
						    <td style="HEIGHT: 25px" align="left">
                                    <asp:DropDownList id="rpt_type" runat="server" CssClass="dropdown" type="password" meta:resourcekey="TxtdestResource1">
                                    </asp:DropDownList>
                            </td>
                        </tr>
                        ...
                        <tr >
                            ...
                            <asp:button id="btncsv" Width="120px" Runat="server" onclick="BtnRun_Click_csv" Text="CSV Export" Visible="false"></asp:button>
                            </td>
                        </tr>
