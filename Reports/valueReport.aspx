<%@ Page Language="C#" AutoEventWireup="true" CodeFile="valueReport.aspx.cs" EnableEventValidation="false" Inherits="valueReport" %>
...
<body onkeydown="javascript:return tabvaluerebaterepo(event);" onkeypress="eventcalling(event);" onload="document.getElementById('txtfrmdate').focus();">
