<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptunregisteredclient.aspx.cs" Inherits="Reports_rptunregisteredclient" %>
...
<body >
   ...
   <input id="hiddencomcode" runat="server" name="hiddencomcode" type="hidden" />
        ...
        <input id="hdncioid11" runat="server" name="hiddencomcode" type="hidden" />
    </form>
</body>
</html>
