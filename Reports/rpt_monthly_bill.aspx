<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rpt_monthly_bill.aspx.cs" Inherits="rpt_monthly_bill" %>
...
<asp:ListBox ID="lstproduct" Width="124px" Height="65px" runat="server" CssClass="btextlist" ></asp:ListBox>
							...
							<tr>
								...
								<table cellpadding="0" cellspacing="0" width="790" style="WIDTH: 790px; HEIGHT: 488px"
										...
										<tr>
											<td align="center">
											<table ><tr>
											<td><asp:Label ID="heading" runat ="server" CssClass="heading">Month wise Billing</asp:Label></td></tr>
											</table>
											<br />
    ...
    <asp:DropDownList id="dpbranch" runat="server" style="text-align:left;" CssClass="dropdownbill" ></asp:DropDownList>                          
                                    	 ...
                                    	 <tr>
                                                     <td align="left"><asp:Label id="lbagencytype" runat="server" CssClass="TextField" ></asp:Label></td>
														<td align="left">
                                                                     <asp:DropDownList id="dpagencytype" runat="server" CssClass="dropdownbill"></asp:DropDownList></td>
                                                </tr>
                                    	
													<tr><td align="left"><asp:Label id="lbdistrict" runat="server" CssClass="TextField" ></asp:Label></td>
														<td align="left">
        ...
        <asp:ListItem Value="A">Agency Type wise</asp:ListItem>
         <asp:ListItem Value="C">Ad Category Wise</asp:ListItem>
          <asp:ListItem Value="E">Edition Wise</asp:ListItem>
            <asp:ListItem Value="R">Region Wise</asp:ListItem>
                           </asp:DropDownList></td>  
        </tr>
                                                <tr>
