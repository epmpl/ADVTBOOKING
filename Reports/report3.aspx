<%@ Page Language="C#" EnableEventValidation="false" Debug="true" AutoEventWireup="true" CodeFile="report3.aspx.cs" Inherits="report3" %>
...
<body onclick="chklstagencyaa();"  onkeydown="javascript:return tabvalue();chklstagencyaa();" onkeypress="eventcallingaa(event)" onload="document.getElementById('dpdadtype').focus();" >
							...
							<tr>
								...
								<table cellpadding="0" cellspacing="0" width="790" style="WIDTH: 790px; HEIGHT: 488px" borderColorDark="#000000" border="1">
										<tr>
											<td align="center">
											<table ><tr>
											<td align="left" style="padding-right:140px"><asp:Label ID="heading" runat ="server" CssClass="heading"></asp:Label></td></tr>
											</table>
