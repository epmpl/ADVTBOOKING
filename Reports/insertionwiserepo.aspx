<%@ Page Language="C#" AutoEventWireup="true" CodeFile="insertionwiserepo.aspx.cs" Inherits="Reports_insertionwiserepo" %>
...
<head runat="server">
   <title>Issue Insertion Wise Report</title>
     ...
     <script type="text/javascript"  language="javascript" src="javascript/popupcalender.js"></script>
		...
		<script type="text/javascript"  language="javascript" src="javascript/isuesertionwise.js"></script>
							...
							<tr>
								...
								<table cellpadding="0" cellspacing="0" width="790" style="WIDTH: 790px; HEIGHT: 488px"
										...
										<tr>
											<td align="center">
											<table ><tr>
											<td><asp:Label ID="heading" runat ="server" CssClass="heading" Text="Issue Insertion Wise Report"></asp:Label></td></tr>
											</table>
											<br />
