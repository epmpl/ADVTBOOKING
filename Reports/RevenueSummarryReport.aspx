<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="RevenueSummarryReport.aspx.cs" Inherits="RevenueSummarryReport" %>
...
<body onkeydown="javascript:return tabvalue();" onkeypress="eventcalling(event);" onload="javascript:return clearrevenue();">
										...
										<td  align="left">
                                            <%--<asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                                <ContentTemplate>--%>
                                                    ...
                                                    <img src='Images/cal1.gif'  onclick='popUpCalendar(this, RevnSum.txttodate1, "mm/dd/yyyy")' onfocus="abc();" height="14" width="14"/>
                                               <%-- </ContentTemplate>
                                            </asp:UpdatePanel>--%>
                                        </td>
                                           ...
                                           <%-- </ContentTemplate>
														...
														<td  align="left">
                                                          <%--  <asp:UpdatePanel ID="UpdatePanel66" runat="server">
                                                                <ContentTemplate>--%>
                                                                    <asp:DropDownList id="Txtdest" runat="server" CssClass="dropdown" type="password" Visible="true"></asp:DropDownList>
                                                               <%-- </ContentTemplate>
                                                            </asp:UpdatePanel>--%>
                                                        </td></tr>
                                                                                                                <tr><td align="left">
														...
														<tr>
														<td align="left"><asp:Label id="lsearching" runat="server" CssClass="TextField" Text="Report Type"></asp:Label></td>
														<td style="HEIGHT: 25px" align="left">
													  <asp:DropDownList id="Droprptsearching" runat="server" CssClass="dropdown" >
                                                                        <asp:ListItem Selected="True" Value="D">Default</asp:ListItem>
                                                                        <asp:ListItem Value="P">Publication Wise</asp:ListItem>
                                                                        <asp:ListItem Value="S">State Wise</asp:ListItem>
                                                                        <asp:ListItem Value="R">Revenue Center Wise</asp:ListItem>
                                                                    </asp:DropDownList>
													</td></tr>
													...
													<tr >
														...
														<%--<asp:UpdatePanel ID="updatebtn" runat ="server">
                                                                <ContentTemplate >--%>
                                                                    <asp:button id="BtnRun" CssClass="btntext" OnClick="BtnRun_Click" Runat="server" ></asp:button>
                                                                    <%--</ContentTemplate>
                                                                    </asp:UpdatePanel> --%>
