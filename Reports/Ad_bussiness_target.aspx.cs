...
public partial class Reports_Ad_bussiness_target : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Ajax.Utility.RegisterTypeForAjax(typeof(Reports_Ad_bussiness_target));
        DataSet ds = new DataSet();

        ds.ReadXml(Server.MapPath("XML/ad_bussiness_targetrpt.xml"));
    ...
    public void bindpaymode()
    {
        ...
        {
            NewAdbooking.Report.classesoracle.ad_bussiness_targetrpt advpub = new NewAdbooking.Report.classesoracle.ad_bussiness_targetrpt();
            ds = advpub.paymode(Session["compcode"].ToString(), Session["userid"].ToString());
        }
        else if (ConfigurationSettings.AppSettings["ConnectionType"].ToString() == "sql")
        {
            NewAdbooking.Report.Classes.ad_bussiness_targetrpt advpub = new NewAdbooking.Report.Classes.ad_bussiness_targetrpt();
            ds = advpub.paymode(Session["compcode"].ToString(), Session["userid"].ToString());
        }
        else
        {
        ...
        ds1.ReadXml(Server.MapPath("XML/ad_bussiness_targetrpt.xml"));
    ...
    public DataSet edition_bind(string publication, string compcode)
    {
        ...
        if (ConfigurationSettings.AppSettings["ConnectionType"].ToString() == "orcl")
        {
            NewAdbooking.Report.classesoracle.ad_bussiness_targetrpt pub_cent2 = new NewAdbooking.Report.classesoracle.ad_bussiness_targetrpt();
            ds = pub_cent2.edition(publication, "", compcode);
        }
        else if (ConfigurationSettings.AppSettings["ConnectionType"].ToString() == "sql")
        {
            NewAdbooking.Report.Classes.ad_bussiness_targetrpt pub_cent2 = new NewAdbooking.Report.Classes.ad_bussiness_targetrpt();
            ds = pub_cent2.edition(publication, "", compcode);
        }
        else
        {
    ...
    public DataSet fillF2_CreditAgency(string compcol, string agen)
    {
        ...
        if (ConfigurationSettings.AppSettings["ConnectionType"].ToString() == "orcl")
        {
            NewAdbooking.Report.classesoracle.ad_bussiness_targetrpt adagency = new NewAdbooking.Report.classesoracle.ad_bussiness_targetrpt();
            ds = adagency.agencyxls(compcol, agen);
        }
        else if (ConfigurationSettings.AppSettings["ConnectionType"].ToString() == "sql")
        {
            NewAdbooking.Report.Classes.ad_bussiness_targetrpt adagency = new NewAdbooking.Report.Classes.ad_bussiness_targetrpt();
            ds = adagency.agencyxls(compcol, agen);
        }
        else
        {
            string procedureName = "targetanalysis_rePf2";
            NewAdbooking.classmysql.CommonClass obj = new NewAdbooking.classmysql.CommonClass();
