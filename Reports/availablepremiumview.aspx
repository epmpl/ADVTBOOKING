<%@ Page Language="C#" AutoEventWireup="true" CodeFile="availablepremiumview.aspx.cs" Inherits="availablepremiumview" %>
...
<tr><td style="width: 69px"></td></tr>
 ...
 <tr>
        <td class="upper2" >PAGE:</td><td class="middle2"><asp:Label ID="lblpagepr" CssClass="reporttext2" runat="server" ></asp:Label></td>
 ...
 <table id="xlsgrid" align="center">
     ...
     <asp:DataGrid ID="DataGrid1" runat="server" CssClass="dtGrid" Width="770px" AutoGenerateColumns="False" OnItemDataBound="DataGrid1_ItemDataBound"> <%--OnItemDataBound="DataGrid1_ItemDataBound"  >--%>
