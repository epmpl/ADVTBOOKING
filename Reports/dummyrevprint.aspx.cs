...
public partial class Reports_dummyrevprint : System.Web.UI.Page
{
    string day = "";
    string month = "";
    string year = "";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string prm = Session["prm_dummyrevsum_print"].ToString();
        ...
        Ajax.Utility.RegisterTypeForAjax(typeof(Reports_dummyrevprint));
