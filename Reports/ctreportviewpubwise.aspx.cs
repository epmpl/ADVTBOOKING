...
public partial class Reports_ctreportviewpubwise : System.Web.UI.Page
{
    ...
    public void onscreen()
    {
        ...
        if (ConfigurationSettings.AppSettings["ConnectionType"].ToString() == "orcl")
        {
            ...
            //ds = obj.ctreport_main11(Session["compcode"].ToString(), des_printcent, Branch_Code, des_adty1, des_adcat1, des_adcat2, des_adcat3, pad_subcat4, pad_subcat5, des_district, fromdate, dateto, Session["dateformat"].ToString(), puserid, pextra1, pextra2, pextra3, pextra4, pextra5, pubcode, edicode, teamcode, execcode);
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            if (hiddenascdesc.Value == "")
            {
                ...
                tbl = tbl + "<tr class='rep_datatotal_vouchdata'width='100%'><td width='20%' class='rep_datatotal_vouchdata'><b>Publication</b></td>";
                tbl = tbl + "<td class='rep_datatotal_vouchdata'width='20%'><b>Main Edition<b></td>";
                tbl = tbl + "<td  class='rep_datatotal_vouchdata'width='10%'><b>Sub Edition<b></td>";
                tbl = tbl + "<td  class='rep_datatotal_vouchdata' align='right' width='10%'><b>Ad.Cat<b></td>";
                tbl = tbl + "<td  class='rep_datatotal_vouchdata' align='right' width='10%'><b>Ad Sub Cat1</td>";
                tbl = tbl + "<td  class='rep_datatotal_vouchdata' align='right' width='10%'><b>Ad Qty</td>";
                tbl = tbl + "<td  class='rep_datatotal_vouchdata' align='right' width='10%'><b>Size<b></td>";
                tbl = tbl + "<td  class='rep_datatotal_vouchdata' align='right' width='10%'><b>Amount<b></td></tr>";
            ...
            for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
            {
                if (rowcounter >= maxlimit)
                {
                    ...
                    if (hiddenascdesc.Value == "")
                    {
                        tbl = tbl + "<tr><td width='20%' class='rep_datatotal_vouchdata'><b>Publication</b></td>";
                        tbl = tbl + "<td class='rep_datatotal_vouchdata'width='20%'><b>Main Edition<b></td>";
                        tbl = tbl + "<td  class='rep_datatotal_vouchdata'width='10%'><b>Sub Edition<b></td>";
                        tbl = tbl + "<td  class='rep_datatotal_vouchdata' align='right' width='10%'><b>Ad.Cat<b></td>";
                        tbl = tbl + "<td  class='rep_datatotal_vouchdata' align='right' width='10%'><b>Ad Sub Cat1</td>";
                        tbl = tbl + "<td  class='rep_datatotal_vouchdata' align='right' width='10%'><b>Ad Qty</td>";
                        tbl = tbl + "<td  class='rep_datatotal_vouchdata' align='right' width='10%'><b>Size</td>";
                        tbl = tbl + "<td  class='rep_datatotal_vouchdata' align='right' width='10%'><b>Amount</td></tr>";
                ...
                if (i > 0)
                {
                    if (ds.Tables[0].Rows[i]["AD_MAIN_CAT"].ToString() == ds.Tables[0].Rows[i - 1]["AD_MAIN_CAT"].ToString())
                    {
                        ...
                        tbl = tbl + ("<td align='left'class='rep_data'>");
                        tbl = tbl + (ds.Tables[0].Rows[i]["MAIN_EDITION"] + "</td>");
                        tbl = tbl + ("<td align='left'; class='rep_data'>");
                        tbl = tbl + (ds.Tables[0].Rows[i]["SUB_EDITION"] + "</td>");
    ...
    public string createheader(DataSet ds)
    {
        ...
        string reportname1 = "Publication, Main Edition ,Sub Edition Category wise Report ";
        Hearder1 += "<tr><td align='center'colspan='8'><b> ";
        Hearder1 += company1;
        Hearder1 += "</b></td></tr>";
        Hearder1 += "<tr><td align='center'colspan='8'><b> ";
        ...
        Hearder1 += "<tr width='100%'><td colspan='4' align='left'style='font-family:Arial;font-size:12px;'><b>Printing Center:</b>" + printingname + "</td><td colspan='4'  align='right'style='font-family:Arial;font-size:12px;'><b>Branch Name:</b>" + brname + "</td></tr>";
        ...
        Hearder1 += "<tr width='100%'><td colspan='4' align='left'style='font-family:Arial;font-size:12px;'><b>District Name:</b>" + Daname + "</td></tr>";



        string adtype = "";
        if (des_adty1 == "--Select AdCat--" || des_adty1 == "")
        {
            adtype = "All";
        ...
        Hearder1 += "<tr width='100%'><td colspan='4' align='left'style='font-family:Arial;font-size:12px;'><b>Ad Type:</b>" + adtype + "</td><td colspan='4' align='right'style='font-family:Arial;font-size:12px;'><b>Ad Category:</b>" + adcatrgy + "</td></tr>";
        ...
        string adcatrgy2 = "";
        if (des_adcat2 == "--Select AdCat--" || des_adcat2 == "")
        {
            adcatrgy2 = "All";
        ...
        {
            adcatrgy2 = des_adcat2;
        }



        string adcatrgy3 = "";
        if (des_adcat3 == "--Select AdCat--" || des_adcat3 == "")
        {
            adcatrgy3 = "All";
        ...
        {
            adcatrgy3 = des_adcat3;
        }
        Hearder1 += "<tr width='100%'><td colspan='4' align='left'style='font-family:Arial;font-size:12px;'><b>Ad Sub Cat1:</b>" + adcatrgy2 + "</td><td colspan='4' align='right'style='font-family:Arial;font-size:12px;'><b>Ad Sub Cat2:</b>" + adcatrgy3 + "</td></tr>";
        ...
        string medition = ds.Tables[0].Rows[0]["MAIN_EDITION"].ToString();


        Hearder1 += "<tr width='100%'><td colspan='4' align='left'style='font-family:Arial;font-size:12px;'><b>Publication Name:</b>" + pub + "</td><td  colspan='4' align='right'style='font-family:Arial;font-size:12px;'><b>Main Edition:</b>" + medition + "</td></tr>";



        string subedition = ds.Tables[0].Rows[0]["SUB_EDITION"].ToString();


        Hearder1 += "<tr width='100%'><td colspan='4' align='left'style='font-family:Arial;font-size:12px;'><b>Sub Edition:</b>" + subedition + "</td><td colspan='4'  align='right'style='font-family:Arial;font-size:12px;'><b>Page No:</b>" + pgno + "</td></tr>";
 ...
 int rowcounter = 10;
    ...
    public void pdf()
    {
        ...
        try
        {
            ...
            tbl2.addCell(new Phrase("Publication, Main Edition ,Sub Edition Category wise Report ".ToString(), font3));
            document.Add(tbl2);


            //////////////////////////////////////////////////////////////////////////////
            PdfPTable tbl37 = new PdfPTable(2);
            float[] xy37 = {50,50};
            ...
            tbl37.addCell(new Phrase("Printing Center:" + printingname, font2));
            tbl37.DefaultCell.HorizontalAlignment = Element.ALIGN_RIGHT;
            tbl37.addCell(new Phrase("Branch Name:" + brname, font2));
            ...
            tbl3.addCell(new Phrase("District:" + Daname, font2));
            ...
            tbl6.addCell(new Phrase("Ad Type:" + adtype, font2));
            tbl6.DefaultCell.HorizontalAlignment = Element.ALIGN_RIGHT;
            tbl6.addCell(new Phrase("Ad Category:" + adcatrgy, font2));
            ...
            PdfPTable tbl61 = new PdfPTable(2);
            float[] abc1 = { 50, 50 };
            tbl61.DefaultCell.BorderWidth = 0;
            tbl61.WidthPercentage = 100;
            tbl61.DefaultCell.Padding = 0;
            tbl61.HorizontalAlignment = Element.ALIGN_CENTER;
            tbl61.DefaultCell.HorizontalAlignment = Element.ALIGN_LEFT;
            tbl61.setWidths(abc1);
            ...
            tbl61.addCell(new Phrase("Ad Sub Cat1:" + adcatrgy2, font2));
            tbl61.DefaultCell.HorizontalAlignment = Element.ALIGN_RIGHT;
            tbl61.addCell(new Phrase("Ad Sub Cat2" + adcatrgy3, font2));

            document.Add(tbl61);


            PdfPTable tbl611 = new PdfPTable(2);
            float[] abc11 = { 50, 50 };
            tbl611.DefaultCell.BorderWidth = 0;
            tbl611.WidthPercentage = 100;
            tbl611.DefaultCell.Padding = 0;
            tbl611.HorizontalAlignment = Element.ALIGN_CENTER;
            tbl611.DefaultCell.HorizontalAlignment = Element.ALIGN_LEFT;
            tbl611.setWidths(abc11);
            ...
            tbl611.addCell(new Phrase("Publication Name:" + pub, font2));
            tbl611.DefaultCell.HorizontalAlignment = Element.ALIGN_RIGHT;
            tbl611.addCell(new Phrase("Main Edition" + medition, font2));

            document.Add(tbl611);

            PdfPTable tbl6111 = new PdfPTable(1);
            float[] abc111 = { 50};
            tbl6111.DefaultCell.BorderWidth = 0;
            tbl6111.WidthPercentage = 100;
            tbl6111.DefaultCell.Padding = 0;
            tbl6111.HorizontalAlignment = Element.ALIGN_CENTER;
            tbl6111.DefaultCell.HorizontalAlignment = Element.ALIGN_LEFT;
            tbl6111.setWidths(abc111);


            string subedition = ds.Tables[0].Rows[0]["SUB_EDITION"].ToString();

            tbl6111.addCell(new Phrase("Sub Edition:" + subedition, font2));
            

            document.Add(tbl6111);



            PdfPTable tb89 = new PdfPTable(8);
            tb89.DefaultCell.BorderWidth = 1;
            tb89.WidthPercentage = 100;
            tb89.DefaultCell.Colspan = 8;
           // tb89.addCell(new Phrase("--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------", font3));
            ...
            float[] headerwidths = { 20, 20, 10, 10, 10, 10, 10,10};// percentage
            ...
            datatable111.DefaultCell.HorizontalAlignment = Element.ALIGN_LEFT;
            datatable111.addCell(new Phrase("Main Edition", font3));
            datatable111.addCell(new Phrase("Sub Edition", font3));
            datatable111.DefaultCell.HorizontalAlignment = Element.ALIGN_RIGHT;
            datatable111.addCell(new Phrase("Ad Cat", font3));
            datatable111.addCell(new Phrase("Ad Sub Cat1", font3));
            datatable111.addCell(new Phrase("Ad Qty", font3));
            datatable111.addCell(new Phrase("Size", font3));
           ...
           // tb897.addCell(new Phrase("--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------", font3));
            ...
            for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
            {
                ...
                float[] abhg = { 20, 20, 10, 10, 10, 10, 10 ,10};// percentage
                ...
                if (i > 0)
                {
                    if (ds.Tables[0].Rows[i]["AD_MAIN_CAT"].ToString() == ds.Tables[0].Rows[i - 1]["AD_MAIN_CAT"].ToString())
                    {
                        ...
                        datatable.addCell(new Phrase(ds.Tables[0].Rows[i]["MAIN_EDITION"].ToString(), font31));
                        datatable.addCell(new Phrase(ds.Tables[0].Rows[i]["SUB_EDITION"].ToString(), font31));
