<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="true" CodeFile="summarized_report.aspx.cs" Inherits="summarized_report" %>
...
<body onkeydown="javascript:return tabvaluesumrisrepo(event);" onkeypress="eventcalling(event);" onload="document.getElementById('dpdadtype').focus();">
							...
							<tr>
								...
								<table cellpadding="0" cellspacing="0" width="790" style="WIDTH: 790px; HEIGHT: 488px"
										...
										<tr>
											<td align="center">
											<table ><tr>
											<td><asp:Label ID="heading" runat ="server" CssClass="heading">Status Wise Daily Summarized Report</asp:Label></td></tr>
											</table>
											<br />
