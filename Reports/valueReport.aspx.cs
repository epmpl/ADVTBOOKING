       ...
       // Session["dateformat"] = "mm/dd/yyyy";
        ...
        if (!IsPostBack)
        {
           ...
           // BtnRun.Attributes.Add("onfocus", "javascript:checkrundate();checkrundate1();");
            ...
            txt_executive.Attributes.Add("onkeydown", "javascript:return F2fillexecutivecr_reb(event);");
            txt_executive.Attributes.Add("onkeypress", "javascript:return F2fillexecutivecr_reb(event);");

            lstexecutive.Attributes.Add("onclick", "javascript:return Clickexecutive_reb(event);");
            lstexecutive.Attributes.Add("onkeydown", "javascript:return Clickexecutive_reb(event);");
