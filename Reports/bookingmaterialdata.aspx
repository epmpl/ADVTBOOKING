<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="bookingmaterialdata.aspx.cs" Inherits="Reports_bookingmaterialdata" %>
...
<head  id="Head1" runat="server">
		<title>Booking Material Report</title>
     ...
     <div>
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%" style="width:auto;margin:5px 0px;">
                  <tr>
                     ...
                     <td style="width:135PX;font-family:Verdana;text-align:right;font-size:10px;background-color:#a0bfeb; height:20px;"><b><center>Booking Material Report</center></b></td>
