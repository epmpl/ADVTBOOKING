<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="IssueWiseBussiness.aspx.cs" Inherits="IssueWiseBussiness" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>Issue Wise Bussiness Report</title>
...
<body onkeydown="javascript:return tabvalueisubuk(event);" onkeypress="eventcalling(event);" onload="document.getElementById('txtfrmdate').focus();">
    <form id="Issrep" runat="server">
...
<asp:ListBox ID="lstclient" Width="124px" Height="65px" runat="server" CssClass="btextlist" ></asp:ListBox><%--</ContentTemplate></asp:UpdatePanel>--%></td></tr></table></div> 
										...
										<td  align="left">
                                          <%--  <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                                <ContentTemplate>--%>
                                                    ...
                                                    <img src='Images/cal1.gif'  onclick='popUpCalendar(this, Issrep.txtfrmdate, "mm/dd/yyyy")' onfocus="abc();" height=14 width=14/>
                                              <%--  </ContentTemplate>
                                            </asp:UpdatePanel>--%>
                                        </td>
										...
										<td  align="left">
                                           <%-- <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                                <ContentTemplate>--%>
                                                    ...
                                                    <img src='Images/cal1.gif'  onclick='popUpCalendar(this, Issrep.txttodate1, "mm/dd/yyyy")' onfocus="abc();" height="14" width="14"/>
                                                <%--</ContentTemplate>
                                            </asp:UpdatePanel>--%>
                                        </td>
