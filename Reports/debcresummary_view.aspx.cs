...
public partial class Reports_debcresummary_view : System.Web.UI.Page
{
    string compcode = "";
    string rprttype = "";
    string frdt = "";
    ...
    public void showreport()
    {
        ...
        string[] parameterValueArray = new string[] { compcode, unitcode, branch, frdt, todt, rprttype, userid, dateformat, extra1, extra2, extra3, extra4, extra5 };
        if (ConfigurationManager.AppSettings["ConnectionType"].ToString() == "orcl")
        {
            string procedureName = "rpt_monthwise_qbc_summary_p";
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            TBL.Append("<tr><td style='text-align:center' class='mis_hdr2'><b>" + "Debit/Credit Summary Report" + "</b></td></tr>");
            TBL.Append("</table>");
            TBL.Append("<table width='100%' cellspacing='0px' cellpadding = '0px' border='0'>");
            //TBL.Append("<tr>");
            //if (rprttype == "C")
            //{
            //    string reportype2 = "Credit Summary";
            //    TBL.Append("<td class='mis_hdr1'  align='left'style='font-size:15px;' width='10%'><b>" + "Report Type : </b>" + " " + reportype2 + "</td>");
            //}
            //else
            //{
            //    string reportype2 = "Debit Summary";
            //    TBL.Append("<td class='mis_hdr1'  align='left'style='font-size:15px;' width='10%'><b>" + "Report Type : </b>" + " " + reportype2 + "</td>");
            //}
            ...
            //    TBL.Append("<td class='mis_hdr1'  align='left'style='font-size:15px;' width='10%'><b>" + "Publication : </b>" + " " + pub + "</td>");
            //}
            ...
            TBL.Append("<td  align='left'  style='padding-right:5px'font-size:12px;'><b>TOTAL</b>");
            for (var x = 4; x < ds.Tables[0].Columns.Count; x++)
            {
                TBL.Append("<td  width='6%' class='quotationnam' align='right' style='font-size:12px;'><b>" + string.Format("{0:0.00}", arr_Grand[x]) + "</b></td>");
                gg = 0;
            }
            TBL.Append("</tr>");
