<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ageanaview.aspx.cs" Inherits="ageanaview" %>
...
<tr><td style="width: 69px"></td></tr>
 ...
 <tr style="border-bottom:dashed">
<%-- <td  class="upper2" valign="top" style="font-size:10px" Visible="false">REVENUE CENTER:</td><td class="middle2"><asp:Label ID="lblrevcent" CssClass="reporttext2" runat="server" Visible="false"></asp:Label></td>    --%>
   
 <%--    <td  class="upper2" >REVENUE CENTER:</td><td class="middle2"><asp:Label ID="Label2" CssClass="reporttext2" runat="server"></asp:Label></td>    
      <td  class="upper2" >CITY:</td><td class="middle2"><asp:Label ID="Label3" CssClass="reporttext2" runat="server"></asp:Label></td>    
   --%>
...
<td  class="middle" style="width: 200px">PAGE:</td><td class="middle2" style="width: 400px;"><asp:Label ID="lblpage" CssClass="reporttext" runat="server" Width="202px"></asp:Label></td>
    ...
    <table id="xlsgrid" align="center">
     ...
     <td align="center">
     <asp:DataGrid ID="DataGrid2" runat="server" CssClass="dtGrid" Width="770px" AutoGenerateColumns="False" OnItemDataBound="DataGrid1_ItemDataBound"  >
     <SelectedItemStyle Font-Size="XX-Small" BackColor="#046791"></SelectedItemStyle>
     <HeaderStyle HorizontalAlign="Center" Height="20px" ForeColor="White" CssClass="dtGridHd12" BackColor="#7DAAE3" >     
     </HeaderStyle>
     </asp:DataGrid>
     ...
     <ItemStyle HorizontalAlign="Left"></ItemStyle>
      <HeaderStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
         Font-Underline="False" ForeColor="White" HorizontalAlign="Center" />
          ...
          <asp:BoundColumn DataField="Agency" HeaderText="Client" SortExpression="Agency">
			<ItemStyle HorizontalAlign="Left"></ItemStyle>
            <HeaderStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
             Font-Underline="False" ForeColor="White" HorizontalAlign="Center" />
			</asp:BoundColumn>
				...
				<asp:BoundColumn DataField="A_Place" HeaderText="Client Address" SortExpression="A_Place">
			<ItemStyle HorizontalAlign="Left"></ItemStyle>
            <HeaderStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
             Font-Underline="False" ForeColor="White" HorizontalAlign="Center" />
			</asp:BoundColumn>
