...
public partial class Reports_insertionwiserepo : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Ajax.Utility.RegisterTypeForAjax(typeof(Reports_insertionwiserepo));
        DataSet xml = new DataSet();
        xml.ReadXml(Server.MapPath("XML/isueinsertion.xml"));
    ...
    public void bindpubcent()
    {
        ...
        {
            NewAdbooking.Report.classesoracle.issueinsertion pub_cent1 = new NewAdbooking.Report.classesoracle.issueinsertion();
            ds = pub_cent1.pub_cent_NEW(Session["compcode"].ToString(), Session["access"].ToString(), Session["userid"].ToString());
        }

        else if (ConfigurationSettings.AppSettings["ConnectionType"].ToString() == "sql")
        {
            NewAdbooking.Report.Classes.isueinsertion pub_cent1 = new NewAdbooking.Report.Classes.isueinsertion();
            ds = pub_cent1.pub_cent_NEW(Session["compcode"].ToString(), Session["access"].ToString(), Session["userid"].ToString());
        }
    ...
    public void binddistrict()
    {
        ...
        if (ConfigurationSettings.AppSettings["ConnectionType"].ToString() == "orcl")
        {
            NewAdbooking.Report.classesoracle.issueinsertion pub = new NewAdbooking.Report.classesoracle.issueinsertion();
            ds = pub.district(Session["compcode"].ToString(), Session["userid"].ToString());
        }
        else if (ConfigurationSettings.AppSettings["ConnectionType"].ToString() == "sql")
        {
            NewAdbooking.Report.Classes.isueinsertion pub = new NewAdbooking.Report.Classes.isueinsertion();
            ds = pub.district(Session["compcode"].ToString(), Session["userid"].ToString());
        }
    ...
    public void bindpub()
    {
        ...
        {
            NewAdbooking.Report.Classes.isueinsertion advpub = new NewAdbooking.Report.Classes.isueinsertion();
            ds = advpub.advpub(Session["compcode"].ToString());
        }
        else if (ConfigurationSettings.AppSettings["ConnectionType"].ToString() == "orcl")
        {
            NewAdbooking.Report.classesoracle.issueinsertion advpub = new NewAdbooking.Report.classesoracle.issueinsertion();
            ds = advpub.advpub(Session["compcode"].ToString());
        }
