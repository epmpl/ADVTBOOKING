<%@ Page Language="C#" AutoEventWireup="true" CodeFile="picontractreport.aspx.cs" Inherits="picontractreport" %>
...
<body onkeydown="javascript:return tabvaluepicont(event);" onload=" document.getElementById('txtfrmdate').focus();">
										...
										<tr>
											...
											<table width="0" border="0" cellspacing="0" cellpadding="2">
													...
													<td align="left">
                                                        ...
                                                        <tr>
													<td align="left">
														<asp:Label id="lblagency" runat="server"  CssClass="TextField"></asp:Label></td>
														<td  align="left" style="width: 210px">
                                                          <%--  <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                                       	...
                                                       	<tr>
													<td align="left">
														<asp:Label id="lblclient" runat="server" CssClass="TextField" ></asp:Label></td>
														<td  align="left" style="width: 210px">
													...
													<td align="left">
                                                      ...
                                                      <asp:DropDownList id="dpproduct" runat="server" CssClass="dropdown"></asp:DropDownList>
                                                        ...
                                                        <tr>
													<td align="left">
														<asp:Label id="lblcat" runat="server" CssClass="TextField" Text="Category"></asp:Label></td>
														<td  align="left" style="width: 210px">
                                                           <%-- <asp:UpdatePanel ID="UpdatePanel7" runat="server">
                                                                <ContentTemplate>--%>
                                                                     <asp:DropDownList id="drpcat" runat="server" CssClass="dropdown"></asp:DropDownList>
                                                               <%-- </ContentTemplate>
                                                            </asp:UpdatePanel>--%>
                                                        </td>
                                                       	  ...
                                                       	  <tr>
													    <td align="left">
													        	<asp:Label id="Label1" runat="server" CssClass="TextField" Text="Ads"></asp:Label></td>
														<td  align="left" style="width: 150px">
                                                            <%--<asp:UpdatePanel ID="UpdatePanel9" runat="server">
                                                                <ContentTemplate>--%>
                                                                          <asp:RadioButton ID="rdsch" Text="Scheduled" runat="server" GroupName="radio" Checked="true" />
                                                     ...
                                                     <td  align="left" style="width: 110px">--%>
                                                          <%--  <asp:UpdatePanel ID="UpdatePanel10" runat="server">
                                                                <ContentTemplate>--%>
                                                                           <asp:RadioButton ID="rdbilled" Text="Billed" runat="server" GroupName="radio" />
