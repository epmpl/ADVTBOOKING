<%@ Page Language="C#" AutoEventWireup="true" CodeFile="date_pubediwise_billing_rpt.aspx.cs"
    Inherits="Reports_date_pubediwise_billing_rpt" %>
...
<head runat="server">
    ...
    <script type="text/javascript" language="javascript" src="javascript/datewise_pubwise_editionwise_billing.js"></script>
                                ...
                                <tr>
                                    <td align="center">
                                        ...
                                        <table width="0" border="0" cellspacing="0" cellpadding="0">
                                            ...
                                            <tr>
                                                <td align="left">
                                                    <asp:Label ID="lblpublication2" runat="server" CssClass="TextField"></asp:Label>
                                                </td>
                                                <td style="height: 25px" align="left">
                                                    <%--<asp:UpdatePanel ID="UpdatePanel5" runat="server">
                                                                <ContentTemplate>--%>
                                                    <asp:DropDownList ID="drppublication2" runat="server" CssClass="dropdown">
                                                    </asp:DropDownList>
                                                    <%-- </ContentTemplate>
                                                            </asp:UpdatePanel>--%>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td style="height: 25px" align="left">
                                                    ...
                                                    <asp:DropDownList ID="Txtdest" runat="server" CssClass="dropdown" type="password">
                                                        ...
                                                        <asp:ListItem Value="4">Excel Sheet</asp:ListItem>
                                                    </asp:DropDownList>
                                                    <%--</ContentTemplate>
                                                            </asp:UpdatePanel>--%>
                                                </td>
