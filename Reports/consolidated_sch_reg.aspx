<%@ Page Language="C#" AutoEventWireup="true" CodeFile="consolidated_sch_reg.aspx.cs" Inherits="consolidated_sch_reg" EnableEventValidation="false"  %>
...
<head id="Head1" runat="server">
    <title>Consolidate Schedule Register</title>
	...
	.style2 { COLOR: #ffffff }
        ...
        <script type="text/javascript" language="javascript" src="javascript/consolidated_sch_reg.js"></script>
							...
							<tr>
								...
								<table cellpadding="0" cellspacing="0" width="790" style="WIDTH: 790px; HEIGHT: 488px"
										...
										<tr>
											<td align="center">
											<table ><tr>
											<td><asp:Label ID="heading" runat ="server" CssClass="heading">Consolidated Schedule Register</asp:Label></td></tr>
											</table>
											<br />
											...
											<table width="0" border="0" cellspacing="0" cellpadding="2">
                                                  ...
                                                  <%--<tr>
                                                    ...
                                                    <td  align="left">           
                                                  <asp:DropDownList id="dppubcent" runat="server" style="text-align:left;" CssClass="dropdown" ></asp:DropDownList>                          
                                                   </td>
