<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="availablepremium.aspx.cs" Inherits="availablepremium" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>Available Premium Date</title>
...
<body onkeydown="javascript:return tabvalue();" onload="clearavailable();" >
										...
										<tr>
											...
											<table width="0" border="0" cellspacing="0" cellpadding="2">
													...
													<tr>
                                                      ...
                                                      <tr><td align="left">
                                                        <asp:Label id="lblpageno" runat="server" CssClass="TextField" Text="Page No"></asp:Label></td>
														<td  align="left">
                                                          
                                                                    <asp:DropDownList id="dppageno" runat="server" CssClass="dropdown" ></asp:DropDownList>
                                                              
                                                        </td></tr>
                                                        
                                              <tr><td align="left">
                                                        <asp:Label id="adtype" runat="server" CssClass="TextField" Text="Ad Type"></asp:Label></td>
														<td  align="left">
                                                        ...
                                                        <tr><td align="left">
                                                        <asp:Label id="adcat" runat="server" CssClass="TextField" Text="Ad Category"></asp:Label></td>
														<td  align="left">
  ...
  <input id="hidden1" type="hidden" name="hiddentext" runat="server" />
  ...
  <input id="hiddencompcode" type="hidden" name="hiddencompcode" runat="server" />
    <input id="hiddenedition" type="hidden" name="hiddenedition" runat="server" />
      <input id="hiddeneditionname" type="hidden" name="hiddeneditionname" runat="server" />
       <input id="hdnadcat" type="hidden" name="hiddeneditionname" runat="server" />
