...
public partial class Reports_bookingmaterialdata : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Ajax.Utility.RegisterTypeForAjax(typeof(Reports_bookingmaterialdata));
    ...
    protected void BtnRun_Click(object sender, EventArgs e)
    {
        ...
        {
            ScriptManager.RegisterClientScriptBlock(this, typeof(Reports_bookingmaterialdata), "sa", "alert(\"searching criteria is not valid\");", true);
            return;
        }
        else
        {
