<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="ScheduleRegister.aspx.cs" Inherits="ScheduleRegister" %>
...
<head id="Head1" runat="server">
	...
	.style2 { COLOR: #ffffff }
		...
		<script type="text/javascript"  language="javascript" src="javascript/scheduleregister.js"></script>
										...
										<tr>
											...
											<table width="0" border="0" cellspacing="0" cellpadding="2">
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left" ><asp:Label ID="lblreptype" runat ="server" Text="" CssClass="TextField" >Report Type</asp:Label></td>
                                                    <td   ><asp:DropDownList ID="drpreptype" runat ="server"  CssClass="dropdown">
                                                         <asp:ListItem Value="E">Edition Wise Format</asp:ListItem>
                                                      <asp:ListItem Value="N">New Format</asp:ListItem>
                                                          <asp:ListItem Value="O">Old Format</asp:ListItem>
                                                      </asp:DropDownList></td>  
                                                </tr>
													...
													<tr >
                                                        ...
                                                        <td align="center">
                                                                    ...
                                                                    <asp:button id="btnRunedtn" CssClass="btntext" Runat="server" Text="Edition Run"></asp:button>
