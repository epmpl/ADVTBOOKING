<%@ Page Language="C#" AutoEventWireup="true" CodeFile="categorywisereport.aspx.cs" Inherits="categorywisereport" %>
...
<body onkeydown="javascript:return tabvalue();" onkeypress="eventcalling(event);" onload="javascript:return clearcategorywise(event);" >
													...
													<td align="left">
														...
														<td  align="left">
                                                          <%--  <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                                       	...
                                                       	<tr>
													<td align="left">
														<asp:Label id="lablbranch" runat="server" CssClass="TextField" Text="Branch"></asp:Label></td>
														<td  align="left">
                                                          <%--  <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                                                <ContentTemplate>--%>
                                                       ...
                                                       <td align="left">
														...
														<td  align="left">
                                                            <%--<asp:UpdatePanel ID="UpdatePanel8" runat="server">
                                                                <ContentTemplate>--%>
                                                                    <asp:DropDownList id="dpadtype" runat="server" CssClass="dropdown" type="password"  ></asp:DropDownList>
                                                               <%-- </ContentTemplate>
                                                            </asp:UpdatePanel>--%>
                                                        </td>
														...
														<td  align="left">
                                                           <%-- <asp:UpdatePanel ID="UpdatePane21" runat="server">
                                                                <ContentTemplate>--%>
                                                                    <asp:DropDownList id="dpregion" runat="server" CssClass="dropdown" type="password"></asp:DropDownList>
                                                                <%--</ContentTemplate>
                                                            </asp:UpdatePanel>--%>
                                                        </td></tr>
                                                       
                                                        <tr><td align="left">
                                                        <asp:Label id="lbplace" runat="server" CssClass="TextField"></asp:Label></td>
														<td  align="left">
                                                           <%-- <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                                                <ContentTemplate>--%>
                                                                    <asp:DropDownList id="dpplace" runat="server" CssClass="dropdown" type="password"></asp:DropDownList>
                                                                <%--</ContentTemplate>
                                                            </asp:UpdatePanel>--%>
                                                        </td></tr>
                                                        
                                                        <tr><td align="left">
                                                        <asp:Label id="lbagcat" runat="server" CssClass="TextField"></asp:Label></td>
														<td  align="left">
                                                           <%-- <asp:UpdatePanel ID="UpdatePanel10" runat="server">
                                                                <ContentTemplate>--%>
                                                                    <asp:DropDownList id="dpagcat" runat="server" CssClass="dropdown" type="password"></asp:DropDownList>
                                                              <%--  </ContentTemplate>
                                                            </asp:UpdatePanel>--%>
                                                        </td></tr>
                                                        <tr><td align="left">
                                                        <asp:Label id="lbpage" runat="server" CssClass="TextField"></asp:Label></td>
														<td  align="left">
                                                           <%-- <asp:UpdatePanel ID="UpdatePanel11" runat="server">
                                                                <ContentTemplate>--%>
                                                                    <asp:DropDownList id="dppage" runat="server" CssClass="dropdown" type="password"></asp:DropDownList>
                                                                <%--</ContentTemplate>
                                                            </asp:UpdatePanel>--%>
                                                        </td></tr>
