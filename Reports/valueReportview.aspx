<%@ Page Language="C#" AutoEventWireup="true" CodeFile="valueReportview.aspx.cs" Inherits="valueReportview" %>
...
<body onload="document.getElementById('btnprint').focus();" onkeydown ="javascript:return windowop('valuereportview2.aspx');">
