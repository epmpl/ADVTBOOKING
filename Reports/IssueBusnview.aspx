<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IssueBusnview.aspx.cs" Inherits="IssueBusnview" %>
...
<tr><td style="width: 69px"></td></tr>
    ...
    <tr>
        ...
        <td  class="upper2" style="height: 19px" >DATE TO:</td><td class="middle2" style="height: 19px" ><asp:Label ID="lblto" CssClass="reporttext2" runat="server" ></asp:Label></td>
