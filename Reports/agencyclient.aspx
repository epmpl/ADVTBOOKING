<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="agencyclient.aspx.cs" Inherits="agencyclient" %>
...
<body onclick="chklstagencyaa();" onkeydown="javascript:return tabvalue();chklstagencyaa();" onkeypress="eventcallingaa(event)" onload="javascript:return clearallclient();">
											...
											<table width="0" border="0" cellspacing="0" cellpadding="0">
														...
														<td align="left"><%--<asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                                <ContentTemplate>--%>
                                                                  <%--  <asp:DropDownList CssClass="dropdownget" id="dpclient" runat="server" ></asp:DropDownList>--%>
                                                                    <asp:TextBox ID="dpclient" runat="server" CssClass="dropdownget"></asp:TextBox>
													...
													<tr>
														...
														<td style="HEIGHT: 25px" align="left">
                                                         ...
                                                         <tr> <td align="left" ><asp:Label ID="lblbranch" runat="server"   CssClass="TextField">Branch</asp:Label></td>
                                              <td  align="left">           
                                              <asp:DropDownList id="drpbrnch" runat="server" style="text-align:left;" CssClass="dropdown" ></asp:DropDownList>                          
													...
													<table>
													<tr >
														<td align="center" style="padding-right:140px">
   ...
   <input id="hdncompcode" type="hidden" name="hiddencompcode" runat="server" />
