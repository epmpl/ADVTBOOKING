...
<asp:Button ID="btnprint" runat="server"  OnClick="btnprint_Click1" Text="Print" />
</td>
...
<tr><td style="width: 69px"></td></tr>
     ...
     <tr >
        <%--<td class="upper2" valign="top" style="font-size:10px">ADTYPE:</td><td class="middle2"  ><asp:Label ID="lbladtype" CssClass="reporttext2" runat="server" ></asp:Label></td>--%>
