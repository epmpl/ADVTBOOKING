...
public partial class Reports_booking_master_report : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        ds.ReadXml(Server.MapPath("XML/bookingmaterialdata.xml"));
        ...
        formname = "booking_master_report";
        Ajax.Utility.RegisterTypeForAjax(typeof(Reports_booking_master_report));
    ...
    public void bindreporttype()
    {
        ...
        destination.ReadXml(Server.MapPath("XML/bookingmaterialdata.xml"));
        rpt_type.Items.Clear();
        int i;
        ListItem li1;
        li1 = new ListItem();
    ...
    protected void BtnRun_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            //string procedureName = "booking_material_det";
            string[] parameterValueArray = { Session["compcode"].ToString(), drppubcenterc, drpadtypec, drppublicationc, fromdate, todate, extra1, extra2, extra3, extra4 };
            ...
            ds = bind.bookingmasterdatabind(Session["compcode"].ToString(), drppubcenterc, drpadtypec, drppublicationc, fromdate, todate, extra1, extra2, extra3, extra4);

        }
        string destination = "1";
        if (ds.Tables[0].Rows.Count == 0)
        {
            ScriptManager.RegisterClientScriptBlock(this, typeof(Reports_booking_master_report), "sa", "alert(\"searching criteria is not valid\");", true);
            return;
        }
        else
        {
            ...
            Response.Redirect("bookingmaterialdata_rpt.aspx");
        }
    ...
    protected void BtnRun_Click_csv(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            //ds = obj.DynamicBindProcedure(procedureName, parameterValueArray);
            NewAdbooking.classmysql.bookingmaterialdata bind = new NewAdbooking.classmysql.bookingmaterialdata();
            ds = bind.bookingmaterialdatabind(Session["compcode"].ToString(), drppubcenterc, drpadtypec, drppublicationc, fromdate, todate, extra1, extra2, extra3, extra4);
