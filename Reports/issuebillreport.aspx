<%@ Page Language="C#" AutoEventWireup="true" CodeFile="issuebillreport.aspx.cs" Inherits="Reports_issuebillreport" %>
...
<head id="Head1" runat="server">
   <title> Issue Bill Wise Report</title>
     ...
     <script type="text/javascript"  language="javascript" src="javascript/popupcalender.js"></script>
		...
		<script type="text/javascript"  language="javascript" src="javascript/issuebillreport.js"></script>
...
<body onload="blankfields();" onkeypress="javascript:return chkfld(event);">
    ...
    <form id="form1" runat="server">
							...
							<tr>
								...
								<table cellpadding="0" cellspacing="0" width="790" style="WIDTH: 790px; HEIGHT: 488px"
										...
										<tr>
											<td align="center">
											<table ><tr>
											<td><asp:Label ID="heading" runat ="server" CssClass="heading" Text="Issue Billwise Report"></asp:Label></td></tr>
											</table>
											<br />
                                                      ...
                                                      <tr>
                                                       ...
                                                       <tr><td align="left">
														...
														<td style="HEIGHT: 25px" align="left">
                                                         ...
                                                         <%-- <tr><td align="left">
                                                        <asp:Label id="lblsubedn" runat="server" CssClass="TextField" ></asp:Label></td>
														<td style="HEIGHT: 25px" align="left">
                                                          
                                                                    <asp:DropDownList  ID="ddlsubedn"  runat="server"  CssClass="dropdown" ></asp:DropDownList>
                                                       ...
                                                       <%-- <tr>
														<td align="left">
														<asp:Label id="lblsupplement" runat="server" CssClass="TextField"></asp:Label></td>
														<td style="HEIGHT: 25px" align="left">
                                                           
                                                                    <asp:TextBox id="txtsupplement" runat="server" CssClass="btext1" ></asp:TextBox>
        ...
        <input id="HDN_server_date" runat="server" name="HDN_server_date" type="hidden" />
        <input id="branch" runat="server" name="branch" type="hidden" />
        <input id="branchname" runat="server" name="branchname" type="hidden" />
