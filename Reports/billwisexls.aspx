<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="billwisexls.aspx.cs" Inherits="billwisexls" %>
                                                      ...
                                                      <%--  </td>
                                                       ...
                                                       <td ></td>
														...
														<td align="left">--%>
                                                         ...
                                                         <tr id="trbasedon" runat="server">
                                                    <td align="left" colspan="3">
                                                         <asp:Label id="lbdtbason" runat="server" CssClass="TextField"  Text="Date Based On"></asp:Label>
                                                        <%-- </td>
														<td align="left">--%>
                                                          <asp:DropDownList id="drpdtbasedon"  runat="server" CssClass="dropdownbill">
                                                              <asp:ListItem Value="P">Publish Date</asp:ListItem>
                                                            <asp:ListItem Value="B">Bill Date</asp:ListItem>
