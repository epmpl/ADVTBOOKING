<%@ Page Language="C#" AutoEventWireup="true"   CodeFile="VTS.aspx.cs" Inherits="Reports_VTS" %>
...
<head id="Head1" runat="server">
    <title>VTS Report</title>
		...
		<%--<script type="text/javascript"  language="javascript" src="javascript/VTSRPT.js"></script>--%>
   ...
   <body   onkeypress="eventcallingaa(event)"  onkeydown="javascript:return chklstagencyaa(event);" onload="javascript:return clear();"  >
...
<tr>
<td align="left" ><asp:Label id="lbagencyname" runat="server" CssClass="TextField"></asp:Label></td>
...
<asp:TextBox CssClass="dropdownget" id="dpclient" runat="server" ></asp:TextBox>
 ...
 <td align="left"><%--<asp:UpdatePanel ID="UpdatePanel1" runat="server">
	...
	<tr>
		<td align="left"><asp:Label visible="false" id="lbadcatgory" runat="server" CssClass="TextField" ></asp:Label></td>
		<td align="left"><%--<asp:UpdatePanel ID="UpdatePanel2" runat="server" >
                                                                <ContentTemplate>--%>
                       <asp:ListBox visible="false" id="dpadcatgory" runat="server" CssClass="btext1" Height ="66px"  Width="144px"  >
        ...
        <asp:ListBox ID="dpedition" runat="server" CssClass="btextlistqbcnew" Width="147px"
                  onpaste="return false;"  SelectionMode="Multiple" AutoPostBack="false" 
                Height="57px"></asp:ListBox>
        </td>
                                                            </tr>
                                                        <tr>
													...
													<td align="left"><asp:Label id="lbl_branch" runat="server" CssClass="TextField" ></asp:Label></td>
                                                        ...
                                                        <tr>
                                                    <td align="left">
                                                        <asp:Label id="LabelClient" runat="server" CssClass="TextField"></asp:Label></td>
                                                        <td  align="left">
                                                           <%-- <asp:UpdatePanel ID="UpdatePanel6" runat="server">
                                                                <ContentTemplate>--%>
                                                                    <asp:DropDownList id="DropDownClient" runat="server" CssClass="dropdown" type="password"></asp:DropDownList>
                                                               <%-- </ContentTemplate>
                                                            </asp:UpdatePanel>--%>
                                                        </td>    
													...
													<tr>
													 <td align="left">
                                                        <asp:Label id="lbbilled" runat="server" CssClass="TextField"></asp:Label></td>
                                                        <td  align="left">
                                                     
                                                                    <asp:DropDownList id="drpbilles" runat="server" CssClass="dropdown" type="password">
        ...
        <td colspan="2" align="left" >
        <asp:ListBox ID="ListBox1" runat="server" CssClass="btextlistqbcnew" Width="147px"
                  onpaste="return false;"  SelectionMode="Multiple" AutoPostBack="false" 
                Height="57px"></asp:ListBox>
        </td></tr> 
													 <%--<tr>
													...
													<td align="left"><asp:Label id="lbagtype" runat="server" CssClass="TextField" ></asp:Label></td>
														<td align="left"><%--<asp:UpdatePanel ID="UpdatePanel13" runat="server" >
                                                                <ContentTemplate>
                                                                     <asp:DropDownList id="dpagtype" runat="server" CssClass="dropdown" Visible="false"></asp:DropDownList>
                                                               <%-- </ContentTemplate>
                                                            </asp:UpdatePanel>
                                                        </td>
													</tr>  --%> 
   ...
   <input id="hiddenolddate" type="hidden" name="hiddenolddate" runat="server" />
						<input id="hiddendpclie" type="hidden" name="hiddendpclie" runat="server" />
		 <input id="hiddencompcode" type="hidden" name="hiddencompcode" runat="server" />
		 <input id="hiddendpagency" type="hidden" name="hiddendpagency" runat="server" />
    <input id="hiddenadcat" type="hidden" name="hiddenadcat" runat="server" />
     ...
     <input id="hiddenadsubcatname" type="hidden" name="hiddenadsubcatname" runat="server" />
      ...
      <input id="hiddenbranchname" name="hiddenbranchname" runat="server" type="hidden" />
      
       <input id="hiddenpubcenter" name="hiddenpubcenter" runat="server" type="hidden" />
      <input id="hdnagencytxt" name="hdnagencytxt" runat="server" type="hidden" />
      
<input id="hiddendppubcent" type="hidden" name="hiddendppubcent" runat="server" />
<input id="hiddendpedition" type="hidden" name="hiddendpedition" runat="server" />
<input id="hiddendpd_branch" type="hidden" name="hiddendpd_branch" runat="server" />
