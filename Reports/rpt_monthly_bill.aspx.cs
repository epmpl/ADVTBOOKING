...
public partial class rpt_monthly_bill : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Ajax.Utility.RegisterTypeForAjax(typeof(rpt_monthly_bill));
        DataSet ds = new DataSet();
        ds.ReadXml(Server.MapPath("XML/rpt_monthly_bill.xml"));
        ...
        lbagencytype.Text = ds.Tables[0].Rows[0].ItemArray[7].ToString();
        lbdistrict.Text = ds.Tables[0].Rows[0].ItemArray[8].ToString();
    ...
    public void setSessionmis_run(string fromdate, string todate,string pcent, string branch, string pub, string edtn, string dest, string adtype, string adcat, string agtype,  string dist, string reptype, string extra1, string extra2, string extra3, string extra4, string extra5, string adcatNM,string branch_nm,string pub_nm)
    {
