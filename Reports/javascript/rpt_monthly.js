...
function bind_edition13() {
    ...
    var pub_cent = "";
    rpt_monthly_bill.edition_bind(publication, pub_cent, comp_code, call_bind_edition);
...
//            rpt_monthly_bill.fillF2_client(compcode, client, bindclient_callback);
//        }
//    }
...
//            rpt_monthly_bill.fillF2_Agency(compcode, agn, bindAgency_callback);
//        }
//    }
...
function bindadcat() {
    ...
    rpt_monthly_bill.adcatbnd(adtype1, compcode, call_adcatbind);
...
//    rpt_monthly_bill.fillQBC(document.getElementById('dppubcent').value, bindQBC_callback11);
//}
...
function forreport() {
    ...
    rpt_monthly_bill.setSessionmis_run(fromdate, todate, pcent, branch, pub, edtn, dest, adtype, adcat, agtype, dist, reptype, extra1, extra2, extra3, extra4, extra5, adcatNM, branch_nm, pub_nm);
    window.open('rpt_monthly_bill_view.aspx');
    return false;
