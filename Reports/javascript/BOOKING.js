...
return false;
    ...
    agencyclient.bind_adcat(ad_type,comp_code,call_adcat_bind);
    ...
    var comp_code=document.getElementById('hiddencompcode').value;
     ...
     Booking_Detail.bind_adcat(ad_type,comp_code,call_adcat_bind);
...
//    }
     ...
     function bind_edition5()
    {
     ...
     Booking_Detail.edition_bind(publication,pub_cent,comp_code,call_bind_edition);
    }
    function printbtn()
{
...
if(key==113)
{
    if(document.activeElement.id=="dpclient")
        {       
            ...
            document.getElementById("div2").style.display="block";
            document.getElementById('div2').style.top=160+ "px" ;
            document.getElementById('div2').style.left=470+ "px";
            document.getElementById('lstclient').focus();
            Booking_Detail.fillF2_Creditclient(compcode,client,bindclient_callbackaa);
      }
 }
...
document.getElementById('hiddenadcat').value=newstr;
document.getElementById('hiddenadcatname').value=newstr1;
//document.getElementById('hdnedition1').value=document.getElementById('dpedition').value;
 var des=document.getElementById('dpedition').options.selectedIndex;
  if(des!=-1)
    document.getElementById('hiddeneditionname').value=document.getElementById('dpedition').options[des].text;
       ...
       var flagDate=compareDates();
        ...
        if(des_pub!=-1)
        document.getElementById('hdnpublication').value=document.getElementById('dppub1').options[des_pub].text;
        var pub_name=document.getElementById('hdnpublication').value;
    
		var from_date=document.getElementById('txtfrmdate').value
		var todate=document.getElementById('txttodate1').value
		
		var pubcent_code=document.getElementById('dppubcent').value
		 var des_pub1=document.getElementById('dppubcent').options.selectedIndex;
        if(des_pub1!=-1)
        document.getElementById('hdnpublicationcent').value=document.getElementById('dppubcent').options[des_pub1].text;        
		var publication_center=document.getElementById('hdnpublicationcent').value
		
		var edition_code=document.getElementById('hiddeneditionname').value
		var edition_name=document.getElementById('dpedition').value
        //var branch_code=document.getElementById('hdndppubcenttxt').value
        
        var branch_code=document.getElementById('dpd_branch').value
		 var des_pub11=document.getElementById('dpd_branch').options.selectedIndex;
        if(des_pub11!=-1)
        document.getElementById('hdnbranch').value=document.getElementById('dpd_branch').options[des_pub11].text;        
	
		var branch_name=document.getElementById('hdnbranch').value
		
				var agency_typecode=document.getElementById('dpagtype').value
		 var des_pub12=document.getElementById('dpagtype').options.selectedIndex;
        if(des_pub12!=-1)
        document.getElementById('hdnagency2').value=document.getElementById('dpagtype').options[des_pub12].text;
    var agency_typename = document.getElementById('hdnagency2').value
    var currency = document.getElementById('drpcurrencuconvert').value
		var userid=document.getElementById('hiddenuseid').value
		var dest=document.getElementById('Txtdest').value		
		window.open("bookingdetailview.aspx?agency_code1="+agency_code+"&des_pub1="+des_pub+"&agency_name1="+agency_name+"&client_code1="+client_code+"&client_name1="+client_name+"&pub_code1="+pub_code+"&pub_name1="+pub_name+"&from_date1="+from_date+"&todate1="+todate+"&publication_center1="+publication_center+"&edition_name1="+edition_name+"&branch_name1="+branch_name+"&userid1="+userid+"&dest1="+dest+"&edition_code1="+edition_code+"&pubcent_code1="+pubcent_code+"&branch_code1="+branch_code+"&agency_typecode1="+agency_typecode+"&des_pub121="+des_pub12+"&agency_typename1="+agency_typename+"&currency_typename1="+currency)
...
if(key==113)
{
    if(document.activeElement.id=="dpagency")
        {       
            ...
            document.getElementById("div1").style.display="block";
            document.getElementById('div1').style.top=185+ "px" ;//314//290
            document.getElementById('div1').style.left=470+ "px";//395//1004
            document.getElementById('lstagency').focus();
             Booking_Detail.fillF2_CreditAgency(compcode,agn,bindAgency_callbackbb);
      }
 }
...
if(key==116)
{
window.open ('BookingDetail.aspx','_self','',false)
return false;
}
}