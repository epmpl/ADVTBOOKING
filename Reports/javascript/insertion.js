...
if(key==113)
{
    ...
    if(document.activeElement.id=="txtdistrict") {
        var distnam = document.getElementById('txtdistrict').value;
            ...
            document.getElementById('divdistrict').style.top=325+ "px" ;
            document.getElementById('divdistrict').style.left=740+ "px";
            document.getElementById('lstdistrict').focus();
            insertion.fillF2_Creditexecutive(compcode,uid,distnam,F2filldistrict_callback);
           // return false;
      }
  }
...
//    }
     ...
     function bind_edition5()
    {
     ...
     insertion.edition_bind(publication,pub_cent,comp_code,call_bind_edition);
    }
  ...
  if(des!=-1)
    document.getElementById('hiddeneditionname').value=document.getElementById('dpedition').options[des].text;
       ...
       var flagDate=compareDates();
		...
		var pubcent_code=document.getElementById('dpprintcenter').value
		 var des_pub1=document.getElementById('dpprintcenter').options.selectedIndex;
        if(des_pub1!=-1)
        document.getElementById('hdnpublicationcent').value=document.getElementById('dpprintcenter').options[des_pub1].text;        
	   ...
	   var distcode=document.getElementById('hidden_dist').value
	//	var des_pub12=document.getElementById('txtdistrict').options.selectedIndex;
    //    if(des_pub12!=-1)
    //    document.getElementById('hdndistrict').value=document.getElementById('txtdistrict').options[des_pub12].text;        
		var distname= document.getElementById('txtdistrict').value
		...
		window.open("insertionview.aspx?des_pub1="+des_pub+"&pub_code1="+pub_code+"&pub_name1="+pub_name+"&from_date1="+from_date+"&todate1="+todate+"&publication_center1="+publication_center+"&edition_name1="+edition_name+"&branch_name1="+branch_name+"&userid1="+userid+"&comp_code="+comp_code+"&dest1="+dest+"&edition_code1="+edition_code+"&pubcent_code1="+pubcent_code+"&branch_code1="+branch_code+"&distcode="+distcode+"&distname="+distname)
