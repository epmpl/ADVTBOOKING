...
function bindsubcat() {
    ...
    Reports_ctrdatereport.subcatbind(compcode, adcat1, call_adsubcatbind);
...
function bindsubcat345() {
    ...
    Reports_ctrdatereport.subcat345(adsubcat1, compcode, "", "", call_adsubcat345);
}
...
function bindadcat() {
    ...
    Reports_ctrdatereport.adcatbnd(adtype1, compcode, call_adcatbind);
...
function F2filldistrict(event) {
    ...
    if (key == 113) {
        ...
        if (document.activeElement.id == "txtdistrict") {
            ...
            Reports_ctrdatereport.fillF2_Creditexecutive(compcode, uid, distnam, F2filldistrict_callback);
            // return false;
        }
...
function bind_team_exe() {
    ...
    Reports_ctrdatereport.exe_bind(comp_code, userid, team, call_bind_team_exe);
...
function bind_edition5() {
    ...
    Reports_ctrdatereport.edition_bind(publication, pub_cent, comp_code, call_bind_edition);
}
...
function tabvaluectrepo(event) {
    ...
    if (key == 116) {
        ...
        window.open('ctrdatereport.aspx', '_self', '', false)
        return false;
