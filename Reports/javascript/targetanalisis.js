function bind_edition5() {
    ...
    Reports_targetanalisis.edition_bind(publication, comp_code, call_bind_edition);
}
...
/*function binduom() 
{
    if (document.getElementById("drpadtype").value != "" && document.getElementById("drpadtype").value != "0") {
        ...
        Reports_targetanalisis.bind_uom(copcode, userid, adtype, call_bind_uom);
        return false
    }
    else 
    {
...
function F2fillagencycr_allagency(event) {
    ...
    if (key == 113) {
        if (document.activeElement.id == "dpagency") {
            ...
            Reports_targetanalisis.fillF2_CreditAgency(compcode, agn, bindAgency_callback1);
        }
    }
...
function ClickAgaency1(event) {
  ...
  function runreport() 
  {
      ...
      if (document.getElementById('drpbasedon').value == "0" || document.getElementById('drpbasedon').value == "") 
      {
...
function ValidateForm(event, id) {
    ...
    if (isDate12(dt, id) == false) {
        ...
        if (document.getElementById('txtfrmdate').value != "") 
        {
            ...
            Reports_targetanalisis.getlastday(frmdate, dateformat,call_bind_lastday);
            return true;
        }
        return true;
    }
