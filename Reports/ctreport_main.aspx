<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ctreport_main.aspx.cs" Inherits="ctreport_main" %>
...
<head runat="server">
    ...
    <script type="text/javascript" language="javascript" src="javascript/ctreport.js"></script>
...
<tr>
        ...
        <%--</ContentTemplate>
                                               ...
                                               <tr>
                                                    <td align="left">
                                                        <asp:Label ID="lbreptype" runat="server" CssClass="TextField"></asp:Label></td>
                                                    <td align="left">
                                                        <asp:DropDownList ID="drpreptype" runat="server" CssClass="dropdown" type="password">
                                                            ...
                                                            <%--<asp:ListItem Value="RD">Region Wise Detail</asp:ListItem>
                                                            <asp:ListItem Value="R">Publish Date Rate Code</asp:ListItem>
                                                            <asp:ListItem Value="B">Booking Date Rate Code</asp:ListItem>
                                                            <asp:ListItem Value="A">Agency Wise Collection</asp:ListItem>
                                                            <asp:ListItem Value="AS">Agency Wise Collection Summary</asp:ListItem>
                                                            <asp:ListItem Value="L">Last Date of Ins Wise</asp:ListItem>--%>
                                                        </asp:DropDownList>
                                                    </td>
                                                </tr>
