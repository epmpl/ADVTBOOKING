...
public partial class agencclientpop : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        heading.Text = ds.Tables[0].Rows[0].ItemArray[55].ToString();
        ...
        if (!Page.IsPostBack)
        {
            ...
            bindpub();
            binddest();
            BtnRun.Attributes.Add("onclick", "javascript:return drill_outclient();");
            txtfrmdate.Text = fromdt;
            Btnreset.Attributes.Add("onclick", "javascript:return filldrop();");
    ...
    public void bindsortvalue()
    {
        ...
        for (i = 0; i < sortvalue.Tables[0].Columns.Count; i++)
        {
            ListItem li;
            li = new ListItem();
            li.Text = sortvalue.Tables[0].Rows[0].ItemArray[i].ToString();
            i = i + 1;
            li.Value = sortvalue.Tables[0].Rows[0].ItemArray[i].ToString();
    ...
    protected void dpdadtype_SelectedIndexChanged(object sender, EventArgs e)
    {
      ...
      //  ScriptManager.RegisterClientScriptBlock(this, typeof(agencclientpop), "sa", "document.getElementById('dpdadtype').focus();", true);
    }
    ...
    protected void DropDownList1_SelectedIndexChanged(object sender, EventArgs e)
    {
       ...
       // ScriptManager.RegisterClientScriptBlock(this, typeof(agencclientpop), "sa", "document.getElementById('pubcent').focus();", true);
    }
    protected void dppub1_SelectedIndexChanged2(object sender, EventArgs e)
    {
        ...
        //ScriptManager.RegisterClientScriptBlock(this, typeof(agencclientpop), "sa", "document.getElementById('dppub1').focus();", true);
    }
    protected void Btnreset_Click(object sender, EventArgs e)
    {

        //dpclient.SelectedValue = "0";
        //dpdadtype.SelectedValue = "0";
        //dpadcatgory.SelectedValue = "0";
        //dppub1.SelectedValue = "0";
        //dpedition.SelectedValue = "0";
        //pubcent.SelectedValue = "0";
        //dppackage.SelectedValue = "0";
