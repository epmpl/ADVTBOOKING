<%@ Page Language="C#" AutoEventWireup="true" CodeFile="statuspop.aspx.cs" Inherits="statuspop" %>
...
<%--                                                                    <img src='Images/cal1.gif'  onclick='popUpCalendar(this, status.txtfrmdate, "mm/dd/yyyy")' onfocus="abc();" height=14 width=14/>
--%>                                                                </ContentTemplate>
                                                            </asp:UpdatePanel>
                                                        </td>
...
<%--<%--                                                                    <img src='Images/cal1.gif'  onclick='popUpCalendar(this, status.txttodate1, "mm/dd/yyyy")' onfocus="abc();" height=14 width=14/>
--%>                                                                </ContentTemplate>
                                                            </asp:UpdatePanel>
                                                        </td>
