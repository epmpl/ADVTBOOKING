...
public partial class pdf_uday : System.Web.UI.UserControl
{
    ...
    public void setcard(int printcount)
    {
        ...
        float ht = 50;
        double servicetax = 0;
        double servicetax_per = 0;
        double amt_servicetax = 0;
        String dytbl;
        dytbl = "";
        ...
        for (packlength = 0; packlength < c1; packlength++)
        {
            ...
            //Sign Image
           // string path = "Images/" + ds.Tables[1].Rows[0].ItemArray[1].ToString();// ds4.Tables[0].Rows[0]["FILE_PATH"].ToString();
            string imageFilePath = Server.MapPath(".") + "/Images1/Manipal-Group-Logo-copy.jpg";
                ...
                string imageFilePathNew = Server.MapPath(".") + "Images/" + ds.Tables[1].Rows[0].ItemArray[1].ToString();// ds4.Tables[0].Rows[0]["FILE_PATH"].ToString();


                divimg.InnerHtml = "<img src='" + imageFilePathNew + "' height='" + ht + "'>";
            ...
            if (ds4.Tables[0].Rows[0]["agenadd"].ToString() == "" || ds4.Tables[0].Rows[0]["agenadd"].ToString() == null || ds4.Tables[0].Rows[0]["bill2"].ToString() == "" || ds4.Tables[0].Rows[0]["bill2"].ToString() == null)
            {
                ...
                if (agencyaddtxt.Text != "" && ds4.Tables[0].Rows[0]["add2"].ToString() == "" && ds4.Tables[0].Rows[0]["add3"].ToString() == "" && ds4.Tables[0].Rows[0]["street1"].ToString() == "")
                {
                    agencyaddtxt.Text = agencyaddtxt.Text;
                }
                else
                    if (agencyaddtxt.Text != "" && ds4.Tables[0].Rows[0]["add2"].ToString() != "" && ds4.Tables[0].Rows[0]["add3"].ToString() == "" && ds4.Tables[0].Rows[0]["street1"].ToString() == "")
                    {
                        agencyaddtxt.Text = agencyaddtxt.Text + ", " + street + ds4.Tables[0].Rows[0]["add2"].ToString();
                        ...
                        if (agencyaddtxt.Text != "" && ds4.Tables[0].Rows[0]["add2"].ToString() != "" && ds4.Tables[0].Rows[0]["add3"].ToString() != "" && ds4.Tables[0].Rows[0]["street1"].ToString() == "")
                        {
                            ...
                            if (agencyaddtxt.Text != "" && ds4.Tables[0].Rows[0]["add2"].ToString() != "" && ds4.Tables[0].Rows[0]["add3"].ToString() != "" && ds4.Tables[0].Rows[0]["street1"].ToString() != "")
                            {
                                agencyaddtxt.Text = agencyaddtxt.Text + ", " + street + ds4.Tables[0].Rows[0]["add2"].ToString() + ", " + ds4.Tables[0].Rows[0]["add3"].ToString() + ", " + ds4.Tables[0].Rows[0]["street1"].ToString();
            ...
            {
                //string[] addname = ds4.Tables[0].Rows[0]["agenname"].ToString().Split('$$'.ToCharArray());
            ...
            //if (ds4.Tables[0].Rows[0]["agenadd"].ToString() == "" || ds4.Tables[0].Rows[0]["agenadd"].ToString() == null)
            //{
            //    agencyaddtxt.Text = ds4.Tables[0].Rows[0]["add1"].ToString();
            //    agencyaddtxt.Text = agencyaddtxt.Text + "," + street + ds4.Tables[0].Rows[0]["add2"].ToString() + ds4.Tables[0].Rows[0]["add3"].ToString();
            //}
            //else
            //{
            //    agencyaddtxt.Text = ds4.Tables[0].Rows[0]["agenadd"].ToString();
            //}
            //agencyaddtxt.Text = ds4.Tables[0].Rows[0]["add1"].ToString();
            ...
            txtpackname.Text = ds4.Tables[0].Rows[0]["RoNo."].ToString();
            ...
            for (packlength1 = 0; packlength1 < c1; packlength1++)
            {
                ...
                if (ConfigurationSettings.AppSettings["ConnectionType"].ToString() == "sql")
                {
                    ...
                    //ds4 = objedition1.values_bill_uday(ciobookingid, editionname.Trim(), i12, Session["compcode"].ToString(), Session["dateformat"].ToString());
                }
                else
                {
                ...
                {
                    //if (ds4.Tables[0].Rows[0]["agreed_amountmast"].ToString() != "")
                    //{
                    //    trate = Convert.ToDouble(ds4.Tables[0].Rows[0]["agreed_amountmast"].ToString());
                    //}
                    if (ds4.Tables[0].Rows[0]["gross_rate"].ToString() != "")
                    {
                        //trate = Convert.ToDouble(ds4.Tables[0].Rows[0]["agreed_ratemast"].ToString());
                        trate = trate + Convert.ToDouble(ds4.Tables[0].Rows[0]["gross_rate"].ToString());
                    }
                }
                else if (ds4.Tables[0].Rows[0]["ACTIVE_AGREEDRATE"].ToString() == "1")
                {
                    if (ds4.Tables[0].Rows[0]["agreed_ratemast"].ToString() != "")
                    {
                        trate = Convert.ToDouble(ds4.Tables[0].Rows[0]["agreed_ratemast"].ToString());
                    }
                }
            ...
            for (packlength = 0; packlength < c1; packlength++)
            {
                ...
                runtxt.Text = ds4.Tables[4].Rows[0]["bill_dt"].ToString();
               ...
               // }
                ...
                {
                    dytbl += "<td width='35px'  class=display align=left >" + ds4.Tables[0].Rows[0]["EditionName"].ToString() + "</td>";
                ...
                if (ds4.Tables[0].Rows[0]["uom_code"].ToString() == "ZC0" || ds4.Tables[0].Rows[0]["uom_code"].ToString() == "CO0")
                {

                    dytbl += "<td   align=center class=display >" + ds4.Tables[0].Rows[0]["No_ofcolumn"].ToString() + "*" + ds4.Tables[0].Rows[0]["Depth"].ToString() + "</td>";
                ...
                else
                {
                    ...
                    {
                        dytbl += "<td align=center class=display>" + ds4.Tables[0].Rows[0]["volume"].ToString() + "</td>"; //dytbl += "<td class=display  align=center>---</td>";
                    }
                ...
                if (packlength == 0)
                    dytbl += "<td id=str" + packlength + " align=center class=display>" + trate.ToString("F2") + "</td>";
                else
                ...
                if (packlength == 0)
                    dytbl += "<td  align=center class=display>" + tgamt.ToString("F2") + "</td>";
                else
                    dytbl += "<td class=display align=right>---</td>";
            ...
            lb_totalamt.Text = amt4.ToString("F2");
            ...
            lbladddis.Text = adddis.ToString("F2");
            //lblextra.Text = addchr.ToString();
            //lblnetamt.Text = bill_amt1.ToString("F2");
           // bill_amt1 = bill_amt1 +0.01;
            bill_amt1 = bill_amt1;
           
            //==============******Changes for Internet Bill*****====================//
            if (ds4.Tables[0].Rows[0]["vat_rate"].ToString() == "" || ds4.Tables[0].Rows[0]["vat_rate"].ToString() == null)
            {
                lblboxcr.Text = "Box/ ExtraChg";
                lblnetamt1.Text = "Net Amount";
            ...
            {
                lblboxcr.Text = "Net Amount";
                lblnetamt1.Text = "Service Tax";

                servicetax_per = 100 + Convert.ToDouble(ds4.Tables[0].Rows[0]["vat_rate"].ToString());
                amt_servicetax = (bill_amt1 * 100) / servicetax_per;
                servicetax= (amt_servicetax * Convert.ToDouble(ds4.Tables[0].Rows[0]["vat_rate"].ToString())) / 100;

                lblextra.Text = bill_amt1.ToString("F2");
                lblnetamt.Text = servicetax.ToString("F2");
            }
            //=================**************************===================//
            ...
            if (printcount >= 2)
            {
                lit_pagebreak.Text = "<div style=\"page-break-before:always;\">&nbsp;</div>";
            }
        }
