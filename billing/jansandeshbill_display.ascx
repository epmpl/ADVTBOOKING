<%@ Control Language="C#" AutoEventWireup="true" CodeFile="jansandeshbill_display.ascx.cs" Inherits="jansandeshbill_display" %>
...
<tr>
<td><IMG SRC="Images/janshandesh.jpg" style="height: 55px; width:189px;" /></td>
</tr>
...
<table>
<tr ><td style="vertical-align:top;height:50px;padding-left:40px;" ></td><td style="vertical-align:top;height:50px;" ><asp:Label CssClass="agecnycodeclasspune" ID="agencyaddtxt" runat ="server"></asp:Label></td></tr>
</table>
<table>
...
<asp:Label ID="txt_remark" runat="server"></asp:Label>
  ...
  <tr>
  <td width="500px" align="right"><asp:Label  ID="Label4" runat ="server"  CssClass="agecnycodeclasspune"><b>Manager(Advt.)</b></asp:Label></td>
