...
public partial class sea_controlclassified_priv : System.Web.UI.UserControl
{
    ...
    public sea_controlclassified_priv()
    {
    ...
    public void setcard()
    {
        ...
        if ( ds4.Tables[0].Rows[0]["Invoice"].ToString()!= "")
        {
            txtinvoice.Text = ds4.Tables[0].Rows[0]["Invoice"].ToString();
        }
        else
        {
            txtinvoice.Text = "XXXX ";
        }
