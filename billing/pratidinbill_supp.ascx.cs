...
public partial class pratidinbill_supp : System.Web.UI.UserControl
{
...
//Extra amount
        ...
        //lblexamt_pos.Text = "-";
        //lblamt.Text = "-";
        if (ds4.Tables[0].Rows[0]["Executive_code"].ToString() != "" && ds4.Tables[0].Rows[0]["Executive_code"].ToString() != null)
        {
            txtscode.Text = ds4.Tables[0].Rows[0]["Executive_code"].ToString();
        }
        if (ds4.Tables[0].Rows[0]["RETAINER"].ToString() != "")
        {
            txtratecode.Text = ds4.Tables[0].Rows[0]["RETAINER"].ToString();
        }
        ...
        else
        {
            ...
            int je;
            string edicode = "";
            int counteditioncode = ds4.Tables[4].Rows.Count;
            ...
            for (je = 0; je < counteditioncode; je++)
            {
                if (edicode == "")
                {
                    edicode = ds4.Tables[4].Rows[je].ItemArray[0].ToString();
                }
                else
                {
                    edicode = edicode + "+" + ds4.Tables[4].Rows[je].ItemArray[0].ToString();
                }

            }

            lbllocval.Text = edicode.ToString();
            ...
            dytbl += "<table width='660px' align='left' cellpadding='0' cellspacing='0' >";
            {
                ...
                dytbl += "<td width='90px' class='insertiontxtclass1' >" + dsb.Tables[0].Rows[0].ItemArray[12].ToString() + "</td>";
            ...
            for (packlength = 0; packlength < c1; packlength++)
            {
              ...
              dytbl += "<tr>";
                ...
                {
                    dytbl += "<td width=90px class=display  align=center >" + ds4.Tables[0].Rows[0]["RONO."].ToString() + "</td>";
                }
                else
