...
public partial class mangalam_bill : System.Web.UI.UserControl
{
    ...
    public string _txtbilldate;
    public string _txtbillno;
    public string _txtrono;
    public string _txtrodate;
    public string _txttermspay;
    public string _txtcap;
    public string _txtedition;
    public string _txtgrossamt;
    public string _txttradedisc;
    public string _txtbalance;
    public string _txtboxchrgs;
    public string _txtnetbal;
    public string _txtrupees;

    public string _llbcompaddress;
    public string _txtmailid;
    public string _lbemailtxt;
    public string _agddxt;
    public string _agencyaddtxt;
    public string _txtchk;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        ds.ReadXml(Server.MapPath("XML/bill_mangalam_new.xml"));
        lblbillno.Text = ds.Tables[0].Rows[0].ItemArray[0].ToString();
        lbldate.Text = ds.Tables[0].Rows[0].ItemArray[1].ToString();
        lblrono.Text = ds.Tables[0].Rows[0].ItemArray[2].ToString();
        lblrodate.Text = ds.Tables[0].Rows[0].ItemArray[3].ToString();
        lblterms.Text = ds.Tables[0].Rows[0].ItemArray[4].ToString();
        lbladvertiser.Text = ds.Tables[0].Rows[0].ItemArray[5].ToString();
        lblcaption.Text = ds.Tables[0].Rows[0].ItemArray[6].ToString();
        lbledition.Text = ds.Tables[0].Rows[0].ItemArray[7].ToString();
        lblgrossamt.Text = ds.Tables[0].Rows[0].ItemArray[8].ToString();
        lbltradedisc.Text = ds.Tables[0].Rows[0].ItemArray[9].ToString();
        lblbalance.Text = ds.Tables[0].Rows[0].ItemArray[10].ToString();
        lblboxchrgs.Text = ds.Tables[0].Rows[0].ItemArray[11].ToString();
        lblnetbal.Text = ds.Tables[0].Rows[0].ItemArray[12].ToString();
        lblrupees.Text = ds.Tables[0].Rows[0].ItemArray[13].ToString();
        lblcomname.Text = ds.Tables[0].Rows[0].ItemArray[14].ToString();
        lblauth.Text = ds.Tables[0].Rows[0].ItemArray[15].ToString();
        lblchk.Text = "Checked By:";
    ...
    public void setcard()
    {
        ...
        for (packlength = 0; packlength < c1; packlength++)
        {
            ...
            txtadv.Text = ds4.Tables[0].Rows[0]["advertiser"].ToString();
            txtedition.Text = ds4.Tables[0].Rows[0]["edition"].ToString();
            txtchk.Text = ds4.Tables[0].Rows[0]["executive"].ToString();
            /////////////////////
            if (ds4.Tables[0].Rows[0]["insert_date"].ToString() != "")
            {
                txtbilldate.Text = ds4.Tables[0].Rows[0]["insert_date"].ToString();
            }

            if (ds4.Tables[0].Rows[0]["RoNo."].ToString() != "")
            {
                txtrono.Text = ds4.Tables[0].Rows[0]["RoNo."].ToString();
            }
            ...
            txtgrossamt.Text = grossamt.ToString("f2");
            ...
            txtnetbal.Text = Math.Round(finalamount + 0.01).ToString();
            if (ds4.Tables[0].Rows[0]["Cap"].ToString() != "")
            {
                txtcap.Text = ds4.Tables[0].Rows[0]["Cap"].ToString();
            }
            ...
            string compname = "<B>MANGALAM PUBLICATION</B>";
            string compname25 = "<B>Mangalam Publication Pvt. Ltd.</B>";
            if (Session["revenue"].ToString() == "ja1")
            {
                lblcomname.Text = compname25;
            }
            else
            {
                lblcomname.Text = compname;
            }
            //string rev = ds4.Tables[0].Rows[0]["Print_cent_name"].ToString();
            //string revenu = "<b><u>Terms & Conditions:</u></b><br />1:&nbsp;All cheques/drafts should be in favour of Mangalam & payable at,&nbsp;" + rev + ".<br /> 2:&nbsp;Any query may please be reverted within 15 days of receipt of bill.<br /> 3:&nbsp;22% Interest will be charged on overdue bills.<br />4:&nbsp;All disputes are subject to&nbsp;&nbsp;" + rev + " &nbsp;&nbsp;jurisdiction.<br /> ";
            //string revenu25 = "<b><u>Terms & Conditions:</u></b><br />1:&nbsp;All cheques/drafts should be in favour of mangalam & payable at,&nbsp;" + compname25 + " , &nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;" + rev + ".<br /> 2:&nbsp;Any query may please be reverted within 15 days of receipt of bill.<br /> 3:&nbsp;22% Interest will be charged on overdue bills.<br /> 4:&nbsp;All disputes are subject to&nbsp;&nbsp;" + rev + " &nbsp;&nbsp;jurisdiction.<br /> ";
            //if (Session["revenue"].ToString() == "ja1")
            //{
            ...
            string GAamt1 = "0";
            dytbl = "";
            dytbl += "<table width='820px' align='left' cellpadding='5' cellspacing='0' >";
            {
                DataSet dsb = new DataSet();
                dsb.ReadXml(Server.MapPath("XML/bill_mangalam_new.xml"));
               
                dytbl += "<tr align=center >";
                dytbl += "<td colspan='1' class='insertiontxtclass1rt'  align='center'  width='10px' >" + dsb.Tables[1].Rows[0].ItemArray[0].ToString() + "</td>";
                dytbl += "<td colspan='1' class='insertiontxtclass1rt'  align='center'  width='150px' >" + dsb.Tables[1].Rows[0].ItemArray[1].ToString() + "</td>";
                dytbl += "<td colspan='1' class='insertiontxtclass1rt'  align='center'  width='150px' >" + dsb.Tables[1].Rows[0].ItemArray[2].ToString() + "</td>";
                dytbl += "<td colspan='1' class='insertiontxtclass1rt'  align='center'  width='90px' >" + dsb.Tables[1].Rows[0].ItemArray[3].ToString() + "</td>";
                dytbl += "<td colspan='1' class='insertiontxtclass1rt'  align='center'  width='90px' >" + dsb.Tables[1].Rows[0].ItemArray[4].ToString() + "</td>";
                dytbl += "<td colspan='1' class='insertiontxtclass1rt'  align='center'  width='90px' >" + dsb.Tables[1].Rows[0].ItemArray[5].ToString() + "</td>";
                dytbl += "<td colspan='2' class='insertiontxtclass1rt'  align='center'  width='90px' >" + dsb.Tables[1].Rows[0].ItemArray[6].ToString() + "</td>";
                //dytbl += "<td colspan='1' class='insertiontxtclass1'  align='center'  width='90px' >" + dsb.Tables[1].Rows[0].ItemArray[6].ToString() + "</td>";
                dytbl += "<td colspan='1' class='insertiontxtclass1rt'  align='right'  width='90px' >" + dsb.Tables[1].Rows[0].ItemArray[8].ToString() + "</td>";
                dytbl += "</tr>";

                dytbl += "<tr align=center >";
                dytbl += "<td colspan='1' class='insertiontxtclass1new'  align='center'  width='10px' >" + "&nbsp;" + "</td>";
                dytbl += "<td colspan='1' class='insertiontxtclass1new'  align='center'  width='150px' >" + "&nbsp;" + "</td>";
                dytbl += "<td colspan='1' class='insertiontxtclass1new'  align='center'  width='150px' >" + "&nbsp;" + "</td>";
                dytbl += "<td colspan='1' class='insertiontxtclass1new'  align='center'  width='90px' >" + "&nbsp;" + "</td>";
                dytbl += "<td colspan='1' class='insertiontxtclass1new'  align='center'  width='90px' >" + "&nbsp;" + "</td>";
                dytbl += "<td colspan='1' class='insertiontxtclass1new'  align='center'  width='90px' >" + "&nbsp;" + "</td>";
                dytbl += "<td colspan='1' class='insertiontxtclass1'  align='center'  width='90px' >" + "%" + "</td>";
                dytbl += "<td colspan='1' class='insertiontxtclass1'  align='center'  width='90px' >" + "Amount" + "</td>";

                dytbl += "<td colspan='1' class='insertiontxtclass1new'  align='right'  width='90px' >" + "&nbsp;" + "</td>";
                dytbl += "</tr>";
            ...
            for (packlength1 = 0; packlength1 < c1; packlength1++)
            {
                ...
                for (packlength = 0; packlength < c1; packlength++)
                {
                    ...
                    for (int a_ed1 = 0; a_ed1 < counteditin_latest1; a_ed1++)
                    {
                       ...
                       // dytbl += "<td class='insertiontxtclass' align='center' width='150px'style='border-right:solid 1px black;' >" + ds4.Tables[0].Rows[0]["EditionName"].ToString() + "</td>";
                        dytbl += "<td class='insertiontxtclass' align='center'width='50px' style='border-right:solid 1px black;border-left:solid 1px black;'>" + ds4.Tables[0].Rows[0]["Ins.date"].ToString() + "</td>";
                        if (ds4.Tables[0].Rows[0]["Page_No"].ToString()=="")
                        {
                            dytbl += "<td class='insertiontxtclass'align='center' width='90px' style='border-right:solid 1px black;border-left:solid 1px black;' >" + "&nbsp;" + "</td>";
                        }
                        else
                        {
                            dytbl += "<td class='insertiontxtclass'align='center' width='90px' style='border-right:solid 1px black;border-left:solid 1px black;' >" + ds4.Tables[0].Rows[0]["Page_No"].ToString() + "</td>";
                        }
                        if (ds4.Tables[0].Rows[0]["column1"].ToString()=="")
                        {
                            dytbl += "<td class='insertiontxtclass'align='center' width='90px' style='border-right:solid 1px black;border-left:solid 1px black;' >" + "&nbsp;" + "</td>";
                        }
                        else
                        {
                            dytbl += "<td class='insertiontxtclass'align='center' width='90px' style='border-right:solid 1px black;border-left:solid 1px black;' >" + ds4.Tables[0].Rows[0]["column1"].ToString() + "</td>";
                        }
                        ...
                        {
                            dytbl += "<td class='insertiontxtclass'align='center' width='90px' style='border-right:solid 1px black;border-left:solid 1px black;' >" + ds4.Tables[0].Rows[0]["Uom_name"].ToString() + "</td>";
                        }
                        ...
                        {
                            dytbl += "<td class='insertiontxtclass'align='center' width='90px' style='border-right:solid 1px black;border-left:solid 1px black;' >" + ds4.Tables[0].Rows[0]["volume"].ToString() + "</td>";
                        }
                        if (ds4.Tables[0].Rows[0]["card_rate"].ToString()=="")
                        {
                            dytbl += "<td class='insertiontxtclass'align='center' width='90px' style='border-right:solid 1px black;border-left:solid 1px black;' >" + "&nbsp;" + "</td>";
                        ...
                        {
                            dytbl += "<td class='insertiontxtclass'align='center' width='90px' style='border-right:solid 1px black;border-left:solid 1px black;' >" + ds4.Tables[0].Rows[0]["card_rate"].ToString() + "</td>";
                        }
                        ...
                        {
                            dytbl += "<td class='insertiontxtclass'align='center' width='90px' style='border-right:solid 1px black;border-left:solid 1px black;' >" + ds4.Tables[0].Rows[0]["pag_prem"].ToString() + "</td>";
                        }
                        dytbl += "<td class='insertiontxtclass'align='center' width='90px' style='border-right:solid 1px black;border-left:solid 1px black;' >" + "&nbsp;" + "</td>";

                        if (ds4.Tables[0].Rows[0]["gross_amount"].ToString()=="")
                        {
                            dytbl += "<td class='insertiontxtclass'align='right' width='90px' style='border-right:solid 1px black;border-left:solid 1px black;' >" + "&nbsp;" + "</td>";
                        }
                        else
                        {
                            double groamt=Convert.ToDouble(ds4.Tables[0].Rows[0]["gross_amount"].ToString());
                            dytbl += "<td class='insertiontxtclass'align='right' width='90px' style='border-right:solid 1px black;border-left:solid 1px black;' >" + groamt.ToString("F2") + "</td>";
                        }
                    ...
                    for (int a1 = ds4.Tables[0].Rows.Count; a1 < maxlimit - ds4.Tables[0].Rows.Count; a1++)
                    {
                        dytbl += "<tr align=center hight='67px'>";
                        dytbl += "<td  class='insertiontxtclass' align='right' width='150px'  style='border-right:solid 1px black;border-left:solid 1px black;'>" + "&nbsp;" + "</td>";
                        dytbl += "<td  class='insertiontxtclass' align='right' width='150px'  style='border-right:solid 1px black;border-left:solid 1px black;'>" + "&nbsp;" + "</td>";
                        dytbl += "<td  class='insertiontxtclass' align='right' width='150px'  style='border-right:solid 1px black;border-left:solid 1px black;'>" + "&nbsp;" + "</td>";
                        dytbl += "<td  class='insertiontxtclass' align='right' width='150px'  style='border-right:solid 1px black;border-left:solid 1px black;'>" + "&nbsp;" + "</td>";
                        dytbl += "<td  class='insertiontxtclass' align='right' width='150px'  style='border-right:solid 1px black;border-left:solid 1px black;'>" + "&nbsp;" + "</td>";
                ...
                txtboxchrgs.Text = ds4.Tables[0].Rows[0]["boxchares"].ToString();
                ...
                if (ds4.Tables[0].Rows[0]["trade_disc"].ToString() != "")
                {
                    ...
                    txttradedisc.Text = "( " + ds4.Tables[0].Rows[0]["trade_disc"].ToString() + "% )";
                }
                else
                {
                    txttradedisc.Text = "( " + "0" + "% )";
               ...
               // txtdiscal.Text = string.Format("{0:0.00}", traddis).ToString();
                ...
                txtnetbal.Text = bill_amt1.ToString();
                bill_amt1 = bill_amt1 + 0.00;
                double amountinckudingbox1 = bill_amt1;

                txtnetbal.Text = string.Format("{0:0.00}", amountinckudingbox1).ToString();
                ...
                txtrupees.Text = obj.changeNumericToWords(txtnetbal.Text.ToString()) + "Only";
                ...
                if (packlength == c1)
                {
                    ...
                    if (ConfigurationSettings.AppSettings["ConnectionType"].ToString() == "sql")
                    {
                        ...
                        dssave = objabc.updatebillprintstatus(txtbillno.Text);
                    }
                    else
                    {
