<%@ Control Language="C#" AutoEventWireup="true" CodeFile="classifiedcontrol.ascx.cs" Inherits="classifiedcontrol" %>
       ...
       <tr>
        ...
        <tr>
                ...
                <td colspan ="2" align ="left"  style=" border-style:dashed;">
                      ...
                      <asp:Label CssClass="invoicenoclass" ID="scheme" runat ="server"></asp:Label>
                </td>
       </tr>
       <tr>
                <td valign="top" align ="left"  style=" border-style:dashed;">
