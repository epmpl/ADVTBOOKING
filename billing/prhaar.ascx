<%@ Control Language="C#" AutoEventWireup="true" CodeFile="prhaar.ascx.cs" Inherits="prhaar" %>
...
<table border ="0" width ="650px" align="left" > 
...
<td align ="left" >
 ...
 <td  valign ="top"  align ="center" colspan="2" >
     <img src="Images/Prahaar.jpg" height ="50px" width ="130px" /><span><hr/></span>
...
<table style="vertical-align :top ;width: 500px; border-bottom:0;" cellspacing="0" cellpadding="0" border="1"    <%--style="left: 100px; position: absolute; top: 330px;width :675px"--%> class="table1" >
                       ...
                       <tr>
                                            ...
                                            <td valign="top" style=" height: 40px;" CssClass="weidthclass" > <asp:Label CssClass="weidthclass" ID="lbposition" runat ="server"></asp:Label>
    ...
    <td  valign ="top" style="height: 324px" ><table cellpadding ="0" cellspacing ="0"  border =""  class="table1" >
                   ...
                   <tr>
                    ...
                    <tr>
                                              ...
                                              <td style="width: 92px; height: 18px;"  align="right" >
      ...
      <td valign ="top" ><asp:Label  ID="Label7" runat ="server" CssClass="newhead1">FOR RANE PRAKASHAN PVT.LTD</asp:Label><br /><br /><br />
