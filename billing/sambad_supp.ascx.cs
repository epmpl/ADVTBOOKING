...
public partial class sambad_supp : System.Web.UI.UserControl
{
 ...
 public void setcard()
    {
        ...
        double amountinckudingboxbill = 0.1;
        ...
        for (packlength = 0; packlength < c1; packlength++)
        {
            ...
            {
                //   NewAdbooking.classesoracle.invoice objedition = new NewAdbooking.classesoracle.invoice();
                NewAdbooking.BillingClass.classesoracle.billing_save_supp objedition = new NewAdbooking.BillingClass.classesoracle.billing_save_supp();
                ds4 = objedition.editiondate_bill(editionnamenew[editionlen].Trim(), ciobookingid, Session["compcode"].ToString(), Session["dateformat"].ToString());
                if (ediplusdate == "")
                {
           ...
           //txtpackname.Text = ediplusdate.ToString();
            ...
            {
                //   NewAdbooking.classesoracle.invoice objvalues = new NewAdbooking.classesoracle.invoice();
            ...
            //ds4 = objvalues.values_bill("DEL2009A0100003540", editionname, i12, Session["compcode"].ToString());
            ...
            //if(ds4.Tables[0].Rows[0].ItemArray[1].ToString()!="")
           ...
           // string bukingdate = Convert.ToDateTime(bookingdate).ToString("dd/MM/yyyy");
            ...
            for (packlength = 0; packlength < c1; packlength++)
            {
                ...
                if (counted <= 1)
                {
                    ...
                    if (ConfigurationSettings.AppSettings["ConnectionType"].ToString() == "sql")
                    {
                        // NewAdbooking.Classes.invoice objedition1 = new NewAdbooking.Classes.invoice();
                ...
                if (ConfigurationSettings.AppSettings["ConnectionType"].ToString() == "sql")
                {
                    //  NewAdbooking.Classes.invoice objvalues1 = new NewAdbooking.Classes.invoice();
                    NewAdbooking.BillingClass.Classes.invoice objedition1 = new NewAdbooking.BillingClass.Classes.invoice();
                ...
                {
                    // NewAdbooking.classesoracle.invoice objvalues1 = new NewAdbooking.classesoracle.invoice();
