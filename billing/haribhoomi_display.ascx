<%@ Control Language="C#" AutoEventWireup="true" CodeFile="haribhoomi_display.ascx.cs" Inherits="haribhoomi_display" %>
...
<tr>
 ...
 <tr>
 <td class="style5"><b><asp:Label CssClass="agecnycodeclasspune" ID="Label7" runat ="server">Amount Rs.</asp:Label></b>:&nbsp<asp:TextBox CssClass="agecnycodeclasspune" ID="txtrupees" runat="server" Width="166px"></asp:TextBox></td>
