...
public partial class samab_cls_supp : System.Web.UI.UserControl
{
   public  string _agency;
    ...
    public void setcardnew()
    {
        ...
        for (int i = 0; i < ds4.Tables[0].Rows.Count; i++)
        {
            ...
            dateformat_insertiondate = ds4.Tables[0].Rows[i]["Ins.date"].ToString();
            ...
            if (ds5.Tables[0].Rows.Count == 0)
            {
                ...
                {
                    NewAdbooking.BillingClass.classesoracle.billing_save_supp objbkcenter = new NewAdbooking.BillingClass.classesoracle.billing_save_supp();
                    dsnew = objbkcenter.save_det_new1_bill(bookingid, txtinvoice.Text, ds4.Tables[0].Rows[i].ItemArray[10].ToString(), singleamt, boxamt2, ds4.Tables[0].Rows[i].ItemArray[21].ToString(), ds4.Tables[0].Rows[i].ItemArray[3].ToString(), dateformat_insertiondate, Session["dateformat"].ToString(), insert_id);
            ...
            if (valueofradio == "firstsave")
            {
                ...
                {                 ////////////////////////////
                    ...
                    if (ConfigurationSettings.AppSettings["ConnectionType"].ToString() == "sql")
                    {
                        ...
                        //    NewAdbooking.Classes.billing_save objsave = new NewAdbooking.Classes.billing_save();
                        NewAdbooking.BillingClass.Classes.billing_save objbkcenter = new NewAdbooking.BillingClass.Classes.billing_save();
                    ...
                    else
                    {
                        ...
                        recp.receiptinsert(Session["compcode"].ToString(), unit, type, str_receipt, rdate, paymodres, receivedreg, vouno, txtgross.Text, /*damount,*/ agency1, txtgross.Text, othercd, chno, chedate, bank, narration, rep, vdate, Session["userid"].ToString(), ag_main_code, ag_sub_code, Session["dateformat"].ToString(), prorec);
                        recp.receiptinsert1(Session["compcode"].ToString(), unit, type, str_receipt, rdate, paymodres, receivedreg, vouno, txtgross.Text, /*damount,*/ agency1, txtgross.Text, othercd, chno, chedate, bank, narration, rep, vdate, Session["userid"].ToString(), ag_main_code, ag_sub_code, Session["dateformat"].ToString());
                        recp.receiptinsert2(Session["compcode"].ToString(), unit, type, str_receipt, rdate, paymodres, receivedreg, vouno, txtgross.Text, /*damount,*/ agency1, txtgross.Text, othercd, chno, chedate, bank, narration, rep, vdate, Session["userid"].ToString(), ag_main_code, ag_sub_code, Session["dateformat"].ToString());
                        ...
                        string chk_billtype = "classifed";

                        NewAdbooking.BillingClass.classesoracle.billing_save_supp objbkcenter = new NewAdbooking.BillingClass.classesoracle.billing_save_supp();
                        dssave = objbkcenter.saveininsertion_bill(bookingid, txtinvoice.Text, txtgr.Text, txtgross.Text, boxamt2, insnum_cou, doctyp, maxinsert, Session["dateformat"].ToString(), chk_billtype);

                       // dssave = objbkcenter.saveinclassified_bill(bookingid, txtinvoice.Text, txtgross.Text, txtgr.Text, boxamt2, insnum_cou, doctyp, maxinsert);
