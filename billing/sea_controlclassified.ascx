<%@ Control Language="C#" AutoEventWireup="true" CodeFile="sea_controlclassified.ascx.cs" Inherits="sea_controlclassified" %>
...
--%>  <td align='center' class="style11" ><asp:Label ID="lblextra" runat ="server" CssClass="dateclasspune" ></asp:Label></td>
  <td align='center' class="style11"   ><asp:Label ID="lblnetamt" runat ="server" CssClass="dateclasspune"></asp:Label></td>
  <td align='center' class="style11"  ><b><asp:Label ID="lblround" runat ="server" CssClass="dateclasspune"></asp:Label></b></td>
  </tr>
