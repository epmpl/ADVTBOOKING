...
public partial class jansandeshbill_display : System.Web.UI.UserControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        hribhomi_text.Text = "For Jansandesh Times";
     ...
     public void setcard()
    {
        ...
        for (packlength = 0; packlength < c1; packlength++)
        {
            ...
            string compname = "<B>JANSANDESH TIMES</B>";
            string compname25 = "<B>JANSANDESH TIMES PVT. LTD.</B>";
            ...
            string revenu = "<b><u>Terms & Conditions:</u></b><br />1:&nbsp;All cheques/drafts should be in favour of " + compname + "& payable at,&nbsp;" + rev + ".<br /> 2:&nbsp;Any query may please be reverted within 15 days of receipt of bill.<br /> 3:&nbsp;22% Interest will be charged on overdue bills.<br />4:&nbsp;All disputes are subject to&nbsp;&nbsp;" + rev + " &nbsp;&nbsp;jurisdiction.<br /> ";
            string revenu25 = "<b><u>Terms & Conditions:</u></b><br />1:&nbsp;All cheques/drafts should be in favour of Jansandesh & payable at,&nbsp;" + compname25 + " , &nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;" + rev + ".<br /> 2:&nbsp;Any query may please be reverted within 15 days of receipt of bill.<br /> 3:&nbsp;22% Interest will be charged on overdue bills.<br /> 4:&nbsp;All disputes are subject to&nbsp;&nbsp;" + rev + " &nbsp;&nbsp;jurisdiction.<br /> ";
            if (Session["revenue"].ToString() == "ja1")
            {
            ...
            dytbl += "<table width='660px' align='left' cellpadding='5' cellspacing='0' >";
            {
                ...
                dsb.ReadXml(Server.MapPath("XML/jansandesh.xml"));
                ...
                dytbl += "<td class='insertiontxtclass1'  align='center'  width='90px' >" + dsb.Tables[0].Rows[0].ItemArray[77].ToString() + "</td>";
            ...
            for (packlength1 = 0; packlength1 < c1; packlength1++)
            {
                ...
                for (packlength = 0; packlength < c1; packlength++)
                {
                    ...
                    for (int a_ed1 = 0; a_ed1 < counteditin_latest1; a_ed1++)
                    {
                        ...
                        dytbl += "<td class='insertiontxtclass' align='center' width='150px' style='border-right:solid 1px black;border-left:solid 1px black;'>" + ds4.Tables[0].Rows[0]["EditionName"].ToString() + "</td>";
                        dytbl += "<td class='insertiontxtclass' align='center'width='50px' style='border-right:solid 1px black;border-left:solid 1px black;'>" + ds4.Tables[0].Rows[0]["insert_date"].ToString() + "</td>";


                        if (ds4.Tables[0].Rows[0]["Depth"].ToString() != "")
                        {
                            {
                                dytbl += "<td  class='insertiontxtclass' align='center' width='90px' style='border-right:solid 1px black;border-left:solid 1px black;'>" + ds4.Tables[0].Rows[0]["Depth"].ToString() + "*" + ds4.Tables[0].Rows[0]["Width"].ToString() + "</td>";
                            }
                        }
                        else
                        {
                        ...
                        if (ds4.Tables[0].Rows[0]["Hue"].ToString() == "BLACK AND WHITE")
                        {
                            dytbl += "<td  class='insertiontxtclass' align='center' width='90px' style='border-right:solid 1px black;border-left:solid 1px black;'>" + "B/W" + "</td>";
                        }
                        else
                        {
                            dytbl += "<td  class='insertiontxtclass' align='center' width='90px' style='border-right:solid 1px black;border-left:solid 1px black;'>" + "C" + "</td>";
                        }
                        ...
                        if (packlength == 0)
                        {
                            ...
                            if (ds4.Tables[0].Rows[0]["Agrred_rate"].ToString() != "")
                            {
                                dytbl += "<td class='insertiontxtclass' align='center'  width='90px' style='border-right:solid 1px black;border-left:solid 1px black;'>" + ds4.Tables[0].Rows[0]["Agrred_rate"].ToString() + "</td>";
                            }
                            else
                            {
                                dytbl += "<td class='insertiontxtclass' align='center'  width='90px' style='border-right:solid 1px black;border-left:solid 1px black;'>" + ds4.Tables[0].Rows[0]["package rate"].ToString() + "</td>";
                            }
                            ...
                            if (Convert.ToDouble(addchr.ToString()) == 0.0)
                            {
                                ...
                                dytbl += "<td class='insertiontxtclass' align='center'  width='90px' style='border-right:solid 1px black;border-left:solid 1px black;'>" + grossbillamt.ToString("F2") + "</td>";
                            }
                            else
                            {
                                dytbl += "<td class='insertiontxtclass' align='center'  width='90px' style='border-right:solid 1px black;border-left:solid 1px black;'>" + billamt.ToString("F2") + "</td>";
                            }




                            dytbl += "<td class='insertiontxtclass' align='center'  width='90px' style='border-right:solid 1px black;border-left:solid 1px black;'>" + addchr + "</td>";
