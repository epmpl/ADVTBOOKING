<%@ Control Language="C#" AutoEventWireup="true" CodeFile="pratidinbill.ascx.cs" Inherits="pratidinbill" %>
...
<%--<p  id="P1" style="page-break-after:auto;">--%>
...
<tr><td></td></tr>
 ...
 <tr><td>
 <table width="660px"  cellspacing="0" cellpadding="0">
 <tr style="border-bottom:solid 1px black;"><td  style="font-size:11px;font-family :Verdana; height:20px;border-bottom:solid 1px black; width:60px;" align="left"><asp:Label ID="lblissue" runat="server"><b>ISSUE: </b></asp:Label><asp:Label ID="lblisname"  runat="server"></asp:Label></td><td style="font-size:11px;font-family :Verdana;border-bottom:solid 1px black; width:70px;" align="right"><asp:Label ID="lblloc"  runat="server"><b>EDITION: </b></asp:Label></td><td style="font-size:11px;font-family :Verdana;border-bottom:solid 1px black;" align="left"><asp:Label ID="lbllocval"  runat="server"></asp:Label></td><td style="font-size:11px;font-family :Verdana;border-bottom:solid 1px black;" align="right"><asp:Label ID="lblpage"  runat="server"><b>PAGE: </b></asp:Label></td><td style="font-size:11px;font-family :Verdana;border-bottom:solid 1px black;" align="left"><asp:Label ID="lblpageval"  runat="server"></asp:Label></td></tr>
 </table>
 <hr size="2px" />
 </td></tr>
<%-- <tr><td>
...
<td valign ="top" style ="height :150px;">
 ...
 <hr size="2px" />
   <table width="660px"  cellspacing="0" cellpadding="0">
   <tr style="height:70px;"><td style="font-size:11px;font-family :Verdana;" align="left"><asp:Label ID="Label43"  runat="server"><b>Rupees: </b></asp:Label><asp:Label ID="lblamtword"  runat="server"></asp:Label></td></tr>
...
<td align="right"  style="font-size:10px;font-family :Verdana;" valign="bottom"><asp:Label ID="Label1" runat ="server" >For <b>PRATIDIN PRAKASHANI LTD.</b> </asp:Label></td>
 </tr>
