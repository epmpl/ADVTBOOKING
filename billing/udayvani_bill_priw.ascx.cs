...
public partial class udayvani_bill_priw : System.Web.UI.UserControl
{
    ...
    public void setcard()
    {
        ...
        for (packlength = 0; packlength < c1; packlength++)
        {
            ...
            //lblgross.Text = Convert.ToDouble(ds4.Tables[0].Rows[0]["gross_amount"]).ToString("F2");
            ...
            for (packlength1 = 0; packlength1 < t1; packlength1++)
            {
                ...
                //string[] editionname12 = editionname1.Split('+');
                //int t = editionname12.Length;
                //for (int l = 0; l < t; l++)
                //{
            ...
            for (packlength = 0; packlength < t1; packlength++)
            {
                ...
                string editionname1;//= ds3.Tables[0].Rows[0].ItemArray[0].ToString();
                //string[] editionname12 = packna.Split(',');
                //int t = editionname12.Length;
                //for (int l5 = 0; l5 < t; l5++)
                //{
