<%@ Control Language="C#" AutoEventWireup="true" CodeFile="billformat_classified.ascx.cs" Inherits="billformat_classified" %>
...
<table style="border:solid 1px black;width:650px;margin-left :20px;" cellspacing="0" cellpadding="0" id="TABLE1" onclick="return TABLE1_onclick()"><tr><td>
 ...
 <tr>
    ...
    <td  valign ="middle"  align ="LEFT" style="font-family:Times New Roman ;font-size:18px;font-weight :bold " ><asp:Label CssClass="dateclasspuneheading" ID="lbcompanyname" runat ="server" Font-Names="Times New Roman" Font-Bold="True"></asp:Label></td>
    

      <td  valign ="middle"  align ="center" style="font-family:Verdana UI;font-size:20px;font-weight :bold" ><u><asp:Label CssClass="dateclasspuneheading" ID="lbbilltype" runat ="server" Text="INVOICE" Font-Names="Verdana"></asp:Label></u></td>
 </tr>
