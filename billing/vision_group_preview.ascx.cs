...
public partial class vision_group_preview : System.Web.UI.UserControl
{
     ...
     public void setcard()
    {
        ...
        for (packlength = 0; packlength < c1; packlength++)
        {
            ...
            txt_rono.Text = ds4.Tables[0].Rows[0]["CIOID"].ToString();
            txt_order.Text = ds4.Tables[0].Rows[0]["RONO."].ToString();
            txt_invoice.Text = "xxxx";
            if (ds4.Tables[0].Rows[0]["RETAINER"].ToString() != "" && ds4.Tables[0].Rows[0]["RETAINER"].ToString() != "0")
            {
                txt_salesperson.Text = ds4.Tables[0].Rows[0]["RETAINER"].ToString();
            }
            else
            {
                txt_salesperson.Text = ds4.Tables[0].Rows[0]["EXECUTIVE_CODE"].ToString();
            }
          ...
          //  txtinvoice1.Text = invoiceno.ToString();
            ...
            for (packlength = 0; packlength < c1; packlength++)
            {
               ...
               // runtxt.Text = ds4.Tables[0].Rows[0].ItemArray[28].ToString();
                ...
                {
                    dytbl += "<td width=90px  class='lable_textbox' align=left >" + ds4.Tables[0].Rows[0]["edition"].ToString() + "</td>";
                }
                else
                    dytbl += "<td width=90px  class=display align=center>-</td>";

                if (ds4.Tables[0].Rows[0]["package_name"].ToString() != "")
                {
                    dytbl += "<td width='70px'  class='lable_textbox' align=center >" + ds4.Tables[0].Rows[0]["package_name"].ToString() + "</td>";
                ...
                if (ds4.Tables[0].Rows[0]["rundate"].ToString() != "")
                {
                    dytbl += "<td width='70px'   class='lable_textbox' align=right >" + ds4.Tables[0].Rows[0]["rundate"].ToString() + "</td>";
                ...
                dytbl += "<td width='70px' class='lable_textbox' align=center>---</td>";
                if (ds4.Tables[0].Rows[0]["Ins.No."].ToString() != "")
                {
                    dytbl += "<td width='70px'  class=lable_textbox align=center >" + ds4.Tables[0].Rows[0]["Ins.No."].ToString() + "</td>";
                ...
                {
                    dytbl += "<td width='70px'  class=lable_textbox align=left >" + ds4.Tables[0].Rows[0]["uom_name"].ToString() + "</td>";
                ...
                if (ds4.Tables[0].Rows[0]["card_rate"].ToString() != "")
                {
                    dytbl += "<td width='100px'  class=lable_textbox align=center >" + ds4.Tables[0].Rows[0]["card_rate"].ToString() + "</td>";
                ...
                dytbl += "<td width='70px'   class='lable_textbox' align=center >" + ds4.Tables[0].Rows[0]["trade_disc"].ToString() + "</td>";
                dytbl += "<td width='70px'   class='lable_textbox' align=right >" + ds4.Tables[0].Rows[0]["Gross_Rate"].ToString() + "</td>";
            ...
            dytbl += "<tr align=center >";
            dytbl += "<td colspan='6'   align=center></td>";
            dytbl += "<td colspan='3' align='left'  class='lable_textbox' >" + vat_new + "%" + dsb.Tables[0].Rows[0].ItemArray[17].ToString() + "</td>";
