...
public partial class insertion_wise_bill_generate : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!url1.Contains("page"))
        {
            ...
            publicationcenter = Session["pcenter"].ToString();
            publicationcentername = Session["pcentername"].ToString();
            billdate = Session["bill_date"].ToString();
    ...
    private void BindinsertionWise(string ciobookid, int c4, string insertion, string agencycode, string frmdt, string dateto1, string client, string bill_date_re, string publicationcenter, string publicationcentername)
    {
        ...
        for (inew = 0; inew < c4; inew++)
        {
            ...
            {
                bill_generate_insertionwise objcard = new bill_generate_insertionwise();
                objcard = (bill_generate_insertionwise)(Page.LoadControl("bill_generate_insertionwise.ascx"));
