<%@ Control Language="C#" AutoEventWireup="true" CodeFile="pdf_uday.ascx.cs" Inherits="pdf_uday" %>
...
<%--                 <td align="left"><asp:Label ID="lbinwords" runat="server" CssClass ="agecnycodeclasspune" Text="In Words Rupees  :"></asp:Label></td>--%>
  ...
  <tr>
  <td  style="font-size:6px;font-family :Times New Roman; height: 54px;border-bottom :solid 1px black;width: 320px;border-right:solid 1px black;vertical-align:top;" rowspan="4">
  <asp:Label ID="Label4" runat ="server" ><b><u>Terms & Conditions:</u></b>
        ...
        <td style="font-size:10px;font-family :Verdana; height: 54px;width: 300px;vertical-align:top;"  >
            ...
            <table  width='200px' cellspacing="0" cellpadding="0" ><tr>
            <td align="right" valign="bottom" style="padding-bottom:-10px;">
              ...
              <tr>
              <td align="right" valign="bottom" style="padding-bottom:-10px;"><div id="divimg" runat="server" style="height:auto;"></div>
              </td>
              </tr>
...
<asp:Literal ID="lit_pagebreak" runat="server"></asp:Literal>
