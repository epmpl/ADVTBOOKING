<%@ Control Language="C#" AutoEventWireup="true" CodeFile="udayvani_bill_classi.ascx.cs" Inherits="udayvani_bill_classi" %>
...
<table style="border:solid 1px black;width:650px;margin-left :0px;" cellspacing="0" cellpadding="0" id="TABLE1" onclick="return TABLE1_onclick()">
...
<table  style="border-bottom:solid 1px black;vertical-align :top " width="660px" cellspacing="0" cellpadding="0" >
<tr>
 <td   align="center" valign="top"><b>BILL</b></td>

 <%--<td align="center" ><img src="Images1/Manipal-Group-Logo-copy.jpg" height ="30px"/></td>--%>
...
<asp:Label CssClass="agecnycodeclasspune" ID="txtpinno" runat ="server"></asp:Label></b></td>
 ...
 <tr><td >&nbsp;</td></tr>
 <tr>
  <td   align ="left" style="padding-left:30px;width:225px" ><b><asp:Label CssClass="agecnycodeclasspune" ID="lbcontectp" runat ="server" Text="Contact Person :"></asp:Label>
...
<table width="30px">
<tr>
<td  align="left" valign="top" ><img src="Images1/Manipal-Group-Logo-copy.jpg" alt="" height ="50px" id="IMG1" onclick="return IMG1_onclick()"/></td>
<td>
...
<tr><td colspan="4" align="center" ><asp:Label ID="lbcomp_add" CssClass="dateclasspune" runat="server"><b>Regd.office:Udayavani Building, Tile Factory Road,Manipal-576104</b></asp:Label></td></tr>
...
<td align='right'><asp:Label ID="Label3" CssClass="dateclasspune" runat="server"><b>PAN:AAACM 8839Q</b></asp:Label></td>
</tr>
...
<td align="left" class="display1" style="visibility:hidden;"><b><asp:Label CssClass="agecnycodeclasspune" ID="lbpackagena" runat ="server">RONo.</asp:Label></b></td>
<td align ="left" class="insertiontxtclassCLA" style="visibility:hidden;"><asp:Label CssClass="dateclasspune" ID="txtpackname" runat ="server"></asp:Label></td>
...
<%--<table width="660px" cellspacing="0" cellpadding="0" ><tr>
...
<td valign ="top" style ="height :150px;">
 ...
 <tr ><td id="totaltab" runat="server">
...
<%--                 <td align="left"><asp:Label ID="lbinwords" runat="server" CssClass ="agecnycodeclasspune" Text="In Words Rupees  :"></asp:Label></td>--%>
  ...
  <table   width="660px" id="notetab" cellspacing="0" runat="server" cellpadding="0" border="0" >
  <tr>
...
1:&nbsp;Payment shall be made by A/c payee cheque or Bank Draft favouring <b>"MANIPAL MEDIA &nbsp;&nbsp;&nbsp;&nbsp;NETWORK LIMITED"</b> payable at <b>MANIPAL.</b><br /> 
...
5:&nbsp;Interest @20% on the bill amount will not be charged for the delayed payment.<br /> 
6:&nbsp;All disputes are subject to Manipal jurisdiction only.<br /> 
</asp:Label>
  </td>
  ...
  <tr valign="top">
  <td  align="center" class="insertiontxtclass4" style="height: 13px;width:60px; " ><asp:Label ID="Label5" runat ="server" CssClass="dateclasspune_uday" >Gross</asp:Label></td>
  ...
  <td  align='center'  class="insertiontxtclass4" style="height: 13px" ><asp:Label ID="Label12" runat ="server" CssClass="dateclasspune_uday" >Addl Disc</asp:Label></td>
  <td  class="insertiontxtclass4" style="height: 13px;width:30px;" ><asp:Label ID="Label9" runat ="server" CssClass="dateclasspune_uday" >Box/ ExtraChg</asp:Label></td>
...
<table width="660px" id="TBL_NEW" runat ="server"  cellspacing="0" cellpadding="0"  >
<tr  >
...
<%--<td style=" border-top:solid 1px black;font-size:10px; height: 12px;" align="center" width="280px" valign ="bottom" ><asp:Label  CssClass="BORDERPAN" ID="lbpune" runat ="server"><b></asp:Label><asp:Label  CssClass="dateclasspune" ID="lbpunetxt" runat ="server" Text=""></asp:Label><b></td>--%>
...
<table width="660px"  cellspacing="0" cellpadding="0" style="border-top:solid 1px black;">
