...
public partial class billing_bill_preview_print : System.Web.UI.Page
{
    ...
    private void onscreen(string ciobookid, int c4, string insertion, string agencycode, string fromdate, string dateto, string client, string invoice)
    {
        ...
        for (inew = 0; inew < countbookid2.Length; inew++)
        {
            ...
            RCB2 obj_RCB1 = new RCB2();
            obj_RCB1 = (RCB2)Page.LoadControl("RCB2.ascx");
            DataSet ds4 = new DataSet();

            if (ConfigurationSettings.AppSettings["ConnectionType"].ToString() == "orcl")
            {
                NewAdbooking.BillingClass.classesoracle.billling_preview objvalues1 = new NewAdbooking.BillingClass.classesoracle.billling_preview();
                ds4 = objvalues1.selectlastnew_preview(bookingid, Session["dateformat"].ToString(), fromdate, dateto, invoice2, Session["compcode"].ToString(),Session["center"].ToString());
            }
            ...
            if (rcount == 0)
            {
                //ScriptManager.RegisterClientScriptBlock(this, typeof(billing_bill_preview_print), "sa", "alert(\"searching criteria is not valid\");", true);
            ...
            {
                RCB2 obj_RCB = new RCB2();
                obj_RCB = (RCB2)Page.LoadControl("RCB2.ascx");
                ...
                obj_RCB.txtinvoice1 = bookingid.ToString();
