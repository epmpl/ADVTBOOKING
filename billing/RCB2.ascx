<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RCB2.ascx.cs" Inherits="RCB2" %>
...
<table  style="border-bottom:solid 1px black;vertical-align :top " width="683px" cellspacing="0" cellpadding="0" >
 <tr>
     ...
     <td  valign ="middle"  align ="center" style="font-family:Verdana UI;font-size:20px;font-weight :bold" ><u><asp:Label  ID="lbbilltype" runat ="server" Text="PERFORMA" Font-Names="Verdana"></asp:Label></u></td>
 </tr>
 ...
 <tr>
 <td align ="left" width="100px"   ><asp:Label CssClass="agecnycodeclasspune" ID="lbclientna" runat ="server"></asp:Label></td>
...
<td style="height: 13px"><asp:Label CssClass="agecnycodeclasspune" ID="lbpackagerate" runat ="server"></asp:Label></td>
...
<td valign ="top" style ="height :150px;border-right:solid 1px black"   >
  ...
  <tr>
        ...
        <tr>
            <td  align="left"><asp:Label CssClass="agecnycodeclasspune" ID="lbinsertionnumber" runat ="server"></asp:Label> </td>
            <td align="right"><asp:Label CssClass="dateclasspune" ID="insertiontxt" runat ="server"></asp:Label></td>
        </tr>
      
        <tr>
            <td align="left" style="padding-bottom :5PX; height: 18px;" > <asp:Label  ID="lblamount" runat ="server"  CssClass="agecnycodeclasspune"></asp:Label></td>
            <td align="right" style="height: 18px"><asp:Label   ID="amount1" runat ="server"  CssClass="dateclasspune"></asp:Label></td>
        </tr>
        <tr>
        ...
        <tr>
            <td align="left" style="padding-bottom :5PX; height: 18px;" ><asp:Label CssClass="agecnycodeclasspune" ID="lbtrade1" runat ="server"></asp:Label></td>
            <td align="right" style="height: 18px"><asp:Label CssClass="dateclasspune" ID="txtdiscal" runat ="server"></asp:Label></td>
        </tr>
        ...
        <tr style="border-bottom:solid 1px black">
            <td align="left" style="height: 13px"><asp:Label CssClass="agecnycodeclasspune" ID="lblnetpayable" runat ="server"></asp:Label></td>
...
<td valign ="bottom" style="font-size:10px;"  > <asp:Label CssClass="agecnycodeclasspune"  ID="EOU" runat ="server"></asp:Label></td>

<td align="right"  valign ="bottom"   style="font-size:10px;" ><asp:Label  CssClass="BORDERPAN" ID="lbpune" runat ="server"></asp:Label><asp:Label  CssClass="dateclasspune" ID="lbpunetxt" runat ="server"></asp:Label></td>
