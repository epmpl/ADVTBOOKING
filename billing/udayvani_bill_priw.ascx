<%@ Control Language="C#" AutoEventWireup="true" CodeFile="udayvani_bill_priw.ascx.cs" Inherits="udayvani_bill_priw" %>
<link href="css/udyavanibill.css" type="text/css" rel="Stylesheet" />
<head>
<title>UDAYANI BILL PRIVIEW</title>
...
<table width="30px">
<tr>
<td  align="left" valign="top" ><img src="Images1/Manipal-Group-Logo-copy.jpg" height ="50px"/></td>
<td>
...
--%>  <td width='30px' class="insertiontxtclass4" style="height: 13px" ><asp:Label ID="lblboxcr" runat ="server" CssClass="dateclasspune_uday" ></asp:Label></td>
