...
function checkboxidbillpreview() {
    ...
    if (document.getElementById("DataGrid2") == null) {
        ...
        for (j = 1; j < document.getElementById("DataGrid2").rows.length; j++) {
            ...
            if (document.getElementById(str1).checked == true) {
                ...
                if (ciobookid == "") {
                    agencycode = document.getElementById("DataGrid2").rows[j].cells[2].innerHTML;
                    ciobookid = document.getElementById("DataGrid2").rows[j].cells[0].innerHTML;

                }
                else {
                    agencycode = agencycode + "," + document.getElementById("DataGrid2").rows[j].cells[2].innerHTML;
    ...
    orderwise_last_supp.setSessionlast_priev(ciobookid, checkradio, insertion, agencycode, dateto, frmdt, client, adtype, hiddenbillstatus);
    window.open('invoice_classified_supp.aspx');
        ...
        for (j = 1; j < document.getElementById("DataGrid2").rows.length; j++) {
            ...
            if (document.getElementById(str1).checked == true) {
                ...
                if (ciobookid == "") {
                    ...
                    agencycode = agencycode + "," + document.getElementById("DataGrid2").rows[j].cells[3].innerHTML;
                    ciobookid = ciobookid + "," + document.getElementById("DataGrid2").rows[j].cells[0].innerHTML;
...
function checkboxidbillgen() {
    ...
    if (document.getElementById("DataGrid2") == null) {
        ...
        for (j = 1; j < document.getElementById("DataGrid2").rows.length; j++) {
            ...
            if (document.getElementById(str1).checked == true) {
                ...
                if (ciobookid == "") {
                    ciobookid = document.getElementById("DataGrid2").rows[j].cells[0].innerHTML;
                    insertion = document.getElementById("DataGrid2").rows[j].cells[5].innerHTML;
                    edition = "";
                    publish = "";
                    ...
                    ciobookid = ciobookid + "," + document.getElementById("DataGrid2").rows[j].cells[0].innerHTML;
                    insertion = insertion + "," + document.getElementById("DataGrid2").rows[j].cells[5].innerHTML;
                    edition = edition + "," + "";
                    publish = publish + "," + "";
    ...
    orderwise_last_supp.setSessionIns_gen(ciobookid, checkradio, insertion, dateto, frmdt, client, adtype, bill, hiddenbillstatus, todate_v, edition, spl_dis, trade_dis, todate_v, rborg);
    window.open('order_wise_bill_generate_supp.aspx');
}
...
function checkboxidbillreprint() {
    ...
    var str1 = "DataGrid2_ctl02_CheckBox1";
    var str12="DataGrid2_ctl02_CheckBox3";
    if (document.getElementById("DataGrid2") == null) {
        alert('please check atleast  id from grid');
        return false;
    }
        ...
        for (j = 1; j < document.getElementById("DataGrid2").rows.length; j++) {
            ...
            if (document.getElementById(str1).checked == true) {
                ...
                if (ciobookid == "") {
                    ...
                    if (document.getElementById(str12).checked == true) {
                        trade_dis = "1";
                    }
                    else {
                        trade_dis = "0";
            ...
            var str21 = str12.split('_')[1]


            var str31 = str21.split('l')[1]
            var str41 = str21.split('l')[0]
            str31 = str31
            str31 = Number(str31) + 1;
            if (str31 >= 10) {
                str12="DataGrid2_ctl" + str31 + "_CheckBox3";
            }
            else {
                str12="DataGrid2_ctl0" + str31 + "_CheckBox3";
            }
    ...
    orderwise_last_supp.setSessionlast(ciobookid, checkradio, insertion, edition, agencycode, dateto, frmdt, client, adtype, invoice_no, hiddenbillstatus,trade_dis);
    window.open('classifiednew_supp.aspx');
...
function SelectHILAST1(grdid, obj, objlist) {


    if (document.getElementById("DataGrid2_ctl01_Checkbox5").checked == true) {
        var j1;
        var j;
        var str1 = "DataGrid2_ctl02_CheckBox3";
        for (j = 1; j < document.getElementById("DataGrid2").rows.length; j++) {
            ...
            if (objlist == "Checkbox5") {
                ...
                str3 = Number(str3) + 1;
                if (str3 >= 10) {
                    str1 = "DataGrid2_ctl" + str3 + "_CheckBox3";
                }
                else {
                    str1 = "DataGrid2_ctl0" + str3 + "_CheckBox3";
                }
