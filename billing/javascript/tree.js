...
{
    window.open("http://localhost/circulation/default.aspx?unit="+document.getElementById('Topbar1$hidcenter').value+"&compname="+document.getElementById('Topbar1$hidcompname').value+"&userid="+document.getElementById('Topbar1$hiduserid').value+"&compcode="+document.getElementById('Topbar1$hidcompcode').value+"&dateformat="+document.getElementById('Topbar1$hidauto').value+"&unitname="+document.getElementById('Topbar1$hidunitname').value+"");
}
 function openadaccount()
{
//192.168.5.205\updates\Collection
//window.open("http://192.168.5.205/Collection/default.aspx");
//window.open("http://localhost/Collection/default.aspx?auto="+document.getElementById('Topbar1$hidautogenerated').value+"&Username="+document.getElementById('Topbar1$hidusername').value+"&userid="+document.getElementById('Topbar1$hiduserid').value+"&compcode="+document.getElementById('Topbar1$hidcompcode').value+"&dateformat="+document.getElementById('Topbar1$hidauto').value+"&prefix="+document.getElementById('hiddenprefix').value+"&suffix="+document.getElementById('hiddensuffix').value+"&financestatus="+document.getElementById('hiddenfinancestatus').value+"&voucherstatus="+document.getElementById('hiddenvoucherstatus').value+"");
window.open("http://localhost/Collection/default.aspx?auto="+document.getElementById('Topbar1$hidautogenerated').value+"&Username="+document.getElementById('Topbar1$hidusername').value+"&userid="+document.getElementById('Topbar1$hiduserid').value+"&compcode="+document.getElementById('Topbar1$hidcompcode').value+"&dateformat="+document.getElementById('Topbar1$hidauto').value+"&revenue="+document.getElementById('Topbar1$hiddenreveneue').value+"");
...
function chkadmin()
{
	...
	document.getElementById("_lbuser").innerHTML="User:";
    document.getElementById("_lbcom").innerHTML="Organizational Unit:";
    document.getElementById("_lbadmin").innerHTML="Profile:";
