    ...
    if(event.keyCode==113)  
            {
                  ...
                  if(document.activeElement.id=="txtagency")
                {
                    ...
                    billing.bindagencyname(compcode,txtagency1,bindagencyname_callback);
...
function chekvalidaton()
{
    ...
    if(document.getElementById('drpbooking').value=="0")
    {            
        alert('Please publication center');
        document.getElementById('drpbooking').focus();
        return false;            
    }				 
    if(document.getElementById('drpbillstatus').value=="0")
    {            
...
billing.adcatbnd(adtype1,compcode,call_adcatbind1);
...
var compcode=document.getElementById('hiddencompcode').value;
var adtype1=document.getElementById('dpdadtype').value;
billing.bindpackagenew(adtype1,compcode,call_bindpackage);
//billwisexls.adcatbnd(adtype1,compcode,call_adcatbind);
}
...
billing.bindtaluka(compcode,district,call_bind_taluka);
