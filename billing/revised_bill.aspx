<%@ Page Language="C#" AutoEventWireup="true" CodeFile="revised_bill.aspx.cs" Inherits="revised_bill" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server" >
     <title>RevisedBilling</title>
		...
		<link href="css/report.css" type="text/css" rel="stylesheet"/>
				...
				<script type="text/javascript"  language="javascript" src="javascript/entertotab.js"></script>
				  <script language="javascript" src="javascript/revised_bill.js" type="text/javascript"></script>
				  <style type="text/css">
    .hiddencol
    {
        display:none;
									...
									<td style="HEIGHT: 25px" align="left">
                                                                    ...
                                                                    <asp:DropDownList CssClass="dropdown" id="drpbillstatus" runat="server"  >
                                                                     <asp:ListItem Value="0">-Select Bill Type-</asp:ListItem>                                                                    
                                                                           ...
                                                                           <asp:ListItem Value="7">Reprint</asp:ListItem>                                                           
...
<td align="left">
<asp:Label id="txtbilltype" runat="server" CssClass="TextField">Bill Type</asp:Label></td>
<td style="HEIGHT: 25px; width: 143px;" align="left">
...
</td>	<td style="HEIGHT: 40px" align="left" id="Td1" runat ="server">    
