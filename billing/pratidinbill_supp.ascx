<%@ Control Language="C#" AutoEventWireup="true" CodeFile="pratidinbill_supp.ascx.cs" Inherits="pratidinbill_supp" %>
...
<tr>
 ...
 <td  align="center" colspan="2" style="visibility:hidden;"><img src="http://192.168.0.157/booking/images1/EML.jpg" height ="80px"/></td>
</tr>
...
<tr>
<td align="right" style="font-size:11px;font-family :Verdana;width:450px;visibility:hidden;"><asp:Label ID="Label13"  runat="server">PHONE:2210-8400-05,FAX:(033)2212-7977</asp:Label></td>
...
<hr style="border-bottom:solid 1px black;"></hr>
 ...
 <tr style="height:125px;"><td style="width:80px;font-size:11px;font-family :Verdana;"><asp:Label ID="lblnameadd" runat ="server">NAME & ADDRESS</asp:Label></td>
 ...
 <td style="width:200px;"><table cellpadding="0" cellspacing="0"><tr><td style="font-size:11px;font-family :Verdana;"><asp:Label  ID="l8" runat ="server">BILL NO. :</asp:Label></td><td style="font-size:11px;font-family :Verdana; width:100px" align="left"><asp:Label  ID="lbbillno" runat ="server"></asp:Label></td></tr><tr><td style="font-size:11px;font-family :Verdana;"><asp:Label  ID="Label5" runat ="server">DATE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</asp:Label></td><td style="font-size:11px;font-family :Verdana; width:100px" align="left"><asp:Label  ID="lbldate" runat ="server"></asp:Label></td></tr><tr><td style="font-size:11px;font-family :Verdana;"><asp:Label  ID="Label6" runat ="server">CODE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</asp:Label></td><td style="font-size:11px;font-family :Verdana; width:100px" align="left"><asp:Label  ID="lblcode" runat ="server"></asp:Label></td></tr>
 </table></td></tr></table>
 ...
 <tr><td>
 <table width="660px"  cellspacing="0" cellpadding="0">
 <tr style="border-bottom:solid 1px black;"><td  style="font-size:11px;font-family :Verdana; height:20px;border-bottom:solid 1px black; width:60px;" align="right"><asp:Label ID="lblissue" runat="server">ISSUE :</asp:Label></td><td style="font-size:11px;font-family :Verdana;border-bottom:solid 1px black;" align="left"><asp:Label ID="lblisname"  runat="server"></asp:Label></td><td style="font-size:11px;font-family :Verdana;border-bottom:solid 1px black; width:70px;"><asp:Label ID="lblloc"  runat="server">EDITION :</asp:Label></td><td style="font-size:11px;font-family :Verdana;border-bottom:solid 1px black;" align="left"><asp:Label ID="lbllocval"  runat="server"></asp:Label></td><td style="font-size:11px;font-family :Verdana;border-bottom:solid 1px black;" align="right"><asp:Label ID="lblpage"  runat="server">PAGE :</asp:Label></td><td style="font-size:11px;font-family :Verdana;border-bottom:solid 1px black;" align="left"><asp:Label ID="lblpageval"  runat="server"></asp:Label></td></tr>
 </table>
 </td></tr>
<%-- <tr><td>
<table width="660px"  cellspacing="0" cellpadding="0">
...
<td valign ="top" style ="height :150px;">
  ...
  <td align="right" >
  <b>
  <asp:Label ID="lb_card_rate" runat="server"  Text="Card Rate" CssClass="tabro" ></asp:Label></b></td>
  <td align="center">
  
   <asp:Label ID="txt_rate" runat="server"  CssClass="tabro"  ></asp:Label>
  </td>
  </tr>
  </table>
  </td>
  ...
  <tr><td>
   <table width="660px"  cellspacing="0" cellpadding="0">
 <tr><td style="font-size:11px;font-family :Verdana;border-right:solid 1px black;border-top:solid 1px black;border-bottom:solid 1px black;width:70px;" align="center"><asp:Label ID="Label31"  runat="server">AMOUNT</asp:Label></td><td style="font-size:11px;font-family :Verdana;border-right:solid 1px black;border-top:solid 1px black;border-bottom:solid 1px black;width:70px;" align="center"><asp:Label ID="Label32"  runat="server">EXTRAAMT FOR SPL POSITION</asp:Label></td><td style="font-size:11px;font-family :Verdana;border-right:solid 1px black;border-top:solid 1px black;border-bottom:solid 1px black;width:70px;" align="center"><asp:Label ID="Label33"  runat="server">EXTRA AMT FOR SPL DAY</asp:Label></td><td style="font-size:11px;font-family :Verdana;border-right:solid 1px black;border-top:solid 1px black;border-bottom:solid 1px black;width:70px;" align="center"><asp:Label ID="Label25"  runat="server">EXTRA AMT FOR COLOR</asp:Label></td><td style="font-size:11px;font-family :Verdana;border-right:solid 1px black;border-top:solid 1px black;border-bottom:solid 1px black;width:70px;" align="center">GROSS AMT<asp:Label ID="Label26" CssClass="dateclasspune" runat="server"></asp:Label></td><td style="font-size:11px;font-family :Verdana;border-right:solid 1px black;border-top:solid 1px black;border-bottom:solid 1px black;width:90px;" align="center"><asp:Label ID="Label27"  runat="server">SPL DISCOUNT % AMOUNT</asp:Label></td><td style="font-size:11px;font-family :Verdana;border-right:solid 1px black;border-top:solid 1px black;border-bottom:solid 1px black;width:90px;" align="center"><asp:Label ID="Label28"  runat="server">TRADE DISCOUNT % AMOUNT</asp:Label></td><td style="font-size:11px;font-family :Verdana;border-right:solid 1px black;border-top:solid 1px black;border-bottom:solid 1px black;width:50px;" align="center"><asp:Label ID="Label29"  runat="server">BOX CHRG.</asp:Label></td><td style="font-size:11px;font-family :Verdana;border-top:solid 1px black;border-bottom:solid 1px black;width:80px;" align="center"><asp:Label ID="Label30"  runat="server">NET AMOUNT</asp:Label></td></tr>
 <tr><td style="font-size:11px;font-family :Verdana;border-right:solid 1px black;border-bottom:solid 1px black;width:70px;" align="center"><asp:Label ID="lblamt"  runat="server"></asp:Label></td><td style="font-size:11px;font-family :Verdana;border-right:solid 1px black;border-bottom:solid 1px black;width:70px;" align="center"><asp:Label ID="lblexamt_pos"  runat="server"></asp:Label></td><td style="font-size:11px;font-family :Verdana;border-right:solid 1px black;border-bottom:solid 1px black;width:70px;" align="center"><asp:Label ID="lblexamt_day"  runat="server"></asp:Label></td><td style="font-size:11px;font-family :Verdana;border-right:solid 1px black;border-bottom:solid 1px black;width:70px;" align="center"><asp:Label ID="lblexamt_col"  runat="server"></asp:Label></td><td style="font-size:11px;font-family :Verdana;border-right:solid 1px black;border-bottom:solid 1px black;width:70px;" align="center"><asp:Label ID="lblgross"  runat="server"></asp:Label></td><td style="font-size:11px;font-family :Verdana;border-right:solid 1px black;border-bottom:solid 1px black;width:90px;" align="center"><asp:Label ID="lbladddis"  runat="server"></asp:Label></td><td style="width:90px;"><table cellpadding="0" cellspacing="0"><tr><td style="font-size:11px;font-family :Verdana;border-right:solid 1px black;border-bottom:solid 1px black;width:30px;" align="center"><asp:Label ID="lbltrade"  runat="server"></asp:Label></td><td style="font-size:11px;font-family :Verdana;border-right:solid 1px black;border-bottom:solid 1px black;width:61px;" align="center"><asp:Label ID="lbltradedis"  runat="server"></asp:Label></td></tr></table></td><td style="font-size:11px;font-family :Verdana;border-right:solid 1px black;border-bottom:solid 1px black;width:50px;" align="center"><asp:Label ID="lblboxchrg"  runat="server"></asp:Label></td><td style="font-size:11px;font-family :Verdana;width:80px;border-bottom:solid 1px black;" align="center"><asp:Label ID="lblnetamt" runat="server"></asp:Label></td></tr>
   ...
   <table width="660px"  cellspacing="0" cellpadding="0">
   <tr style="height:70px;"><td style="font-size:11px;font-family :Verdana;width:70px;" align="center"><asp:Label ID="Label43"  runat="server"><b>Rupees:</b></asp:Label></td><td style="font-size:11px;font-family :Verdana;width:590px;" align="left"><asp:Label ID="lblamtword"  runat="server"></asp:Label></td></tr>
   <tr style="height:70px;"><td style="font-size:11px;font-family :Verdana;width:70px;" align="center"><asp:Label ID="Label45" runat="server">SCODE:</asp:Label></td><td style="font-size:11px;font-family :Verdana;width:590px;"><table><tr><td style="font-size:11px;font-family:Verdana;width:80px;" align="left"><asp:Label ID="txtscode" runat="server"></asp:Label></td>
       <td style="font-size:11px;font-family:Verdana;" class="style1"><asp:Label ID="lbratecod" runat="server">RCODE:</asp:Label></td><td style="font-size:11px;font-family:Verdana;" align="left"><asp:Label ID="txtratecode" runat="server"></asp:Label></td></tr></table></td></tr>
   </table>
...
<td align="right"  style="font-size:10px;font-family :Verdana;"><asp:Label ID="Label1" runat ="server" >For <b>PRATIDIN PRAKASHANI LTD.</b> </asp:Label></td>
 </tr>
...
<tr style="width:385px;visibility:hidden;" >
...
<table width="660px" style="visibility:hidden;">
<tr>
