<%@ Control Language="C#" AutoEventWireup="true" CodeFile="seaexpressbill_priv.ascx.cs" Inherits="seaexpressbill_priv" %>

<link href="css/udyavanibill.css" type="text/css" rel="Stylesheet" />
<head>
<title>SEA EXPRESS BILL PRIVIEW</title>
...
<tr><td colspan="4" align="center" ><asp:Label ID="lbcomp_add" CssClass="dateclasspune" runat="server"><b>Express House,Manas Nagar X-ing Road,M.G.-2 Shahganj,Agra-282010</b></asp:Label></td></tr>
...
5:&nbsp;All disputes are subject to AGRA jurisdiction only.<br /> 
 ...
 <b>This is a computer generated document and dose not require a signature.</b>
  </asp:Label>
