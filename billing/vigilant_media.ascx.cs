...
public partial class vigilant_media : System.Web.UI.UserControl
{
    ...
    public void setcard()
    {
        ...
        for (packlength = 0; packlength < c1; packlength++)
        {
            ...
            // agencytxt.Text = ds4.Tables[0].Rows[0]["add1"].ToString();
            agencytxt.Text = agencytxt.Text + "," + ds4.Tables[0].Rows[0]["add1"].ToString();// +"," + street;
            // lbaddress.Text = ds4.Tables[0].Rows[0]["city_name"].ToString();
            ...
            double tgamt = 0;
            dytbl = "";
            dytbl += "<table width='763px' border=0 align='left' cellpadding='0' cellspacing='0' >";
            {
                DataSet dsb = new DataSet();
                dsb.ReadXml(Server.MapPath("XML/vigilant.xml"));
                dytbl += "<tr align=center >";
                dytbl += "<td class='insertiontxtclass1' width='200px'  >" + dsb.Tables[0].Rows[0].ItemArray[0].ToString() + "</td>";
                dytbl += "<td   class='insertiontxtclass1'width='79px' >" + dsb.Tables[0].Rows[0].ItemArray[1].ToString() + "</td>";
                ...
                // dytbl += "<td width='35px'class='insertiontxtclass1' >" + dsb.Tables[0].Rows[0].ItemArray[3].ToString() + "</td>";
                // dytbl += "<td width='35px' class='insertiontxtclass1' >" + dsb.Tables[0].Rows[0].ItemArray[4].ToString() + "</td>";


                dytbl += "<td  class='insertiontxtclass1' width='66px' >" + dsb.Tables[0].Rows[0].ItemArray[5].ToString() + "</td>";
                dytbl += "<td class='insertiontxtclass1' width='50px' >" + dsb.Tables[0].Rows[0].ItemArray[6].ToString() + "</td>";
            ...
            for (packlength = 0; packlength < c1; packlength++)
            {
                ...
                boxchg2 = boxchg1 / c1;
                lbl_box.Text = boxchg1.ToString("F2");
                ...
                Label2.Text = ds4.Tables[0].Rows[0]["Box_no"].ToString();
...
//========================Bill Remarks===================================//
                ...
                dytbl += "<td    align='left' class='display'>" + ds4.Tables[0].Rows[0]["Pub"].ToString() + "</td>";
                ...
                {
                    dytbl += "<td    class=display align='center' width='100px' >" + "<table cellpadding='0' cellspacing='0' width='100px' ><tr><td style='border-right:solid 1px black;' >" + ds4.Tables[0].Rows[0]["Depth"].ToString() + "</td><td>" + ds4.Tables[0].Rows[0]["Width"].ToString() + "</td></tr></table></td>";
                    //+ ds4.Tables[0].Rows[0]["Depth"].ToString() + "</td>";
                ...
                //{
                //    dytbl += "<td   class=display align='center' >" + ds4.Tables[0].Rows[0]["Width"].ToString() + "</td>";
                ...
                //if (ds4.Tables[0].Rows[0]["Width"].ToString() != "")
                //{
                //    dytbl += "<td width='35px'  class=display align=left >" + ds4.Tables[0].Rows[0]["Width"].ToString() + "</td>";
                ...
                if (ds4.Tables[0].Rows[0]["Page_insrt"].ToString() != "" && ds4.Tables[0].Rows[0]["Page_insrt"].ToString() != null)
                {
                    dytbl += "<td   class=display align='right' >" + ds4.Tables[0].Rows[0]["Page_insrt"].ToString() + "</td>";
                ...
                dytbl += "<td    align='right' class='display1'>" + tgamt + "</td>";
            ...
            //lbl_net.Text = Math.Round(finalamount + 0.01).ToString();
