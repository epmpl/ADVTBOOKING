<%@ Page Language="C#" AutoEventWireup="true" CodeFile="orderwise_last_supp.aspx.cs" Inherits="orderwise_last_supp" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <      <title>Orderwise(last)_Supplement</title>
<link href="css/main.css" type="text/css" rel="stylesheet"/>
		<link href="css/booking.css" type="text/css" rel="stylesheet"/>
		<link href="css/report.css" type="text/css" rel="stylesheet"/>
				<script type="text/javascript"  language="javascript" src="javascript/popupcalender.js"></script>
				<script type="text/javascript"  language="javascript" src="javascript/entertotab.js"></script>
				  <script language="javascript" src="javascript/orderwise_last_supp.js" type="text/javascript"></script>
     ...
     <ItemStyle HorizontalAlign="Center"></ItemStyle>
      <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
         Font-Underline="False" ForeColor="White" HorizontalAlign="Center" />
           ...
           <asp:TemplateColumn  >
           <HeaderTemplate>
<input id="Checkbox5"  type="checkbox" name="Checkbox5" runat="server" onclick="SelectHILAST1('DataGrid3', this, 'Checkbox5');" /> 
                   </HeaderTemplate>
																...
																<ItemTemplate >
																	<asp:CheckBox ID="CheckBox3" CssClass="TextField1" Runat="server"   />
																</ItemTemplate>
															</asp:TemplateColumn>	
