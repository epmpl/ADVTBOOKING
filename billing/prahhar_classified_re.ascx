<%@ Control Language="C#" AutoEventWireup="true" CodeFile="prahhar_classified_re.ascx.cs" Inherits="prahhar_classified_re" %>
...
<table  width ="750px" align="left"   class ="break"   >

<tr align = "left" >
<td align ="left" >
 <table   width="640px" cellspacing="0" cellpadding="0"  >
 <tr> 
                   <td align ="center" colspan="2" style ="border :solid 1px black;"><asp:Label ID="pagestatus" runat ="server"   CssClass="billstatusnew" ></asp:Label></td></tr>
...
<%--<td  valign ="top" rowspan ="4" align ="left" >
     <img src="Images/Prahaar.jpg" height ="50px" width ="80px" />
 </td>--%>
<td  style="border-left:solid 1px black" align="left"class ="newhead1"><label id="lbreg"  runat ="server">Regd.Off.:</label> </td> 
...
<td style="border-right:solid 1px black" align ="left" class="newhead"><asp:Label ID="lbhead2" runat ="server" CssClass="extrasizeclass" ></asp:Label></td>
 ...
 <td   style="border-left:solid 1px black;border-right:solid 1px black" colspan ="2" align ="center" ><asp:Label ID="Label4" runat ="server" class ="newhead1" >Tel No.:</asp:Label><asp:Label ID="Label1" runat ="server"  CssClass="agecnycodeclass" >40969999/</asp:Label><asp:Label ID="Label2" runat ="server" class ="newhead1">Fax No.:</asp:Label><asp:Label ID="Label3" runat ="server" CssClass="extrasizeclass">40969900</asp:Label></td>
	...
	<table border="1"  cellspacing="0" cellpadding="0"   class="table1"  width ="640px"  <%--style="left: 100px; position: absolute; top: 118px; width :675px"--%>  >
       <tr>
                ...
                <tr> <td><asp:Label CssClass="agecnycodeclass" ID="agddxt" runat ="server"></asp:Label><hr style="width:100%" /></td></tr>
       ...
       <tr>
        ...
        <tr>
                ...
                <td colspan ="2" align ="left">
                      ...
                      <asp:Label CssClass="schemeclass" ID="scheme" runat ="server"></asp:Label>
                </td>
       </tr>
       <tr>
                <td valign="top" align ="left" >
                ...
                <td colspan ="2" align ="left" style=" border-top-style:solid ; ">
                      ...
                      <asp:Label CssClass="adtypeclass"  ID="txtpan" runat ="server"></asp:Label>
                </td>
        </tr>
        <tr>
       ...
       <tr style=" border-top-width:thin; border-top-color:Gray ; border-top-style:solid">
        ...
        <%--<tr>
                       ...
                       <td  style=" height: 40px; width :60px;"  valign ="top" >
                                            ...
                                            <td valign="top" style=" height: 40px; width :60px;" > <asp:Label CssClass="positionclass" ID="lbra" runat ="server"></asp:Label>
             ...
             <table border="1"  cellspacing="0" cellpadding="0"    width ="638px"  <%--style="left: 100px; position: absolute; top: 330px;width :675px"--%> class="table1" >
               <tr >
                            <td valign="top"    align="left" colspan="8" class="amtxtclass"   id="tabledy" runat ="server" style ="width :640px;<%--height :300px;--%>" >
                            <asp:Label ID="dynamictable" runat="server" CssClass ="amtxtclass"  style ="width :640px;"></asp:Label>                       
                            </td>   
                       </tr>
                       
                       
                      <tr>
                         <td style="font-weight:bold;"  ><asp:Label CssClass="amount1class" ID="lbgross" runat ="server"></asp:Label></td>
                         <td style="width:170px" ><asp:Label CssClass="amount1class" ID="txtgross" runat ="server"></asp:Label></td>
                     </tr>
                     <tr>
                         <td style="font-weight:bold;"  ><asp:Label CssClass="amount1class" ID="lbcomm" runat ="server"></asp:Label></td>
                         <td ><asp:Label CssClass="amount1class" ID="txtcomm" runat ="server"></asp:Label></td>
                     </tr>
                        
                     <tr>
                        <td style="font-weight:bold;"><asp:Label CssClass="amount1class" ID="lbgr" runat ="server"></asp:Label></td>
                         <td ><asp:Label CssClass="amount1class" ID="txtgr" runat ="server"></asp:Label></td>
                     </tr>
                     <tr>
                         <td style="font-weight:bold;"><asp:Label CssClass="amount1class" ID="lbbox" runat ="server"></asp:Label></td>
                     ...
                     <tr>
                        <td style="font-weight:bold;"> <asp:Label CssClass="amount1class" ID="amtinwords" runat ="server">Rupees in Words:</asp:Label></td>
                         <td ><asp:Label CssClass="amount1class" ID="txtrupee" runat ="server"></asp:Label></td>
                     </tr>
               </table>      
       
     
      <table  border="1"  cellspacing="0" cellpadding="0"    width ="643px" class ="table1"  >
      <tr>
      <td align="left" style="height: 104px"> <asp:Label  ID="Label6" runat ="server" CssClass="newhead1" >Terms & Conditions</asp:Label><br />
      ...
      <td valign ="top" style="height: 104px" ><asp:Label  ID="Label7" runat ="server" CssClass="newhead1">FOR RANE PRAKASHAN PVT.LTD</asp:Label><br /><br /><br /><br />
