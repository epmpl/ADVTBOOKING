...
public partial class herald_bill : System.Web.UI.UserControl
{
    ...
    public void setcard()
    {
        ...
        ds_new.ReadXml(Server.MapPath("XML/herald_bill.xml"));
     //   line.Text = ds_new.Tables[0].Rows[0].ItemArray[16].ToString();

        lbcompanynametxt1.Text = ds_new.Tables[0].Rows[0].ItemArray[1].ToString();
        line1.Text = ds_new.Tables[0].Rows[0].ItemArray[2].ToString();
        line2.Text = ds_new.Tables[0].Rows[0].ItemArray[3].ToString();
        line3.Text = ds_new.Tables[0].Rows[0].ItemArray[4].ToString();
        lbl1.Text = ds_new.Tables[0].Rows[0].ItemArray[5].ToString();
        lbl2.Text = ds_new.Tables[0].Rows[0].ItemArray[6].ToString();
        lbl3.Text = ds_new.Tables[0].Rows[0].ItemArray[7].ToString();
        lbl4.Text = ds_new.Tables[0].Rows[0].ItemArray[8].ToString();
        lblcomp.Text = ds_new.Tables[0].Rows[0].ItemArray[9].ToString();
        lbladdres.Text = ds_new.Tables[0].Rows[0].ItemArray[10].ToString();
        lblcom.Text = ds_new.Tables[0].Rows[0].ItemArray[11].ToString();
        lblbill1.Text = ds_new.Tables[0].Rows[0].ItemArray[12].ToString();
        lblgrosss.Text = ds_new.Tables[0].Rows[0].ItemArray[13].ToString();
        lblless1.Text = ds_new.Tables[0].Rows[0].ItemArray[14].ToString();
        bllnet.Text = ds_new.Tables[0].Rows[0].ItemArray[15].ToString();
        lblvj.Text = ds_new.Tables[0].Rows[0].ItemArray[16].ToString();
        Label19.Text = ds_new.Tables[0].Rows[0].ItemArray[16].ToString();
        vjl13.Text = ds_new.Tables[0].Rows[0].ItemArray[17].ToString();
        vjl14.Text = ds_new.Tables[0].Rows[0].ItemArray[17].ToString();
        ...
        for (packlength = 0; packlength < c1; packlength++)
        {
            ...
            //Label22.Text = ds4.Tables[0].Rows[0]["trade_disc"].ToString();
            ...
            txtinvoice1.Text = invoiceno.ToString();
            ...
            for (packlength = 0; packlength < c1; packlength++)
            {
                ...
                dytbl += "<td   align=left class=display>" + ds4.Tables[0].Rows[0].ItemArray[28].ToString() + "</td>";
            ...
            lblgross2.Text = amt5.ToString();
            Label21.Text = amt5.ToString();
            traddis = amt5 * traddis / 100;
            lbltradedis.Text = traddis.ToString();
            lbltradedis1.Text = traddis.ToString();
            trdiscpercentage.Text = ds4.Tables[0].Rows[0]["trade_disc"].ToString();
            ...
            lblround1.Text = amountinckudingbox1.ToString();
            ...
            totalruptxt.Text = obj.changeNumericToWords(lb_totalamt.Text.ToString()) + "Only";
