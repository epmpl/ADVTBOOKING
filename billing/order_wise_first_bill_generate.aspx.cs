...
public partial class order_wise_first_bill_generate : System.Web.UI.Page
{
    string publication = "";
    ...
    private void BindinsertionWise(string ciobookid, int c4, string insertion, string agencycode, string frmdt, string dateto1, string client, string bill_date_re, string publicationcenter, string publicationcentername)
    {
        ...
        for (inew = 0; inew < c4; inew++)
        {
            ...
            {
                bill_generate_orderwisewise_first objcard = new bill_generate_orderwisewise_first();
                objcard = (bill_generate_orderwisewise_first)(Page.LoadControl("bill_generate_orderwisewise_first.ascx"));
