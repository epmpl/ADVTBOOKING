<%@ Control Language="C#" AutoEventWireup="true" CodeFile="sea_controlclassified_priv.ascx.cs" Inherits="sea_controlclassified_priv" %>
...
<table style="border-top:solid 1px black; width: 364px;" cellspacing="0" 
        cellpadding="0">
<tr >
<td align ="left" class="style18" ><b><asp:Label CssClass="agecnycodeclasspune" ID="Label1" runat ="server">Publication</asp:Label></b></td>
<td  align ="left" class="style22" ><asp:Label CssClass="insertiontxtclass2" ID="lblpubname" runat ="server"></asp:Label></td>
...
<td align ="left" class="style16"  ><b><asp:Label CssClass="agecnycodeclasspune" ID="lbadtype" runat ="server">Ad Type</asp:Label></b></td>
<td align ="left" class="style20"  ><asp:Label CssClass="dateclasspune" ID="adcat" runat ="server"></asp:Label></td>
...
<td align="left" class="style17"><b><asp:Label CssClass="agecnycodeclasspune" ID="lbpackagena" runat ="server">Tariff Plan/Package</asp:Label></b></td>
<td align ="left" class="style21"><asp:Label CssClass="dateclasspune" ID="txtpackname" runat ="server"></asp:Label></td>
...
<%--         border-top:solid 1px black;        <td align="left"><asp:Label ID="lbinwords" runat="server" CssClass ="agecnycodeclasspune" Text="In Words Rupees  :"></asp:Label></td>--%>
                 ...
                 <td width='56px'style="height: 12px;border-top:solid 1px black;border-left:solid 1px black;border-right:solid 1px black;  " align="center"  ><asp:Label ID="lb_total" runat="server" CssClass ="dateclasspune" ><b>Total:-</b></asp:Label></td>
...
--%>  <td align="center"  class="style10" ><asp:Label ID="Label9" runat ="server" CssClass="dateclasspune_uday" >Special Charges</asp:Label></td>
  <td align="center"  class="style13" ><asp:Label ID="Label10" runat ="server" CssClass="dateclasspune_uday" >Net Amount</asp:Label></td>
...
--%>  <td align='center' class="style11" ><asp:Label ID="lblextra" runat ="server" CssClass="dateclasspune" ></asp:Label></td>
  <td align='center' class="style14" ><asp:Label ID="lblnetamt" runat ="server" CssClass="dateclasspune"></asp:Label></td>
  <td align='center' class="display2" style="height: 13px;border-left:solid 1px black;" ><b><asp:Label ID="lblround" runat ="server" CssClass="dateclasspune"></asp:Label></b></td>
  </tr>
