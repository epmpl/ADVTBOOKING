...
public partial class seaexpressbill_print : System.Web.UI.UserControl
{
        ...
        for (packlength = 0; packlength < c1; packlength++)
        {
           ...
           // street = ds4.Tables[0].Rows[0]["street"].ToString();
            ...
            for (packlength = 0; packlength < c1; packlength++)
            {
                ...
                if (ds4.Tables[0].Rows[0]["Disc"].ToString() != "")
                    dytbl += "<td  align=center class=display>" + ds4.Tables[0].Rows[0]["Disc"].ToString() + "</td>";
                else
                    dytbl += "<td class=display align=center>---</td>";
