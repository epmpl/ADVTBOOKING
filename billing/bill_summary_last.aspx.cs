...
public partial class bill_summary_last : System.Web.UI.Page
{
    string client = "";
    string dtformat = "";
    string todate = "";
    ...
    private void onscreen( string  dtformat,string todate, string  fromdt, string pub, string bkcen,string  rev,string  agtype,string pckg, string adtyp, string ag, string client, string billstate, string rtaudit,string  blmod,string  blcycle, string comp_code , string userid )
    {
        ...
        else if (ConfigurationSettings.AppSettings["ConnectionType"].ToString() == "orcl")
        {
            ...
            //ds = abc.maxdatenew_summary(dtformat, todate, fromdt, pub, bkcen, rev, agtype, pckg, adtyp, ag, client, billstate, rtaudit, blmod, blcycle, Session["compcode"].ToString(), Session["userid"].ToString());

            ds = abc.websp_LAST_summary(dtformat, todate, fromdt, pub, bkcen, rev, agtype, pckg, adtyp, ag, client, billstate, rtaudit, blmod, Session["compcode"].ToString());
        ...
        //tbl = tbl + ("<tr><td class='middle31'>S.No.</td><td class='middle31'>BOOKING_ID</td><td class='middle31'>H</td><td class='middle31'>W</td><td class='middle31'>TotAr</td><td class='middle31'>RO.NO</td><td class='middle31'>Client Name</td><td class='middle31'>Agency Name</td><td class='middle31'>RoDt</td><td class='middle31'>City</td><td class='middle31'>AgreedAmt</td><td class='middle31'>Comm.</td><td class='middle31'>Boxch.</td><td class='middle31'>Spl.dis.</td><td class='middle31'>Gr.Amt</td><td class='middle31'>BillAmt</td><td class='middle31'>CardRt.</td></tr>");
        ...
        //    tbl = tbl + ("<td class='rep_data'>");
        //    tbl = tbl + (ds.Tables[0].Rows[i]["RO_NO_V"] + "</td>");
        ...
        //    tbl = tbl + ("<td class='rep_data'>");
        //    tbl = tbl + (ds.Tables[0].Rows[i]["CLIENT_NA_V"] + "</td>");

        //    tbl = tbl + ("<td class='rep_data'>");
        //    tbl = tbl + (ds.Tables[0].Rows[i]["AGENCY_V"] + "</td>");
        ...
        //    tbl = tbl + ("<td class='rep_data'>");
        //    tbl = tbl + (ds.Tables[0].Rows[i]["ADDRESS"] + "</td>");

        //    tbl = tbl + ("<td class='rep_data' align='right'>");
        //    tbl = tbl + (ds.Tables[0].Rows[i]["AGREEDAMT"] + "</td>");
        ...
        //    tbl = tbl + ("<td class='rep_data' align='right'>");
        //    tbl = tbl + (ds.Tables[0].Rows[i]["AGENCY_COMM"] + "</td>");

        //    tbl = tbl + ("<td class='rep_data' align='right' >");
        //    tbl = tbl + (ds.Tables[0].Rows[i]["BOXCHARGES"] + "</td>");



        //    tbl = tbl + ("<td class='rep_data' align='right'>");
        //    tbl = tbl + (ds.Tables[0].Rows[i]["GROSS_AMT"] + "</td>");
        //    tbl = tbl + ("<td class='rep_data' align='right'>");
        ...
        //    tbl = tbl + ("<td class='rep_data' align='right'>");
        //    tbl = tbl + (ds.Tables[0].Rows[i]["EXTRA_CHARGES"] + "</td>");
        ...
        //}
        //tbl = tbl + ("<tr >");
        //tbl = tbl + "<tr><td class='middle14' width='3px'>-</td><td class='middle14' width='3px'>-</td><td class='middle14' width='3px'>-</td><td class='middle14' width='3px'>-</td><td class='middle14' width='3px'>-</td><td class='middle14' width='3px'>-</td><td class='middle14' width='3px'>-</td><td class='middle14' width='3px'>-</td><td class='middle14' width='3px'>-</td><td class='middle14' width='3px'>-</td><td class='middle4' width='3px'>-</td><td class='middle14' width='3px'>-</td><td class='middle14' width='3px'>-</td><td class='middle14' width='3px'>-</td><td class='middle14' width='3px'>-</td><td class='middle14' width='3px'>-</td><td class='middle14' width='3px'>-</td><td class='middle14' width='3px'>-</td></tr>";
        //tbl = tbl + ("<tr >");
        //tbl = tbl + ("<td class='rep_data'>TotalAds:-</td>");
        //tbl = tbl + ("<td class='rep_data'>");
        ...
        tbl = tbl + ("<tr><td class='middle31'>S.No.</td><td class='middle31'>BOOKING_ID</td><td class='middle31'>H</td><td class='middle31'>W</td><td class='middle31'>Size</td><td class='middle31'>Rono</td><td class='middle31'>Agency</td><td class='middle31'>Client</td><td class='middle31'>Commission</td><td class='middle31'>premium</td><td class='middle31'>Spl.Dis</td><td class='middle31'>BoxCh.</td><td class='middle31'>BillStatus</td><td class='middle31'>GrossRate</td><td class='middle31'>BillAmt</td><td class='middle31'>Ag.Rt.</td><td class='middle31'>CardRt.</td><td class='middle31'>RoDt</td><td class='middle31'>SplDiscper</td></tr>");
        ...
        for (int i = 0; i <= cont - 1; i++)
        {
            ...
            tbl = tbl + ("<td class='rep_data'>");
            tbl = tbl + (ds.Tables[0].Rows[i]["Ad_size_height"] + "</td>");

            tbl = tbl + ("<td class='rep_data'>");
            tbl = tbl + (ds.Tables[0].Rows[i]["Ad_size_width"] + "</td>");
