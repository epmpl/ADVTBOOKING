<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RP_bill.ascx.cs" Inherits="RP_bill" %>
...
<td colspan="2"  align="left" style="display:none"><asp:Label CssClass="dateclasspune" ID="lblschemetype" runat ="server"></asp:Label></td>
</tr>
...
<table height="192px;" cellspacing="0" cellpadding="0" 
    ...
    <table cellpadding="0" cellspacing="0" style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; width: 898px; ">
    <tr>
    <td class="style4">
...
<tr><td style="border-right-style: solid; border-right-width: 1px; border-right-color: #000000;font-family: Verdana; font-size: 11px; color: #000000; font-weight: bold;" 
    ...
    NET PAYABLE</B></td><td></td><td class="style9"  align="right"><asp:Label ID="lbl_net" runat="server"></asp:Label></td></tr>
                            ...
                            <table cellpadding="0" cellspacing="0" class="style10" width="80%">
                                <tr>
