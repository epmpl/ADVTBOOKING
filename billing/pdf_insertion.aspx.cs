...
public partial class pdf_insertion : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        invoice_no = Request.QueryString["invoice2"].Trim().ToString();
        insertion = Request.QueryString["insertion"].Trim().ToString();
        editionbill = Request.QueryString["edition"].Trim().ToString();
        ...
        for (i3 = 0; i3 < count; i3++)
        {
            ...
            if (ConfigurationSettings.AppSettings["BILLING_FORMAT"].ToString() == "pratidin" && (Session["bill_cycle1"].ToString() == "2" || Session["bill_cycle1"].ToString() == "3" || Session["bill_cycle1"].ToString() == "4" || Session["bill_cycle1"].ToString() == "5"))
            {
                ...
                if (ConfigurationSettings.AppSettings["BILLING_FORMAT"].ToString() == "kannad")
                {
                    ...
                    kannad_prabha_pdf objcard = new kannad_prabha_pdf();
                    objcard = (kannad_prabha_pdf)(Page.LoadControl("kannad_prabha_pdf.ascx"));
