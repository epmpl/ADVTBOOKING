<%@ Page Language="C#" AutoEventWireup="true" CodeFile="monthly_wise_supp.aspx.cs" Inherits="monthly_wise_supp" %>
...
<link href="css/main.css" type="text/css" rel="stylesheet"/>
		...
		<link href="css/report.css" type="text/css" rel="stylesheet"/>
				...
				<script type="text/javascript"  language="javascript" src="javascript/entertotab.js"></script>
				  <script language="javascript" src="javascript/monthly_wise_supp.js" type="text/javascript"></script>
				 <%--
...
<body>
   ...
   <td>
     ...
     <ItemStyle HorizontalAlign="Center" ></ItemStyle>
      ...
      <asp:BoundColumn  HeaderText="r"  DataField="RETAINER_CODE1"   HeaderStyle-CssClass="DataGrid_new"    ReadOnly="True">
     <ItemStyle HorizontalAlign="Center"   CssClass="DataGrid_new" ></ItemStyle>
      <HeaderStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
         ...
         <asp:BoundColumn  HeaderText="h"   DataField="EXECUTIVE_CODE1"   HeaderStyle-CssClass="hiddencol"   ReadOnly="True">
     <ItemStyle HorizontalAlign="Center"  CssClass="DataGrid_new"  ></ItemStyle>
      <HeaderStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
         Font-Underline="False" ForeColor="White" HorizontalAlign="Center" />
          </asp:BoundColumn>
