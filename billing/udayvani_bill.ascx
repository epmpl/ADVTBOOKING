<%@ Control Language="C#" AutoEventWireup="true" CodeFile="udayvani_bill.ascx.cs" Inherits="udayvani_bill" %>
...
<table width="30px">
<tr>
<td  align="left" valign="top" ><img src="Images1/Manipal-Group-Logo-copy.jpg" alt="" height ="50px"/></td>
<td>
...
<td align="left" class="display1"><b><asp:Label CssClass="agecnycodeclasspune" ID="lbpackagena" runat ="server">RONo.</asp:Label></b></td>
...
--%>  <td  class="insertiontxtclass4" style="height: 13px;width:30px;" ><asp:Label ID="lblboxcr" runat ="server" CssClass="dateclasspune_uday" ></asp:Label></td>
  <td  class="insertiontxtclass4" style="height: 13px" ><asp:Label ID="lblnetamt1" runat ="server" CssClass="dateclasspune_uday" ></asp:Label></td>
