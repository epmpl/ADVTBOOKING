...
public partial class bill_generate_orderwisewise_first : System.Web.UI.UserControl
{public string _agency;
    ...
    public bill_generate_orderwisewise_first()
    {
    ...
    public void setcardlastnew()
    {
        ...
        string adtype = porderno.Substring(0, 2);
        string pinsertion_no = insertion;
        string pbill_cycle = Session["blcycle"].ToString();
        string puserid = "";
        ...
        string pnoofinsert = "";
        string pprefix = adtype+"/"+publicationcenter;
        string pextra1 = "";
        string pextra2 = "";
        string pextra3 = "";
        string pextra4 = "";
        ...
        if (ConfigurationSettings.AppSettings["ConnectionType"].ToString() == "orcl")
        {
            ...
            result = objbkcenter.bill_save_data_orderwisefirst(pcompcode, pcenter, porderno, pinsertion_no, pbill_cycle, puserid, pfrom_date, ptill_date, pbill_date, pdateformat, pnoofinsert, pprefix, pextra1, pextra2, pextra3, pextra4, pextra5);
        }
        else
        {
