<%@ Page Language="C#" AutoEventWireup="true" CodeFile="deviationpop.aspx.cs" Inherits="deviationpop" %>
...
//						var h="y";
//						//alert('zsx')
//						x_win.location.href="Deviationview.aspxx?adtype=" + $('dpdadtype').value + "&fromdate=" + $('txtfrmdate').value + "&dateto=" + $('txttodate1').value + "&publication=" + $('dppub1').value + "&pubcenter=" + $('pubcent').value + "&edition=" + $('dpedition').value + "&package=" + $('dppackage').value + "&client=" + $('dpclient').value + "&agency=" + $('dpagency').value + "&drilout=" + "yes" + "&destination=" + "1";
...
//		{
//	
//			window.location.href="Deviationview.aspx?adtype=" + $('dpdadtype').value + "&fromdate=" + $('txtfrmdate').value + "&dateto=" + $('txttodate1').value + "&publication=" + $('dppub1').value + "&pubcenter=" + $('pubcent').value + "&edition=" + $('dpedition').value + "&package=" + $('dppackage').value + "&client=" + $('dpclient').value + "&agency=" + $('dpagency').value + "&drilout=" + "yes" + "&destination=" + "1";
//			//window.open("epapermain.aspx?queryed="+a+"&getda=h&eddate="+b);
//		}
//	}
//	catch(e)
														...
														<td style="HEIGHT: 25px" align="left">
                                                            <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                                                <ContentTemplate>
                                                                    ...
                                                                    <%--<img src='Images/cal1.gif'  onclick='popUpCalendar(this, status1.txtfrmdate, "mm/dd/yyyy")' onfocus="abc();" height=14 width=14/>--%>
                                                                </ContentTemplate>
                                                            </asp:UpdatePanel>
                                                        </td>
														...
														<td style="HEIGHT: 25px" align="left">
                                                            <asp:UpdatePanel ID="UpdatePanel7" runat="server">
                                                                <ContentTemplate>
                                                                    ...
                                                                    <%--<img src='Images/cal1.gif'  onclick='popUpCalendar(this, status1.txttodate1, "mm/dd/yyyy")' onfocus="abc();" height=14 width=14/>--%>
                                                                </ContentTemplate>
                                                            </asp:UpdatePanel>
                                                        </td>
