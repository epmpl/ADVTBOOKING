...
public partial class statuspop : System.Web.UI.Page
{
    string fromdate = "";
    string dateto = "";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        heading.Text = ds.Tables[0].Rows[0].ItemArray[48].ToString();
       ...
       // lbcity.Text = ds.Tables[0].Rows[0].ItemArray[53].ToString();
        ...
        if (!Page.IsPostBack)
        {
           ...
           // bindregion();
            ...
            binddest();
            bindstatus();
            BtnRun.Attributes.Add("onclick", "drill_outstatus();");
    ...
    protected void dpdadtype_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        ScriptManager.RegisterClientScriptBlock(this, typeof(statuspop), "sa", "document.getElementById('dpdadtype').focus();", true);
    }
    ...
    protected void DropDownList1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        ScriptManager.RegisterClientScriptBlock(this, typeof(statuspop), "sa", "document.getElementById('dppubcent').focus();", true);
    }
    protected void dppub1_SelectedIndexChanged2(object sender, EventArgs e)
    {
        ...
        ScriptManager.RegisterClientScriptBlock(this, typeof(statuspop), "sa", "document.getElementById('dppub1').focus();", true);
    }
}
