...
public partial class alagency : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
       ...
       // lbcity.Text = ds.Tables[0].Rows[0].ItemArray[53].ToString();
        ...
        heading.Text = ds.Tables[0].Rows[0].ItemArray[47].ToString();
        ...
        if (!Page.IsPostBack)
        {
           ...
           // bindregion();
            ...
            BtnRun.Attributes.Add("onclick", "drill_outagency();");
            Btnreset.Attributes.Add("onclick", "javascript:return agencyreset();");
    ...
    protected void dpdadtype_SelectedIndexChanged(object sender, EventArgs e)
    {
      ...
      //  ScriptManager.RegisterClientScriptBlock(this, typeof(alagency), "sa", "document.getElementById('dpdadtype').focus();", true);
    }
    ...
    protected void DropDownList1_SelectedIndexChanged(object sender, EventArgs e)
    {
       ...
       // ScriptManager.RegisterClientScriptBlock(this, typeof(alagency), "sa", "document.getElementById('pubcent').focus();", true);
    }
    protected void dppub1_SelectedIndexChanged2(object sender, EventArgs e)
    {
      ...
      //  ScriptManager.RegisterClientScriptBlock(this, typeof(alagency), "sa", "document.getElementById('dppub1').focus();", true);
    }
}
