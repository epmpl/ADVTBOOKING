...
public partial class valuereportview2 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
       ...
       // lbproduct.Text = ds.Tables[0].Rows[0].ItemArray[37].ToString();
        heading.Text = ds.Tables[0].Rows[0].ItemArray[36].ToString();
        ...
        if (!IsPostBack)
        {
           ...
           // bindcategory();
            ...
            Btnreset.Attributes .Add ("onclick","javascript:return valuereport();");
