<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Deviationreport.aspx.cs" Inherits="Devationreport" %>
...
<body onkeydown="javascript:return tabvalue();"onload="document.getElementById('dpagencycli').focus();" >
												...
												<tr>
													<td align="left"><asp:Label id="lbadcatgory" runat="server" CssClass="TextField" ></asp:Label></td>
														<td align="left"><asp:UpdatePanel ID="UpdatePanel2" runat="server" >
                                                                <ContentTemplate>
                                                                    <asp:ListBox id="dpadcatgory" runat="server" CssClass="btext1" Height ="66px" SelectionMode="Multiple" Width="144px" OnSelectedIndexChanged="dpadcatgory_SelectedIndexChanged1">
													...
													<tr>
														...
														<td align="left"><asp:UpdatePanel ID="UpdatePanel10" runat="server">
                                                                <ContentTemplate>
                                                                    <asp:DropDownList CssClass="dropdown" id="dpagencyna" runat="server"></asp:DropDownList>
                                                                </ContentTemplate>
                                                            </asp:UpdatePanel>
                                                        </td>
