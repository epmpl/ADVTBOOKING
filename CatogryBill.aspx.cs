...
public partial class CatogryBill : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        heading.Text = ds.Tables[0].Rows[0].ItemArray[31].ToString();
        lbdestination.Text = ds.Tables[0].Rows[0].ItemArray[14].ToString();
        agencytype.Text = ds.Tables[0].Rows[0].ItemArray[36].ToString();
