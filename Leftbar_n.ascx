<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Leftbar_n.ascx.cs" Inherits="Leftbar_n" %>

<table border="0" cellpadding="0" cellspacing="0" >
    <tr valign="top" style="height:35px">
        <td valign="baseline" colspan="3">
            <div id="tP1" runat="server" class="topbarclock1"><asp:Label id="lbrelease" runat="server"></asp:Label></div>
        </td>
    </tr>
   <%--<tr>
    <td>
