   ...
   if(browser=="Microsoft Internet Explorer")
     {
        ...
        //tls.disabled=true;
        toolsT.disabled=true;
        fnttlbrT.disabled=true;
        stntlbrT.disabled=true;
        toolsB.disabled=true;
        tagsT.disabled=true;
        txtproT.disabled=true;
        document.getElementById('picproT').disabled=true;
        settingmnu.disabled=true;
        //createAd.disabled=true;
        saveAd.disabled=true;
        //ajay saveAdas.disabled=true;
...
//      document.getElementById('redo').src="icons/redo_d.jpg"; 
        ...
        /* the status bar*/
// ajay        document.getElementById('rightpaste').disabled=true;
...
//ajay  document.getElementById('saveAdas').onclick=ignoreClick;
//ajay  document.getElementById('saveAdas').style.cursor="text";
     ...
     if(browser!="Microsoft Internet Explorer")
      {
        ...
        txtproT.getElementById('editordiv').disabled=false;
         //editordiv.disabled=true;
         ////alert('abbn');
...
//        document.getElementById('fonttoolbar_fntname').disabled=false;
    ...
    else if(browser=="Microsoft Internet Explorer")
        {
          ...
          document.getElementById('printT').disabled=false;
          document.getElementById('cutT').disabled=false;
          document.getElementById('copyT').disabled=false;
          //ajay  document.getElementById('checktemplate').disabled=false;
        ...
        document.getElementById('rotateT').disabled=false;
        //document.getElementById('stretchT').disabled=false;
        document.getElementById('textboxT').disabled=false;
        document.getElementById('picboxT').disabled=false;
        document.getElementById('tagsT').disabled=false;
        document.getElementById('txtproT').disabled=false;
        document.getElementById('picproT').disabled=false;
        document.getElementById('txtproT').disabled=false;
        toolsT.disabled=false;
        fnttlbrT.disabled=false;
        stntlbrT.disabled=false;
        toolsB.disabled=false;
 ...
 //       document.getElementById('deletes').src="icons/delete_d.jpg"; 
        ...
        /*opener.*/document.getElementById('deleteT').disabled=false;
                   ...
                   document.getElementById('deletes').disabled=false;
 ...
 function template_ads()
  {
        ...
        if(ad_template==1)
         {
            ...
            //ajay document.getElementById('saveAdas').disabled=false;
      ...
      else if(ad_template==0)
      {
        ...
        //ajay document.getElementById('saveAdas').disabled=true;
     ...
     if(ad_template==1)
      {
          ...
          document.getElementById('saveAd').onclick=null;
          document.getElementById('saveAd').style.cursor="pointer";
//ajay    document.getElementById('saveAdas').onclick=null;
//ajay    document.getElementById('saveAdas').style.cursor="pointer";
   ...
   if(obj.id=="outer")
        {
            ...
            document.getElementById('rotateT').disabled=true;
            ...
            document.getElementById('cutT').disabled=true;
            document.getElementById('copyT').disabled=true;
            document.getElementById('pasteT').disabled=true;
            document.getElementById('rotateT').disabled=true;
         }
     else
       {
       ...
       {        
        ...
        else if(splitevalu[0].indexOf("Txt")>=0 || splitevalu[0].indexOf("leftD")>=0)
            {
              fonttoolbarenabled();
              document.getElementById('linedialog').style.display='none';
              document.getElementById('picdialog').style.display='none';
...
function alignText()
  {
    if(document.getElementById('myhdnval').value==null || document.getElementById('myhdnval').value=='editordiv' || document.getElementById('myhdnval').value=="")
      {
   ...
   if(document.all)
    {
        ...
        document.getElementById('txtlinespacing').style.lineHeight = val;
        return false;
    ...
    if(saveme1 && !saveme1.closed){saveme1.focus();}
    else
       {
          ...
          if(ht1=="")
            ...
            {
              //ajay if(CheckTemplate("save")=="true")
              //ajay  {
              //CheckAd();
    ...
    if(document.all)
        {
            ...
            //opener.document.getElementById('txtbillwidth').value=opener.document.getElementById('txtadsize2').value;
            //opener.document.getElementById('txtbillheight').value=opener.document.getElementById('txtadsize1').value;
...
function call_adreferrence1(response)
 {
   if(document.all)
    {
        var ds=response.value;
        var abc=ds.Tables[0].Rows[0].ad_xhtml;
        var uom2=ds.Tables[0].Rows[0].ad_uom;
        var id=ds.Tables[0].Rows[0].ad_id;
        document.getElementById('temp_id').value="";
        document.getElementById('temp_id').value=id;
        document.getElementById('fetchid1').value=1;
        document.getElementById('sav').value="";
        document.getElementById('sav').value=2;
        document.getElementById('selected_name').value= ds.Tables[0].Rows[0].name;
        var count=abc.split("</DIV>");
        document.getElementById('ctrval').value = count.length;
        enabled();
     ...
     //  document.getElementById('ad_height').value=100;
     //  document.getElementById('ad_width').value=100;  
...
//                    left = left.replace("px","");
            ...
            //
               ...
               if(document.getElementById('fetchid').value == "" || document.getElementById('fetchid').value !== "")
              {
               var ajay;
              ajay=document.getElementById('selected_name').value;
              //var ankur;
          ...
          if(opener.document.getElementById('myhdnval').value=="")
           {
            ...
            {
                var myresult="";
         /*ajay18/01/2011       opener.document.getElementById(currentid).style.paddingTop = top;
                opener.document.getElementById(currentid).style.paddingLeft = left;
                opener.document.getElementById(currentid).style.paddingRight = rght;
                opener.document.getElementById(currentid).style.paddingBottom = btm;
                ...
                //alert(theImg.width)
                //alert(theImg.height)
                //myresult=('<div id ="imagetest"><img src='+source1+' id="image1" border='+imgborder+'/></div>');myhdnval*/
                opener.document.getElementById(opener.document.getElementById('myhdnval').value).style.paddingTop = top;
                opener.document.getElementById(opener.document.getElementById('myhdnval').value).style.paddingLeft = left;
                opener.document.getElementById(opener.document.getElementById('myhdnval').value).style.paddingRight = rght;
                opener.document.getElementById(opener.document.getElementById('myhdnval').value).style.paddingBottom = btm;
...
function numeric(e)
			{
			   ...
			   if(document.getElementById('input_hght').value.indexOf("..")>=0)
			    {
			      alert('Please enter The Correct value');
			      document.getElementById('input_hght').value=document.getElementById('input_hght').value.substring(0,document.getElementById('input_hght').value.length-1);
				  return false;
			    }
			    if(document.getElementById('input_wdth').value.indexOf("..")>=0)
			    {
			      alert('Please enter The Correct value');
			      document.getElementById('input_wdth').value=document.getElementById('input_wdth').value.substring(0,document.getElementById('input_wdth').value.length-1);
				  return false;
			    }
			    
			    if(document.getElementById('input_hghtP').value.indexOf("..")>=0)
			    {
			      alert('Please enter The Correct value');
			      document.getElementById('input_hghtP').value=document.getElementById('input_hghtP').value.substring(0,document.getElementById('input_hghtP').value.length-1);
				  return false;
			    }
			    
			   if(document.getElementById('input_wdthP').value.indexOf("..")>=0)
			    {
			      alert('Please enter The Correct value');
			      document.getElementById('input_wdthP').value=document.getElementById('input_wdthP').value.substring(0,document.getElementById('input_wdthP').value.length-1);
				  return false;
			    }
			    
			    if(document.getElementById('input_hghtL').value.indexOf("..")>=0)
			    {
			      alert('Please enter The Correct value');
			      document.getElementById('input_hghtL').value=document.getElementById('input_hghtL').value.substring(0,document.getElementById('input_hghtL').value.length-1);
				  return false;
			    }
			    
			    if(document.getElementById('input_wdthL').value.indexOf("..")>=0)
			    {
			      alert('Please enter The Correct value');
			      document.getElementById('input_wdthL').value=document.getElementById('input_wdthL').value.substring(0,document.getElementById('input_wdthL').value.length-1);
				  return false;
			    }
     ...
     if(document.getElementById('myhdnval').value=="" || document.getElementById('myhdnval').value==null)
      {
      ...
      else
        {
         ...
         //if(xright>parseInt(document.getElementById('myhdnval').offsetWidth+document.getElementById('myhdnval').offsetLeft))
           {
              ...
              //document.getElementById(document.getElementById('myhdnval').value).style.pixelLeft=parseInt(document.getElementById('myhdnval').offsetWidth+document.getElementById('myhdnval').offsetLeft)-parseInt(document.getElementById(document.getElementById('myhdnval').value).offsetWidth);
              //document.getElementById(document.getElementById('myhdnval').value).style.pixelTop="16";
...
function changeH_L()
  {
    ...
    /*   else
       {
         if(document.getElementById(document.getElementById('myhdnval').value)==null)
       } 
       alert('Item not Exist ?');*/
       else
       {
...
function getdimsT()
 {
   if(document.getElementById('myhdnval').value==null && document.getElementById('myhdnval').value=="" && document.getElementById('myhdnval').value=="outer" )
    {
       alert("Please Select The TextBox")
    }
   else
    {
      try
          ...
          if(document.getElementById('editordiv').childNodes[0].id=="outer")
            {
              if(document.getElementById('ad_height').value!="")
                {
                 if(document.getElementById('sel_unit_disp').value=="Pixel")
                    {
                        unit =1;
                    }
                    if(document.getElementById('sel_unit_disp').value=="Inches")
                        {
                           unit =2;
                        }
                  ...
                  document.getElementById(document.getElementById('myhdnval').childNodes[0].id).style.height=r_conversion(document.getElementById('ad_height').value,unit);
                  document.getElementById(document.getElementById('myhdnval').childNodes[0].id).style.width=r_conversion(document.getElementById('ad_width').value,unit);
                 return;
                 }       
...
if(document.getElementById('myhdnval').value=="outer" || document.getElementById('myhdnval').value=="outer")
       {
         alert('Please Select textbox !');
       }
        else
         {
        try{
...
function openpicdialog()
 {
    if(document.getElementById('myhdnval').value=="outer" || document.getElementById('myhdnval').value=="outer")
       {
         alert('Please Select picturebox !');
       }
        else
         {
        ...
        try{
            ...
            {  
                var ht1=document.getElementById('editordiv').innerHTML;   
                //var ht1=document.getElementById('myhdnval').innerHTML;   
                //alert(ht1);        
 ...
 function rotatedialog()
 {
  ...
  if(browser=="Microsoft Internet explorer")
  {
   ...
   /*  if(document.getElementById('myhdnval').value==null || document.getElementById('myhdnval').value=='editordiv' || document.getElementById('myhdnval').value=="" )
     {
      alert('Template can not be Rotate');
     }
...
if(document.getElementById('input_hght').value.indexOf("..")>=0)
 ...
 if(document.getElementById('myhdnval').value==null || document.getElementById('myhdnval').value=='editordiv' || document.getElementById('myhdnval').value=="")
    ...
    else
    {
      ...
      {
        document.getElementById(document.getElementById('myhdnval').value).style.height=temp+"px";
        if(document.getElementById(document.getElementById('myhdnval').value))
        {
          document.getElementById(document.getElementById('myhdnval').value).style.height=document.getElementById(document.getElementById('myhdnval').value).style.height;
        }
...
function changeW()
{
   ...
   /*     if(unit==1)
        {
          // ajay document.getElementById(document.getElementById('myhdnval').value).style.width=temp+"px";
          document.getElementById('selectedwidth').value=conversion(document.getElementById(document.getElementById('myhdnval').value).style.width.replace("px",""),unit);
        }
        if(unit==2)
        {
          // ajay document.getElementById(document.getElementById('myhdnval').value).style.width=temp+"in";
          document.getElementById('selectedwidth').value=conversion(document.getElementById(document.getElementById('myhdnval').value).style.width.replace("in",""),unit);
        }
        if(unit==3)
        {
          // ajay document.getElementById(document.getElementById('myhdnval').value).style.width=temp+"cm";
          document.getElementById('selectedwidth').value=conversion(document.getElementById(document.getElementById('myhdnval').value).style.width.replace("cm",""),unit);
        }
        if(unit==4)
        {
          // ajay document.getElementById(document.getElementById('myhdnval').value).style.width=temp+"mm";
          document.getElementById('selectedwidth').value=conversion(document.getElementById(document.getElementById('myhdnval').value).style.width.replace("mm",""),unit);
        }*/
   }
 //}       
...
if(document.all)
{
  ...
  else
  {
    ...
    if(document.getElementById('myhdnval').value==null || document.getElementById('myhdnval').value=='editordiv' || document.getElementById('myhdnval').value==""){alert('Please Select Item !');}
     else
      {
           ...
           // alert('ev.keyCode');
            if(ev.keyCode==undefined)
            {
                ...
                { 
                 ...
                 document.getElementById('hghtsel').value="";
                 document.getElementById('wdthsel').value=""; 
                 //document.getElementById('fntname').disabled=false;
     ...
     if(document.getElementById('outer').value=="")
     ...
     else if(browser=="Microsoft Internet Explorer")  
      {
	     ...
	     if(obj1.type=="Text")
         {
           ...
           // ajay document.getElementById('rightpaste').disabled=false;
    ...
    try
    {
        ...
        else
        {
            ...
            if(src!="")
             ...
             else alert("No Image available to Crop!!");
         }
         //else alert("No picture available to Crop ?");
     }
    catch(er){} 
