...
public partial class EditionStatus : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        Response.Expires = -1;
        Ajax.Utility.RegisterTypeForAjax(typeof(EditionStatus));
    ...
    [Ajax.AjaxMethod]
    public void savePackageStatus(string compcode, string userid, string ad_type, string pkgcode, string pkgstatus, string editionname)
    {
        if (ConfigurationSettings.AppSettings["ConnectionType"].ToString() == "sql")
        {
            NewAdbooking.Classes.Contract objpackagestatus = new NewAdbooking.Classes.Contract();
            objpackagestatus.clspackagestatus(compcode, userid, ad_type, pkgcode, pkgstatus);
        }
        else if (ConfigurationSettings.AppSettings["ConnectionType"].ToString() == "orcl")
        {
            NewAdbooking.classesoracle.Contract objpackagestatus = new NewAdbooking.classesoracle.Contract();
            objpackagestatus.clspackagestatus( compcode,  userid,  ad_type,  pkgcode,  pkgstatus, editionname);
        }
        else
        {
            NewAdbooking.classmysql.Contract objpakagestatus = new NewAdbooking.classmysql.Contract();
            objpakagestatus.clspackagestatus(compcode, userid, ad_type, pkgcode, pkgstatus);
        }
    }

    [Ajax.AjaxMethod]
    public void modifyPackageStatus(string compcode, string ad_type, string pkgcode, string pkgstatus, string recordid, string editionname)
    {
        if (ConfigurationSettings.AppSettings["ConnectionType"].ToString() == "sql")
        {
            NewAdbooking.Classes.Contract objpackagestatus = new NewAdbooking.Classes.Contract();
            objpackagestatus.clsmodifypackagestatus(compcode, ad_type, pkgcode, pkgstatus, recordid);
        }
        else if (ConfigurationSettings.AppSettings["ConnectionType"].ToString() == "orcl")
        {
            NewAdbooking.classesoracle.Contract objpackagestatus = new NewAdbooking.classesoracle.Contract();
            objpackagestatus.clsmodifypackagestatus( compcode,  ad_type,  pkgcode,  pkgstatus,  recordid,  editionname);
        }
        else
        {
    ...
    public void deletePackageStatus(string compcode, string adtype, string pkgcode)
    {
     ...
     [Ajax.AjaxMethod]
    public DataSet ExistingPkgStatus(string compcode,string adtype,string pkgcode)
    {
        DataSet ds = new DataSet();
        if (ConfigurationSettings.AppSettings["ConnectionType"].ToString() == "sql")
        {
            NewAdbooking.Classes.Contract objexistpackage = new NewAdbooking.Classes.Contract();
            ds = objexistpackage.clsexistpackagestatus(compcode, adtype, pkgcode); 
        }
        else if (ConfigurationSettings.AppSettings["ConnectionType"].ToString() == "orcl")
        {
            NewAdbooking.classesoracle.Contract objexistpackage = new NewAdbooking.classesoracle.Contract();
            ds = objexistpackage.clsexistpackagestatus(compcode, adtype, pkgcode);
        }
        else
        {
    ...
    [Ajax.AjaxMethod]
    public DataSet bindEntry(string compcode,string adtype,string pkgcode,string pkgstatus)
    {
        DataSet ds = new DataSet();
        if (ConfigurationSettings.AppSettings["ConnectionType"].ToString() == "sql")
        {
            NewAdbooking.Classes.Contract objbind = new NewAdbooking.Classes.Contract();
            ds = objbind.clsbindEntry(compcode, adtype, pkgcode, pkgstatus);
        }
        else if (ConfigurationSettings.AppSettings["ConnectionType"].ToString() == "orcl")
        {
            NewAdbooking.classesoracle.Contract objbind = new NewAdbooking.classesoracle.Contract();
            ds = objbind.clsbindEntry(compcode, adtype, pkgcode, pkgstatus);
        }
        else
        {
