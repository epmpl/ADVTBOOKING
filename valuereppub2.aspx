<%@ Page Language="C#" AutoEventWireup="true" CodeFile="valuereppub2.aspx.cs" Inherits="valuereppub2" %>
...
//          }
		    ...
		    try
	{
		...
		else
		{
			...
			window.location.href="valuereppubview.aspx?fromdate=" + $('txtfrmdate').value + "&todate=" +$('txttodate1').value  + "&region=" + $('dpregion').value +  "&agency=" +$('dpagency').value  + "&client=" + $('dpclient').value + "&publication=" + $('dppub').value + "&adtype=" + $('dpadtype').value + "&payment=" + $('dppayment').value + "&billstatus=" + $('dpbillstatus').value + "&drilout=" + "yes" + "&destination=" + $('Txtdest').value+ $('Txtdest').value+ "&sortorder=" + $('txtpdfsort').value + "&sortvalue=" + $('txtpdfsortvalue').value+ "&myrange=" + myrange +"&userrange="+ userrange;
			//window.open("epapermain.aspx?queryed="+a+"&getda=h&eddate="+b);
		}
	}
	catch(e)
...
<body>
    <form id="valurreppub2" runat="server">
														...
														<td  align="left">
                                                            <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                                                <ContentTemplate>
                                                                    ...
                                                                    <img src='Images/cal1.gif'  onclick='popUpCalendar(this, valurreppub2.txtfrmdate, "mm/dd/yyyy")' onfocus="abc();" height=14 width=14/>
                                                                </ContentTemplate>
                                                            </asp:UpdatePanel>
                                                        </td>
														...
														<td  align="left">
                                                            <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                                                <ContentTemplate>
                                                                    ...
                                                                    <img src='Images/cal1.gif'  onclick='popUpCalendar(this, valurreppub2.txttodate1, "mm/dd/yyyy")' onfocus="abc();" height="14" width="14"/>
                                                                </ContentTemplate>
                                                            </asp:UpdatePanel>
                                                        </td>
