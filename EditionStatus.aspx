<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditionStatus.aspx.cs" Inherits="EditionStatus" enableEventValidation="false" %>
...
<HEAD>
		...
		<script language="javascript" src="javascript/EditionStatus.js"></script>		
	...
	<body leftMargin="5" topmargin="0"  id="bdy" onload="javascript:return clearedition();" onkeydown="javascript:return tabvalue(event,'drpStatus');" style="background-color:#f3f6fd;"> 
		<form id="Form1" method="post" runat="server">
			eedi<table id="OuterTable" width="980" border="0" cellpadding="0" cellspacing="0">
				<tr valign="top">
			...
			<table border="0" cellpadding="0" cellspacing="0" width=100% style="width:auto;margin:15px 40px;">
                  <tr>
                     ...
                     <td style="width:135PX;font-family:Verdana;text-align:right;font-size:10px;background-color:#a0bfeb; height:20px;"><b><center>Edition/Package Status</center></b></td>
			...
			<table cellpadding="0" cellspacing="0" style="width:auto;margin:40px 200px;">
				<TR>
					<TD><asp:Label id="AdType" runat="server" CssClass="TextField"></asp:Label></TD>
					<TD><asp:DropDownList id="drpadtype" runat="server" CssClass="btext"></asp:DropDownList></TD>
				</TR>
				<TR>
