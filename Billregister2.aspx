<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Billregister2.aspx.cs" Inherits="Billregister2" %>
...
<body>
    <form id="billregister2" runat="server">
					...
					<td width="100%" bordercolor="#1"><img src="images/top.jpg" width="500" border="0" /></td>
                        ...
                        <input id="hiddendateformat" type="hidden" runat="server" /></td>
                         <td><input id="hiddendateformat1" type="hidden" runat="server" /></td>
                           <td><input id="hiddendateformat2" type="hidden" runat="server" />
