        ...
        <script type="text/javascript"  language="javascript" src="javascript/insertion.js"></script>
...
<tr>
        ...
        <ContentTemplate>--%>
            <asp:DropDownList id="dpprintcenter" runat="server" CssClass="dropdown" ></asp:DropDownList>
        <%--</ContentTemplate>
        </asp:UpdatePanel>--%>
        </td>
        ...
        <td align="left"><%--<asp:UpdatePanel ID="UpdatePanel13" runat="server" >
        <ContentTemplate>--%>
            <asp:TextBox id="txtdistrict" runat="server" CssClass="btext1" Visible="true"></asp:TextBox>
        <%-- </ContentTemplate>
        </asp:UpdatePanel>--%>
        </td>
        </tr>   
