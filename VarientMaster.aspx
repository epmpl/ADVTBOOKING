<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VarientMaster.aspx.cs" Inherits="VarientMaster" %>
...
<head runat="server">
    ...
    <script type="text/javascript"  language="javascript" src="javascript/VarientMaster.js"></script>
    	<script language="javascript" type="text/javascript" src="javascript/permission.js"></script>
				<script type="text/javascript"language="javascript" src="javascript/Validations.js"></script>
			
</head>
<body ID ="bdy" onload="javascript:return clearvarient();"  onkeydown="javascript:return tabvalue(event,'txtvarientalias');" onkeypress="eventcalling(event);"style="background-color:#f3f6fd;">
    <form id="form1" runat="server" >
    <table id="OuterTable" width="1000" border="0" cellpadding="0" cellspacing="0">
				<tr valign="top">
					<td colspan="2"><uc1:topbar id="Topbar1" runat="server" Text="Variant Master"></uc1:topbar></td>
				</tr>
				<tr valign="top">
					...
					<td> <asp:UpdatePanel ID="UpdatePanel1" runat="server"><ContentTemplate>
						...
						<table border="0" cellpadding="0" cellspacing="0" width="100%" style="width:auto;margin:15px 30px;">
                  <tr>
				     <td style="width:27px;"></td>
                     <td style="background-image:url(images/corner-left.jpg);width:11px; background-position:right center; background-repeat:no-repeat; height:20px;"></td>
                     <td style="width:135PX;font-family:Verdana;text-align:right;font-size:10px;background-color:#a0bfeb; height:20px;"><b><center>Varient Master</center></b></td>
					 ...
					 <td style="width:770px"><table cellpadding="0" cellspacing="0"><tr><td style="background-color:#a0bfeb;width:770px; height:3px;"></td></tr></table></td>
						...
						<table  align="center" style="width:auto;margin:30px 170px;" cellpadding="0" cellspacing="0" border="0">
				        <tr>
				           <td><asp:Label ID ="lbbrandcode" runat ="server" CssClass ="TextField"></asp:Label></td>
				           <td><asp:UpdatePanel ID="Update1" runat ="server"><ContentTemplate><asp:DropDownList ID="drpbrand" runat="server" CssClass="dropdown" OnSelectedIndexChanged="drpproduct_SelectedIndexChanged"></asp:DropDownList></ContentTemplate></asp:UpdatePanel></td>
				        
				        </tr>
				        <tr>
				          <td><asp:Label ID="lbvarientcode" runat ="server" CssClass ="TextField"></asp:Label> </td>
				          <td><asp:UpdatePanel ID="Update2" runat ="server" ><ContentTemplate><asp:TextBox onkeypress="return ClientSpecialchar(event);" ID="txtvarientcode" runat="server" CssClass="btext1" MaxLength="8"></asp:TextBox></ContentTemplate></asp:UpdatePanel></td>
				        
				        </tr>
				        <tr>
				           <td><asp:Label ID="lbvarientname" runat ="server" CssClass="TextField"></asp:Label> </td>
				           <td><asp:UpdatePanel ID ="Update3" runat="server"><ContentTemplate><asp:TextBox onkeypress="return ClientSpecialchar(event);" ID="txtvarientname" runat="server" CssClass ="btext" MaxLength="30"></asp:TextBox></ContentTemplate></asp:UpdatePanel></td>
				        
				        </tr>
				        <tr>
				          <td><asp:Label ID="lbvarientalias" runat ="server" CssClass="TextField"></asp:Label></td>
				          <td><asp:UpdatePanel ID="Update4" runat="server"><ContentTemplate><asp:TextBox onkeypress="return ClientSpecialchar(event);" ID ="txtvarientalias" runat="server" CssClass="btext" MaxLength="30"></asp:TextBox></ContentTemplate></asp:UpdatePanel></td>
			...
			<asp:UpdatePanel ID="update11" runat="server"><ContentTemplate><input id="hiddenmodtxt" type="hidden" runat="server" /></ContentTemplate></asp:UpdatePanel>
			...
			<asp:UpdatePanel ID="UpdatePanel2" runat="server"><ContentTemplate><input id="heddentext" type="hidden" runat ="server" /></ContentTemplate></asp:UpdatePanel> 
