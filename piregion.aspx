<%@ Page Language="C#" AutoEventWireup="true" CodeFile="piregion.aspx.cs" Inherits="piregion" %>
...
<body onload="document.getElementById('txtfrmdate').focus();">
    <form id="regionreport" runat="server">
													...
													<tr>
														...
														<td  align="left">
                                                            <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                                                <ContentTemplate>
                                                                    <asp:TextBox id="txtfrmdate" runat="server" CssClass="btext1" MaxLength="12" ></asp:TextBox>
                                                                    <img src='Images/cal1.gif'  onclick='popUpCalendar(this, regionreport.txtfrmdate, "mm/dd/yyyy")' onfocus="abc();" height=14 width=14/>
                                                                </ContentTemplate>
                                                            </asp:UpdatePanel>
                                                        </td>
													...
													<td align="left">
														...
														<td  align="left">
                                                            <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                                                <ContentTemplate>
                                                                    <asp:TextBox id="txttodate1" runat="server" CssClass="btext1" MaxLength="12" ></asp:TextBox>
                                                                    <img src='Images/cal1.gif'  onclick='popUpCalendar(this, regionreport.txttodate1, "mm/dd/yyyy")' onfocus="abc();" height="14" width="14"/>
                                                                </ContentTemplate>
                                                            </asp:UpdatePanel>
                                                        </td>
														...
														<td  align="left">
                                                            <asp:UpdatePanel ID="UpdatePane21" runat="server">
                                                                <ContentTemplate>
                                                                <asp:ListBox id="dpregion" runat="server" CssClass="btext1" Height ="66px" SelectionMode="Multiple" Width="144px" meta:resourcekey="dpadcatgoryResource1">
                                                       ...
                                                       <%-- <tr>
														...
														<td  align="left">
                                                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                                <ContentTemplate>
                                                        <asp:TextBox ID="txtproduct" runat="server" CssClass="btext1"></asp:TextBox>
                                                    </ContentTemplate>
                                                            </asp:UpdatePanel>
                                                        </td>
