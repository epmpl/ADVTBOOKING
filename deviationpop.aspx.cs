...
public partial class deviationpop : System.Web.UI.Page
{
    string fromdate = "";
    string todate = "";
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        heading.Text = ds.Tables[0].Rows[0].ItemArray[49].ToString();
        ...
        if (!Page.IsPostBack)
        {
           ...
           // bindregion();
            ...
            BtnRun.Attributes.Add("onclick", "drill_outdeviation();");           
            Btnreset .Attributes .Add ("onclick","javascript:return deviationreset();");
            bindsortvalue();
            bindsort();
    ...
    public void bindsortvalue()
    {
        ...
        for (i = 0; i < sortvalue.Tables[1].Columns.Count; i++)
        {
            ListItem li;
            li = new ListItem();
            li.Text = sortvalue.Tables[1].Rows[0].ItemArray[i].ToString();
            i = i + 1;
            li.Value = sortvalue.Tables[1].Rows[0].ItemArray[i].ToString();
    ...
    protected void dpdadtype_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        // ScriptManager.RegisterClientScriptBlock(this, typeof(deviationpop), "sa", "document.getElementById('dpdadtype').focus();", true);
    }
    ...
    protected void DropDownList1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        //ScriptManager.RegisterClientScriptBlock(this, typeof(deviationpop), "sa", "document.getElementById('dppubcent').focus();", true);
    }
    protected void dppub1_SelectedIndexChanged2(object sender, EventArgs e)
    {
      ...
      // ScriptManager.RegisterClientScriptBlock(this, typeof(deviationpop), "sa", "document.getElementById('dppub1').focus();", true);
    }
}
