<%@ Page Language="C#" AutoEventWireup="true" CodeFile="approvalAttachment.aspx.cs" Inherits="approvalAttachment" ValidateRequest="false" %>
...
<head runat="server">
    ...
    { 
        ...
        window.opener.document.getElementById('hidattach1').value=document.getElementById('lebforattach').textContent;
        }
        else
        {
         window.opener.document.getElementById('hidattach1').value=document.getElementById('lebforattach').innerText;
        }
    ...
    if (document.getElementById('hidfilepth').value==""){
        ...
        {
           //window.open(document.getElementById('hidfilepth').value + document.getElementById('lblfilename').innerHTML);
            window.open("http://202.54.139.23/attachfileprevordown/Default.aspx?xab=" + document.getElementById('lblfilename').innerHTML);
        }
        return false;
    }
    ...
    {
    if (document.getElementById('hidfilepth').value==""){
        window.open("ApprovalAttachment/" + filename);
        }
        else
        {
            //window.open(document.getElementById('hidfilepth').value +filename);
            window.open("http://202.54.139.23/attachfileprevordown/Default.aspx?xab=" + filename);
        }
...
<body onload="javascript:return selval();">
    ...
    <div style="overflow:auto; height:100">
                             ...
                             <input id="hidfilepth" type="hidden" size="1" name="Hidden2" runat="server" />
    </form>
</body>
</html>
