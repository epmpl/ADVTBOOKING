...
<div class="n_topbar">
	...
	<div  class="n_logo"><img id="imglogo" runat="server" height="68" /></div>
	<div class="n_top">
  	     <div class="n_t_inside">
        	<ul>
            	<li runat="server"  id="_lbuser" >.</li>
                <li runat="server"  id="_user" ></li>
                <li runat="server" style="margin-left:10px;" id="_lbcom" ></li>
                <li runat="server" ID="_com" ></li>
                <li runat="server" style="margin-left:10px;" Id="_lbadmin"></li>
                <li runat="server" id="_admin"></li>
            </ul>
             <ul>
            <li runat="server"   style="text-align:left"  id="_lbdatetime" ></li>
                <li runat="server" style="text-align:left"   id="_datetime" ></li>
            </ul>
        </div>
       <div class="clear"></div>
        <div class="n_t_inside2">
        	<ul>
        	<li><asp:Label ID="lbladaccount" runat="server" CssClass="newDAMS" ForeColor="#5050A4" onclick="javascript:return openadaccount();"> Ad-Accounts |</asp:Label></li>
        	<li><asp:Label ID="lbllayoutx" runat="server" CssClass="newDAMS" ForeColor="#5050A4" onclick="javascript:return openlay();"> Layout-X |</asp:Label></li>
        	<li><asp:Label ID="lblcir" runat="server" CssClass="newDAMS" ForeColor="#5050A4" onclick="javascript:return opencir();"> Circulation |</asp:Label></li>
        	<li ><asp:Label ID="lbldashboard" runat="server" CssClass="DisplayAd" ForeColor="#5050A4">Dashboard |</asp:Label></li>
        	<li><asp:Label ID="lblpam" runat="server" CssClass="newDAMS" ForeColor="#5050A4" onclick="javascript:return openpam();"> PAM |</asp:Label></li>
        	<li><asp:Label ID="lblnews" runat="server" CssClass="newDAMS" ForeColor="#5050A4"  onclick="javascript:return opennew();"> NewsPrint |</asp:Label></li>
        	<li><asp:Label ID="lblpayroll" runat="server" CssClass="newDAMS" ForeColor="#5050A4" onclick="javascript:return openpay();"> Payroll |</asp:Label></li>
        	<li><asp:Label ID="lblfinance" runat="server" CssClass="newDAMS" ForeColor="#5050A4" onclick="javascript:return openfin();"> Finance |</asp:Label></li>
        	
        	<li ><asp:Label ID="lblciodashboard" style="cursor:pointer;" runat="server" CssClass="newDAMS" ForeColor="#5050A4"> <span onclick="opendashboard();">CIODashboard |</span></asp:Label></li>
                <li ><asp:Label ID="lblintranet" style="cursor:pointer;" runat="server" CssClass="newDAMS" ForeColor="#5050A4"> <span onclick="openintranet();">Intranet |</span></asp:Label></li>              
        	<li class="lougout " id="Formnamezz" onclick="javascript:return logoutpage();">Logout</li>
                ...
                <li ><asp:Label ID="Label3" runat="server" CssClass="newDAMS" ForeColor="#5050A4" > <span onclick="openlayout();">Layout-X |</span></asp:Label></li>
                <li ><asp:Label ID="Label4" runat="server" CssClass="News-Wrap" ForeColor="#5050A4"> News-Wrap |</asp:Label></li>
                <li ><asp:Label ID="lblcir1" runat="server" CssClass="newDAMS" ForeColor="#5050A4"> <span onclick="openCirculation();">Circulation |</span></asp:Label></li>
                <li class="lougout " id="Formnamezz" onclick="javascript:return logoutpage();">Logout</li>
