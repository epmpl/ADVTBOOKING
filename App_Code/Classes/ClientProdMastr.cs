...
public class ClientProdMastr: connection
{
    ...
    public DataSet clientbind(string userid, string compcode,string custcode)
    {
        ...
        try
        {
            ...
            objSqlCommand = GetCommand("websp_clientbind", ref objSqlConnection);
		...
		public DataSet insertclientcode(string client_code,string client_name,string product_code,string compcode,string userid, string execcode1)
		{
			SqlConnection objSqlConnection;
			SqlCommand objSqlCommand;
			objSqlConnection = GetConnection();
			...
			{
				objSqlConnection.Open();
				objSqlCommand = GetCommand("insertclientprod1", ref objSqlConnection);
				objSqlCommand.CommandType = CommandType.StoredProcedure;
             ...
             //   objSqlCommand.Parameters["@userid"].Value = userid;
                ...
                objSqlCommand.Parameters["@exec_code"].Value = execcode1;
    ...
    public DataSet deleteclientprod(string client_code, string client_name, string product_name, string compcode, string userid, string client_prod_code)
		{
			...
			{
				con.Open();
                com = GetCommand("delclientprod", ref con);
				com.CommandType=CommandType.StoredProcedure;
                ...
                com.Parameters.Add("@product_name", SqlDbType.VarChar);
                com.Parameters["@product_name"].Value = product_name;

                com.Parameters.Add("@client_prod_code", SqlDbType.VarChar);
                com.Parameters["@client_prod_code"].Value = client_prod_code;
    ...
    public DataSet contactbind12(string client_code, string userid, string compcode,string client_prod_code)
    {
        ...
        {
            objSqlConnection.Open();
            objSqlCommand = GetCommand("websp_clientbind12", ref objSqlConnection);
            objSqlCommand.CommandType = CommandType.StoredProcedure;
            ...
            objSqlCommand.Parameters.Add("@client_prod_code", SqlDbType.VarChar);
            objSqlCommand.Parameters["@client_prod_code"].Value = client_prod_code;
    ...
    public DataSet chk(string client_code, string product_code, string compcode, string userid, string exec_code)
    {
        ...
        {
            con.Open();
            com = GetCommand("chkclientprod", ref con);
            com.CommandType = CommandType.StoredProcedure;
    ...
    public DataSet updateclientcode(string client_code, string client_name, string product_code, string compcode, string userid, string client_prod_code, string exec_code)
    {
        ...
        {
            objSqlConnection.Open();
            objSqlCommand = GetCommand("updateclientprod", ref objSqlConnection);
            objSqlCommand.CommandType = CommandType.StoredProcedure;
