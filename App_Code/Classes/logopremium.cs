...
namespace NewAdbooking.Classes
{
    ...
    /// </summary>
    public class logopremium : connection
    {
        public logopremium()
        {
            //
        ...
        public DataSet chkpastypename1(string PosTypCode, string PosTypName, string compcode, string userid, string fdate, string tdate, string flag)
        {
            ...
            try
            {
                ...
                objSqlCommand = GetCommand("logopremiumTypechknameindate", ref objSqlConnection);
        ...
        public DataSet chkadvposition1(string str)
        {
            ...
            {
                objSqlConnection.Open();
                objSqlCommand = GetCommand("chkadvlogtyp", ref objSqlConnection);
                objSqlCommand.CommandType = CommandType.StoredProcedure;
        ...
        public DataSet SelectValue(string PosTypCode, string PosType, string Alias, string amount, string premium, string compcode, string userid, string dateformat)
        {
            ...
            {
                objSqlConnection.Open();
                objSqlCommand = GetCommand("logopremiumTypeSelect", ref objSqlConnection);
                objSqlCommand.CommandType = CommandType.StoredProcedure;
        ...
        public DataSet ModifyValue(string PosTypCode, string PosType, string Alias, string amount, string premium, string compcode, string userid, string fdate, string tdate, string dateformat)
        {
            ...
            {
                objSqlConnection.Open();
                objSqlCommand = GetCommand("logoTypeMstModify", ref objSqlConnection);
                objSqlCommand.CommandType = CommandType.StoredProcedure;
        ...
        public DataSet delete1(string PosTypCode, string compcode, string userid)
        {
            ...
            {
                objSqlConnection.Open();
                objSqlCommand = GetCommand("logotypedel", ref objSqlConnection);
                objSqlCommand.CommandType = CommandType.StoredProcedure;
        ...
        public DataSet chksave(string PosTypCode, string compcode, string userid)
        {
            ...
            {
                objSqlConnection.Open();
                objSqlCommand = GetCommand("logoTypechk", ref objSqlConnection);
                objSqlCommand.CommandType = CommandType.StoredProcedure;
        ...
        public DataSet InsertValue(string PosTypCode, string PosType, string Alias, string amount, string premium, string compcode, string userid, string fdate, string tdate, string dateformat)
        {
            ...
            {
                objSqlConnection.Open();
                objSqlCommand = GetCommand("LogTypeMstInser", ref objSqlConnection);
                objSqlCommand.CommandType = CommandType.StoredProcedure;
        ...
        public DataSet logobind1( string compcode,string logocode)
        {
            ...
            {
                objSqlConnection.Open();
                objSqlCommand = GetCommand("logobind1", ref objSqlConnection);
                objSqlCommand.CommandType = CommandType.StoredProcedure;
        ...
        public DataSet save(string compcode, string userid, string logoprem, string edition, string premimum, string amount, string validfrom, string validto)
        {
            ...
            {
                objSqlConnection.Open();
                objSqlCommand = GetCommand("savelogochild", ref objSqlConnection);
                objSqlCommand.CommandType = CommandType.StoredProcedure;
                ...
                objSqlCommand.Parameters.Add("@pvalidfrom", SqlDbType.VarChar);
                objSqlCommand.Parameters["@pvalidfrom"].Value = validfrom;


                objSqlCommand.Parameters.Add("@pvalidto", SqlDbType.VarChar);
                objSqlCommand.Parameters["@pvalidto"].Value = validto;
        ...
        public DataSet update1(string COMP_CODE, string USERID, string LOGOPREMIUM_CODE, string EDITION, string AMOUNT, string premimum, string hdnsequenceno)
        {
            ...
            {
                objSqlConnection.Open();
                objSqlCommand = GetCommand("updatelogochild", ref objSqlConnection);
                objSqlCommand.CommandType = CommandType.StoredProcedure;
        ...
        public DataSet logobind(string compcode, string logocode)
        {
            ...
            {
                objSqlConnection.Open();
                objSqlCommand = GetCommand("logobind", ref objSqlConnection);
                objSqlCommand.CommandType = CommandType.StoredProcedure;
        ...
        //}
         ...
         public DataSet Delete(string compcode,string amount)
         {
             ...
             {
                 objSqlConnection.Open();
                 objSqlCommand = GetCommand("dellogo", ref objSqlConnection);
                 objSqlCommand.CommandType = CommandType.StoredProcedure;
         ...
         public DataSet duplicay1(string compcode,string logoprem,string edition)
         {
             ...
             {
                 objSqlConnection.Open();
                 objSqlCommand = GetCommand("duplicaylogobind", ref objSqlConnection);
                 objSqlCommand.CommandType = CommandType.StoredProcedure;
         ...
         public DataSet bindedition11( string compcode)
         {
             ...
             {
                 objSqlConnection.Open();
                 objSqlCommand = GetCommand("bindedition1", ref objSqlConnection);
                 objSqlCommand.CommandType = CommandType.StoredProcedure;
