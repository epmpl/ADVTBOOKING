...
{
    public class clientexecmastr:orclconnection
    {
        ...
        public DataSet clientbind(string userid, string compcode, string custcode)
        {
            ...
            {
                objOracleConnection.Open();
                objOraclecommand = GetCommand("websp_clientbindexec.websp_clientbindexec_p", ref objOracleConnection);
                objOraclecommand.CommandType = CommandType.StoredProcedure;
        ...
        public DataSet insertclientcode(string client_code, string client_name, string exec_code, string compcode, string userid)
        {
            ...
            {
                objOracleConnection.Open();
                objOraclecommand = GetCommand("insertclientexec.insertclientexec_p", ref objOracleConnection);
                objOraclecommand.CommandType = CommandType.StoredProcedure;
        ...
        public DataSet deleteclientprod(string client_code, string client_name, string exec_name, string compcode, string userid, string client_exec_code)
        {
            OracleConnection objOracleConnection;
            OracleCommand objOraclecommand;
            DataSet objDataSet = new DataSet();
            ...
            {
                objOracleConnection.Open();
                objOraclecommand = GetCommand("delclientexec1.delclientexec1_p", ref objOracleConnection);
                objOraclecommand.CommandType = CommandType.StoredProcedure;
                ...
                OracleParameter prm6 = new OracleParameter("pexec_name", OracleType.VarChar, 50);
                prm6.Direction = ParameterDirection.Input;
                prm6.Value = exec_name;
                objOraclecommand.Parameters.Add(prm6);

                OracleParameter prm7 = new OracleParameter("pclient_exec_code", OracleType.VarChar, 50);
                prm7.Direction = ParameterDirection.Input;
                prm7.Value = client_exec_code;
                objOraclecommand.Parameters.Add(prm7);
        ...
        public DataSet contactbind12(string client_code, string userid, string compcode, string client_prod_code)
        {
            ...
            {
                objOracleConnection.Open();
                objOraclecommand = GetCommand("websp_clientexecbind12.websp_clientexecbind12_p", ref objOracleConnection);
                objOraclecommand.CommandType = CommandType.StoredProcedure;
        ...
        public DataSet chk(string client_code, string exec_code, string compcode, string userid)
        {
            ...
            {
                objOracleConnection.Open();
                objOraclecommand = GetCommand("chkclientexec.chkclientexec_p", ref objOracleConnection);
                objOraclecommand.CommandType = CommandType.StoredProcedure;
        ...
        public DataSet updateclientcode(string client_code, string client_name, string exec_code, string compcode, string userid, string client_prod_code)
        {
            ...
            {
                objOracleConnection.Open();
                objOraclecommand = GetCommand("updateclientexec.updateclientexec_p", ref objOracleConnection);
                objOraclecommand.CommandType = CommandType.StoredProcedure;
