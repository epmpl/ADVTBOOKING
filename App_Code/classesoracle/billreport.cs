...
namespace NewAdbooking.classesoracle
{
    ...
    public class billreport : orclconnection
    {
        ...
        public DataSet spcontractreportnew(string fromdate, string dateto, string compcode, string dateformat, string product, string descid, string ascdesc, string temp1, string temp2, string temp3, string temp4, string temp5, string temp6, string temp7, string temp8, string temp9, string temp10, string temp11)
        {
            OracleConnection objOracleConnection;
            OracleCommand objOraclecommand;
            DataSet objDataSet = new DataSet();
        ...
        public DataSet retainonscreen(string fromdate, string dateto, string region, string product, string compcode, string dateformat, string descid, string ascdesc, string temp1, string temp2, string temp3, string temp4, string temp5, string temp6, string branch ,string edition ,string retainer ,string addtype)
        {
            OracleConnection objOracleConnection;
            OracleCommand objOraclecommand;
            DataSet objDataSet = new DataSet();
            ...
            try
            {
                ...
                objOracleConnection.Open();
                objOraclecommand = GetCommand("SACHI_Bill_Reportnew3331", ref objOracleConnection);
                objOraclecommand.CommandType = CommandType.StoredProcedure;
