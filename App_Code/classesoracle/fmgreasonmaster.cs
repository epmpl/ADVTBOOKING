...
{
    public class fmgreasonmaster : orclconnection
    {
        ...
        public DataSet gencodfmg(string compcod, string desc)
        {
            ...
            {
                con.Open();
                cmd = GetCommand("Ad_Gen_Code_fmg", ref con);
                cmd.CommandType = CommandType.StoredProcedure;
                ...
                OracleParameter prm6 = new OracleParameter("pdescp", OracleType.VarChar, 2000);
                prm6.Direction = ParameterDirection.Input;
                prm6.Value = desc;
                cmd.Parameters.Add(prm6);
