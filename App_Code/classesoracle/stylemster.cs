...
namespace NewAdbooking.classesoracle
{
    ...
    /// <summary>
    /// Summary description for stylemster
    /// </summary>
    public class stylemster : orclconnection
    {
        public stylemster()
        {
            //
        ...
        public DataSet update1(string COMP_CODE, string USERID, string LOGOPREMIUM_CODE, string EDITION, string AMOUNT, string PREMIUM, string hdnsequenceno, string validfrom, string validto)
        {
            ...
            try
            {
                ...
                objOraclecommand = GetCommand("stylebulletchild", ref objOracleConnection);
        ...
        public DataSet duplicay1(string pcompcode, string pdesigntypecode, string validfrom, string validto)
        {
            ...
            {
                objOracleConnection.Open();
                objOraclecommand = GetCommand("duplicaystyletbind", ref objOracleConnection);
                objOraclecommand.CommandType = CommandType.StoredProcedure;
        ...
        public DataSet Delete(string compcode, string amount)
        {
            ...
            {
                objOracleConnection.Open();
                objOraclecommand = GetCommand("delstyle", ref objOracleConnection);
                objOraclecommand.CommandType = CommandType.StoredProcedure;
        ...
        public DataSet logobind(string compcode, string logocode)
        {
            ...
            {
                objOracleConnection.Open();
                objOraclecommand = GetCommand("stylebind", ref objOracleConnection);
                objOraclecommand.CommandType = CommandType.StoredProcedure;
        ...
        public DataSet save1(string compcode, string userid, string logoprem, string edition, string premimum, string amount, string validfrom, string validto)
        {
            ...
            {
                objOracleConnection.Open();
                objOraclecommand = GetCommand("savestylechild", ref objOracleConnection);
                objOraclecommand.CommandType = CommandType.StoredProcedure;
        ...
        public DataSet logobind1(string compcode, string logocode, string bulletcode)
        {
            ...
            {
                objOracleConnection.Open();
                objOraclecommand = GetCommand("stylebind1", ref objOracleConnection);
                objOraclecommand.CommandType = CommandType.StoredProcedure;
        ...
        public DataSet delete1(string PosTypCode, string compcode, string userid)
        {
            ...
            {
                objOracleConnection.Open();
                objOraclecommand = GetCommand("styTypedel.styTypedel_P", ref objOracleConnection);
                objOraclecommand.CommandType = CommandType.StoredProcedure;
        ...
        public DataSet ModifyValue(string PosTypCode, string PosType, string Alias, string amount, string premium, string compcode, string userid, string fdate, string tdate, string dateformat, string description)
        {
            ...
            {
                objOracleConnection.Open();
                objOraclecommand = GetCommand("STYLETypeMstModify.STYLETypeMstModify_P", ref objOracleConnection);
                objOraclecommand.CommandType = CommandType.StoredProcedure;
        ...
        public DataSet SelectValue(string PosTypCode, string PosType, string Alias, string amount, string premium, string compcode, string userid, string dateformat)
        {
            ...
            {
                objOracleConnection.Open();
                objOraclecommand = GetCommand("AdvstyTypeSelect.AdvstyTypeSelect_P", ref objOracleConnection);
                objOraclecommand.CommandType = CommandType.StoredProcedure;
        ...
        public DataSet chksave(string PosTypCode, string compcode, string userid)
        {
            ...
            {
                objOracleConnection.Open();
                objOraclecommand = GetCommand("styleTypechk.styleTypechk_p", ref objOracleConnection);
                objOraclecommand.CommandType = CommandType.StoredProcedure;
        ...
        public DataSet InsertValue(string PosTypCode, string PosType, string Alias, string amount, string premium, string compcode, string userid, string fdate, string tdate, string dateformat, string description)
        {
            OracleConnection objOracleConnection;
            OracleCommand objOraclecommand;
            DataSet objDataSet = new DataSet();
            ...
            {
                objOracleConnection.Open();
                objOraclecommand = GetCommand("styleTypeMstInsert.styleTypeMstInsert_p", ref objOracleConnection);
                objOraclecommand.CommandType = CommandType.StoredProcedure;
        ...
        public DataSet chkpastypename1(string PosTypCode, string PosTypName, string compcode, string userid, string fdate, string tdate, string flag)
        {
            ...
            {
                objOracleConnection.Open();
                objOraclecommand = GetCommand("styleTypechkname", ref objOracleConnection);
                objOraclecommand.CommandType = CommandType.StoredProcedure;
        ...
        public DataSet chkadvposition1(string str)
        {
            ...
            {
                objOracleConnection.Open();
                objOraclecommand = GetCommand("chkadvstytyp.chkadvstytyp_P", ref objOracleConnection);
                objOraclecommand.CommandType = CommandType.StoredProcedure;
