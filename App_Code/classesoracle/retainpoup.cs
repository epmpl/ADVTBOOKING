...
namespace NewAdbooking.classesoracle
{
    ...
    public class retainpoup : orclconnection
    {
        public retainpoup()
        {
            //
        ...
        public DataSet duplicasy_ckeck(string compcode, string execcode, string agencycode, string fromdate, string todate, string dateformat)
        {
            ...
            {
                objOracleConnection.Open();
                objOraclecommand = GetCommand("AD_RETAIN_DUP", ref objOracleConnection);
                objOraclecommand.CommandType = CommandType.StoredProcedure;
                ...
                OracleParameter prm2 = new OracleParameter("pret_code", OracleType.VarChar, 50);
                prm2.Direction = ParameterDirection.Input;
                prm2.Value = execcode;
                objOraclecommand.Parameters.Add(prm2);
        ...
        public DataSet savedata_table(string compcode, string agencycode, string days, string limit, string recovery, string fromdate, string todate, string execcode, string createdby, string createddt, string updatedby, string updateddt, string dateformat)
        {
            ...
            {
                objOracleConnection.Open();
                objOraclecommand = GetCommand("AD_RETAIN_insert", ref objOracleConnection);
                objOraclecommand.CommandType = CommandType.StoredProcedure;
                ...
                OracleParameter prm8 = new OracleParameter("pret_code", OracleType.VarChar, 50);
                prm8.Direction = ParameterDirection.Input;
                prm8.Value = execcode;
                objOraclecommand.Parameters.Add(prm8);
        ...
        public DataSet binddata_grid(string compcode, string agencycode)
        {
            ...
            {
                objOracleConnection.Open();
                objOraclecommand = GetCommand("AD_RETAIN_CREDIT_BIND", ref objOracleConnection);
                objOraclecommand.CommandType = CommandType.StoredProcedure;
                ...
                OracleParameter prm2 = new OracleParameter("retaincode", OracleType.VarChar, 50);
                prm2.Direction = ParameterDirection.Input;
                prm2.Value = agencycode;
                objOraclecommand.Parameters.Add(prm2);
        ...
        public DataSet mdy_table(string compcode, string agencycode, string days, string limit, string recovery, string fromdate, string todate, string execcode, string createdby, string createddt, string updatedby, string updateddt, string dateformat, string slab_no)
        {
            ...
            {
                objOracleConnection.Open();
                objOraclecommand = GetCommand("AD_RETAIN_update", ref objOracleConnection);
                objOraclecommand.CommandType = CommandType.StoredProcedure;
                ...
                OracleParameter prm8 = new OracleParameter("pretain_code", OracleType.VarChar, 50);
                prm8.Direction = ParameterDirection.Input;
                prm8.Value = execcode;
                objOraclecommand.Parameters.Add(prm8);
                ...
                OracleParameter prm13 = new OracleParameter("pretain_slab_sno", OracleType.VarChar, 50);
        ...
        public DataSet delete_data(string compcode, string execcode, string slab_no)
        {
            ...
            {
                objOracleConnection.Open();
                objOraclecommand = GetCommand("AD_RETAIN_del", ref objOracleConnection);
                objOraclecommand.CommandType = CommandType.StoredProcedure;
