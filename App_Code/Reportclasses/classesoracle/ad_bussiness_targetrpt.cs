...
namespace NewAdbooking.Report.classesoracle
{
    ...
    /// </summary>
    public class ad_bussiness_targetrpt : orclconnection
    {
        ...
        public DataSet agencyxls(string compcode, string agen)
        {
            ...
            {
                objOracleConnection.Open();
                objOraclecommand = GetCommand("targetanalysis_rePf2", ref objOracleConnection);
                objOraclecommand.CommandType = CommandType.StoredProcedure;
        ...
        public DataSet bussinesstargetreport(string compcode,string pub_center,string branch, string publication,string edition,string agency_code,string client_code,string executive_code, string adtype, string uom,string agency_pay, string datefrom, string todate, string dateformat, string userid,string chk_access, string extra1, string extra2)
        {
            OracleConnection objOracleConnection;
            OracleCommand objOraclecommand;
            DataSet objDataSet = new DataSet();
        ...
        public DataSet getexcname(string CompCode, string getexccode)
        {
            ...
            {
                con.Open();
                string query = "select AD_GET_EXECNAME('" + CompCode + "','" + getexccode + "') from dual";
