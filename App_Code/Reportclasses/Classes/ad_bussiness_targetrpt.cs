...
namespace NewAdbooking.Report.Classes
{
    ...
    /// <summary>
    /// Summary description for ad_bussiness_targetrpt
    /// </summary>
    public class ad_bussiness_targetrpt : connection
    {
        public ad_bussiness_targetrpt()
        {
            //
        ...
        public DataSet agencyxls(string compcode, string agen)
        {
            ...
            {
                objSqlConnection.Open();
                objSqlCommand = GetCommand("targetanalysis_rePf2", ref objSqlConnection);
                objSqlCommand.CommandType = CommandType.StoredProcedure;
                ...
                objSqlCommand.Parameters["@agency"].Value = agen;
        ...
        public DataSet bussinesstargetreport(string compcode,  string publication,   string adtype, string uom,   string datefrom, string todate, string dateformat, string userid, string extra1, string extra2)
        {
            SqlConnection objSqlConnection;
            SqlCommand objSqlCommand;
            objSqlConnection = GetConnection();
            ...
            {
                objSqlConnection.Open();
                objSqlCommand = GetCommand("ad_rep_bussiness_target", ref objSqlConnection);
                objSqlCommand.CommandType = CommandType.StoredProcedure;
                ...
                {
                    objSqlCommand.Parameters["@puom_code"].Value = uom;
                }
 ...
 public DataSet getexcname(string CompCode, string getexccode)
        {
            SqlConnection objSqlConnection;
            SqlCommand objSqlCommand;
            objSqlConnection = GetConnection();
            ...
            try
            {
                ...
                //string query = "select FA_GET_SEGMENT_NAME('" + CompCode + "','" + SegmentCode + "') from dual";
                string query = "select dbo.AD_GET_EXECNAME('" + CompCode + "','" + getexccode + "')";// from dual";
                //  objSqlCommand.CommandType = CommandType.StoredProcedure;
                objSqlDataAdapter = new SqlDataAdapter();
                objSqlCommand = new SqlCommand();
