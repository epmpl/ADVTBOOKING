...
public class PDFGenerator:System.Web.UI.Page
{
    ...
    public string Run(string sRawUrl)
    {
       ...
       // string sPage = Server.MapPath("" + sFileName + ".html");
        ...
        string[] names = new string[] { "<td  valign =\"middle\"  align =\"center\" style=\"font-family:Times New Roman ;font-size:20px;font-weight :bold \" >" };
        ...
        for (int i = 0; i < strd.Length; i++)
        {
            ...
            else
            {
                ...
                std = std + "<td  valign =\"middle\"  align =\"center\" style=\"font-family:Times New Roman ;font-size:20px;font-weight :bold \" ><h1>" + strd2[0] + "</span></h1>";
