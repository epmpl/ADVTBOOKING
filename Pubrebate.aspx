<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Pubrebate.aspx.cs" Inherits="Pubrebatet" %>
                                                ...
                                                <asp:DropDownList ID="drpbrand" runat="server" CssClass="dropdown" Enabled="False">
													...
													<tr >
														<td align="center">
                                                                ...
                                                                <ContentTemplate >
                                                                    <asp:button id="BtnRun" CssClass="btntext" Runat="server" OnClick="BtnRun_Click2"></asp:button>
