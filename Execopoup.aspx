<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Execopoup.aspx.cs" Inherits="Execopoup" EnableEventValidation="false" %>
...
<script type="text/javascript" language="javascript" src="javascript/AdvertisementMaster.js"></script>
		...
		<script type="text/javascript"  language="javascript" src="javascript/execopoup.js"></script>
...
<body onload="search_data();">
    ...
    <div style="height:200px;width:775px; margin-left:180px; margin-top: 8px; border:2px solid black; ">
    
    
    <div>
    
    
   <table id="table3" cellSpacing="0" cellPadding="0" width="775px" align="center" bgColor="#7daae3"
							border="0">
							<tr>
...
<td><asp:TextBox ID="txtcreditlimit" runat="server" CssClass="btext1" onkeypress="javascript:return isnumKey(event);" ></asp:TextBox></td>
  ...
  <td><asp:label id="lblrecovery" runat="server" CssClass="TextField"></asp:label></td>			
...
<div id="divcost" style="height:100px;width:775px;  margin-top: 8px; overflow:auto;"  >
<table>
...
<td   ><asp:Button ID="addrow" runat="server" text="addrow" style=" float:right"/></td>
</tr>
</table>
</div>
