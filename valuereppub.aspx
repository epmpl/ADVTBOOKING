<%@ Page Language="C#" AutoEventWireup="true" CodeFile="valuereppub.aspx.cs" Inherits="valuereppub" %>
                                                ...
                                                <asp:DropDownList ID="drpbrand" runat="server" CssClass="dropdown" Enabled="False">
													...
													<tr >
														...
														<asp:UpdatePanel ID ="updatepanelbtn" runat ="server">
                                                                ...
                                                                <ContentTemplate>    <asp:button id="BtnRun" CssClass="btntext" Runat="server" OnClick="BtnRun_Click" ></asp:button>
                                                                </ContentTemplate>
                                                                    </asp:UpdatePanel>
