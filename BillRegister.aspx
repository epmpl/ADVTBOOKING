<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BillRegister.aspx.cs" Inherits="BillRegister" %>
										...
										<tr>
											...
											<table width="0" border="0" cellspacing="0" cellpadding="2">
													...
													<td align="left">
                                                       ...
                                                       <asp:DropDownList id="dppublication" runat="server" CssClass="dropdown" OnSelectedIndexChanged="dppublication_SelectedIndexChanged" AutoPostBack="TRUE"></asp:DropDownList>
                                                       ...
                                                       <asp:DropDownList id="dpedition" runat="server" CssClass="dropdown" OnSelectedIndexChanged="dpedition_SelectedIndexChanged"></asp:DropDownList>
														...
														<td  align="left">
                                                            <asp:UpdatePanel ID="UpdatePane21" runat="server">
                                                                <ContentTemplate>
                                                                    <asp:DropDownList id="dpregion" runat="server" CssClass="dropdown" AutoPostBack="True"><%-- OnSelectedIndexChanged="dpregion_SelectedIndexChanged" >--%>
                                                                    </asp:DropDownList>
                                                                </ContentTemplate>
                                                            </asp:UpdatePanel>
                                                        </td>
