<%@ Page Language="C#" AutoEventWireup="true" CodeFile="style_premium.aspx.cs" Inherits="style_premium" %>
...
<head id="Head1" runat="server">
    ...
    <title>Bullet Premium Child</title>
     ...
     <script language="javascript" src="javascript/style_premium.js" type="text/javascript"></script>
    ...
    <tr>
							 ...
							 <td><asp:Label ID="premium" runat="server" CssClass="TextField"></asp:Label></td>
							  ...
							  <asp:ListItem Value="fix" Text="Fixed"></asp:ListItem>
							    <asp:ListItem Value="per" Text="Percent"></asp:ListItem>
							  </asp:DropDownList>
									...
									<asp:datagrid    id="DataGrid1" runat="server" CssClass="dtGrid" 
                                        AllowSorting="True" AutoGenerateColumns="False" 
											...
											<asp:CheckBox ID="CheckBox1" CssClass="textfield1" Runat="server" />
												...
												<asp:BoundColumn Visible ="false"  DataField="STYLEPREMIUMDETCODE" SortExpression="STYLEPREMIUMDETCODE" HeaderText="STYLEPREMIUMDETCODE">
													<HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle"></HeaderStyle><ItemStyle HorizontalAlign="Center"></ItemStyle>
												</asp:BoundColumn>
